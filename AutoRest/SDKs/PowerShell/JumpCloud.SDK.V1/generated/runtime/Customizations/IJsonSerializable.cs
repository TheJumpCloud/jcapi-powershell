...
using JumpCloud.SDK.V1.Runtime.Json;
using System;
...
namespace JumpCloud.SDK.V1.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is JumpCloud.SDK.V1.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return JumpCloud.SDK.V1.Runtime.JsonSerializable.ToJson(dictionary, null);
            }

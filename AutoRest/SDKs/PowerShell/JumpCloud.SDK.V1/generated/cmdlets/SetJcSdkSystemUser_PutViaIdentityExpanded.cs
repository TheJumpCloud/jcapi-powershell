namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemUser_PutViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.ISystemuserreturn))]
    [JumpCloud.SDK.V1.Description(@"This endpoint allows you to update a system user.\n\n#### Sample Request\n\n```\ncurl -X PUT https://console.jumpcloud.com/api/systemusers/{UserID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""email\"":\""{email_address}\"",\n\t\""firstname\"":\""{Name}\"",\n\t\""lastname\"":\""{Name}\""\n}'\n```")]
    [JumpCloud.SDK.V1.Generated]
    public partial class SetJcSdkSystemUser_PutViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        public JumpCloud.SDK.V1.Models.ISystemuserputAddressesItem[] Addresses { get => Body.Addresses ?? null /* arrayOf */; set => Body.Addresses = value; }
        ...
        public JumpCloud.SDK.V1.Models.ISystemuserputAttributesItem[] Attributes { get => Body.Attributes ?? null /* arrayOf */; set => Body.Attributes = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloud.SDK.V1.Models.ISystemuserput _body= new JumpCloud.SDK.V1.Models.Systemuserput();

        /// <summary>SystemUserPut</summary>
        private JumpCloud.SDK.V1.Models.ISystemuserput Body { get => this._body; set => this._body = value; }
        ...
        public JumpCloud.SDK.V1.Models.ISystemuserputPhoneNumbersItem[] PhoneNumbers { get => Body.PhoneNumbers ?? null /* arrayOf */; set => Body.PhoneNumbers = value; }
        ...
        public JumpCloud.SDK.V1.Models.ISystemuserputRelationshipsItem[] Relationships { get => Body.Relationships ?? null /* arrayOf */; set => Body.Relationships = value; }
        ...
        public JumpCloud.SDK.V1.Models.ISshkeypost[] SshKeys { get => Body.SshKeys ?? null /* arrayOf */; set => Body.SshKeys = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystemUser_PutViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystemUser_PutViaIdentityExpanded()
        {

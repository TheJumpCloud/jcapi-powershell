...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V1.json#/paths/~1systemusers~1{id}'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: SystemUser
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemUser_PutViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.ISystemuserreturn))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to update a system user.\n\n#### Sample Request\n\n```\ncurl -X PUT https://console.jumpcloud.com/api/systemusers/{UserID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""email\"":\""{email_address}\"",\n\t\""firstname\"":\""{Name}\"",\n\t\""lastname\"":\""{Name}\""\n}'\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class SetJcSdkSystemUser_PutViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "type, poBox, extendedAddress, streetAddress, locality, region, postalCode, country")]
        [global::JumpCloud.SDK.V1.Category(global::JumpCloud.SDK.V1.ParameterCategory.Body)]
        [JumpCloud.SDK.V1.Runtime.Info(
        Required = false,
        ReadOnly = false,

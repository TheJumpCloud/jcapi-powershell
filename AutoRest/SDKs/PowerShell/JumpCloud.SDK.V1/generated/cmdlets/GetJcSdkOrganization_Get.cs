...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-Organization=>GET:"/organizations/{id}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V1.json#/paths/~1organizations~1{id}'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkOrganization_Get")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IOrganization))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint returns a particular Organization.\n\n#### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/organizations/{OrganizationID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class GetJcSdkOrganization_Get : global::System.Management.Automation.PSCmdlet,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetOrganization(Id, this.InvocationInformation.BoundParameters.ContainsKey("Fields") ? Fields : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onUnauthorized, onForbidden, this, Pipeline);

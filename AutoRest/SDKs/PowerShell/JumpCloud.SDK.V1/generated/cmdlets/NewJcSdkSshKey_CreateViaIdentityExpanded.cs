namespace JumpCloud.SDK.V1.Cmdlets
{
        ...
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V1.Models.ISshkeypost _body= new JumpCloud.SDK.V1.Models.Sshkeypost();

        /// <summary>SSHKeyPost</summary>
        private JumpCloud.SDK.V1.Models.ISshkeypost Body { get => this._body; set => this._body = value; }
        ...
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V1.Models.ISshkeylist> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V1.Models.ISshkeylist
                WriteObject((await response));
            }
        }
    }

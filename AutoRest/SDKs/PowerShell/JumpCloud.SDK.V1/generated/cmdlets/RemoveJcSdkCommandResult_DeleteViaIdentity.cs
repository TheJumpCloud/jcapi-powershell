...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"JcSdkCommandResult_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.ICommandresult))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint deletes a specific command result.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/commandresults/{CommandID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n  ````")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class RemoveJcSdkCommandResult_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,

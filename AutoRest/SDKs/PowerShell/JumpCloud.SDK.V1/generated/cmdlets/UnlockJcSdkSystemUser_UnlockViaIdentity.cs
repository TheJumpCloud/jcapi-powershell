namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V1.json#/paths/~1systemusers~1{id}~1unlock'
    /// [DETAILS]
    /// verb: Unlock
    /// subjectPrefix:
    /// subject: SystemUser
    /// variant: UnlockViaIdentity
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Unlock, @"JcSdkSystemUser_UnlockViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    [JumpCloud.SDK.V1.Description(@"This endpoint allows you to unlock a user's account.")]
    [JumpCloud.SDK.V1.Generated]
    public partial class UnlockJcSdkSystemUser_UnlockViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SystemUserUnlock(InputObject.Id ?? null, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  }));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UnlockJcSdkSystemUser_UnlockViaIdentity" /> cmdlet class.
        /// </summary>
        public UnlockJcSdkSystemUser_UnlockViaIdentity()
        {

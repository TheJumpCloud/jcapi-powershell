...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V1.json#/paths/~1commands'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    /// subject: Command
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"JcSdkInternalCommand_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.ICommand))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to create a new command.\n\n#### Sample Request\n\n```\ncurl -X POST https://console.jumpcloud.com/api/commands/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""name\"":\""Test API Command\"",\n\t\""command\"":\""String\"",\n\t\""user\"":\""{UserID}\"",\n\t\""schedule\"":\""\"",\n\t\""timeout\"":\""100\""\n}'\n\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class NewJcSdkInternalCommand_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkInternalCommand_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkInternalCommand_CreateExpanded()
        {

namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// variant: Put
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemUser_Put", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkSystemUser_Put : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserput _body;

        /// <summary>SystemUserPut</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SystemUserPut", ValueFromPipeline = true)]
        [JumpCloud.SDK.V1.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"SystemUserPut",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserput) })]
        public JumpCloud.SDK.V1.Models.ISystemuserput Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystemUser_Put" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystemUser_Put()
        {

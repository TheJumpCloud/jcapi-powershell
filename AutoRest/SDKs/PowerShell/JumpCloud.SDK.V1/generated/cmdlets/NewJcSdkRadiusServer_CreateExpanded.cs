namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IRadiusserver))]
    [JumpCloud.SDK.V1.Description(@"This endpoint allows you to create RADIUS servers in your organization.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/radiusservers/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""name\"": \""{test_radius}\"",\n    \""networkSourceIp\"": \""{0.0.0.0}\"",\n    \""sharedSecret\"":\""{secretpassword}\"",\n    \""userLockoutAction\"": \""REMOVE\"",\n    \""userPasswordExpirationAction\"": \""MAINTAIN\""\n}'\n```")]

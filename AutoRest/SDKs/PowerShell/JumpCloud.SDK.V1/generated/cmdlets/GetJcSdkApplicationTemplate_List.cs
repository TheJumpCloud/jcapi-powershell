...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V1.json#/paths/~1application-templates'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkApplicationTemplate_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IApplicationtemplateslist))]
    [global::JumpCloud.SDK.V1.Description(@"The endpoint returns all the SSO / SAML Application Templates.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/application-templates \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class GetJcSdkApplicationTemplate_List : global::System.Management.Automation.PSCmdlet,

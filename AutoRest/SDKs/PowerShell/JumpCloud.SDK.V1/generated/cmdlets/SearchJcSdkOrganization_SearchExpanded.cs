...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V1.json#/paths/~1search~1organizations'
    /// [DETAILS]
    /// verb: Search
    /// subjectPrefix:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Search, @"JcSdkOrganization_SearchExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IOrganizationslist))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint will return Organization data based on your search parameters. This endpoint WILL NOT allow you to add a new Organization.\n\nYou can use the supported parameters and pass those in the body of request. \n\nThe parameters must be passed as Content-Type application/json.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/search/organizations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  \""search\"":{\n    \""fields\"" : [\""settings.name\""],\n    \""searchTerm\"": \""Second\""\n    },\n  \""fields\"": [\""_id\"", \""displayName\"", \""logoUrl\""],\n  \""limit\"" : 0,\n  \""skip\"" : 0\n}'\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class SearchJcSdkOrganization_SearchExpanded : global::System.Management.Automation.PSCmdlet,

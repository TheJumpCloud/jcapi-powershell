...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkSystem_PutViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IJcSystem))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to update a system.\n\n#### Sample Request \n```\ncurl -X PUT https://console.jumpcloud.com/api/systems/{SystemID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""displayName\"":\""Name_Update\"",\n\t\""allowSshPasswordAuthentication\"":\""true\"",\n\t\""allowSshRootLogin\"":\""true\"",\n\t\""allowMultiFactorAuthentication\"":\""true\"",\n\t\""allowPublicKeyAuthentication\"":\""false\""\n}'\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class SetJcSdkSystem_PutViaIdentity : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SystemPut", ValueFromPipeline = true)]
        [JumpCloud.SDK.V1.Runtime.Info(
        Required = true,
        ReadOnly = false,

...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// variant: Delete
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"JcSdkSystemUser_Delete", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.ISystemuserreturn))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to delete a particular system user.\n\n#### Sample Request\n```\ncurl -X DELETE https://console.jumpcloud.com/api/systemusers/{UserID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class RemoveJcSdkSystemUser_Delete : global::System.Management.Automation.PSCmdlet,

namespace JumpCloud.SDK.V1.Cmdlets
{
        ...
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V1.Models.IBodyParameterOrganizationPutRequestBody _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.IBodyParameterOrganizationPutRequestBody) })]
        public JumpCloud.SDK.V1.Models.IBodyParameterOrganizationPutRequestBody Body { get => this._body; set => this._body = value; }

...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V1.json#/paths/~1organizations'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkOrganization_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IOrganizationslist))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint returns Organization Details.\n\n#### Sample Request \n\n```\ncurl -X GET \\\n  https://console.jumpcloud.com/api/organizations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class GetJcSdkOrganization_List : global::System.Management.Automation.PSCmdlet,

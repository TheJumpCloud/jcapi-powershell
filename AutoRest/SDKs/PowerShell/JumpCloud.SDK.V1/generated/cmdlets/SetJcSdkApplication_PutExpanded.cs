namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Application_Put=>PUT:"/applications/{id}"
    /// [METADATA]
    ...
    /// variant: PutExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkApplication_PutExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IApplication))]
    [JumpCloud.SDK.V1.Description(@"The endpoint updates a SSO / SAML Application.")]
    [JumpCloud.SDK.V1.Generated]
    public partial class SetJcSdkApplication_PutExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V1.Models.IApplication _body= new JumpCloud.SDK.V1.Models.Application();

        /// <summary>Application</summary>
        private JumpCloud.SDK.V1.Models.IApplication Body { get => this._body; set => this._body = value; }
        ...
        public JumpCloud.SDK.V1.Models.IApplicationConfig Config { get => Body.Config ?? null /* object */; set => Body.Config = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ApplicationPut' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ApplicationPut(Id, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, this.InvocationInformation.BoundParameters.ContainsKey("XOrgId") ? XOrgId : null, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkApplication_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkApplication_PutExpanded()
        {

namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class ApplicationtemplateConfigIdpPrivateKey :
        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKey,
        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyInternal
    {

        /// <summary>Internal Acessors for Tooltip</summary>
        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltip JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyInternal.Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloud.SDK.V1.Models.ApplicationtemplateConfigIdpPrivateKeyTooltip()); set { {_tooltip = value;} } }

        /// <summary>Internal Acessors for TooltipVariables</summary>
        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipVariables JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyInternal.TooltipVariables { get => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).Variables; set => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).Variables = value; }
        ...
        private JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltip _tooltip;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        internal JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltip Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloud.SDK.V1.Models.ApplicationtemplateConfigIdpPrivateKeyTooltip()); set => this._tooltip = value; }
        ...
        public string TooltipTemplate { get => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).Template; set => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).Template = value; }
        ...
        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public string VariableIcon { get => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableIcon; set => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableIcon = value; }

        /// <summary>FIXME: Property VariableMessage is MISSING DESCRIPTION</summary>
        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public string VariableMessage { get => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableMessage; set => ((JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableMessage = value; }
...

    {
        ...
        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltip Tooltip { get; set; }

        string TooltipTemplate { get; set; }

        JumpCloud.SDK.V1.Models.IApplicationtemplateConfigIdpPrivateKeyTooltipVariables TooltipVariables { get; set; }

...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Userput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IUserput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IUserput.</returns>
        public static JumpCloud.SDK.V1.Models.IUserput FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Userput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Userput" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Userput" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._growthData ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._growthData.ToJson(null,serializationMode) : null, "growthData" ,container.Add );
            AddIf( null != this._lastWhatsNewChecked ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) new JumpCloud.SDK.V1.Runtime.Json.JsonString(this._lastWhatsNewChecked?.ToString(@"yyyy-MM-dd",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "lastWhatsNewChecked" ,container.Add );
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Userput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Userput(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_growthData = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("growthData"), out var __jsonGrowthData) ? JumpCloud.SDK.V1.Models.UserputGrowthData.FromJson(__jsonGrowthData) : GrowthData;}
            {_lastWhatsNewChecked = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("lastWhatsNewChecked"), out var __jsonLastWhatsNewChecked) ? global::System.DateTime.TryParse((string)__jsonLastWhatsNewChecked, global::System.Globalization.CultureInfo.InvariantCulture, global::System.Globalization.DateTimeStyles.AdjustToUniversal, out var __jsonLastWhatsNewCheckedValue) ? __jsonLastWhatsNewCheckedValue : LastWhatsNewChecked : LastWhatsNewChecked;}

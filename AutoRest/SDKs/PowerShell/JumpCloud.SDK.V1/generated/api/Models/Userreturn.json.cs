...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Userreturn
    {
        ...
        internal Userreturn(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_growthData = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("growthData"), out var __jsonGrowthData) ? JumpCloud.SDK.V1.Models.UserreturnGrowthData.FromJson(__jsonGrowthData) : GrowthData;}

namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Systemuserreturn :
        ...
        JumpCloud.SDK.V1.Models.ISystemuserreturnInternal
    {
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserreturnAddressesItem[] _addresses;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISystemuserreturnAddressesItem[] Addresses { get => this._addresses; set => this._addresses = value; }
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserreturnAttributesItem[] _attributes;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISystemuserreturnAttributesItem[] Attributes { get => this._attributes; set => this._attributes = value; }

        /// <summary>Backing field for <see cref="BadLoginAttempts" /> property.</summary>
        private int? _badLoginAttempts;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public int? BadLoginAttempts { get => this._badLoginAttempts; set => this._badLoginAttempts = value; }
        ...
        JumpCloud.SDK.V1.Models.IMfa JumpCloud.SDK.V1.Models.ISystemuserreturnInternal.Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.V1.Models.Mfa()); set { {_mfa = value;} } }
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserreturnPhoneNumbersItem[] _phoneNumbers;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISystemuserreturnPhoneNumbersItem[] PhoneNumbers { get => this._phoneNumbers; set => this._phoneNumbers = value; }
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserreturnRelationshipsItem[] _relationships;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISystemuserreturnRelationshipsItem[] Relationships { get => this._relationships; set => this._relationships = value; }
        ...
        private JumpCloud.SDK.V1.Models.ISshkeylist[] _sshKeys;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISshkeylist[] SshKeys { get => this._sshKeys; set => this._sshKeys = value; }
        ...
        /// <summary>Creates an new <see cref="Systemuserreturn" /> instance.</summary>
        public Systemuserreturn()
        {
        ...
        JumpCloud.SDK.V1.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserreturnAddressesItem) })]
        JumpCloud.SDK.V1.Models.ISystemuserreturnAddressesItem[] Addresses { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserreturnAttributesItem) })]
        JumpCloud.SDK.V1.Models.ISystemuserreturnAttributesItem[] Attributes { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserreturnPhoneNumbersItem) })]
        JumpCloud.SDK.V1.Models.ISystemuserreturnPhoneNumbersItem[] PhoneNumbers { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserreturnRelationshipsItem) })]
        JumpCloud.SDK.V1.Models.ISystemuserreturnRelationshipsItem[] Relationships { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISshkeylist) })]
        JumpCloud.SDK.V1.Models.ISshkeylist[] SshKeys { get; set; }
    ...
    /// SystemUserReturn
    internal partial interface ISystemuserreturnInternal

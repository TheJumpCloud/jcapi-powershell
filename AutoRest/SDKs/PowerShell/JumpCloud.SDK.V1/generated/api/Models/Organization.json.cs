namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Organization
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IOrganization.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IOrganization.</returns>
        public static JumpCloud.SDK.V1.Models.IOrganization FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Organization(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Organization" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Organization(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_hasStripeCustomerId = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("hasStripeCustomerId"), out var __jsonHasStripeCustomerId) ? (bool?)__jsonHasStripeCustomerId : HasStripeCustomerId;}
            {_logoUrl = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("logoUrl"), out var __jsonLogoUrl) ? (string)__jsonLogoUrl : (string)LogoUrl;}
            ...
            {_settings = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("settings"), out var __jsonSettings) ? JumpCloud.SDK.V1.Models.Organizationsettings.FromJson(__jsonSettings) : Settings;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Organization" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Organization" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._hasStripeCustomerId ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._hasStripeCustomerId) : null, "hasStripeCustomerId" ,container.Add );
            AddIf( null != (((object)this._logoUrl)?.ToString()) ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) new JumpCloud.SDK.V1.Runtime.Json.JsonString(this._logoUrl.ToString()) : null, "logoUrl" ,container.Add );
            ...
            AddIf( null != this._settings ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._settings.ToJson(null,serializationMode) : null, "settings" ,container.Add );

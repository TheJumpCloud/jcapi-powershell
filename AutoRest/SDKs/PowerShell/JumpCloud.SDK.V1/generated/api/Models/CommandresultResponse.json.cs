namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class CommandresultResponse
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="CommandresultResponse" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal CommandresultResponse(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_data = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("data"), out var __jsonData) ? JumpCloud.SDK.V1.Models.CommandresultResponseData.FromJson(__jsonData) : Data;}
            {_error = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("error"), out var __jsonError) ? (string)__jsonError : (string)Error;}
            {_id = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("id"), out var __jsonId) ? (string)__jsonId : (string)Id;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.ICommandresultResponse.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.ICommandresultResponse.</returns>
        public static JumpCloud.SDK.V1.Models.ICommandresultResponse FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new CommandresultResponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="CommandresultResponse" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="CommandresultResponse" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._data ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._data.ToJson(null,serializationMode) : null, "data" ,container.Add );
            AddIf( null != (((object)this._error)?.ToString()) ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) new JumpCloud.SDK.V1.Runtime.Json.JsonString(this._error.ToString()) : null, "error" ,container.Add );

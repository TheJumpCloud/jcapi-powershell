namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Organizationsettingsput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IOrganizationsettingsput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IOrganizationsettingsput.</returns>
        public static JumpCloud.SDK.V1.Models.IOrganizationsettingsput FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Organizationsettingsput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Organizationsettingsput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Organizationsettingsput(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_features = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("features"), out var __jsonFeatures) ? JumpCloud.SDK.V1.Models.OrganizationsettingsputFeatures.FromJson(__jsonFeatures) : Features;}
            {_passwordPolicy = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("passwordPolicy"), out var __jsonPasswordPolicy) ? JumpCloud.SDK.V1.Models.OrganizationsettingsputPasswordPolicy.FromJson(__jsonPasswordPolicy) : PasswordPolicy;}
            {_userPortal = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("userPortal"), out var __jsonUserPortal) ? JumpCloud.SDK.V1.Models.OrganizationsettingsputUserPortal.FromJson(__jsonUserPortal) : UserPortal;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Organizationsettingsput" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Organizationsettingsput" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>

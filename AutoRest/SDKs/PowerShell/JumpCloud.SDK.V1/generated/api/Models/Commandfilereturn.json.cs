namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Commandfilereturn
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Commandfilereturn" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Commandfilereturn(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_results = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("results"), out var __jsonResults) ? JumpCloud.SDK.V1.Models.CommandfilereturnResults.FromJson(__jsonResults) : Results;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.ICommandfilereturn.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.ICommandfilereturn.</returns>
        public static JumpCloud.SDK.V1.Models.ICommandfilereturn FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Commandfilereturn(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Commandfilereturn" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Commandfilereturn" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._results ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._results.ToJson(null,serializationMode) : null, "results" ,container.Add );

...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Organizationsettings
    {
        ...
        internal Organizationsettings(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_betaFeatures = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("betaFeatures"), out var __jsonBetaFeatures) ? JumpCloud.SDK.V1.Models.OrganizationsettingsBetaFeatures.FromJson(__jsonBetaFeatures) : BetaFeatures;}
            ...
            {_disableCommandRunner = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("disableCommandRunner"), out var __jsonDisableCommandRunner) ? (bool?)__jsonDisableCommandRunner : DisableCommandRunner;}
            {_disableGoogleLogin = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("disableGoogleLogin"), out var __jsonDisableGoogleLogin) ? (bool?)__jsonDisableGoogleLogin : DisableGoogleLogin;}
            ...
            {_enableUserPortalAgentInstall = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("enableUserPortalAgentInstall"), out var __jsonEnableUserPortalAgentInstall) ? (bool?)__jsonEnableUserPortalAgentInstall : EnableUserPortalAgentInstall;}
            ...
            {_pendingDelete = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("pendingDelete"), out var __jsonPendingDelete) ? (bool?)__jsonPendingDelete : PendingDelete;}
        ...
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._betaFeatures ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._betaFeatures.ToJson(null,serializationMode) : null, "betaFeatures" ,container.Add );
            ...
            AddIf( null != this._disableCommandRunner ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._disableCommandRunner) : null, "disableCommandRunner" ,container.Add );
            AddIf( null != this._disableGoogleLogin ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._disableGoogleLogin) : null, "disableGoogleLogin" ,container.Add );
            ...
            AddIf( null != this._enableUserPortalAgentInstall ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._enableUserPortalAgentInstall) : null, "enableUserPortalAgentInstall" ,container.Add );
            ...
            AddIf( null != this._pendingDelete ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._pendingDelete) : null, "pendingDelete" ,container.Add );

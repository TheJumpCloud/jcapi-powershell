namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class SystemputAgentBoundMessagesItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.ISystemputAgentBoundMessagesItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.ISystemputAgentBoundMessagesItem.</returns>
        public static JumpCloud.SDK.V1.Models.ISystemputAgentBoundMessagesItem FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new SystemputAgentBoundMessagesItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="SystemputAgentBoundMessagesItem" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemputAgentBoundMessagesItem(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_cmd = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("cmd"), out var __jsonCmd) ? (string)__jsonCmd : (string)Cmd;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemputAgentBoundMessagesItem" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemputAgentBoundMessagesItem" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._cmd)?.ToString()) ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) new JumpCloud.SDK.V1.Runtime.Json.JsonString(this._cmd.ToString()) : null, "cmd" ,container.Add );

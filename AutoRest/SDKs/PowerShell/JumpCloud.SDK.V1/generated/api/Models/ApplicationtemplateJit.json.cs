namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class ApplicationtemplateJit
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationtemplateJit" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationtemplateJit(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_attributes = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloud.SDK.V1.Models.ApplicationtemplateJitAttributes.FromJson(__jsonAttributes) : Attributes;}
            {_createOnly = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("createOnly"), out var __jsonCreateOnly) ? (bool?)__jsonCreateOnly : CreateOnly;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IApplicationtemplateJit.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IApplicationtemplateJit.</returns>
        public static JumpCloud.SDK.V1.Models.IApplicationtemplateJit FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new ApplicationtemplateJit(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationtemplateJit" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationtemplateJit" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._createOnly ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._createOnly) : null, "createOnly" ,container.Add );

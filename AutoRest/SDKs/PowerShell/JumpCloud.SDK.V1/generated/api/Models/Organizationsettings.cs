...
namespace JumpCloud.SDK.V1.Models
{
        ...
        JumpCloud.SDK.V1.Models.IOrganizationsettingsInternal
    {
        ...
        private JumpCloud.SDK.V1.Models.IOrganizationsettingsBetaFeatures _betaFeatures;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.IOrganizationsettingsBetaFeatures BetaFeatures { get => (this._betaFeatures = this._betaFeatures ?? new JumpCloud.SDK.V1.Models.OrganizationsettingsBetaFeatures()); set => this._betaFeatures = value; }
        ...
        public bool? DirectoryInsightPremiumEnabled { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).DirectoryInsightPremiumEnabled; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).DirectoryInsightPremiumEnabled = value; }

        /// <summary>Backing field for <see cref="DisableCommandRunner" /> property.</summary>
        private bool? _disableCommandRunner;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public bool? DisableCommandRunner { get => this._disableCommandRunner; set => this._disableCommandRunner = value; }

        /// <summary>Backing field for <see cref="DisableGoogleLogin" /> property.</summary>
        private bool? _disableGoogleLogin;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public bool? DisableGoogleLogin { get => this._disableGoogleLogin; set => this._disableGoogleLogin = value; }
        ...
        /// <summary>Backing field for <see cref="EnableUserPortalAgentInstall" /> property.</summary>
        private bool? _enableUserPortalAgentInstall;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public bool? EnableUserPortalAgentInstall { get => this._enableUserPortalAgentInstall; set => this._enableUserPortalAgentInstall = value; }
        ...
        /// <summary>Internal Acessors for FeatureDirectoryInsightsPremium</summary>
        JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesDirectoryInsightsPremium JumpCloud.SDK.V1.Models.IOrganizationsettingsInternal.FeatureDirectoryInsightsPremium { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).DirectoryInsightsPremium; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).DirectoryInsightsPremium = value; }
        ...
        /// <summary>Backing field for <see cref="PendingDelete" /> property.</summary>
        private bool? _pendingDelete;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public bool? PendingDelete { get => this._pendingDelete; set => this._pendingDelete = value; }
        ...
        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewDarwin { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewDarwin; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewDarwin = value; }

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewLinux { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewLinux; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewLinux = value; }

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewWindows { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewWindows; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesInternal)Features).SystemInsightEnableNewWindows = value; }
        ...
        JumpCloud.SDK.V1.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.IOrganizationsettingsBetaFeatures) })]
        JumpCloud.SDK.V1.Models.IOrganizationsettingsBetaFeatures BetaFeatures { get; set; }
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? DisableCommandRunner { get; set; }
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? DisableGoogleLogin { get; set; }
        ...
        PossibleTypes = new [] { typeof(bool) })]
        bool? EnableUserPortalAgentInstall { get; set; }
...

    {
        ...
        JumpCloud.SDK.V1.Models.IOrganizationsettingsFeaturesDirectoryInsightsPremium FeatureDirectoryInsightsPremium { get; set; }

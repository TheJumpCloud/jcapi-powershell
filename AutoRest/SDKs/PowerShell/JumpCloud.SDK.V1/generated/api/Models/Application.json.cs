...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Application
    {
        ...
        internal Application(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_logo = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("logo"), out var __jsonLogo) ? JumpCloud.SDK.V1.Models.ApplicationLogo.FromJson(__jsonLogo) : Logo;}
            ...
            {_databaseAttributes = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("databaseAttributes"), out var __jsonDatabaseAttributes) ? If( __jsonDatabaseAttributes as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.V1.Models.IApplicationDatabaseAttributesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.V1.Models.IApplicationDatabaseAttributesItem) (JumpCloud.SDK.V1.Models.ApplicationDatabaseAttributesItem.FromJson(__u) )) ))() : null : DatabaseAttributes;}
        ...
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            if (null != this._databaseAttributes)
            {
                var __w = new JumpCloud.SDK.V1.Runtime.Json.XNodeArray();
                foreach( var __x in this._databaseAttributes )
                {
                    AddIf(__x?.ToJson(null, serializationMode) ,__w.Add);
                }
                container.Add("databaseAttributes",__w);
            }

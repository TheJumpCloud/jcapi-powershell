namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class UserGraphManagementReq
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IUserGraphManagementReq.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IUserGraphManagementReq.</returns>
        public static JumpCloud.SDK.V1.Models.IUserGraphManagementReq FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new UserGraphManagementReq(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReq" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReq" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReq" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReq(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_attributes = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloud.SDK.V1.Models.UserGraphManagementReqAttributes.FromJson(__jsonAttributes) : Attributes;}

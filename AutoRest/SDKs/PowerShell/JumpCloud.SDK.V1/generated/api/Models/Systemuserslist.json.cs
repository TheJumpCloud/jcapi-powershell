namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Systemuserslist
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.ISystemuserslist.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.ISystemuserslist.</returns>
        public static JumpCloud.SDK.V1.Models.ISystemuserslist FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Systemuserslist(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Systemuserslist" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Systemuserslist(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_results = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("results"), out var __jsonResults) ? If( __jsonResults as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.V1.Models.ISystemuserreturn[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.V1.Models.ISystemuserreturn) (JumpCloud.SDK.V1.Models.Systemuserreturn.FromJson(__u) )) ))() : null : Results;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Systemuserslist" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Systemuserslist" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>

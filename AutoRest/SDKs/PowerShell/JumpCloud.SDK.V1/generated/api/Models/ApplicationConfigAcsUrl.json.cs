namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class ApplicationConfigAcsUrl
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigAcsUrl" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigAcsUrl(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloud.SDK.V1.Models.ApplicationConfigAcsUrlTooltip.FromJson(__jsonTooltip) : Tooltip;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IApplicationConfigAcsUrl.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IApplicationConfigAcsUrl.</returns>
        public static JumpCloud.SDK.V1.Models.IApplicationConfigAcsUrl FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new ApplicationConfigAcsUrl(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigAcsUrl" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigAcsUrl" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class BodyParameterRadiusServerPutRequestBody
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="BodyParameterRadiusServerPutRequestBody" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal BodyParameterRadiusServerPutRequestBody(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_tags = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("tags"), out var __jsonTags) ? If( __jsonTags as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is JumpCloud.SDK.V1.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : Tags;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IBodyParameterRadiusServerPutRequestBody.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V1.Models.IBodyParameterRadiusServerPutRequestBody.
        /// </returns>
        public static JumpCloud.SDK.V1.Models.IBodyParameterRadiusServerPutRequestBody FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new BodyParameterRadiusServerPutRequestBody(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BodyParameterRadiusServerPutRequestBody" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BodyParameterRadiusServerPutRequestBody" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"
        /// />.
        /// </returns>

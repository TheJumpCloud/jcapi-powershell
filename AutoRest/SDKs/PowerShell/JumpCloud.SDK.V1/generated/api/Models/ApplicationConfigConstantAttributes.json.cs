namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class ApplicationConfigConstantAttributes
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigConstantAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigConstantAttributes(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloud.SDK.V1.Models.ApplicationConfigConstantAttributesTooltip.FromJson(__jsonTooltip) : Tooltip;}
            ...
            {_value = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.V1.Models.IApplicationConfigConstantAttributesValueItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.V1.Models.IApplicationConfigConstantAttributesValueItem) (JumpCloud.SDK.V1.Models.ApplicationConfigConstantAttributesValueItem.FromJson(__u) )) ))() : null : Value;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IApplicationConfigConstantAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IApplicationConfigConstantAttributes.</returns>
        public static JumpCloud.SDK.V1.Models.IApplicationConfigConstantAttributes FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new ApplicationConfigConstantAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigConstantAttributes" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigConstantAttributes" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class OrganizationsettingsputFeatures
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeatures.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeatures.</returns>
        public static JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeatures FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new OrganizationsettingsputFeatures(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="OrganizationsettingsputFeatures" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OrganizationsettingsputFeatures(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_systemInsights = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("systemInsights"), out var __jsonSystemInsights) ? JumpCloud.SDK.V1.Models.OrganizationsettingsputFeaturesSystemInsights.FromJson(__jsonSystemInsights) : SystemInsights;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OrganizationsettingsputFeatures" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OrganizationsettingsputFeatures" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>

...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IPathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V1.Models.IPathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema.
        /// </returns>
        public static JumpCloud.SDK.V1.Models.IPathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema" />
        ...
        /// <returns>
        /// a serialized instance of <see cref="PathsZx6QbkSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema" /> as

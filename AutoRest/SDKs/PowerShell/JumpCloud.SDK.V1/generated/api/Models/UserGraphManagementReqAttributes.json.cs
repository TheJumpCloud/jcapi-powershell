namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class UserGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IUserGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V1.Models.IUserGraphManagementReqAttributes.</returns>
        public static JumpCloud.SDK.V1.Models.IUserGraphManagementReqAttributes FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new UserGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReqAttributes" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReqAttributes" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sudo ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._sudo.ToJson(null,serializationMode) : null, "sudo" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReqAttributes(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_sudo = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("sudo"), out var __jsonSudo) ? JumpCloud.SDK.V1.Models.UserGraphManagementReqAttributesSudo.FromJson(__jsonSudo) : Sudo;}
            AfterFromJson(json);
        }
    }
}
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Systemuser :
        JumpCloud.SDK.V1.Models.ISystemuser,
        JumpCloud.SDK.V1.Models.ISystemuserInternal
    {
        ...
        private JumpCloud.SDK.V1.Models.ISystemuserAttributesItem[] _attributes;

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.ISystemuserAttributesItem[] Attributes { get => this._attributes; set => this._attributes = value; }
        ...
        JumpCloud.SDK.V1.Models.IMfa JumpCloud.SDK.V1.Models.ISystemuserInternal.Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.V1.Models.Mfa()); set { {_mfa = value;} } }
        ...
        JumpCloud.SDK.V1.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.ISystemuserAttributesItem) })]
        JumpCloud.SDK.V1.Models.ISystemuserAttributesItem[] Attributes { get; set; }

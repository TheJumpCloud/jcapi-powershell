...
namespace JumpCloud.SDK.V1.Models
{
        ...
        JumpCloud.SDK.V1.Models.IOrganizationsettingsputInternal
    {
        ...
        public bool? DirectoryInsightPremiumEnabled { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).DirectoryInsightPremiumEnabled; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).DirectoryInsightPremiumEnabled = value; }
        ...
        JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesDirectoryInsightsPremium JumpCloud.SDK.V1.Models.IOrganizationsettingsputInternal.FeatureDirectoryInsightsPremium { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).DirectoryInsightsPremium; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).DirectoryInsightsPremium = value; }
        ...
        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewDarwin { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewDarwin; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewDarwin = value; }

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewLinux { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewLinux; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewLinux = value; }

        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Inlined)]
        public bool? SystemInsightEnableNewWindows { get => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewWindows; set => ((JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesInternal)Features).SystemInsightEnableNewWindows = value; }
...

    {
        ...
        JumpCloud.SDK.V1.Models.IOrganizationsettingsputFeaturesDirectoryInsightsPremium FeatureDirectoryInsightsPremium { get; set; }

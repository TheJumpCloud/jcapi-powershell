namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class ApplicationtemplateConfigConstantAttributes
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationtemplateConfigConstantAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationtemplateConfigConstantAttributes(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloud.SDK.V1.Models.ApplicationtemplateConfigConstantAttributesTooltip.FromJson(__jsonTooltip) : Tooltip;}
            ...
            {_mutable = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonBoolean>("mutable"), out var __jsonMutable) ? (bool?)__jsonMutable : Mutable;}
            ...
            {_value = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.V1.Models.IApplicationtemplateConfigConstantAttributesValueItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.V1.Models.IApplicationtemplateConfigConstantAttributesValueItem) (JumpCloud.SDK.V1.Models.ApplicationtemplateConfigConstantAttributesValueItem.FromJson(__u) )) ))() : null : Value;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IApplicationtemplateConfigConstantAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V1.Models.IApplicationtemplateConfigConstantAttributes.
        /// </returns>
        public static JumpCloud.SDK.V1.Models.IApplicationtemplateConfigConstantAttributes FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new ApplicationtemplateConfigConstantAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationtemplateConfigConstantAttributes" /> into a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationtemplateConfigConstantAttributes" /> as a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._mutable ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode)new JumpCloud.SDK.V1.Runtime.Json.JsonBoolean((bool)this._mutable) : null, "mutable" ,container.Add );

namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class BulkUserCreate :
        JumpCloud.SDK.V1.Models.IBulkUserCreate,
        JumpCloud.SDK.V1.Models.IBulkUserCreateInternal
    {

        /// <summary>Backing field for <see cref="Attributes" /> property.</summary>
        private JumpCloud.SDK.V1.Models.IBulkUserCreateAttributesItem[] _attributes;

        /// <summary>Map of additional attributes.</summary>
        [JumpCloud.SDK.V1.Origin(JumpCloud.SDK.V1.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V1.Models.IBulkUserCreateAttributesItem[] Attributes { get => this._attributes; set => this._attributes = value; }
        ...
        JumpCloud.SDK.V1.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V1.Models.IBulkUserCreateAttributesItem) })]
        JumpCloud.SDK.V1.Models.IBulkUserCreateAttributesItem[] Attributes { get; set; }

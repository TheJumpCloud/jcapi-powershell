...
SETTINGS <IOrganizationsettingsput>: 
  ...
  [UserPortalIdleSessionDurationMinutes <Int32?>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/set-jcorganization
#>
 Function Set-JCOrganization
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Set-JcSdkOrganization @PSBoundParameters
    }
    End
    {
        Return $Results

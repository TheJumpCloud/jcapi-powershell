...
CONFIG <IApplicationConfig>: 
  ...
  [SpEntityIdVisible <Boolean?>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/new-jcapplication
#>
 Function New-JCApplication
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\New-JcSdkApplication @PSBoundParameters
    }
    End
    {
        Return $Results

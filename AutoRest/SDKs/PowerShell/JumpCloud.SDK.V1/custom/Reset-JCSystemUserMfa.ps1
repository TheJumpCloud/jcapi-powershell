...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/reset-jcsystemusermfa
#>
 Function Reset-JCSystemUserMfa
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Reset-JcSdkSystemUserMfa @PSBoundParameters
    }
    End
    {
        Return $Results

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/new-jccommand
#>
 Function New-JCCommand
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\New-JcSdkCommand @PSBoundParameters
    }
    End
    {
        Return $Results

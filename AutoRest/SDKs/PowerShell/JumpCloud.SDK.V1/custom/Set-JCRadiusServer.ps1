...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/set-jcradiusserver
#>
 Function Set-JCRadiusServer
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Set-JcSdkRadiusServer @PSBoundParameters
    }
    End
    {
        Return $Results

...
SSHKEYS <ISshkeypost[]>: 
  ...
  PublicKey <String>: The Public SSH key.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/set-jcsystemuser
#>
 Function Set-JCSystemUser
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Set-JcSdkSystemUser @PSBoundParameters
    }
    End
    {
        Return $Results

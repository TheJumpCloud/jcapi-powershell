...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/new-jcsystemusersshkey
#>
 Function New-JCSystemUserSshKey
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\New-JcSdkSystemUserSshKey @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/remove-jcsystemuser
#>
 Function Remove-JCSystemUser
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Remove-JcSdkSystemUser @PSBoundParameters
    }
    End
    {
        Return $Results

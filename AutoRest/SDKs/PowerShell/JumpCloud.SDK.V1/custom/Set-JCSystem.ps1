...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/set-jcsystem
#>
 Function Set-JCSystem
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Set-JcSdkSystem @PSBoundParameters
    }
    End
    {
        Return $Results

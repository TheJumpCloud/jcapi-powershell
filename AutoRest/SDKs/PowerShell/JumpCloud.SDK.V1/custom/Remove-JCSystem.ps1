...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/remove-jcsystem
#>
 Function Remove-JCSystem
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Remove-JcSdkSystem @PSBoundParameters
    }
    End
    {
        Return $Results

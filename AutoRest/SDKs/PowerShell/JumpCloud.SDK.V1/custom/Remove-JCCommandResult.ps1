...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/remove-jccommandresult
#>
 Function Remove-JCCommandResult
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Remove-JcSdkCommandResult @PSBoundParameters
    }
    End
    {
        Return $Results

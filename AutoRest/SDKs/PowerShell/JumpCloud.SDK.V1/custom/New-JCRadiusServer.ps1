...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/new-jcradiusserver
#>
 Function New-JCRadiusServer
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\New-JcSdkRadiusServer @PSBoundParameters
    }
    End
    {
        Return $Results

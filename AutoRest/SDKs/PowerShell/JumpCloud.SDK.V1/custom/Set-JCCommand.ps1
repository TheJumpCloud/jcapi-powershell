...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [Triggername <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/set-jccommand
#>
 Function Set-JCCommand
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\Set-JcSdkCommand @PSBoundParameters
    }
    End
    {
        Return $Results

...
This endpoint will delete a specific System User's SSH Key.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v1/remove-jcsdksshkey
.Inputs
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloud.SDK.V1.private\Remove-JcSdkSshKey_Delete';
            DeleteViaIdentity = 'JumpCloud.SDK.V1.private\Remove-JcSdkSshKey_DeleteViaIdentity';
        }

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v1/new-jcsdkapplication
schema: 2.0.0
---
...
New-JcSdkApplication [-Beta] [-Color <String>] [-Config <IApplicationConfig>] [-Created <String>]
 ...
 [-LogoColor <String>] [-LogoUrl <String>] [-Name <String>] [-Organization <String>] [-SsoUrl <String>]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkpolicyresult
schema: 2.0.0
---
...
### List1 (Default)
```
Get-JcSdkPolicyResult [-Fields <String[]>] [-Filter <String[]>] [-Limit <Int32>] [-Skip <Int32>]

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/set-jcsdkcommandassociation
#>
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'JumpCloud.SDK.V2.private\Set-JcSdkCommandAssociation_Set';
            SetExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkCommandAssociation_SetExpanded';
            SetViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkCommandAssociation_SetViaIdentity';
            SetViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkCommandAssociation_SetViaIdentityExpanded';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/set-jcsdkoffice365association
#>
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'JumpCloud.SDK.V2.private\Set-JcSdkOffice365Association_Set';
            SetExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkOffice365Association_SetExpanded';
            SetViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkOffice365Association_SetViaIdentity';
            SetViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkOffice365Association_SetViaIdentityExpanded';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/get-jcsdkoffice365translationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloud.SDK.V2.private\Get-JcSdkOffice365TranslationRule_Get';
            GetViaIdentity = 'JumpCloud.SDK.V2.private\Get-JcSdkOffice365TranslationRule_GetViaIdentity';
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkOffice365TranslationRule_List';
        }

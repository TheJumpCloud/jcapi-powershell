...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/set-jcsdkldapserversambadomain
#>
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloud.SDK.V2.private\Set-JcSdkLdapServerSambaDomain_Put';
            PutExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkLdapServerSambaDomain_PutExpanded';
            PutViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkLdapServerSambaDomain_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkLdapServerSambaDomain_PutViaIdentityExpanded';
        }

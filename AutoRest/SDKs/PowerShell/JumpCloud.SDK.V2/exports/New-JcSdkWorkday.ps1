...
BODY <IWorkdayInput>: Workday Input
  ...
  [ReportUrl <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/new-jcsdkworkday
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkWorkday_Create';
            CreateExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkWorkday_CreateExpanded';
        }

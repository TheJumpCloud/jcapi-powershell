...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/remove-jcsdkduoaccount
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloud.SDK.V2.private\Remove-JcSdkDuoAccount_Delete';
            DeleteViaIdentity = 'JumpCloud.SDK.V2.private\Remove-JcSdkDuoAccount_DeleteViaIdentity';
        }

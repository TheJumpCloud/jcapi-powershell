...
Only one Duo account will be allowed,\nin case an organization has a Duo account already a 409 (Conflict) code will be returned.\n\n#### Sample Request\n```\n  curl -X POST https://console.jumpcloud.com/api/v2/duo/accounts \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{}'\n```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/new-jcsdkduoaccount
.Outputs
JumpCloud.SDK.V2.Models.IDuoAccount
.Outputs
System.String
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/new-jcsdkduoaccount
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkDuoAccount_Create';
        }

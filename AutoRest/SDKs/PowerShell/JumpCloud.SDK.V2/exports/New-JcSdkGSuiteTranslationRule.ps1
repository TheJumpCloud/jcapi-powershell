...
These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  {Translation Rule Parameters}\n}'\n\n```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/new-jcsdkgsuitetranslationrule
.Inputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/new-jcsdkgsuitetranslationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkGSuiteTranslationRule_Create';
            CreateExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkGSuiteTranslationRule_CreateExpanded';
            CreateViaIdentity = 'JumpCloud.SDK.V2.private\New-JcSdkGSuiteTranslationRule_CreateViaIdentity';
            CreateViaIdentityExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkGSuiteTranslationRule_CreateViaIdentityExpanded';
        }

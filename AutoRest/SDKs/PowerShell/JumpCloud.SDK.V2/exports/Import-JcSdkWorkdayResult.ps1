...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloud.sdk.v2/import-jcsdkworkdayresult
#>
...
begin {
    try {
        ...
        $mapping = @{
            Import = 'JumpCloud.SDK.V2.private\Import-JcSdkWorkdayResult_Import';
            ImportViaIdentity = 'JumpCloud.SDK.V2.private\Import-JcSdkWorkdayResult_ImportViaIdentity';
        }

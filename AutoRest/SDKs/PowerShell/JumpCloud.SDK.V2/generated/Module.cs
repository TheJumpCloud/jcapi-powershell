namespace JumpCloud.SDK.V2
{
    ...
    public partial class Module
    {
        ...
        private JumpCloud.SDK.V2.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private JumpCloud.SDK.V2.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public JumpCloud.SDK.V2.JumpCloudApIs ClientAPI { get; set; }

        /// <summary>Backing field for <see cref="Instance" /> property.</summary>
        private static JumpCloud.SDK.V2.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static JumpCloud.SDK.V2.Module Instance => JumpCloud.SDK.V2.Module._instance?? (JumpCloud.SDK.V2.Module._instance = new JumpCloud.SDK.V2.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"JumpCloud.SDK.V2";
        ...
        partial void AfterCreatePipeline(System.Management.Automation.InvocationInfo invocationInfo, ref JumpCloud.SDK.V2.Runtime.HttpPipeline pipeline);

        /// <summary>FIXME: Method BeforeCreatePipeline is MISSING DESCRIPTION</summary>
        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(System.Management.Automation.InvocationInfo invocationInfo, ref JumpCloud.SDK.V2.Runtime.HttpPipeline pipeline);
        ...
        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <returns>An instance of JumpCloud.SDK.V2.Runtime.HttpPipeline for the remote call.</returns>
        public JumpCloud.SDK.V2.Runtime.HttpPipeline CreatePipeline(System.Management.Automation.InvocationInfo invocationInfo)
        {
            JumpCloud.SDK.V2.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new JumpCloud.SDK.V2.JumpCloudApIs();
            _handler.Proxy = _webProxy;
            _pipeline = new JumpCloud.SDK.V2.Runtime.HttpPipeline(new JumpCloud.SDK.V2.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new JumpCloud.SDK.V2.Runtime.HttpPipeline(new JumpCloud.SDK.V2.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }

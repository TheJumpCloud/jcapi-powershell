namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class Systemuserputpost :
        JumpCloud.SDK.V2.Models.ISystemuserputpost,
        JumpCloud.SDK.V2.Models.ISystemuserputpostInternal
    {
        ...
        private JumpCloud.SDK.V2.Models.ISystemuserputpostAddressesItem[] _addresses;

        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V2.Models.ISystemuserputpostAddressesItem[] Addresses { get => this._addresses; set => this._addresses = value; }
        ...
        private JumpCloud.SDK.V2.Models.ISystemuserputpostAttributesItem[] _attributes;

        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V2.Models.ISystemuserputpostAttributesItem[] Attributes { get => this._attributes; set => this._attributes = value; }
        ...
        JumpCloud.SDK.V2.Models.IMfa JumpCloud.SDK.V2.Models.ISystemuserputpostInternal.Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.V2.Models.Mfa()); set { {_mfa = value;} } }
        ...
        private JumpCloud.SDK.V2.Models.IMfa _mfa;

        /// <summary>mfa</summary>
        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        internal JumpCloud.SDK.V2.Models.IMfa Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.V2.Models.Mfa()); set => this._mfa = value; }
        ...
        public bool? MfaConfigured { get => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).Configured; set => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).Configured = value; }

        /// <summary>FIXME: Property MfaExclusion is MISSING DESCRIPTION</summary>
        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Inlined)]
        public bool? MfaExclusion { get => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).Exclusion; set => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).Exclusion = value; }

        /// <summary>FIXME: Property MfaExclusionUntil is MISSING DESCRIPTION</summary>
        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Inlined)]
        public global::System.DateTime? MfaExclusionUntil { get => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).ExclusionUntil; set => ((JumpCloud.SDK.V2.Models.IMfaInternal)Mfa).ExclusionUntil = value; }
        ...
        private JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem[] _phoneNumbers;

        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem[] PhoneNumbers { get => this._phoneNumbers; set => this._phoneNumbers = value; }
        ...
        private JumpCloud.SDK.V2.Models.ISystemuserputpostRelationshipsItem[] _relationships;

        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V2.Models.ISystemuserputpostRelationshipsItem[] Relationships { get => this._relationships; set => this._relationships = value; }
        ...
        JumpCloud.SDK.V2.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemuserputpostAddressesItem) })]
        JumpCloud.SDK.V2.Models.ISystemuserputpostAddressesItem[] Addresses { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemuserputpostAttributesItem) })]
        JumpCloud.SDK.V2.Models.ISystemuserputpostAttributesItem[] Attributes { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem) })]
        JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem[] PhoneNumbers { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemuserputpostRelationshipsItem) })]
        JumpCloud.SDK.V2.Models.ISystemuserputpostRelationshipsItem[] Relationships { get; set; }
...

    {
        ...
        string Location { get; set; }
        /// <summary>mfa</summary>
        JumpCloud.SDK.V2.Models.IMfa Mfa { get; set; }

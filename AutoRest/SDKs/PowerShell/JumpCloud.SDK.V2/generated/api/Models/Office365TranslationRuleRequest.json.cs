namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class Office365TranslationRuleRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IOffice365TranslationRuleRequest.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IOffice365TranslationRuleRequest.</returns>
        public static JumpCloud.SDK.V2.Models.IOffice365TranslationRuleRequest FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new Office365TranslationRuleRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="Office365TranslationRuleRequest" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Office365TranslationRuleRequest(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_builtIn = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("builtIn"), out var __jsonBuiltIn) ? (string)__jsonBuiltIn : (string)BuiltIn;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Office365TranslationRuleRequest" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Office365TranslationRuleRequest" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._builtIn)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._builtIn.ToString()) : null, "builtIn" ,container.Add );

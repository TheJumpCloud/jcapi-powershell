...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsPythonPackages
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsPythonPackages.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsPythonPackages.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsPythonPackages FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsPythonPackages(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsPythonPackages" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsPythonPackages(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_auther = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("auther"), out var __jsonAuther) ? (string)__jsonAuther : (string)Auther;}
            ...
            {_license = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("license"), out var __jsonLicense) ? (string)__jsonLicense : (string)License;}
            {_summary = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("summary"), out var __jsonSummary) ? (string)__jsonSummary : (string)Summary;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsPythonPackages" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsPythonPackages" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._auther)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._auther.ToString()) : null, "auther" ,container.Add );
            ...
            AddIf( null != (((object)this._license)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._license.ToString()) : null, "license" ,container.Add );
            AddIf( null != (((object)this._summary)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._summary.ToString()) : null, "summary" ,container.Add );

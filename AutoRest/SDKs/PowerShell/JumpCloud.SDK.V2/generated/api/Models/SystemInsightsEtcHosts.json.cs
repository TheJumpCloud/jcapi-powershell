namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsEtcHosts
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsEtcHosts.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsEtcHosts.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsEtcHosts FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsEtcHosts(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsEtcHosts" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsEtcHosts(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_hostnames = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("hostnames"), out var __jsonHostnames) ? (string)__jsonHostnames : (string)Hostnames;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsEtcHosts" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsEtcHosts" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._hostnames)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._hostnames.ToString()) : null, "hostnames" ,container.Add );

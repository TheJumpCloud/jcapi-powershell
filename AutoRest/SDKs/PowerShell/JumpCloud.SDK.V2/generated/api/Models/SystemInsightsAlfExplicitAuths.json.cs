...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsAlfExplicitAuths
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAlfExplicitAuths.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAlfExplicitAuths.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsAlfExplicitAuths FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsAlfExplicitAuths(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsAlfExplicitAuths" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsAlfExplicitAuths(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_process = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("process"), out var __jsonProcess) ? (string)__jsonProcess : (string)Process;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsAlfExplicitAuths" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsAlfExplicitAuths" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._process)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._process.ToString()) : null, "process" ,container.Add );

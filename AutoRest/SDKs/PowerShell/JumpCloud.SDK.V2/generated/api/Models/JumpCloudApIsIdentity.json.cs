...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class JumpCloudApIsIdentity
    {
        ...
        internal JumpCloudApIsIdentity(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_appleMdmId = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("apple_mdm_id"), out var __jsonAppleMdmId) ? (string)__jsonAppleMdmId : (string)AppleMdmId;}
        ...
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._appleMdmId)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._appleMdmId.ToString()) : null, "apple_mdm_id" ,container.Add );

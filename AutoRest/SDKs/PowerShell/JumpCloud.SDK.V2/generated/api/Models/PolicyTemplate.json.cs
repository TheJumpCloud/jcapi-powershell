...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class PolicyTemplate
    {
        ...
        internal PolicyTemplate(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_alert = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("alert"), out var __jsonAlert) ? (string)__jsonAlert : (string)Alert;}
            ...
            {_deliveryTypes = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonArray>("deliveryTypes"), out var __jsonDeliveryTypes) ? If( __jsonDeliveryTypes as JumpCloud.SDK.V2.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is JumpCloud.SDK.V2.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : DeliveryTypes;}
            ...
            {_reference = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("reference"), out var __jsonReference) ? (string)__jsonReference : (string)Reference;}
        ...
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._alert)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._alert.ToString()) : null, "alert" ,container.Add );
            ...
            if (null != this._deliveryTypes)
            {
                var __w = new JumpCloud.SDK.V2.Runtime.Json.XNodeArray();
                foreach( var __x in this._deliveryTypes )
                {
                ...
                container.Add("deliveryTypes",__w);
            }
            ...
            AddIf( null != (((object)this._reference)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._reference.ToString()) : null, "reference" ,container.Add );

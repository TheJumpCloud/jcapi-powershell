...
namespace JumpCloud.SDK.V2.Models
{
        ...
        JumpCloud.SDK.V2.Models.ISystemInsightsBatteryInternal
    {
        ...
        /// <summary>Backing field for <see cref="Amperage" /> property.</summary>
        private int? _amperage;

        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public int? Amperage { get => this._amperage; set => this._amperage = value; }

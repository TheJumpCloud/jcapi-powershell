namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsLogicalDrvies
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsLogicalDrvies.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsLogicalDrvies.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsLogicalDrvies FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsLogicalDrvies(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsLogicalDrvies" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsLogicalDrvies(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_bootPartition = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("boot_partition"), out var __jsonBootPartition) ? (int?)__jsonBootPartition : BootPartition;}
            ...
            {_fileSystem = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("file_system"), out var __jsonFileSystem) ? (string)__jsonFileSystem : (string)FileSystem;}
            {_freeSpace = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("free_space"), out var __jsonFreeSpace) ? (string)__jsonFreeSpace : (string)FreeSpace;}
            {_size = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("size"), out var __jsonSize) ? (string)__jsonSize : (string)Size;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsLogicalDrvies" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsLogicalDrvies" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._bootPartition ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((int)this._bootPartition) : null, "boot_partition" ,container.Add );
            ...
            AddIf( null != (((object)this._fileSystem)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._fileSystem.ToString()) : null, "file_system" ,container.Add );
            AddIf( null != (((object)this._freeSpace)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._freeSpace.ToString()) : null, "free_space" ,container.Add );
            AddIf( null != (((object)this._size)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._size.ToString()) : null, "size" ,container.Add );

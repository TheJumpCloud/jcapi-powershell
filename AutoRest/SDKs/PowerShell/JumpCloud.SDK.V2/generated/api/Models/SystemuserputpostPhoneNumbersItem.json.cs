namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemuserputpostPhoneNumbersItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemuserputpostPhoneNumbersItem FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemuserputpostPhoneNumbersItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemuserputpostPhoneNumbersItem" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemuserputpostPhoneNumbersItem(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_number = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("number"), out var __jsonNumber) ? (string)__jsonNumber : (string)Number;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemuserputpostPhoneNumbersItem" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemuserputpostPhoneNumbersItem" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._number)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._number.ToString()) : null, "number" ,container.Add );

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsDiskInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsDiskInfo.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsDiskInfo.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsDiskInfo FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsDiskInfo(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsDiskInfo" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsDiskInfo(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_diskIndex = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("disk_index"), out var __jsonDiskIndex) ? (int?)__jsonDiskIndex : DiskIndex;}
            {_diskSize = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("disk_size"), out var __jsonDiskSize) ? (string)__jsonDiskSize : (string)DiskSize;}
            ...
            {_partitions = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("partitions"), out var __jsonPartitions) ? (int?)__jsonPartitions : Partitions;}
            {_pnpDeviceId = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("pnp_device_id"), out var __jsonPnpDeviceId) ? (string)__jsonPnpDeviceId : (string)PnpDeviceId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsDiskInfo" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsDiskInfo" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._diskIndex ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((int)this._diskIndex) : null, "disk_index" ,container.Add );
            AddIf( null != (((object)this._diskSize)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._diskSize.ToString()) : null, "disk_size" ,container.Add );
            ...
            AddIf( null != this._partitions ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((int)this._partitions) : null, "partitions" ,container.Add );
            AddIf( null != (((object)this._pnpDeviceId)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._pnpDeviceId.ToString()) : null, "pnp_device_id" ,container.Add );

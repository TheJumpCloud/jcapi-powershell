...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsIeExtensions
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsIeExtensions.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsIeExtensions.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsIeExtensions FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsIeExtensions(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsIeExtensions" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsIeExtensions(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_registryPath = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("registry_path"), out var __jsonRegistryPath) ? (string)__jsonRegistryPath : (string)RegistryPath;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsIeExtensions" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsIeExtensions" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._registryPath)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._registryPath.ToString()) : null, "registry_path" ,container.Add );

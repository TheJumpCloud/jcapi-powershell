namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class UserGroupGraphManagementReq :
        ...
        JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqInternal
    {

        /// <summary>Backing field for <see cref="Attributes" /> property.</summary>
        private JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqAttributes _attributes;

        /// <summary>The graph connection's attributes.</summary>
        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqAttributes Attributes { get => (this._attributes = this._attributes ?? new JumpCloud.SDK.V2.Models.UserGroupGraphManagementReqAttributes()); set => this._attributes = value; }
        ...
        JumpCloud.SDK.V2.Runtime.IJsonSerializable
    {
        ...
        JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqAttributes Attributes { get; set; }
        /// <summary>The ObjectID of graph object being added or removed as an association.</summary>
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,

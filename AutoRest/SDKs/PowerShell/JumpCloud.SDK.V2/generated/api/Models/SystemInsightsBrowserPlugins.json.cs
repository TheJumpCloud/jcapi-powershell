namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsBrowserPlugins
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsBrowserPlugins.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsBrowserPlugins.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsBrowserPlugins FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsBrowserPlugins(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsBrowserPlugins" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsBrowserPlugins(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_native = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("native"), out var __jsonNative) ? (int?)__jsonNative : Native;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsBrowserPlugins" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsBrowserPlugins" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._native ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((int)this._native) : null, "native" ,container.Add );

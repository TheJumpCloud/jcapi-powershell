...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsDnsResolvers
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsDnsResolvers.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsDnsResolvers.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsDnsResolvers FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsDnsResolvers(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsDnsResolvers" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsDnsResolvers(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_id = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("id"), out var __jsonId) ? (float?)__jsonId : Id;}
            {_netmask = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("netmask"), out var __jsonNetmask) ? (string)__jsonNetmask : (string)Netmask;}
            {_options = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("options"), out var __jsonOptions) ? (string)__jsonOptions : (string)Options;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsDnsResolvers" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsDnsResolvers" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._id ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((float)this._id) : null, "id" ,container.Add );
            AddIf( null != (((object)this._netmask)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._netmask.ToString()) : null, "netmask" ,container.Add );
            AddIf( null != (((object)this._options)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._options.ToString()) : null, "options" ,container.Add );

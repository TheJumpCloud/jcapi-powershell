...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class WebAuthnCredentialRequestCredential
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IWebAuthnCredentialRequestCredential.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IWebAuthnCredentialRequestCredential.</returns>
        public static JumpCloud.SDK.V2.Models.IWebAuthnCredentialRequestCredential FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new WebAuthnCredentialRequestCredential(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WebAuthnCredentialRequestCredential" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WebAuthnCredentialRequestCredential" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._response ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) this._response.ToJson(null,serializationMode) : null, "response" ,container.Add );
            ...
            AddIf( null != (((object)this._rawId)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._rawId.ToString()) : null, "rawId" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="WebAuthnCredentialRequestCredential" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WebAuthnCredentialRequestCredential(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_response = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("response"), out var __jsonResponse) ? JumpCloud.SDK.V2.Models.WebAuthnCredentialRequestCredentialResponse.FromJson(__jsonResponse) : Response;}
            ...
            {_rawId = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("rawId"), out var __jsonRawId) ? (string)__jsonRawId : (string)RawId;}
            AfterFromJson(json);
        }
    }
}
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class ComponentsSchemasLdapServerOutputAllof0
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="ComponentsSchemasLdapServerOutputAllof0" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ComponentsSchemasLdapServerOutputAllof0(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IComponentsSchemasLdapServerOutputAllof0.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V2.Models.IComponentsSchemasLdapServerOutputAllof0.
        /// </returns>
        public static JumpCloud.SDK.V2.Models.IComponentsSchemasLdapServerOutputAllof0 FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new ComponentsSchemasLdapServerOutputAllof0(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ComponentsSchemasLdapServerOutputAllof0" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ComponentsSchemasLdapServerOutputAllof0" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </returns>

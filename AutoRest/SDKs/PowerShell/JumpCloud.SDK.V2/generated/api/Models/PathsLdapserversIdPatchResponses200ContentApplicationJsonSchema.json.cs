namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class PathsLdapserversIdPatchResponses200ContentApplicationJsonSchema
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema.
        /// </returns>
        public static JumpCloud.SDK.V2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new PathsLdapserversIdPatchResponses200ContentApplicationJsonSchema(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="PathsLdapserversIdPatchResponses200ContentApplicationJsonSchema"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PathsLdapserversIdPatchResponses200ContentApplicationJsonSchema(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_userLockoutAction = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("userLockoutAction"), out var __jsonUserLockoutAction) ? (string)__jsonUserLockoutAction : (string)UserLockoutAction;}
            {_userPasswordExpirationAction = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("userPasswordExpirationAction"), out var __jsonUserPasswordExpirationAction) ? (string)__jsonUserPasswordExpirationAction : (string)UserPasswordExpirationAction;}
            AfterFromJson(json);
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="PathsLdapserversIdPatchResponses200ContentApplicationJsonSchema" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._userLockoutAction)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._userLockoutAction.ToString()) : null, "userLockoutAction" ,container.Add );
            AddIf( null != (((object)this._userPasswordExpirationAction)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._userPasswordExpirationAction.ToString()) : null, "userPasswordExpirationAction" ,container.Add );

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class Administrator
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="Administrator" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Administrator(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_enableMultiFactor = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonBoolean>("enableMultiFactor"), out var __jsonEnableMultiFactor) ? (bool?)__jsonEnableMultiFactor : EnableMultiFactor;}
            ...
            {_registered = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonBoolean>("registered"), out var __jsonRegistered) ? (bool?)__jsonRegistered : Registered;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IAdministrator.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IAdministrator.</returns>
        public static JumpCloud.SDK.V2.Models.IAdministrator FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new Administrator(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Administrator" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Administrator" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._enableMultiFactor ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonBoolean((bool)this._enableMultiFactor) : null, "enableMultiFactor" ,container.Add );
            ...
            AddIf( null != this._registered ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonBoolean((bool)this._registered) : null, "registered" ,container.Add );

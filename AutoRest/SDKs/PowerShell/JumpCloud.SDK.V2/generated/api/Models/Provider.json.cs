namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class Provider
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IProvider.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IProvider.</returns>
        public static JumpCloud.SDK.V2.Models.IProvider FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new Provider(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="Provider" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Provider(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_contact = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("contact"), out var __jsonContact) ? JumpCloud.SDK.V2.Models.ProviderContact.FromJson(__jsonContact) : Contact;}
            {_name = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Provider" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Provider" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._contact ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) this._contact.ToJson(null,serializationMode) : null, "contact" ,container.Add );

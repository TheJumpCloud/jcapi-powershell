...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsAuthorizedKeys
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAuthorizedKeys.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAuthorizedKeys.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsAuthorizedKeys FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsAuthorizedKeys(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsAuthorizedKeys" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsAuthorizedKeys(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_algorithm = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("algorithm"), out var __jsonAlgorithm) ? (string)__jsonAlgorithm : (string)Algorithm;}
            ...
            {_keyFile = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("key_file"), out var __jsonKeyFile) ? (string)__jsonKeyFile : (string)KeyFile;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsAuthorizedKeys" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsAuthorizedKeys" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._algorithm)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._algorithm.ToString()) : null, "algorithm" ,container.Add );
            ...
            AddIf( null != (((object)this._keyFile)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._keyFile.ToString()) : null, "key_file" ,container.Add );

...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsSipConfig
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsSipConfig.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsSipConfig.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsSipConfig FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsSipConfig(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsSipConfig" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsSipConfig(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_configFlag = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("config_flag"), out var __jsonConfigFlag) ? (string)__jsonConfigFlag : (string)ConfigFlag;}
            ...
            {_enabledNvram = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("enabled_nvram"), out var __jsonEnabledNvram) ? (int?)__jsonEnabledNvram : EnabledNvram;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsSipConfig" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsSipConfig" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._configFlag)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._configFlag.ToString()) : null, "config_flag" ,container.Add );
            ...
            AddIf( null != this._enabledNvram ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((int)this._enabledNvram) : null, "enabled_nvram" ,container.Add );

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class GsuiteOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IGsuiteOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IGsuiteOutput.</returns>
        public static JumpCloud.SDK.V2.Models.IGsuiteOutput FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new GsuiteOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="GsuiteOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal GsuiteOutput(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasGsuiteOutputAllof0 = new JumpCloud.SDK.V2.Models.ComponentsSchemasGsuiteOutputAllof0(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GsuiteOutput" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GsuiteOutput" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>

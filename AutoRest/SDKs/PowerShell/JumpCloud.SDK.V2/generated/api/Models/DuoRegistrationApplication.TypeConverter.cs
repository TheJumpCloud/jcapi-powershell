namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class DuoRegistrationApplicationTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="DuoRegistrationApplication" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static JumpCloud.SDK.V2.Models.IDuoRegistrationApplication ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(JumpCloud.SDK.V2.Models.IDuoRegistrationApplication).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try

...
namespace JumpCloud.SDK.V2.Models
{
    ...
    /// </summary>
    public partial class SystemInsightsWindowsCrashesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="SystemInsightsWindowsCrashes" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsWindowsCrashes ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(JumpCloud.SDK.V2.Models.ISystemInsightsWindowsCrashes).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try

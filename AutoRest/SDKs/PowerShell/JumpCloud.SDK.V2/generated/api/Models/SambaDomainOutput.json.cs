namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SambaDomainOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISambaDomainOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISambaDomainOutput.</returns>
        public static JumpCloud.SDK.V2.Models.ISambaDomainOutput FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SambaDomainOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SambaDomainOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SambaDomainOutput(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasSambaDomainOutputAllof0 = new JumpCloud.SDK.V2.Models.ComponentsSchemasSambaDomainOutputAllof0(json);
            __sambaDomainInput = new JumpCloud.SDK.V2.Models.SambaDomainInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SambaDomainOutput" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SambaDomainOutput" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>

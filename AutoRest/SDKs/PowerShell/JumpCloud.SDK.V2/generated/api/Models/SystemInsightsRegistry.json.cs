...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsRegistry
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsRegistry.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsRegistry.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsRegistry FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsRegistry(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsRegistry" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsRegistry(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_data = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("data"), out var __jsonData) ? (string)__jsonData : (string)Data;}
            {_key = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("key"), out var __jsonKey) ? (string)__jsonKey : (string)Key;}
            {_mtime = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("mtime"), out var __jsonMtime) ? (string)__jsonMtime : (string)Mtime;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsRegistry" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsRegistry" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._data)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._data.ToString()) : null, "data" ,container.Add );
            ...
            AddIf( null != (((object)this._mtime)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._mtime.ToString()) : null, "mtime" ,container.Add );

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class WorkdayOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IWorkdayOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IWorkdayOutput.</returns>
        public static JumpCloud.SDK.V2.Models.IWorkdayOutput FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new WorkdayOutput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WorkdayOutput" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WorkdayOutput" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._lastImport)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._lastImport.ToString()) : null, "lastImport" ,container.Add );
            AddIf( null != (((object)this._reportUrl)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._reportUrl.ToString()) : null, "reportUrl" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="WorkdayOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WorkdayOutput(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_auth = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("auth"), out var __jsonAuth) ? JumpCloud.SDK.V2.Models.WorkdayOutputAuth.FromJson(__jsonAuth) : Auth;}
            ...
            {_lastImport = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("lastImport"), out var __jsonLastImport) ? (string)__jsonLastImport : (string)LastImport;}
            {_reportUrl = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("reportUrl"), out var __jsonReportUrl) ? (string)__jsonReportUrl : (string)ReportUrl;}
            AfterFromJson(json);
        }
    }
}
...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsWindowsSecurityProducts
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsWindowsSecurityProducts.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsWindowsSecurityProducts.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsWindowsSecurityProducts FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsWindowsSecurityProducts(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsWindowsSecurityProducts" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsWindowsSecurityProducts(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_remediationPath = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("remediation_path"), out var __jsonRemediationPath) ? (string)__jsonRemediationPath : (string)RemediationPath;}
            {_signaturesUpToDate = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("signatures_up_to_date"), out var __jsonSignaturesUpToDate) ? (float?)__jsonSignaturesUpToDate : SignaturesUpToDate;}
            ...
            {_stateTimestamp = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("state_timestamp"), out var __jsonStateTimestamp) ? (string)__jsonStateTimestamp : (string)StateTimestamp;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsWindowsSecurityProducts" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsWindowsSecurityProducts" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._remediationPath)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._remediationPath.ToString()) : null, "remediation_path" ,container.Add );
            AddIf( null != this._signaturesUpToDate ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((float)this._signaturesUpToDate) : null, "signatures_up_to_date" ,container.Add );
            ...
            AddIf( null != (((object)this._stateTimestamp)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._stateTimestamp.ToString()) : null, "state_timestamp" ,container.Add );

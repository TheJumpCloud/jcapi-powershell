namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class ActiveDirectoryOutput
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="ActiveDirectoryOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ActiveDirectoryOutput(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasActiveDirectoryOutputAllof0 = new JumpCloud.SDK.V2.Models.ComponentsSchemasActiveDirectoryOutputAllof0(json);
            __activeDirectoryInput = new JumpCloud.SDK.V2.Models.ActiveDirectoryInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IActiveDirectoryOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IActiveDirectoryOutput.</returns>
        public static JumpCloud.SDK.V2.Models.IActiveDirectoryOutput FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new ActiveDirectoryOutput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ActiveDirectoryOutput" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ActiveDirectoryOutput" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class PolicyRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IPolicyRequest.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IPolicyRequest.</returns>
        public static JumpCloud.SDK.V2.Models.IPolicyRequest FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new PolicyRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="PolicyRequest" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PolicyRequest(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_template = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("template"), out var __jsonTemplate) ? JumpCloud.SDK.V2.Models.PolicyRequestTemplate.FromJson(__jsonTemplate) : Template;}
            {_name = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            {_values = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonArray>("values"), out var __jsonValues) ? If( __jsonValues as JumpCloud.SDK.V2.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.V2.Models.IPolicyValue[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.V2.Models.IPolicyValue) (JumpCloud.SDK.V2.Models.PolicyValue.FromJson(__u) )) ))() : null : Values;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PolicyRequest" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PolicyRequest" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemGraphManagementReqAttributes.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemGraphManagementReqAttributes FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemGraphManagementReqAttributes(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_sudo = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("sudo"), out var __jsonSudo) ? JumpCloud.SDK.V2.Models.SystemGraphManagementReqAttributesSudo.FromJson(__jsonSudo) : Sudo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemGraphManagementReqAttributes" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemGraphManagementReqAttributes" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sudo ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) this._sudo.ToJson(null,serializationMode) : null, "sudo" ,container.Add );

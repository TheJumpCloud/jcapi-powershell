namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class LdapServerOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ILdapServerOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ILdapServerOutput.</returns>
        public static JumpCloud.SDK.V2.Models.ILdapServerOutput FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new LdapServerOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="LdapServerOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LdapServerOutput(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasLdapServerOutputAllof0 = new JumpCloud.SDK.V2.Models.ComponentsSchemasLdapServerOutputAllof0(json);
            __ldapServerInput = new JumpCloud.SDK.V2.Models.LdapServerInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LdapServerOutput" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LdapServerOutput" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>

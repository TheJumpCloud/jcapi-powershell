...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-SystemGroupAssociation=>POST:"/systemgroups/{group_id}/associations"
    /// [METADATA]
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_SetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the _direct_ associations of a System Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example System Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systemgroups/{GroupID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""{UserID}\""\n}'\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_SetExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetSystemGroupAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetSystemGroupAssociation(GroupId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_SetExpanded"
        /// /> cmdlet class.
        /// </summary>
        public SetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_SetExpanded()
        {

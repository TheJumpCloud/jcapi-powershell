namespace JumpCloud.SDK.V2.Cmdlets
{
        ...
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemGroupGraphManagementReqAttributes) })]
        public JumpCloud.SDK.V2.Models.ISystemGroupGraphManagementReqAttributes Attributes { get => Body.Attributes ?? null /* object */; set => Body.Attributes = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloud.SDK.V2.Models.ISystemGroupGraphManagementReq _body= new JumpCloud.SDK.V2.Models.SystemGroupGraphManagementReq();

        /// <summary>SystemGroupGraphManagementReq</summary>
        private JumpCloud.SDK.V2.Models.ISystemGroupGraphManagementReq Body { get => this._body; set => this._body = value; }

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the _direct_ associations of an Application. A direct association can be a non-homogeneous relationship between 2 different objects, for example Application and User Groups.\n\n#### Sample Request\n```\ncurl -X POST 'https://console.jumpcloud.com/api/v2/applications/{Application_ID}/associations' \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user_group\"",\n    \""id\"": \""{Group_ID}\""\n}'\n```")]
        ...
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IGraphManagementReq _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IGraphManagementReq) })]
        public JumpCloud.SDK.V2.Models.IGraphManagementReq Body { get => this._body; set => this._body = value; }

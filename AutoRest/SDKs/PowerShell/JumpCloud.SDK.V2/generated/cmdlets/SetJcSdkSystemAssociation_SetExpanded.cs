namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// relationship between 2 different objects, for example Systems and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systems/{System_ID}/associations
    /// \\\n -H 'Accept: application/json' \\\n -H 'Content-Type: application/json' \\\n -H 'x-api-key: {API_KEY}' \\\n -d '{\n
    /// \"attributes\": {\n \"sudo\": {\n \"enabled\": true,\n \"withoutPassword\": false\n }\n },\n \"op\": \"add\",\n \"type\":
    /// \"user\",\n \"id\": \"UserID\"\n}'\n\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SystemAssociation_Set=>POST:"/systems/{system_id}/associations"
    /// [METADATA]
    /// path: '/systems/{system_id}/associations'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///116?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1systems~1{system_id}~1associations'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: SystemAssociation
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemAssociation_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the _direct_ associations of a System.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Systems and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systems/{System_ID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n   \""attributes\"": {\n      \""sudo\"": {\n         \""enabled\"": true,\n         \""withoutPassword\"": false\n      }\n   },\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""UserID\""\n}'\n\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkSystemAssociation_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.ISystemGraphManagementReq _body= new JumpCloud.SDK.V2.Models.SystemGraphManagementReq();

        /// <summary>SystemGraphManagementReq</summary>
        private JumpCloud.SDK.V2.Models.ISystemGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SystemAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SystemAssociationSet(SystemId, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystemAssociation_SetExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystemAssociation_SetExpanded()
        {

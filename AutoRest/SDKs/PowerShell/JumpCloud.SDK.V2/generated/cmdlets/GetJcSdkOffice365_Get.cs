namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Office365_Get=>GET:"/office365s/{office365_id}"
    /// [METADATA]
    ...
    /// variant: Get
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkOffice365_Get")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IOffice365Output))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns a specific Office 365 instance.\n\n#####\n\nSample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/office365s/{O365_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkOffice365_Get : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkOffice365_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkOffice365_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Office365Get(Office365Id, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  Office365Id=Office365Id}));
                }
                finally
                {

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] PolicyStatus_List=>GET:"/policies/{policy_id}/policystatuses"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: PolicyStatus
    /// variant: List1
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkPolicyStatus_List1")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IPolicyResult))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns the latest policies results for a specific policy.\n\n##### Sample Request\n\n```\n curl -X GET https://console.jumpcloud.com/api/v2/policies/{Policy_ID}/policystatuses \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkPolicyStatus_List1 : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkPolicyStatus_List1" /> cmdlet class.
        /// </summary>
        public GetJcSdkPolicyStatus_List1()
        {

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] LdapServerSambaDomain_Get=>GET:"/ldapservers/{ldapserver_id}/sambadomains/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkLdapServerSambaDomain_GetViaIdentity")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.ISambaDomainOutput))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns a specific samba domain for an LDAP server.\n\n##### Sample Request\n```\ncurl -X GET \\\n  https://console.jumpcloud.com/api/v2/ldapservers/ldapservers/{LDAP_ID}/sambadomains/{SAMBA_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkLdapServerSambaDomain_GetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkLdapServerSambaDomain_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetJcSdkLdapServerSambaDomain_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LdapServerSambaDomainGet(InputObject.LdapserverId ?? null, InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, onOk, this, Pipeline);

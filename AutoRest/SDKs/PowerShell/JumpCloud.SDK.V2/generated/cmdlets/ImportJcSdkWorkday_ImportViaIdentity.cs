namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Workday_Import=>POST:"/workdays/{workday_id}/import"
    /// [METADATA]
    /// path: '/workdays/{workday_id}/import'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    ...
    /// subjectPrefix:
    /// subject: Workday
    /// variant: ImportViaIdentity
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"JcSdkWorkday_ImportViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    [JumpCloud.SDK.V2.Description(@"The endpoint allows you to create a Workday Import request.\n\n#### Sample Request \n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/{WorkdayID}/import \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '[\n\t{\n\t\t\""email\"":\""{email}\"",\n\t\t\""firstname\"":\""{firstname}\"",\n\t\t\""lastname\"":\""{firstname}\"",\n\t\t\""username\"":\""{username}\"",\n\t\t\""attributes\"":[\n\t\t\t{\""name\"":\""EmployeeID\"",\""value\"":\""0000\""},\n\t\t\t{\""name\"":\""WorkdayID\"",\""value\"":\""name.name\""}\n\t\t\t]\n\t\t\n\t}\n]\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class ImportJcSdkWorkday_ImportViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IBulkUserCreate[] _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IBulkUserCreate) })]
        public JumpCloud.SDK.V2.Models.IBulkUserCreate[] Body { get => this._body; set => this._body = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IJobId" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IJobId> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportJcSdkWorkday_ImportViaIdentity" /> cmdlet class.
        /// </summary>
        public ImportJcSdkWorkday_ImportViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WorkdayImport' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayImport(InputObject.WorkdayId ?? null, Body, onCreated, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IJobId> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IJobId

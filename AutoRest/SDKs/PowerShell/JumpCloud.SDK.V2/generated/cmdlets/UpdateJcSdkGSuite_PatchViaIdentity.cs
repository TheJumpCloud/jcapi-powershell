...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1gsuites~1{id}'
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix:
    /// subject: GSuite
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"JcSdkGSuite_PatchViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGsuiteOutput))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows updating some attributes of a G Suite.\n\n##### Sample Request\n\n```\ncurl -X PATCH https://console.jumpcloud.com/api/v2/gsuites/{GSUITE_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""userLockoutAction\"": \""suspend\"",\n    \""userPasswordExpirationAction\"": \""maintain\""\n  }'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class UpdateJcSdkGSuite_PatchViaIdentity : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "GSuite Patch Input", ValueFromPipeline = true)]

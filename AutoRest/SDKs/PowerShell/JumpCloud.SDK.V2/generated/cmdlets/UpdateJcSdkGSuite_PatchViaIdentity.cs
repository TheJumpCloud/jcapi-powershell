namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkGSuite_PatchViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class UpdateJcSdkGSuite_PatchViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IGsuitePatchInput _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IGsuitePatchInput) })]
        public JumpCloud.SDK.V2.Models.IGsuitePatchInput Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkGSuite_PatchViaIdentity" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkGSuite_PatchViaIdentity()
        {

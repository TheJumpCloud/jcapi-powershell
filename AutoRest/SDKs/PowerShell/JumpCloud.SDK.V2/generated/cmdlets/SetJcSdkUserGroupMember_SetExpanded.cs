namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the user members of a User Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""{User_ID}\""\n}'\n```")]
        ...
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IUserGroupMembersReq _body= new JumpCloud.SDK.V2.Models.UserGroupMembersReq();

        /// <summary>UserGroupMembersReq</summary>
        private JumpCloud.SDK.V2.Models.IUserGroupMembersReq Body { get => this._body; set => this._body = value; }

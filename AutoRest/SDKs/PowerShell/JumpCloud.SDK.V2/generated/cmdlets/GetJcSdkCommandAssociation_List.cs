namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// relationship between 2 different objects, for example Commands and User Groups.\n\n\n#### Sample Request\n```\ncurl -X
    /// GET https://console.jumpcloud.com/api/v2/commands/{Command_ID}/associations?targets=system_group \\\n -H 'accept: application/json'
    /// \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CommandAssociation_List=>GET:"/commands/{command_id}/associations"
    /// [METADATA]
    /// path: '/commands/{command_id}/associations'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///116?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1commands~1{command_id}~1associations'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: CommandAssociation
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkCommandAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphConnection))]
    [JumpCloud.SDK.V2.Description(@"This endpoint will return the _direct_ associations of this Command.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Commands and User Groups.\n\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/commands/{Command_ID}/associations?targets=system_group \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkCommandAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Command.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkCommandAssociation_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkCommandAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CommandAssociationList(CommandId, Targets, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);

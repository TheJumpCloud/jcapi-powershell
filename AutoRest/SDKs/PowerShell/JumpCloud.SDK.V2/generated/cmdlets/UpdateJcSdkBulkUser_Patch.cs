namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    [JumpCloud.SDK.V2.Description(@"The endpoint allows you to create a bulk job to asynchronously update users. See [Update a System User](https://docs.jumpcloud.com/1.0/systemusers/update-a-system-user) for full list of attributes.\n\n#### Sample Request \n```\ncurl -X PATCH https://console.jumpcloud.com/api/v2/bulk/users \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '[\n\t{\n\t  \""id\"":\""5be9fb4ddb01290001e85109\"",\n\t\t\""firstname\"":\""{UPDATED_FIRSTNAME}\"",\n\t\t\""department\"":\""{UPDATED_DEPARTMENT}\"",\n\t\t\""attributes\"":[\n\t\t\t{\""name\"":\""Custom\"",\""value\"":\""{ATTRIBUTE_VALUE}\""}\n\t\t]\n\t},\n\t{\n\t  \""id\"":\""5be9fb4ddb01290001e85109\"",\n\t\t\""firstname\"":\""{UPDATED_FIRSTNAME}\"",\n\t\t\""costCenter\"":\""{UPDATED_COST_CENTER}\"",\n\t\t\""phoneNumbers\"":[\n\t\t\t{\""type\"":\""home\"",\""number\"":\""{HOME_PHONE_NUMBER}\""},\n\t\t\t{\""type\"":\""work\"",\""number\"":\""{WORK_PHONE_NUMBER}\""}\n\t\t]\n\t}\n]\n```")]
        ...
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IBulkUserUpdate[] _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IBulkUserUpdate) })]
        public JumpCloud.SDK.V2.Models.IBulkUserUpdate[] Body { get => this._body; set => this._body = value; }

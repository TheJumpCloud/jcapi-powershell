...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-GSuiteTranslationRule=>GET:"/gsuites/{gsuite_id}/translationrules/{id}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1gsuites~1{gsuite_id}~1translationrules~1{id}'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkGSuiteTranslationRule_GetViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGSuiteTranslationRule))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint returns a specific translation rule for a specific G Suite instance. These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n###### Sample Request\n\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules/{id} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkGSuiteTranslationRule_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetGSuiteTranslationRule(InputObject.GsuiteId ?? null, InputObject.Id ?? null, onOk, this, Pipeline);

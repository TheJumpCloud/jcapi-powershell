...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1ldapservers~1{ldapserver_id}~1sambadomains'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"JcSdkLdapServerSambaDomain_CreateViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.ISambaDomainOutput))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a samba domain for an LDAP server.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID}/sambadomains \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\""sid\"":\""{SID_ID}\"",\n\""name\"":\""{WORKGROUP_NAME}\""\n}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class NewJcSdkLdapServerSambaDomain_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,

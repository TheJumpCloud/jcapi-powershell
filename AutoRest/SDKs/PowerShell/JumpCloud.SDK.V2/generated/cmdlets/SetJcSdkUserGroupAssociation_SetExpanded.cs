namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserGroupAssociation_Set=>POST:"/usergroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkUserGroupAssociation_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloud.SDK.V2.Description(@"This endpoint manages the _direct_ associations of this User Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example User Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{SystemID}\""\n}'\n\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkUserGroupAssociation_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqAttributes) })]
        public JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReqAttributes Attributes { get => Body.Attributes ?? null /* object */; set => Body.Attributes = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReq _body= new JumpCloud.SDK.V2.Models.UserGroupGraphManagementReq();

        /// <summary>UserGroupGraphManagementReq</summary>
        private JumpCloud.SDK.V2.Models.IUserGroupGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UserGroupAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UserGroupAssociationSet(GroupId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkUserGroupAssociation_SetExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkUserGroupAssociation_SetExpanded()
        {

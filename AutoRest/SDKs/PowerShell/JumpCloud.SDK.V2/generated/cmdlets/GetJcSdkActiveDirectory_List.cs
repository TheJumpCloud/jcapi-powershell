namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ActiveDirectory_List=>GET:"/activedirectories"
    /// [METADATA]
    /// path: /activedirectories
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///116?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1activedirectories'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkActiveDirectory_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IActiveDirectoryOutput))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to list all your Active Directory Instances.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/activedirectories/ \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkActiveDirectory_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkActiveDirectory_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkActiveDirectory_List()
        {

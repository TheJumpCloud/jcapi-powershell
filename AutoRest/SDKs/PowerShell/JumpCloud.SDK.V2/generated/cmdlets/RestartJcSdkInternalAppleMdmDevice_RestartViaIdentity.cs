...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Restart-AppleMDMDevice=>POST:"/applemdms/{apple_mdm_id}/devices/{device_id}/restart"
    /// [METADATA]
    /// path: '/applemdms/{apple_mdm_id}/devices/{device_id}/restart'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///109?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1applemdms~1{apple_mdm_id}~1devices~1{device_id}~1restart'
    /// [DETAILS]
    /// verb: Restart
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Restart, @"JcSdkInternalAppleMdmDevice_RestartViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"Restarts a DEP-enrolled device.\n\n#### Sample Request\n```\n  curl -X POST https://console.jumpcloud.com/api/v2/applemdms/{apple_mdm_id}/devices/{device_id}/restart \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class RestartJcSdkInternalAppleMdmDevice_RestartViaIdentity : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RestartAppleMdmDevice' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RestartAppleMdmDevice(InputObject.AppleMdmId ?? null, InputObject.DeviceId ?? null, onNoContent, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RestartJcSdkInternalAppleMdmDevice_RestartViaIdentity" /> cmdlet class.
        /// </summary>
        public RestartJcSdkInternalAppleMdmDevice_RestartViaIdentity()
        {

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkRadiusServerAssociation_Set", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the _direct_ associations of a Radius Server.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Radius Servers and Users.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/radiusservers/{RADIUS_ID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\n\""type\"":\""user\"", \n\""id\"":\""{USER_ID}\"", \n\""op\"":\""add\""\n\t\n}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkRadiusServerAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RadiusServerAssociationSet(RadiusserverId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkRadiusServerAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkRadiusServerAssociation_Set()
        {

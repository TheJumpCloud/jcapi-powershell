namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] DuoAccount_List=>GET:"/duo/accounts"
    /// [METADATA]
    /// path: /duo/accounts
    /// apiVersions:
    /// - '2.0'
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkDuoAccount_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IDuoAccount))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns all the Duo accounts for your organization. Note: There can currently only be one Duo account for your organization.\n\n#### Sample Request\n```\ncurl https://console.jumpcloud.com/api/v2/duo/accounts \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkDuoAccount_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkDuoAccount_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkDuoAccount_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DuoAccountList(onOk, this, Pipeline);

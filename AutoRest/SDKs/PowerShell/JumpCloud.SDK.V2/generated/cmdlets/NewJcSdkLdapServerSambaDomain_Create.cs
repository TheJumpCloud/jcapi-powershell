namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1ldapservers~1{ldapserver_id}~1sambadomains'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    ...
    /// variant: Create
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkLdapServerSambaDomain_Create", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.ISambaDomainOutput))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a samba domain for an LDAP server.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID}/sambadomains \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\""sid\"":\""{SID_ID}\"",\n\""name\"":\""{WORKGROUP_NAME}\""\n}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class NewJcSdkLdapServerSambaDomain_Create : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [JumpCloud.SDK.V2.Category(JumpCloud.SDK.V2.ParameterCategory.Header)]
        public string Accept { get => this._accept; set => this._accept = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloud.SDK.V2.Models.ISambaDomainInput _body;

        /// <summary>Samba Domain Input</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Samba Domain Input", ValueFromPipeline = true)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Samba Domain Input",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISambaDomainInput) })]
        public JumpCloud.SDK.V2.Models.ISambaDomainInput Body { get => this._body; set => this._body = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.ISambaDomainOutput" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.ISambaDomainOutput> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkLdapServerSambaDomain_Create" /> cmdlet class.
        /// </summary>
        public NewJcSdkLdapServerSambaDomain_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LdapServerSambaDomainCreate(LdapserverId, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, Body, onCreated, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.ISambaDomainOutput> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.ISambaDomainOutput

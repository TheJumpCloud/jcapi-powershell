...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-SystemGroupMembers=>POST:"/systemgroups/{group_id}/members"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1systemgroups~1{group_id}~1members'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: GraphSystemGroupMemberMembershipSystemGroupMember
    /// variant: SetExpanded
    /// </remarks>
    [global::JumpCloud.SDK.V2.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkInternalGraphSystemGroupMemberMembershipSystemGroupMember_SetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the system members of a System Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systemgroups/{Group_ID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{System_ID}\""\n}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkInternalGraphSystemGroupMemberMembershipSystemGroupMember_SetExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the System Group.")]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ObjectID of member being added or removed.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "How to modify the membership connection.")]
        [global::JumpCloud.SDK.V2.Category(global::JumpCloud.SDK.V2.ParameterCategory.Body)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetSystemGroupMembers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetSystemGroupMembers(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, Body, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  GroupId=GroupId,Authorization=this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null,Date=this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null,body=Body})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkInternalGraphSystemGroupMemberMembershipSystemGroupMember_SetExpanded"
        /// /> cmdlet class.
        /// </summary>
        public SetJcSdkInternalGraphSystemGroupMemberMembershipSystemGroupMember_SetExpanded()
        {

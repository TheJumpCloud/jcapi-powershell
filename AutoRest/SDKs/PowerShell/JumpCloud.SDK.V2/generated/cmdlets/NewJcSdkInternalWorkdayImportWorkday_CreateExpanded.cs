...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1workdays'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"JcSdkInternalWorkdayImportWorkday_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IWorkdayOutput))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a new workday instance.\n\nYou must supply a username and password for `Basic Authentication` that is the same as your WorkDay Integrator System User.  Failure to provide these credentials  will result in the request being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be in the future.\n\nCurrently, only one instance is allowed and it must be `Workday Import`.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  \""name\"": \""Workday2\"",\n  \""reportUrl\"":\""https://workday.com/ccx/service/customreport2/gms/user/reportname?format=json\"",\n  \""auth\"": {\n    \""basic\"": {\n      \""username\"": \""someDeveloper\"",\n      \""password\"": \""notTheRealPassword\""\n    }\n  }\n}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class NewJcSdkInternalWorkdayImportWorkday_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkInternalWorkdayImportWorkday_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkInternalWorkdayImportWorkday_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateWorkday(Body, onCreated, this, Pipeline);

...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1providers~1{provider_id}~1administrators'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    ...
    /// variant: Create
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"JcSdkProviderAdmin_Create", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IAdministrator), typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a provider administrator. You must be associated to the provider to use this route.\n\n**Sample Request**\n\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/providers/{ProviderID}/administrators \\\n    -H 'Accept: application/json' \\\n    -H 'Context-Type: application/json' \\\n    -H 'x-api-key: {API_KEY}' \\\n    -d '{\n      \""email\"":\""{ADMIN_EMAIL}\""\n    }'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class NewJcSdkProviderAdmin_Create : global::System.Management.Automation.PSCmdlet,

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SystemGroupMembers_Set=>POST:"/systemgroups/{group_id}/members"
    /// [METADATA]
    ...
    /// verb: Set
    /// subjectPrefix:
    /// subject: SystemGroupMember
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemGroupMember_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the system members of a System Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systemgroups/{Group_ID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{System_ID}\""\n}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkSystemGroupMember_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.ISystemGroupMembersReq _body= new JumpCloud.SDK.V2.Models.SystemGroupMembersReq();

        /// <summary>SystemGroupMembersReq</summary>
        private JumpCloud.SDK.V2.Models.ISystemGroupMembersReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SystemGroupMembersSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SystemGroupMembersSet(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystemGroupMember_SetExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystemGroupMember_SetExpanded()
        {

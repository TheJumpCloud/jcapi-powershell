...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// <summary>
    /// Updates an Apple MDM configuration. This endpoint is used to supply JumpCloud with a signed certificate from Apple in
    /// order to finalize the setup and allow JumpCloud to manage your devices.\n\n#### Sample Request\n```\n curl -X PUT https://console.jumpcloud.com/api/v2/applemdms/{ID}
    /// \\\n -H 'accept: application/json' \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}' \\\n -d '{\n
    /// \"name\": \"MDM name\",\n \"appleSignedCert\": \"{CERTIFICATE}\",\n \"encryptedDepServerToken\": \"{SERVER_TOKEN}\"\n
    /// }'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update-AppleMDM=>PUT:"/applemdms/{id}"
    /// [METADATA]
    /// path: '/applemdms/{id}'
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1applemdms~1{id}'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: AppleMdm
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkInternalAppleMdm_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IAppleMdm), typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"Updates an Apple MDM configuration.  This endpoint is used to supply JumpCloud with a signed certificate from Apple in order to finalize the setup and allow JumpCloud to manage your devices.\n\n#### Sample Request\n```\n  curl -X PUT https://console.jumpcloud.com/api/v2/applemdms/{ID} \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""name\"": \""MDM name\"",\n    \""appleSignedCert\"": \""{CERTIFICATE}\"",\n    \""encryptedDepServerToken\"": \""{SERVER_TOKEN}\""\n  }'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkInternalAppleMdm_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A signed certificate obtained from Apple after providing Apple with the plist file provided on POST.")]
        ...
        public string AppleSignedCert { get => Body.AppleSignedCert ?? null; set => Body.AppleSignedCert = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloud.SDK.V2.Models.IAppleMdmPatchInput _body= new JumpCloud.SDK.V2.Models.AppleMdmPatchInput();

        /// <summary>Apple MDM Patch Input</summary>
        private JumpCloud.SDK.V2.Models.IAppleMdmPatchInput Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The S/MIME encoded DEP Server Token returned by Apple Business Manager when creating an MDM instance.")]
        [global::JumpCloud.SDK.V2.Category(global::JumpCloud.SDK.V2.ParameterCategory.Body)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string EncryptedDepServerToken { get => Body.EncryptedDepServerToken ?? null; set => Body.EncryptedDepServerToken = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A new name for the Apple MDM configuration.")]
        [global::JumpCloud.SDK.V2.Category(global::JumpCloud.SDK.V2.ParameterCategory.Body)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IAppleMdm" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IAppleMdm> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateAppleMdm' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateAppleMdm(InputObject.Id ?? null, Body, onOk, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkInternalAppleMdm_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkInternalAppleMdm_UpdateViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IAppleMdm> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IAppleMdm

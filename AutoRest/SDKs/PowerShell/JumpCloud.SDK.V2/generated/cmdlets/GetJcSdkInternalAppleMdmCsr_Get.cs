...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// <summary>
    /// Retrieves an Apple MDM CSR Plist for an organization. The user must supply the returned plist to Apple for signing, and
    /// then provide the certificate provided by Apple back into the PUT API.\n\n#### Sample Request\n```\n curl -X GET https://console.jumpcloud.com/api/v2/organizations/{Organization_ID}/mdm/{Apple_MDM_ID}/csr
    /// \\\n -H 'accept: application/json' \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-AppleMDMCsr=>GET:"/applemdms/{apple_mdm_id}/csr"
    /// [METADATA]
    /// path: '/applemdms/{apple_mdm_id}/csr'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///109?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1applemdms~1{apple_mdm_id}~1csr'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: AppleMdmCsr
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalAppleMdmCsr_Get")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"Retrieves an Apple MDM CSR Plist for an organization.  The user must supply the returned plist to Apple for signing, and then provide the certificate provided by Apple back into the PUT API.\n\n#### Sample Request\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/organizations/{Organization_ID}/mdm/{Apple_MDM_ID}/csr \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalAppleMdmCsr_Get : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IPaths150W1C8ApplemdmsAppleMdmIdCsrGetResponses201ContentApplicationOctetStreamSchema"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPaths150W1C8ApplemdmsAppleMdmIdCsrGetResponses201ContentApplicationOctetStreamSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalAppleMdmCsr_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkInternalAppleMdmCsr_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetAppleMdmCsr(AppleMdmId, onCreated, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPaths150W1C8ApplemdmsAppleMdmIdCsrGetResponses201ContentApplicationOctetStreamSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // onCreated - response for 201 / application/octet-stream
                // (await response) // should be JumpCloud.SDK.V2.Models.IPaths150W1C8ApplemdmsAppleMdmIdCsrGetResponses201ContentApplicationOctetStreamSchema
                WriteObject((await response).SignedCsrPlist);
            }
        }

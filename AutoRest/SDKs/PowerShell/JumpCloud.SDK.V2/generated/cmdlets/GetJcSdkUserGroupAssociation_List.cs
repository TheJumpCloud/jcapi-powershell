namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserGroupAssociation_List=>GET:"/usergroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: UserGroupAssociation
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkUserGroupAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphConnection))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns the _direct_ associations of this User Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example User Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/associations?targets=system \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkUserGroupAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkUserGroupAssociation_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkUserGroupAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UserGroupAssociationList(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), Targets, onOk, this, Pipeline);

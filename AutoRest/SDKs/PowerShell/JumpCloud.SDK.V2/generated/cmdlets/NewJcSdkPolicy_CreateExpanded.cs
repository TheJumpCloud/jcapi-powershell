namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IPolicyWithDetails))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a policy. Given the amount of configurable parameters required to create a Policy, we suggest you use the JumpCloud Admin Console to create new policies.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/policies \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  {Policy_Parameters}\n}'\n\n```")]
        ...
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IPolicyRequest _body= new JumpCloud.SDK.V2.Models.PolicyRequest();

        /// <summary>An instance of a policy template.</summary>
        private JumpCloud.SDK.V2.Models.IPolicyRequest Body { get => this._body; set => this._body = value; }
        ...
        public JumpCloud.SDK.V2.Models.IPolicyValue[] Values { get => Body.Values ?? null /* arrayOf */; set => Body.Values = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IPolicyWithDetails" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPolicyWithDetails> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPolicyWithDetails> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IPolicyWithDetails

...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-Office365TraverseUserGroup=>GET:"/office365s/{office365_id}/usergroups"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1office365s~1{office365_id}~1usergroups'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphOffice365TraverseUserGroup_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphObjectWithPaths1))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint will return all Users Groups bound to an Office 365 instance, either directly or indirectly, essentially traversing the JumpCloud Graph for your Organization.\n\nEach element will contain the group's type, id, attributes and paths.\n\nThe `attributes` object is a key/value hash of compiled graph attributes for all paths followed.\n\nThe `paths` array enumerates each path from this Office 365 instance to the corresponding User Group; this array represents all grouping and/or associations that would have to be removed to deprovision the User Group from this Office 365 instance.\n\nSee `/members` and `/associations` endpoints to manage those collections.\n\n#### Sample Request\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/office365s/{O365_ID/usergroups \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkGraphOffice365TraverseUserGroup_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Office 365 suite.")]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,

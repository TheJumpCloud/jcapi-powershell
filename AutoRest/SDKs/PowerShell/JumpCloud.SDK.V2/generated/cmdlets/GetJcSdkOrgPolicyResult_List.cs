namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] OrgPolicyResult_List=>GET:"/policyresults"
    /// [METADATA]
    /// path: /policyresults
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1policyresults'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: OrgPolicyResult
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkOrgPolicyResult_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IPolicyResult))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns all policies results for an organization.\n\n##### Sample Request\n\n```\n curl -X GET https://console.jumpcloud.com/api/v2/policyresults \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkOrgPolicyResult_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkOrgPolicyResult_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkOrgPolicyResult_List()
        {

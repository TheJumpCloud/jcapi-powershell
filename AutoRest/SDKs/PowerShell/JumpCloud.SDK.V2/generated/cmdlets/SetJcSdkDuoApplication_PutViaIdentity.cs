namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkDuoApplication_PutViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IDuoApplication), typeof(string))]
    [JumpCloud.SDK.V2.Description(@"Updates the specified Duo application.\n\n#### Sample Request\n```\n  curl -X PUT https://console.jumpcloud.com/api/v2/duo/accounts/{ACCOUNT_ID}/applications/{APPLICATION_ID} \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""name\"": \""Application Name\"",\n    \""apiHost\"": \""api-1234.duosecurity.com\"",\n    \""integrationKey\"": \""1234\"",\n    \""secretKey\"": \""5678\""\n  }'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkDuoApplication_PutViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IDuoApplicationUpdateReq _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IDuoApplicationUpdateReq) })]
        public JumpCloud.SDK.V2.Models.IDuoApplicationUpdateReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkDuoApplication_PutViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkDuoApplication_PutViaIdentity()
        {

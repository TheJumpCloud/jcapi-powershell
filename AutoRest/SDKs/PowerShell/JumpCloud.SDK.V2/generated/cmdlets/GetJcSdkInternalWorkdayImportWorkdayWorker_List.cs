...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1workdays~1{workday_id}~1workers'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalWorkdayImportWorkdayWorker_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IWorkdayWorker))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint will return all of the data in your WorkDay Custom Report that has been associated with your WorkDay Instance in JumpCloud.\n\n##### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/workdays/{WorkDayID}/workers \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalWorkdayImportWorkdayWorker_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalWorkdayImportWorkdayWorker_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkInternalWorkdayImportWorkdayWorker_List()
        {

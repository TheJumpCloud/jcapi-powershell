namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Office365_Patch=>PATCH:"/office365s/{office365_id}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1office365s~1{office365_id}'
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix:
    /// subject: Office365
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkOffice365_PatchExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IOffice365Output))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows updating some attributes of an Office 365 instance.\n\n#####\n\nSample Request\n\n```\ncurl -X PATCH https://console.jumpcloud.com/api/v2/office365s/{O365_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""userLockoutAction\"": \""maintain\"",\n    \""userPasswordExpirationAction\"": \""suspend\""\n  }'\n\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class UpdateJcSdkOffice365_PatchExpanded : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IOffice365PatchInput _body= new JumpCloud.SDK.V2.Models.Office365PatchInput();

        /// <summary>Office 365 Patch Input</summary>
        private JumpCloud.SDK.V2.Models.IOffice365PatchInput Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Office 365 instance.")]
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IOffice365Output" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IOffice365Output> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'Office365Patch' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Office365Patch(Office365Id, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkOffice365_PatchExpanded" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkOffice365_PatchExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IOffice365Output> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IOffice365Output

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// relationship between 2 different objects, for example Active Directory and Users.\n\n\n#### Sample Request\n```\ncurl
    /// -X GET 'https://console.jumpcloud.com/api/v2/activedirectories/{ActiveDirectory_ID}/associations?targets=user \\\n -H
    /// 'accept: application/json' \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ActiveDirectoryAssociation_List=>GET:"/activedirectories/{activedirectory_id}/associations"
    /// [METADATA]
    /// path: '/activedirectories/{activedirectory_id}/associations'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///116?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1activedirectories~1{activedirectory_id}~1associations'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ActiveDirectoryAssociation
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkActiveDirectoryAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphConnection))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns the direct associations of this Active Directory instance.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Active Directory and Users.\n\n\n#### Sample Request\n```\ncurl -X GET 'https://console.jumpcloud.com/api/v2/activedirectories/{ActiveDirectory_ID}/associations?targets=user \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkActiveDirectoryAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Active Directory instance.")]
        ...
        /// <summary>Backing field for <see cref="Targets" /> property.</summary>
        ...
        PossibleTypes = new [] { typeof(string) })]
        [JumpCloud.SDK.V2.Category(JumpCloud.SDK.V2.ParameterCategory.Query)]
        public string[] Targets { get => this._targets; set => this._targets = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IGraphConnection[]" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IGraphConnection[]> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkActiveDirectoryAssociation_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkActiveDirectoryAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ActiveDirectoryAssociationList(ActivedirectoryId, Targets, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  ActivedirectoryId=ActivedirectoryId,Targets=Targets,Limit=this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?),Skip=this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?)}));
                }
                finally
                {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IGraphConnection[]> response)
        {
            using( NoSynchronizationContext )
            {

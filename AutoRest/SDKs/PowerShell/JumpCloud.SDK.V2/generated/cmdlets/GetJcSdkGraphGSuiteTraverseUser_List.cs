...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GSuiteTraverseUser=>GET:"/gsuites/{gsuite_id}/users"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1gsuites~1{gsuite_id}~1users'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphGSuiteTraverseUser
    /// variant: List
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphGSuiteTraverseUser_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphObjectWithPaths1))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint will return all Users bound to a G Suite instance, either directly or indirectly, essentially traversing the JumpCloud Graph for your Organization.\n\nEach element will contain the type, id, attributes and paths.\n\nThe `attributes` object is a key/value hash of compiled graph attributes for all paths followed.\n\nThe `paths` array enumerates each path from this G Suite instance to the corresponding User; this array represents all grouping and/or associations that would have to be removed to deprovision the User from this G Suite instance.\n\nSee `/members` and `/associations` endpoints to manage those collections.\n\n#### Sample Request\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/gsuites/{Gsuite_ID}/users \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkGraphGSuiteTraverseUser_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphGSuiteTraverseUser_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGraphGSuiteTraverseUser_List()
        {

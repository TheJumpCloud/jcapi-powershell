...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-UserGroupTraverseGSuite=>GET:"/usergroups/{group_id}/gsuites"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1usergroups~1{group_id}~1gsuites'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphUserGroupAssociationUserGroupTraverseGSuite
    /// variant: List
    /// </remarks>
    [global::JumpCloud.SDK.V2.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphObjectWithPaths))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint will return all G Suite Instances bound to a User Group, either directly or indirectly, essentially traversing the JumpCloud Graph for your Organization.\n\nEach element will contain the type, id, attributes and paths\n\nThe `attributes` object is a key/value hash of compiled graph attributes for all paths followed.\n\nThe `paths` array enumerates each path from this User Group to the corresponding G Suite instance; this array represents all grouping and/or associations that would have to be removed to deprovision the G Suite instance from this User Group.\n\nSee `/members` and `/associations` endpoints to manage those collections.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups/{GroupID/gsuites \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite_List" />
        /// cmdlet class.
        /// </summary>
        public GetJcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite_List()
        {

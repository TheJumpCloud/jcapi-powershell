namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystemAssociation_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkSystemAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.ISystemGraphManagementReq _body;

        /// <summary>SystemGraphManagementReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SystemGraphManagementReq", ValueFromPipeline = true)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"SystemGraphManagementReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.ISystemGraphManagementReq) })]
        public JumpCloud.SDK.V2.Models.ISystemGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystemAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystemAssociation_Set()
        {

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IPolicy), typeof(JumpCloud.SDK.V2.Models.IError))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns all policies.\n\n##### Sample Request\n\n```\n curl -X GET  https://console.jumpcloud.com/api/v2/policies \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]

namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] LdapServerSambaDomain_Delete=>DELETE:"/ldapservers/{ldapserver_id}/sambadomains/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"JcSdkLdapServerSambaDomain_DeleteViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to delete a samba domain from an LDAP server.\n\n##### Sample Request\n```\ncurl -X DELETE https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID}/sambadomains/{SAMBA_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class RemoveJcSdkLdapServerSambaDomain_DeleteViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LdapServerSambaDomainDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LdapServerSambaDomainDelete(InputObject.LdapserverId ?? null, InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, onOk, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveJcSdkLdapServerSambaDomain_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveJcSdkLdapServerSambaDomain_DeleteViaIdentity()
        {

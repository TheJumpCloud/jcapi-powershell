...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-ActiveDirectory=>GET:"/activedirectories/{id}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///C:/Users/epanipinto/Documents/GitHub/jcapi-powershell/AutoRest/SwaggerSpecs/V2.json#/paths/~1activedirectories~1{id}'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: Get
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkActiveDirectory_Get")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IActiveDirectoryOutput))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint returns a specific Active Directory.\n\n#### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/activedirectories/{ActiveDirectory_ID} \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkActiveDirectory_Get : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of this Active Directory instance.")]
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetActiveDirectory(Id, onOk, this, Pipeline);

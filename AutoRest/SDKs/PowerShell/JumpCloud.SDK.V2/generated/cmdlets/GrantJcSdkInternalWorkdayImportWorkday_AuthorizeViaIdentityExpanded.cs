...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Authorize-Workday=>POST:"/workdays/{workday_id}/auth"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1workdays~1{workday_id}~1auth'
    /// [DETAILS]
    /// verb: Grant
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsSecurity.Grant, @"JcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint adds an authorization method to a workday instance.\n\nYou must supply a username and password for `Basic Authentication` that is the same as your WorkDay Integrator System User.  Failure to provide these credentials  will result in the request being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be in the future.\n\n#### Sample Request\n\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/{WorkDayID}/auth \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""auth\"":{\n\t  \""basic\"": {\n\t\t\""username\"": \""someDeveloper\"",\t  \n\t\t\""password\"": \""notTheRealPassword\""\n\n\t  }\n\t}\n}'\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GrantJcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GrantJcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public GrantJcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AuthorizeWorkday' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.WorkdayId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.AuthorizeWorkday(InputObject.WorkdayId ?? null, Body, onNoContent, this, Pipeline);

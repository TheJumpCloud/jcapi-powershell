namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SystemMemberOf_List=>GET:"/systems/{system_id}/memberof"
    /// [METADATA]
    /// path: '/systems/{system_id}/memberof'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///116?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1systems~1{system_id}~1memberof'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemMemberOf
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystemMemberOf_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphObjectWithPaths1))]
    [JumpCloud.SDK.V2.Description(@"This endpoint returns all the System Groups a System is a member of.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/systems/{System_ID}/memberof \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkSystemMemberOf_List : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemMemberOf_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemMemberOf_List()
        {

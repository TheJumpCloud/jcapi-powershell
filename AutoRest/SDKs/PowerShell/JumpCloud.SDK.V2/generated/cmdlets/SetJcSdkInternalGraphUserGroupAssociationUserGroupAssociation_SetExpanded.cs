...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-UserGroupAssociation=>POST:"/usergroups/{group_id}/associations"
    /// [METADATA]
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkInternalGraphUserGroupAssociationUserGroupAssociation_SetExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint manages the _direct_ associations of this User Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example User Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{SystemID}\""\n}'\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkInternalGraphUserGroupAssociationUserGroupAssociation_SetExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The graph connection's attributes.")]
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The graph type")]
        [global::JumpCloud.SDK.V2.Category(global::JumpCloud.SDK.V2.ParameterCategory.Body)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetUserGroupAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetUserGroupAssociation(GroupId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkInternalGraphUserGroupAssociationUserGroupAssociation_SetExpanded"
        /// /> cmdlet class.
        /// </summary>
        public SetJcSdkInternalGraphUserGroupAssociationUserGroupAssociation_SetExpanded()
        {

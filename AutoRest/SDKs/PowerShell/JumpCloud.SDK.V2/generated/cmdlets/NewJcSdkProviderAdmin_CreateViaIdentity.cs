namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkProviderAdmin_CreateViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IAdministrator), typeof(string))]
    [JumpCloud.SDK.V2.Description(@"This endpoint allows you to create a provider administrator. You must be associated to the provider to use this route.\n\n**Sample Request**\n\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/providers/{ProviderID}/administrators \\\n    -H 'Accept: application/json' \\\n    -H 'Context-Type: application/json' \\\n    -H 'x-api-key: {API_KEY}' \\\n    -d '{\n      \""email\"":\""{ADMIN_EMAIL}\""\n    }'\n```")]
    [JumpCloud.SDK.V2.Generated]
    public partial class NewJcSdkProviderAdmin_CreateViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        private JumpCloud.SDK.V2.Models.IProviderAdminReq _body;

        /// <summary>ProviderAdminReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ProviderAdminReq", ValueFromPipeline = true)]
        [JumpCloud.SDK.V2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"ProviderAdminReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloud.SDK.V2.Models.IProviderAdminReq) })]
        public JumpCloud.SDK.V2.Models.IProviderAdminReq Body { get => this._body; set => this._body = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IAdministrator" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IAdministrator> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkProviderAdmin_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewJcSdkProviderAdmin_CreateViaIdentity()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IAdministrator> response)
        {
            using( NoSynchronizationContext )
            {

...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// <summary>
    /// Refreshes the list of devices that a JumpCloud admin has added to their virtual MDM in Apple Business Manager - ABM so
    /// that they can be DEP enrolled with JumpCloud.\n\n#### Sample Request\n```\n curl -X POST https://console.jumpcloud.com/api/v2/applemdms/{apple_mdm_id}/refreshdepdevices
    /// \\\n -H 'accept: application/json' \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}' \\\n -d '{}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Refresh-AppleMDMDevice=>POST:"/applemdms/{apple_mdm_id}/refreshdepdevices"
    /// [METADATA]
    /// path: '/applemdms/{apple_mdm_id}/refreshdepdevices'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///109?oai3.shaken.json'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1applemdms~1{apple_mdm_id}~1refreshdepdevices'
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"JcSdkInternalAppleMdmDevice_Refresh", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"Refreshes the list of devices that a JumpCloud admin has added to their virtual MDM in Apple Business Manager - ABM so that they can be DEP enrolled with JumpCloud.\n\n#### Sample Request\n```\n  curl -X POST https://console.jumpcloud.com/api/v2/applemdms/{apple_mdm_id}/refreshdepdevices \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class UpdateJcSdkInternalAppleMdmDevice_Refresh : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IPathsDxuzbcApplemdmsAppleMdmIdRefreshdepdevicesPostResponses400ContentSchema"
        ...
        partial void overrideOnBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPathsDxuzbcApplemdmsAppleMdmIdRefreshdepdevicesPostResponses400ContentSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V2.Models.IPathsMdc7AmApplemdmsAppleMdmIdRefreshdepdevicesPostResponses500ContentSchema"
        /// /> from the remote call</param>
        ...
        partial void overrideOnInternalServerError(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPathsMdc7AmApplemdmsAppleMdmIdRefreshdepdevicesPostResponses500ContentSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RefreshAppleMdmDevice' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RefreshAppleMdmDevice(AppleMdmId, onNoContent, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  AppleMdmId=AppleMdmId})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkInternalAppleMdmDevice_Refresh" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkInternalAppleMdmDevice_Refresh()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPathsDxuzbcApplemdmsAppleMdmIdRefreshdepdevicesPostResponses400ContentSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IPathsDxuzbcApplemdmsAppleMdmIdRefreshdepdevicesPostResponses400ContentSchema
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onInternalServerError(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V2.Models.IPathsMdc7AmApplemdmsAppleMdmIdRefreshdepdevicesPostResponses500ContentSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloud.SDK.V2.Models.IPathsMdc7AmApplemdmsAppleMdmIdRefreshdepdevicesPostResponses500ContentSchema
                WriteObject((await response).Message);
            }
        }

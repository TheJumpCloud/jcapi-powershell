  ...
  public class ExportPsd1 : PSCmdlet
  {
    ...
    protected override void ProcessRecord()
    {
      try
      {
        ...
        string version = Convert.ToString(@"0.0.17");
        ...
        sb.AppendLine($@"{Indent}Description = '{"The JumpCloud V2 PowerShell SDK"}'");
        ...
        sb.AppendLine($@"{Indent}{Indent}{Indent}ProjectUri = '{"https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/JumpCloud.SDK.V2/"}'");

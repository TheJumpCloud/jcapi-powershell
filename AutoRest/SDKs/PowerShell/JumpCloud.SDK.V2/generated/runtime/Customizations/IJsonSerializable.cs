...
using JumpCloud.SDK.V2.Runtime.Json;
using System;
...
namespace JumpCloud.SDK.V2.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is JumpCloud.SDK.V2.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return JumpCloud.SDK.V2.Runtime.JsonSerializable.ToJson(dictionary, null);
            }

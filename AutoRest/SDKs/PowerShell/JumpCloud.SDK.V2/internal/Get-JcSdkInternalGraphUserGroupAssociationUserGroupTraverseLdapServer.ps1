...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphusergroupassociationusergrouptraverseldapserver
#>
function Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseLdapServer {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseLdapServer_List';
        }

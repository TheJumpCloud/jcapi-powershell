...
BODY <IBulkUserCreate[]>: .
  ...
  [Username <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsdkinternalbulkjobrequestbulkuser
#>
function New-JcSdkInternalBulkJobRequestBulkUser {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkInternalBulkJobRequestBulkUser_Create';
        }

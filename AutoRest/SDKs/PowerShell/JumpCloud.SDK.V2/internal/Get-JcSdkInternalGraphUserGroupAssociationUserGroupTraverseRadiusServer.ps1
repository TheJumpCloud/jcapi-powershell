...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphusergroupassociationusergrouptraverseradiusserver
#>
function Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseRadiusServer {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseRadiusServer_List';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphldapserverassociation
#>
function Get-JcSdkInternalGraphLdapServerAssociation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphLdapServerAssociation_List';
        }

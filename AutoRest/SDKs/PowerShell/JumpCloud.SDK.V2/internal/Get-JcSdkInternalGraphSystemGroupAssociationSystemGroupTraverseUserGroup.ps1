...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphsystemgroupassociationsystemgrouptraverseusergroup
#>
function Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseUserGroup_List';
        }

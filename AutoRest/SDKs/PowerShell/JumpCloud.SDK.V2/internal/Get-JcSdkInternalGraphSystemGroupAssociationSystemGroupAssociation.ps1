...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphsystemgroupassociationsystemgroupassociation
#>
function Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_List';
        }

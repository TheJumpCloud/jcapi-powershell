...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphldapservertraverseusergroup
#>
function Get-JcSdkInternalGraphLdapServerTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphLdapServerTraverseUserGroup_List';
        }

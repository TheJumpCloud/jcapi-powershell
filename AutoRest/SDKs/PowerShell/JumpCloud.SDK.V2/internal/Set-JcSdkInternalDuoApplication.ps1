...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkinternalduoapplication
#>
function Set-JcSdkInternalDuoApplication {
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalDuoApplication_Put';
            PutExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalDuoApplication_PutExpanded';
            PutViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalDuoApplication_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalDuoApplication_PutViaIdentityExpanded';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphsystemgroupassociationsystemgrouptraversecommand
#>
function Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseCommand {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseCommand_List';
        }

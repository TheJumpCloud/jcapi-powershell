...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcsdkinternalgsuite
#>
function Update-JcSdkInternalGSuite {
...
begin {
    try {
        ...
        $mapping = @{
            Patch = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalGSuite_Patch';
            PatchExpanded = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalGSuite_PatchExpanded';
            PatchViaIdentity = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalGSuite_PatchViaIdentity';
            PatchViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalGSuite_PatchViaIdentityExpanded';
        }

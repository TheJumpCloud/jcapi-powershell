...
BODY <IBulkUserUpdate[]>: .
  ...
  [Username <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcsdkinternalbulkjobrequestbulkuser
#>
function Update-JcSdkInternalBulkJobRequestBulkUser {
...
begin {
    try {
        ...
        $mapping = @{
            Patch = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalBulkJobRequestBulkUser_Patch';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalpolicy
#>
function Get-JcSdkInternalPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalPolicy_Get';
            GetViaIdentity = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalPolicy_GetViaIdentity';
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalPolicy_List';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphradiusservertraverseuser
#>
function Get-JcSdkInternalGraphRadiusServerTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphRadiusServerTraverseUser_List';
        }

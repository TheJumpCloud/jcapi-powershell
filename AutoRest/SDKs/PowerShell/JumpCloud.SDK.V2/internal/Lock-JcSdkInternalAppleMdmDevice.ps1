...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/lock-jcsdkinternalapplemdmdevice
#>
function Lock-JcSdkInternalAppleMdmDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Lock = 'JumpCloud.SDK.V2.private\Lock-JcSdkInternalAppleMdmDevice_Lock';
            LockExpanded = 'JumpCloud.SDK.V2.private\Lock-JcSdkInternalAppleMdmDevice_LockExpanded';
            LockViaIdentity = 'JumpCloud.SDK.V2.private\Lock-JcSdkInternalAppleMdmDevice_LockViaIdentity';
            LockViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Lock-JcSdkInternalAppleMdmDevice_LockViaIdentityExpanded';
        }

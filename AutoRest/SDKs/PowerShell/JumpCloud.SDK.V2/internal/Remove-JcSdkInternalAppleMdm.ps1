...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/remove-jcsdkinternalapplemdm
#>
function Remove-JcSdkInternalAppleMdm {
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloud.SDK.V2.private\Remove-JcSdkInternalAppleMdm_Delete';
            DeleteViaIdentity = 'JumpCloud.SDK.V2.private\Remove-JcSdkInternalAppleMdm_DeleteViaIdentity';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphradiusservertraverseusergroup
#>
function Get-JcSdkInternalGraphRadiusServerTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphRadiusServerTraverseUserGroup_List';
        }

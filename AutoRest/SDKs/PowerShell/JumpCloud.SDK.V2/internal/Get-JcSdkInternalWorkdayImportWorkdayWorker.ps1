...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalworkdayimportworkdayworker
#>
function Get-JcSdkInternalWorkdayImportWorkdayWorker {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalWorkdayImportWorkdayWorker_List';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/clear-jcapplemdmdevice
#>
 Function Clear-JCAppleMdmDevice
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Clear-JcSdkAppleMdmDevice @PSBoundParameters
    }
    End
    {
        Return $Results

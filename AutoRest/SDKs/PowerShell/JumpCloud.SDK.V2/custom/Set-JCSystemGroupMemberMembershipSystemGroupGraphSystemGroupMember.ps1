...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsystemgroupmembermembershipsystemgroupgraphsystemgroupmember
#>
 Function Set-JCSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember @PSBoundParameters
    }
    End
    {
        Return $Results

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkusergroupmembermembershipusergroupgraphusergroupmembership
#>
 Function Get-JcSdkUserGroupMemberMembershipUserGroupGraphUserGroupMembership
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserGroupMemberMembershipUserGroupGraphUserGroupMembership @PSBoundParameters

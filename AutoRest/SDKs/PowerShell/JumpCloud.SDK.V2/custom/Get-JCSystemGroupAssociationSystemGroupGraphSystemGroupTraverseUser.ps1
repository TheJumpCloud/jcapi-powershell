...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsystemgroupassociationsystemgroupgraphsystemgrouptraverseuser
#>
 Function Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUser
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUser @PSBoundParameters

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcoffice365
#>
 Function Update-JCOffice365
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Update-JcSdkOffice365 @PSBoundParameters
    }
    End
    {
        Return $Results

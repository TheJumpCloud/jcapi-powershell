...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdksystemgroupmembermembershipsystemgroupgraphsystemgroupmember
#>
 Function Get-JcSdkSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember @PSBoundParameters

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcduoapplication
#>
 Function New-JCDuoApplication
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkDuoApplication @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/grant-jcworkdayimportworkday
#>
 Function Grant-JCWorkdayImportWorkday
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Grant-JcSdkWorkdayImportWorkday @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/remove-jcduoaccount
#>
 Function Remove-JCDuoAccount
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkDuoAccount @PSBoundParameters
    }
    End
    {
        Return $Results

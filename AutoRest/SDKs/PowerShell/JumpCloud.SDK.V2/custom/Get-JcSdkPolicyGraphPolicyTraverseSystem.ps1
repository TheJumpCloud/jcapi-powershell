...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkpolicygraphpolicytraversesystem
#>
 Function Get-JcSdkPolicyGraphPolicyTraverseSystem
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalPolicyGraphPolicyTraverseSystem @PSBoundParameters

...
BODY <IBulkUserCreate[]>: 
  ...
  [Username <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcbulkjobrequestbulkuser
#>
 Function New-JCBulkJobRequestBulkUser
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkBulkJobRequestBulkUser @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcusergroup
#>
 Function Set-JCUserGroup
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkUserGroup @PSBoundParameters
    }
    End
    {
        Return $Results

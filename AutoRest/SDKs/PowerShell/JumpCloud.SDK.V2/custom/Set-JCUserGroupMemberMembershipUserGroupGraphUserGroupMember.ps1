...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcusergroupmembermembershipusergroupgraphusergroupmember
#>
 Function Set-JCUserGroupMemberMembershipUserGroupGraphUserGroupMember
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkUserGroupMemberMembershipUserGroupGraphUserGroupMember @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcapplemdm
#>
 Function Set-JCAppleMdm
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkAppleMdm @PSBoundParameters
    }
    End
    {
        Return $Results

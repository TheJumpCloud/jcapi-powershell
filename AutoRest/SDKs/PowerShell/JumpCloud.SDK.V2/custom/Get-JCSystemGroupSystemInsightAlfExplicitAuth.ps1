...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsystemgroupsysteminsightalfexplicitauth
#>
 Function Get-JCSystemGroupSystemInsightAlfExplicitAuth
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkSystemGroupSystemInsightAlfExplicitAuth @PSBoundParameters

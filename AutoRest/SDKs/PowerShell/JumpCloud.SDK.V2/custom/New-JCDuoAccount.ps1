...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcduoaccount
#>
 Function New-JCDuoAccount
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkDuoAccount @PSBoundParameters
    }
    End
    {
        Return $Results

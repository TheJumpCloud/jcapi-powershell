...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcoffice365graphoffice365association
#>
 Function Set-JCOffice365GraphOffice365Association
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkOffice365GraphOffice365Association @PSBoundParameters
    }
    End
    {
        Return $Results

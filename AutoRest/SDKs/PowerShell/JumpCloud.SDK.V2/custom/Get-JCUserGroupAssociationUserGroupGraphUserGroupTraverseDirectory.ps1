...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcusergroupassociationusergroupgraphusergrouptraversedirectory
#>
 Function Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseDirectory
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseDirectory @PSBoundParameters

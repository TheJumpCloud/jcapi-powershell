...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcpolicygraphpolicyassociation
#>
 Function Get-JCPolicyGraphPolicyAssociation
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkPolicyGraphPolicyAssociation @PSBoundParameters

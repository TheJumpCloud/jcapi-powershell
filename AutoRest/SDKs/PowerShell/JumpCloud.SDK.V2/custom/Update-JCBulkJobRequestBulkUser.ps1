...
BODY <IBulkUserUpdate[]>: 
  ...
  [Username <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcbulkjobrequestbulkuser
#>
 Function Update-JCBulkJobRequestBulkUser
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Update-JcSdkBulkJobRequestBulkUser @PSBoundParameters
    }
    End
    {
        Return $Results

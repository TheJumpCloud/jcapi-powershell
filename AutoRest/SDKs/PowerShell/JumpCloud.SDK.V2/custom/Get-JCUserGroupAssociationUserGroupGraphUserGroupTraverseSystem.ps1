...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcusergroupassociationusergroupgraphusergrouptraversesystem
#>
 Function Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseSystem
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseSystem @PSBoundParameters

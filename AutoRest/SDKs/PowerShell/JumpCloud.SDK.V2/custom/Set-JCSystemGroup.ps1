...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsystemgroup
#>
 Function Set-JCSystemGroup
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkSystemGroup @PSBoundParameters
    }
    End
    {
        Return $Results

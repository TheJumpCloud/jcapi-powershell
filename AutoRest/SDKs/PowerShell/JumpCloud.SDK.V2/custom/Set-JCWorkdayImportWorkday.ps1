...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcworkdayimportworkday
#>
 Function Set-JCWorkdayImportWorkday
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkWorkdayImportWorkday @PSBoundParameters
    }
    End
    {
        Return $Results

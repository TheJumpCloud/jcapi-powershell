...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcusergroupmembermembershipusergroupgraphusergroupmember
#>
 Function Get-JCUserGroupMemberMembershipUserGroupGraphUserGroupMember
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkUserGroupMemberMembershipUserGroupGraphUserGroupMember @PSBoundParameters

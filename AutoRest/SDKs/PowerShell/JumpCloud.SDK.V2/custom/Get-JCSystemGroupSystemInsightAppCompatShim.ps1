...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsystemgroupsysteminsightappcompatshim
#>
 Function Get-JCSystemGroupSystemInsightAppCompatShim
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkSystemGroupSystemInsightAppCompatShim @PSBoundParameters

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcapplemdmdevice
#>
 Function Update-JCAppleMdmDevice
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Update-JcSdkAppleMdmDevice @PSBoundParameters
    }
    End
    {
        Return $Results

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkapplicationgraphapplicationtraverseuser
#>
 Function Get-JcSdkApplicationGraphApplicationTraverseUser
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalApplicationGraphApplicationTraverseUser @PSBoundParameters

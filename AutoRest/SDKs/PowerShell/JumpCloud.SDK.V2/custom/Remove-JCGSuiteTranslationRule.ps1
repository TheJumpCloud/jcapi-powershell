...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/remove-jcgsuitetranslationrule
#>
 Function Remove-JCGSuiteTranslationRule
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkGSuiteTranslationRule @PSBoundParameters
    }
    End
    {
        Return $Results

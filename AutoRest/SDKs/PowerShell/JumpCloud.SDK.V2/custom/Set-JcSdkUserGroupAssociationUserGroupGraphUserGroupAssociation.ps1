...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkusergroupassociationusergroupgraphusergroupassociation
#>
 Function Set-JcSdkUserGroupAssociationUserGroupGraphUserGroupAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalUserGroupAssociationUserGroupGraphUserGroupAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

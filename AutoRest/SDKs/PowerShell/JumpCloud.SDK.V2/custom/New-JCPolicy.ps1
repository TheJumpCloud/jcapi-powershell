...
VALUES <IPolicyValue[]>: 
  ...
  [Value <String>]: The value for the configuration field for this Policy instance.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcpolicy
#>
 Function New-JCPolicy
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkPolicy @PSBoundParameters
    }
    End
    {
        Return $Results

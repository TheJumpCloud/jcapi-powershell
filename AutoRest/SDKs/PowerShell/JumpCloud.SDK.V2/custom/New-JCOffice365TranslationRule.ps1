...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcoffice365translationrule
#>
 Function New-JCOffice365TranslationRule
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkOffice365TranslationRule @PSBoundParameters
    }
    End
    {
        Return $Results

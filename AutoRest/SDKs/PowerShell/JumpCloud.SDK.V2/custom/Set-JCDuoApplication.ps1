...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcduoapplication
#>
 Function Set-JCDuoApplication
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkDuoApplication @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/restart-jcapplemdmdevice
#>
 Function Restart-JCAppleMdmDevice
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkWorkdayImportWorkdayAuthorization @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsambadomainldapserversambadomain
#>
 Function New-JCSambaDomainLdapServerSambaDomain
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkSambaDomainLdapServerSambaDomain @PSBoundParameters
    }
    End
    {
        Return $Results

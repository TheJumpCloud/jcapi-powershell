...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/lock-jcapplemdmdevice
#>
 Function Lock-JCAppleMdmDevice
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Lock-JcSdkAppleMdmDevice @PSBoundParameters
    }
    End
    {
        Return $Results

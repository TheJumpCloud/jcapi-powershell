...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcgsuite
#>
 Function Update-JCGSuite
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Update-JcSdkGSuite @PSBoundParameters
    }
    End
    {
        Return $Results

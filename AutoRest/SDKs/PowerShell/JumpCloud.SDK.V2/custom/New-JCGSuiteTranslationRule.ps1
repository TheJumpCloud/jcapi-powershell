...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcgsuitetranslationrule
#>
 Function New-JCGSuiteTranslationRule
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkGSuiteTranslationRule @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkoffice365graphoffice365association
#>
 Function Set-JcSdkOffice365GraphOffice365Association
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalOffice365GraphOffice365Association @PSBoundParameters
    }
    End
    {
        Return $Results

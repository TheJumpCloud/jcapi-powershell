...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdksystemgroupmembermembershipsystemgroupgraphsystemgroupmember
#>
 Function Set-JcSdkSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalSystemGroupMemberMembershipSystemGroupGraphSystemGroupMember @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkusergroupmembermembershipusergroupgraphusergroupmember
#>
 Function Set-JcSdkUserGroupMemberMembershipUserGroupGraphUserGroupMember
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalUserGroupMemberMembershipUserGroupGraphUserGroupMember @PSBoundParameters
    }
    End
    {
        Return $Results

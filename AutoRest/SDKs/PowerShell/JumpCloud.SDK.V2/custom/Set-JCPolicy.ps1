...
VALUES <IPolicyValue[]>: 
  ...
  [Value <String>]: The value for the configuration field for this Policy instance.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcpolicy
#>
 Function Set-JCPolicy
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkPolicy @PSBoundParameters
    }
    End
    {
        Return $Results

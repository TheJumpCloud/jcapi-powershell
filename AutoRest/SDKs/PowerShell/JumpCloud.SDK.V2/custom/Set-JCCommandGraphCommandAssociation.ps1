...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jccommandgraphcommandassociation
#>
 Function Set-JCCommandGraphCommandAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkCommandGraphCommandAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcprovideradmin
#>
 Function New-JCProviderAdmin
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkProviderAdmin @PSBoundParameters
    }
    End
    {
        Return $Results

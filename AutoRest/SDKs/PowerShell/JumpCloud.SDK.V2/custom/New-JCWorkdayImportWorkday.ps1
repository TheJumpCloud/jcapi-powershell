...
BODY <IWorkdayInput>: 
  ...
  [ReportUrl <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcworkdayimportworkday
#>
 Function New-JCWorkdayImportWorkday
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkWorkdayImportWorkday @PSBoundParameters
    }
    End
    {
        Return $Results

...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdksystemgroupassociationsystemgroupgraphsystemgroupassociation
#>
 Function Set-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalSystemGroupAssociationSystemGroupGraphSystemGroupAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

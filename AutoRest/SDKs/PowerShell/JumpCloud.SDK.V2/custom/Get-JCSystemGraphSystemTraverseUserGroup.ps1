...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsystemgraphsystemtraverseusergroup
#>
 Function Get-JCSystemGraphSystemTraverseUserGroup
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkSystemGraphSystemTraverseUserGroup @PSBoundParameters

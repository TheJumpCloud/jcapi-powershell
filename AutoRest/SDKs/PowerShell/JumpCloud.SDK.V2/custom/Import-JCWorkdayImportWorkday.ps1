...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/import-jcworkdayimportworkday
#>
 Function Import-JCWorkdayImportWorkday
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Import-JcSdkWorkdayImportWorkday @PSBoundParameters
    }
    End
    {
        Return $Results

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcusergroupassociationusergroupgraphusergrouptraverseapplication
#>
 Function Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseApplication
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseApplication @PSBoundParameters

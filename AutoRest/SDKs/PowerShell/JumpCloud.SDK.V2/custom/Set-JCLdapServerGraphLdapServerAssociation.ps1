...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcldapservergraphldapserverassociation
#>
 Function Set-JCLdapServerGraphLdapServerAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkLdapServerGraphLdapServerAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsystemgroup
#>
 Function New-JCSystemGroup
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkSystemGroup @PSBoundParameters
    }
    End
    {
        Return $Results

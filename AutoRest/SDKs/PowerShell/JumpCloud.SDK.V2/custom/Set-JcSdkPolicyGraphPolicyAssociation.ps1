...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkpolicygraphpolicyassociation
#>
 Function Set-JcSdkPolicyGraphPolicyAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalPolicyGraphPolicyAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

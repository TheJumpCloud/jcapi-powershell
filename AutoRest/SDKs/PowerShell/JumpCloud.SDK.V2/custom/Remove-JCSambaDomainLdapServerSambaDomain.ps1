...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/remove-jcsambadomainldapserversambadomain
#>
 Function Remove-JCSambaDomainLdapServerSambaDomain
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkSambaDomainLdapServerSambaDomain @PSBoundParameters
    }
    End
    {
        Return $Results

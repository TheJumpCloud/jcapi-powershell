...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcpolicygraphpolicyassociation
#>
 Function Set-JCPolicyGraphPolicyAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkPolicyGraphPolicyAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

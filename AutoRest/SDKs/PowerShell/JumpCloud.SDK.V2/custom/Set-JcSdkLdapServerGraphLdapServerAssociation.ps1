...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkldapservergraphldapserverassociation
#>
 Function Set-JcSdkLdapServerGraphLdapServerAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalLdapServerGraphLdapServerAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

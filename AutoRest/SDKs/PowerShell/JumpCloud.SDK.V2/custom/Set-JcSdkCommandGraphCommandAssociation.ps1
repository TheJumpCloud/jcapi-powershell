...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkcommandgraphcommandassociation
#>
 Function Set-JcSdkCommandGraphCommandAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalCommandGraphCommandAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

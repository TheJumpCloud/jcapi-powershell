...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkactivedirectorygraphactivedirectorytraverseusergroup
#>
 Function Get-JcSdkActiveDirectoryGraphActiveDirectoryTraverseUserGroup
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalActiveDirectoryGraphActiveDirectoryTraverseUserGroup @PSBoundParameters

...
namespace JumpCloud.SDK.DirectoryInsights.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is JumpCloud.SDK.DirectoryInsights.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return JumpCloud.SDK.DirectoryInsights.Runtime.JsonSerializable.ToJson(dictionary, null);
            }

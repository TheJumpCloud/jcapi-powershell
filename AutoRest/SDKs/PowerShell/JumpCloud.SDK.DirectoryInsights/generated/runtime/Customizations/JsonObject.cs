...
namespace JumpCloud.SDK.DirectoryInsights.Runtime.Json
{
    ...
    {
        internal override object ToValue() => JumpCloud.SDK.DirectoryInsights.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());

...
namespace JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        internal AsyncOperationResponse(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode.Parse(text).Type == JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonType.Object;
            }
            catch
            {

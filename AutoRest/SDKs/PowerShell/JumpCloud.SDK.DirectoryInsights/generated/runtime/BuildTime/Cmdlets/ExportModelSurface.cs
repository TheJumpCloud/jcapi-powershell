...
namespace JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"JumpCloud.SDK.DirectoryInsights.Models";
    private const string SupportNamespace = @"JumpCloud.SDK.DirectoryInsights.Support";

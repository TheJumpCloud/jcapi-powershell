...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class Errorresponse
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="Errorresponse" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Errorresponse(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_message = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString>("message"), out var __jsonMessage) ? (string)__jsonMessage : (string)Message;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.IErrorresponse.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.DirectoryInsights.Models.IErrorresponse.</returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.IErrorresponse FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new Errorresponse(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Errorresponse" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Errorresponse" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject container, JumpCloud.SDK.DirectoryInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._message)?.ToString()) ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(this._message.ToString()) : null, "message" ,container.Add );

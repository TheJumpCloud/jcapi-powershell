...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class Sshkeylist
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.ISshkeylist.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.DirectoryInsights.Models.ISshkeylist.</returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.ISshkeylist FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new Sshkeylist(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="Sshkeylist" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Sshkeylist(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_name = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            ...
            {_createDate = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString>("create_date"), out var __jsonCreateDate) ? (string)__jsonCreateDate : (string)CreateDate;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Sshkeylist" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Sshkeylist" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject container, JumpCloud.SDK.DirectoryInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._name)?.ToString()) ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(this._name.ToString()) : null, "name" ,container.Add );
            ...
            AddIf( null != (((object)this._createDate)?.ToString()) ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(this._createDate.ToString()) : null, "create_date" ,container.Add );

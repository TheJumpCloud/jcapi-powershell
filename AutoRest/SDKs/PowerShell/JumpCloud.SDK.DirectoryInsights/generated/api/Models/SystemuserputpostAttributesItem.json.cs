...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class SystemuserputpostAttributesItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem.
        /// </returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new SystemuserputpostAttributesItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="SystemuserputpostAttributesItem" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemuserputpostAttributesItem(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemuserputpostAttributesItem" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemuserputpostAttributesItem" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>

...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class Systemuserputpost
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpost.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpost.</returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpost FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new Systemuserputpost(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="Systemuserputpost" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Systemuserputpost(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_addresses = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray>("addresses"), out var __jsonAddresses) ? If( __jsonAddresses as JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem) (JumpCloud.SDK.DirectoryInsights.Models.SystemuserputpostAddressesItem.FromJson(__u) )) ))() : null : Addresses;}
            ...
            {_attributes = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray>("attributes"), out var __jsonAttributes) ? If( __jsonAttributes as JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem) (JumpCloud.SDK.DirectoryInsights.Models.SystemuserputpostAttributesItem.FromJson(__p) )) ))() : null : Attributes;}
            ...
            {_password = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString>("password"), out var __jsonPassword) ? (string)__jsonPassword : (string)Password;}
            ...
            {_phoneNumbers = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray>("phoneNumbers"), out var __jsonPhoneNumbers) ? If( __jsonPhoneNumbers as JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem) (JumpCloud.SDK.DirectoryInsights.Models.SystemuserputpostPhoneNumbersItem.FromJson(__k) )) ))() : null : PhoneNumbers;}
            ...
            {_relationships = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray>("relationships"), out var __jsonRelationships) ? If( __jsonRelationships as JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem) (JumpCloud.SDK.DirectoryInsights.Models.SystemuserputpostRelationshipsItem.FromJson(__f) )) ))() : null : Relationships;}
            ...
            {_tags = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray>("tags"), out var __jsonTags) ? If( __jsonTags as JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonArray, out var __b) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__b, (__a)=>(string) (__a is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString ___z ? (string)(___z.ToString()) : null)) ))() : null : Tags;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Systemuserputpost" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Systemuserputpost" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject container, JumpCloud.SDK.DirectoryInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._externalPasswordExpirationDate ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(this._externalPasswordExpirationDate?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "external_password_expiration_date" ,container.Add );
            ...
            AddIf( null != (((object)this._password)?.ToString()) ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(this._password.ToString()) : null, "password" ,container.Add );
            ...
            {
                var __h = new JumpCloud.SDK.DirectoryInsights.Runtime.Json.XNodeArray();
            ...
            if (null != this._tags)
            {
                var __c = new JumpCloud.SDK.DirectoryInsights.Runtime.Json.XNodeArray();
                foreach( var __d in this._tags )
                {
                    AddIf(null != (((object)__d)?.ToString()) ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode) new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonString(__d.ToString()) : null ,__c.Add);
                }

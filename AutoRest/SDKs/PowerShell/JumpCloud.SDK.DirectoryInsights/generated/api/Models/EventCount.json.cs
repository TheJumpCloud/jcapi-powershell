...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class EventCount
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="EventCount" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal EventCount(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json)
        {
            ...
            {_count = If( json?.PropertyT<JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNumber>("count"), out var __jsonCount) ? (long?)__jsonCount : Count;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.IEventCount.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.DirectoryInsights.Models.IEventCount.</returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.IEventCount FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new EventCount(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="EventCount" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="EventCount" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject container, JumpCloud.SDK.DirectoryInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._count ? (JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode)new JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNumber((long)this._count) : null, "count" ,container.Add );

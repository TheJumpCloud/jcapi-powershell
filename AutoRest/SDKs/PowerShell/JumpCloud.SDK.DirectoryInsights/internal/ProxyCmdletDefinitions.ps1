...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.directoryinsights/get-jcsdkinternaleventcount
#>
function Get-JcSdkInternalEventCount {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloud.SDK.DirectoryInsights.private\Get-JcSdkInternalEventCount_Get';
            GetExpanded = 'JumpCloud.SDK.DirectoryInsights.private\Get-JcSdkInternalEventCount_GetExpanded';
        }

namespace JumpCloud.SDK.DirectoryInsights
{
    ...
    // using JumpCloud.SDK.DirectoryInsights;
    // using JumpCloud.SDK.DirectoryInsights.Runtime.Json;
    ...
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.MarkdownRenderer;
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.MarkdownTypesExtensions;
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.PsHelpers;
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.PsHelpOutputExtensions;
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.PsProxyOutputExtensions;
    // using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.PsProxyTypeExtensions;

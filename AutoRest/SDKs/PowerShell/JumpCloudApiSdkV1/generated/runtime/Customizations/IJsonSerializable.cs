...
using JumpCloudApiSdkV1.Runtime.Json;
using System;
...
namespace JumpCloudApiSdkV1.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is JumpCloudApiSdkV1.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return JumpCloudApiSdkV1.Runtime.JsonSerializable.ToJson(dictionary, null);
            }

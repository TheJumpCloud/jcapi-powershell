...
namespace JumpCloudApiSdkV1.Runtime.PowerShell
{
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            sb.AppendLine($@"{Indent}RootModule = '{"./JumpCloudApiSdkV1.psm1"}'");
            ...
            sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/JumpCloudApiSdkV1.private.dll"}'");
            ...
            var formatList = customFormatPs1xmlFiles.Prepend("./JumpCloudApiSdkV1.format.ps1xml").ToPsList();

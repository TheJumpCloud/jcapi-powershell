namespace JumpCloudApiSdkV1.Runtime.PowerShell
{
    ...
    {
        JumpCloudApiSdkV1.Runtime.SendAsyncStep Wrap(JumpCloudApiSdkV1.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<JumpCloudApiSdkV1.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloudApiSdkV1.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public JumpCloudApiSdkV1.Runtime.SendAsyncStep Wrap(JumpCloudApiSdkV1.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<JumpCloudApiSdkV1.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloudApiSdkV1.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);

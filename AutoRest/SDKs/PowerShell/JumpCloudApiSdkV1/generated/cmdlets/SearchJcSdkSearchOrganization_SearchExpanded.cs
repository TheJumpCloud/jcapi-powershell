namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Search-Organization=>POST:"/search/organizations"
    /// [METADATA]
    ...
    /// verb: Search
    /// subjectPrefix:
    /// subject: SearchOrganization
    /// variant: SearchExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Search, @"JcSdkSearchOrganization_SearchExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IOrganizationslist))]
    [JumpCloudApiSdkV1.Description(@"This endpoint will return Organization data based on your search parameters. This endpoint WILL NOT allow you to add a new Organization.\n\nYou can use the supported parameters and pass those in the body of request. \n\nThe parameters must be passed as Content-Type application/json.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/search/organizations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  \""search\"":{\n    \""fields\"" : [\""settings.name\""],\n    \""searchTerm\"": \""Second\""\n    },\n  \""fields\"": [\""_id\"", \""displayName\"", \""logoUrl\""],\n  \""limit\"" : 0,\n  \""skip\"" : 0\n}'\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class SearchJcSdkSearchOrganization_SearchExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.ISearch _body= new JumpCloudApiSdkV1.Models.Search();

        /// <summary>Search</summary>
        private JumpCloudApiSdkV1.Models.ISearch Body { get => this._body; set => this._body = value; }
        ...
        SerializedName = @"fields",
        PossibleTypes = new [] { typeof(string) })]
        public string Fields1 { get => Body.Fields ?? null; set => Body.Fields = value; }
        ...
        public JumpCloudApiSdkV1.Models.ISearchFilter Filter1 { get => Body.Filter ?? null /* object */; set => Body.Filter = value; }
        ...
        public JumpCloudApiSdkV1.Models.ISearchFilter1 SearchFilter { get => Body.SearchFilter ?? null /* object */; set => Body.SearchFilter = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IOrganizationslist" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IOrganizationslist> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SearchOrganization' operation"))
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SearchJcSdkSearchOrganization_SearchExpanded" /> cmdlet class.
        /// </summary>
        public SearchJcSdkSearchOrganization_SearchExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IOrganizationslist> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IOrganizationslist

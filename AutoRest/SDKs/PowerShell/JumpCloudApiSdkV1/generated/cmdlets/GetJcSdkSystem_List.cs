namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V1.json#/paths/~1systems'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: System
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystem_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ISystemslist))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns all Systems.\n\n#### Sample Requests\n```\ncurl -X GET https://console.jumpcloud.com/api/systems \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkSystem_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystem_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystem_List()
        {

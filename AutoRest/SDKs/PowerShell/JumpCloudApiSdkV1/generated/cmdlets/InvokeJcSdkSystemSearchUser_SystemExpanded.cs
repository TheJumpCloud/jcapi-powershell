namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] search_SystemUser_Create=>POST:"/search/systemusers"
    /// [METADATA]
        ...
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeJcSdkSystemSearchUser_SystemExpanded" /> cmdlet class.
        /// </summary>
        public InvokeJcSdkSystemSearchUser_SystemExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SearchSystemUserCreate' operation"))
                {

namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// a Command via a Trigger passing a JSON object to the command**\n```\ncurl --silent \\\n -X 'POST' \\\n -H \"x-api-key:
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V1.json#/paths/~1command~1trigger~1{triggername}'
    /// [DETAILS]
    /// verb: Start
    /// subjectPrefix:
    /// subject: CommandTriggerWebhook
    /// variant: Start
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Start, @"JcSdkCommandTriggerWebhook_Start", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV1.Description(@"This endpoint allows you to launch a command based on a defined trigger.\n\n#### Sample Requests\n\n**Launch a Command via a Trigger**\n\n```\ncurl --silent \\\n     -X 'POST' \\\n     -H \""x-api-key: {API_KEY}\"" \\\n     \""https://console.jumpcloud.com/api/command/trigger/{TriggerName}\""\n```\n**Launch a Command via a Trigger passing a JSON object to the command**\n```\ncurl --silent \\\n     -X 'POST' \\\n     -H \""x-api-key: {API_KEY}\"" \\\n     -H 'Accept: application/json' \\\n     -H 'Content-Type: application/json' \\\n     -d '{ \""srcip\"":\""192.168.2.32\"", \""attack\"":\""Cross Site Scripting Attempt\"" }' \\\n     \""https://console.jumpcloud.com/api/command/trigger/{TriggerName}\""\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class StartJcSdkCommandTriggerWebhook_Start : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CommandTriggerWebhookStart(Triggername, onOk, onUnauthorized, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  Triggername=Triggername}));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="StartJcSdkCommandTriggerWebhook_Start" /> cmdlet class.
        /// </summary>
        public StartJcSdkCommandTriggerWebhook_Start()
        {

namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-SystemUser=>GET:"/systemusers/{id}"
    /// [METADATA]
    /// path: '/systemusers/{id}'
    /// apiVersions:
    /// - '1.0'
    ...
    /// variant: Get
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystemUser_Get")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ISystemuserreturn))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns a particular System User.\n\n#### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/systemusers/{UserID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkSystemUser_Get : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemUser_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemUser_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetSystemUser(Id, this.InvocationInformation.BoundParameters.ContainsKey("Fields") ? Fields : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onUnauthorized, this, Pipeline);

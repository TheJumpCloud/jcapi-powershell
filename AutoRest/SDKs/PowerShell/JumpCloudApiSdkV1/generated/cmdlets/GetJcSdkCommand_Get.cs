namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-Command=>GET:"/commands/{id}"
    /// [METADATA]
    /// path: '/commands/{id}'
    /// apiVersions:
    /// - '1.0'
    ...
    /// variant: Get
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkCommand_Get")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ICommand))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns a specific command based on the command ID.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/commands/{CommandID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkCommand_Get : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkCommand_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkCommand_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetCommand(Id, this.InvocationInformation.BoundParameters.ContainsKey("Fields") ? Fields : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onUnauthorized, this, Pipeline);

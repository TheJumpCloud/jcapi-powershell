namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Command_Get=>GET:"/commands/{id}"
    /// [METADATA]
    /// path: '/commands/{id}'
    /// apiVersions:
    /// - '1.0'
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CommandGet(Id, this.InvocationInformation.BoundParameters.ContainsKey("Fields") ? Fields : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onUnauthorized, this, Pipeline);

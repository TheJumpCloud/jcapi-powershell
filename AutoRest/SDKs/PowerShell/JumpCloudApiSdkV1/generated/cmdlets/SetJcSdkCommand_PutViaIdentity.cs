namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkCommand_PutViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ICommand))]
    [JumpCloudApiSdkV1.Description(@"This endpoint Updates a command based on the command ID and returns the modified command record.\n\n#### Sample Request\n```\ncurl -X PUT https://console.jumpcloud.com/api/commands/{CommandID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""name\"":\""Test API Command\"",\n\t\""command\"":\""String\"",\n\t\""user\"":\""{UserID}\"",\n\t\""schedule\"":\""\"",\n\t\""timeout\"":\""100\""\n}'\n\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class SetJcSdkCommand_PutViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.ICommand _body;
        ...
        Description = @"Command",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV1.Models.ICommand) })]
        public JumpCloudApiSdkV1.Models.ICommand Body { get => this._body; set => this._body = value; }

namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"JcSdkCommandResult_DeleteViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ICommandresult))]
    [JumpCloudApiSdkV1.Description(@"This endpoint deletes a specific command result.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/commandresults/{CommandID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n  ````")]
    [JumpCloudApiSdkV1.Generated]
    public partial class RemoveJcSdkCommandResult_DeleteViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DeleteCommandResult(InputObject.Id ?? null, onOk, onUnauthorized, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveJcSdkCommandResult_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveJcSdkCommandResult_DeleteViaIdentity()
        {

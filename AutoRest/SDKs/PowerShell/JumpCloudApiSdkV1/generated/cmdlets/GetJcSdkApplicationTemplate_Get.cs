namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-ApplicationTemplate=>GET:"/application-templates/{id}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V1.json#/paths/~1application-templates~1{id}'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ApplicationTemplate
    /// variant: Get
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkApplicationTemplate_Get")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IApplicationtemplate))]
    [JumpCloudApiSdkV1.Description(@"The endpoint returns a specific SSO / SAML Application Template.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/application-templates/{id} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkApplicationTemplate_Get : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The comma separated fields included in the returned records. If omitted the default list of fields will be returned.")]
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IApplicationtemplate" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IApplicationtemplate> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkApplicationTemplate_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkApplicationTemplate_Get()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IApplicationtemplate> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IApplicationtemplate

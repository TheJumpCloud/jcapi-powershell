namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Organization_List=>GET:"/organizations"
    /// [METADATA]
    /// path: /organizations
    /// apiVersions:
    /// - '1.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V1.json#/paths/~1organizations'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkOrganization_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IOrganizationslist))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns Organization Details.\n\n#### Sample Request \n\n```\ncurl -X GET \\\n  https://console.jumpcloud.com/api/organizations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkOrganization_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkOrganization_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkOrganization_List()
        {

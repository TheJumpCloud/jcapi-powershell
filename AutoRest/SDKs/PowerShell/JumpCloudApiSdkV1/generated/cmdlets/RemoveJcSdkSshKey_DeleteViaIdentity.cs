namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] SshKey_Delete=>DELETE:"/systemusers/{systemuser_id}/sshkeys/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"JcSdkSshKey_DeleteViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveJcSdkSshKey_DeleteViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SshKeyDelete' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SshKeyDelete(InputObject.SystemuserId ?? null, InputObject.Id ?? null, onOk, onBadRequest, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveJcSdkSshKey_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveJcSdkSshKey_DeleteViaIdentity()
        {

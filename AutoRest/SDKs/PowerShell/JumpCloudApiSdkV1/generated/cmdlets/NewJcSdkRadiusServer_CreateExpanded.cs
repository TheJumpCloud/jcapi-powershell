namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkRadiusServer_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IRadiusserver))]
    [JumpCloudApiSdkV1.Description(@"This endpoint allows you to create RADIUS servers in your organization.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/radiusservers/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""name\"": \""{test_radius}\"",\n    \""networkSourceIp\"": \""{0.0.0.0}\"",\n    \""sharedSecret\"":\""{secretpassword}\"",\n    \""userLockoutAction\"": \""REMOVE\"",\n    \""userPasswordExpirationAction\"": \""MAINTAIN\""\n}'\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class NewJcSdkRadiusServer_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.IRadiusserverpost _body= new JumpCloudApiSdkV1.Models.Radiusserverpost();

        /// <summary>RadiusServerPost</summary>
        private JumpCloudApiSdkV1.Models.IRadiusserverpost Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "RADIUS shared secret between the server and client.")]
        [JumpCloudApiSdkV1.Category(JumpCloudApiSdkV1.ParameterCategory.Body)]
        [JumpCloudApiSdkV1.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IRadiusserver" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IRadiusserver> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkRadiusServer_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkRadiusServer_CreateExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IRadiusserver> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IRadiusserver

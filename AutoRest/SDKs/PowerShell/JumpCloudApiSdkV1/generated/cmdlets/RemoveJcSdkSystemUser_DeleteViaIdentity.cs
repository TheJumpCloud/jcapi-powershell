namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"JcSdkSystemUser_DeleteViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ISystemuserreturn))]
    [JumpCloudApiSdkV1.Description(@"This endpoint allows you to delete a particular system user.\n\n#### Sample Request\n```\ncurl -X DELETE https://console.jumpcloud.com/api/systemusers/{UserID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class RemoveJcSdkSystemUser_DeleteViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveJcSdkSystemUser_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveJcSdkSystemUser_DeleteViaIdentity()
        {

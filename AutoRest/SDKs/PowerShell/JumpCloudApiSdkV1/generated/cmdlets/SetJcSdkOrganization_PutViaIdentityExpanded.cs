namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Organization_Put=>PUT:"/organizations/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkOrganization_PutViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IOrganization))]
    [JumpCloudApiSdkV1.Description(@"This endpoint allows you to update an Organization.\n\nNote: `passwordPolicy` settings are only used when `passwordCompliance` is set to \""custom\"". We discourage the use of non-custom passwordCompliance values.\n\n`hasStripeCustomerId` is deprecated and will be removed.\n\n#### Sample Request\n\n```\ncurl -X PUT https://console.jumpcloud.com/api/organizations/{OrganizationID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  \""settings\"": {\n    \""contactName\"": \""Admin Name\"",\n    \""contactEmail\"": \""admin@company.com\"",\n    \""systemUsersCanEdit\"":true,\n    \""passwordPolicy\"": {\n      \""enableMaxHistory\"": true,\n      \""maxHistory\"": 3\n    }\n  }\n}'\n```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class SetJcSdkOrganization_PutViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.IBodyParameterOrganizationPutRequestBody _body= new JumpCloudApiSdkV1.Models.BodyParameterOrganizationPutRequestBody();

        private JumpCloudApiSdkV1.Models.IBodyParameterOrganizationPutRequestBody Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "OrganizationSettingsPut")]
        ...
        public JumpCloudApiSdkV1.Models.IOrganizationsettingsput Settings { get => Body.Settings ?? null /* object */; set => Body.Settings = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IOrganization" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IOrganization> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'OrganizationPut' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OrganizationPut(InputObject.Id ?? null, Body, onOk, onBadRequest, onUnauthorized, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkOrganization_PutViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkOrganization_PutViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IOrganization> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IOrganization

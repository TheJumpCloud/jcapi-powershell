namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    [JumpCloudApiSdkV1.Description(@"This endpoint allows you to create a new system user.\n\n#### Sample Request\n\n```\ncurl -X POST https://console.jumpcloud.com/api/systemusers \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""username\"":\""{username}\"",\n\t\""email\"":\""{email_address}\"",\n\t\""firstname\"":\""{Name}\"",\n\t\""lastname\"":\""{Name}\""\n}'\n```")]
        ...
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        public JumpCloudApiSdkV1.Models.ISystemuserputpostAddressesItem[] Addresses { get => Body.Addresses ?? null /* arrayOf */; set => Body.Addresses = value; }
        ...
        public JumpCloudApiSdkV1.Models.ISystemuserputpostAttributesItem[] Attributes { get => Body.Attributes ?? null /* arrayOf */; set => Body.Attributes = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloudApiSdkV1.Models.ISystemuserputpost _body= new JumpCloudApiSdkV1.Models.Systemuserputpost();

        /// <summary>SystemUserPost</summary>
        private JumpCloudApiSdkV1.Models.ISystemuserputpost Body { get => this._body; set => this._body = value; }
        ...
        public JumpCloudApiSdkV1.Models.ISystemuserputpostPhoneNumbersItem[] PhoneNumbers { get => Body.PhoneNumbers ?? null /* arrayOf */; set => Body.PhoneNumbers = value; }
        ...
        public JumpCloudApiSdkV1.Models.ISystemuserputpostRelationshipsItem[] Relationships { get => Body.Relationships ?? null /* arrayOf */; set => Body.Relationships = value; }

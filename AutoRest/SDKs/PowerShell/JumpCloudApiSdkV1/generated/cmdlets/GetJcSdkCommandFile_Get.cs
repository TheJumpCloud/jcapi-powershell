namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ICommandfilereturn), typeof(JumpCloudApiSdkV1.Models.IPathsFilesCommandIdGetResponses400ContentApplicationJsonSchema))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns the uploaded file(s) associated with a specific command.\n\n#### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/files/command/{commandID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n  ```")]
        ...
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IPathsFilesCommandIdGetResponses400ContentApplicationJsonSchema"
        ...
        partial void overrideOnBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IPathsFilesCommandIdGetResponses400ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.ICommandfilereturn" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.ICommandfilereturn> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IPathsFilesCommandIdGetResponses400ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IPathsFilesCommandIdGetResponses400ContentApplicationJsonSchema
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.ICommandfilereturn> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.ICommandfilereturn
                WriteObject((await response));
            }
        }
    }

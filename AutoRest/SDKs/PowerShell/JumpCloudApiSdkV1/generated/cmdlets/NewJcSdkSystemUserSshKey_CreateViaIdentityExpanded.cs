namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create-SshKey=>POST:"/systemusers/{id}/sshkeys"
    /// [METADATA]
    /// path: '/systemusers/{id}/sshkeys'
    /// apiVersions:
    /// - '1.0'
    /// filename:
    ...
    /// verb: New
    /// subjectPrefix:
    /// subject: SystemUserSshKey
    /// variant: CreateViaIdentityExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkSystemUserSshKey_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.ISshkeylist), typeof(JumpCloudApiSdkV1.Models.IPathsSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema))]
    [JumpCloudApiSdkV1.Description(@"This endpoint will create a specific System User's Public SSH Key.")]
    [JumpCloudApiSdkV1.Generated]
    public partial class NewJcSdkSystemUserSshKey_CreateViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.ISshkeypost _body= new JumpCloudApiSdkV1.Models.Sshkeypost();

        /// <summary>SSHKeyPost</summary>
        private JumpCloudApiSdkV1.Models.ISshkeypost Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the SSH key.")]
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Public SSH key.")]
        [JumpCloudApiSdkV1.Category(JumpCloudApiSdkV1.ParameterCategory.Body)]
        [JumpCloudApiSdkV1.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.IPathsSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema"
        ...
        partial void overrideOnBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IPathsSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV1.Models.ISshkeylist" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.ISshkeylist> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkSystemUserSshKey_CreateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkSystemUserSshKey_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateSshKey' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateSshKey(InputObject.Id ?? null, Body, onOk, onBadRequest, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.IPathsSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.IPathsSystemusersIdSshkeysPostResponses400ContentApplicationJsonSchema
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV1.Models.ISshkeylist> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV1.Models.ISshkeylist
                WriteObject((await response));
            }
        }
    }

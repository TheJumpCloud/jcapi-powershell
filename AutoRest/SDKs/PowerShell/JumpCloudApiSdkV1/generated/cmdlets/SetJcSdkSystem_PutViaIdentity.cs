namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSystem_PutViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkSystem_PutViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV1.Models.ISystemput _body;

        /// <summary>SystemPut</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SystemPut", ValueFromPipeline = true)]
        [JumpCloudApiSdkV1.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"SystemPut",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV1.Models.ISystemput) })]
        public JumpCloudApiSdkV1.Models.ISystemput Body { get => this._body; set => this._body = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutSystem(InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSystem_PutViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkSystem_PutViaIdentity()
        {

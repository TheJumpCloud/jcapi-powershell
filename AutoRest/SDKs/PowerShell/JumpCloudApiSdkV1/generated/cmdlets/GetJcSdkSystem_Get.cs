namespace JumpCloudApiSdkV1.Cmdlets
{
    ...
    /// variant: Get
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystem_Get")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV1.Models.IJcSystem))]
    [JumpCloudApiSdkV1.Description(@"This endpoint returns an individual system.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/systems/{SystemID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n  ```")]
    [JumpCloudApiSdkV1.Generated]
    public partial class GetJcSdkSystem_Get : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystem_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystem_Get()
        {

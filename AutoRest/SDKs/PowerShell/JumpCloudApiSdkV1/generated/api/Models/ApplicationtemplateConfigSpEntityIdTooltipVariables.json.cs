namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationtemplateConfigSpEntityIdTooltipVariables
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationtemplateConfigSpEntityIdTooltipVariables"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationtemplateConfigSpEntityIdTooltipVariables(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationtemplateConfigSpEntityIdTooltipVariables.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloudApiSdkV1.Models.IApplicationtemplateConfigSpEntityIdTooltipVariables.
        /// </returns>
        public static JumpCloudApiSdkV1.Models.IApplicationtemplateConfigSpEntityIdTooltipVariables FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationtemplateConfigSpEntityIdTooltipVariables(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationtemplateConfigSpEntityIdTooltipVariables" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationtemplateConfigSpEntityIdTooltipVariables" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"
        /// />.
        /// </returns>

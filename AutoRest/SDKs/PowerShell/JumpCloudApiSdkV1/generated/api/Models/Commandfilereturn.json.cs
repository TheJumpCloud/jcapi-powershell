namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Commandfilereturn
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="Commandfilereturn" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Commandfilereturn(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_results = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("results"), out var __jsonResults) ? JumpCloudApiSdkV1.Models.CommandfilereturnResults.FromJson(__jsonResults) : Results;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ICommandfilereturn.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ICommandfilereturn.</returns>
        public static JumpCloudApiSdkV1.Models.ICommandfilereturn FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new Commandfilereturn(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Commandfilereturn" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Commandfilereturn" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._results ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) this._results.ToJson(null,serializationMode) : null, "results" ,container.Add );

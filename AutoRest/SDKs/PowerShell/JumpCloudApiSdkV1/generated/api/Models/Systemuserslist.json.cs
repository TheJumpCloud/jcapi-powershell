namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Systemuserslist
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ISystemuserslist.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ISystemuserslist.</returns>
        public static JumpCloudApiSdkV1.Models.ISystemuserslist FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new Systemuserslist(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="Systemuserslist" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Systemuserslist(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_results = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonArray>("results"), out var __jsonResults) ? If( __jsonResults as JumpCloudApiSdkV1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloudApiSdkV1.Models.ISystemuserreturn[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloudApiSdkV1.Models.ISystemuserreturn) (JumpCloudApiSdkV1.Models.Systemuserreturn.FromJson(__u) )) ))() : null : Results;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Systemuserslist" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Systemuserslist" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

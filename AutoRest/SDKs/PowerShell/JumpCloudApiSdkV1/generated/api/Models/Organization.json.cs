namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Organization
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IOrganization.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IOrganization.</returns>
        public static JumpCloudApiSdkV1.Models.IOrganization FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new Organization(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="Organization" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Organization(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_hasStripeCustomerId = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonBoolean>("hasStripeCustomerId"), out var __jsonHasStripeCustomerId) ? (bool?)__jsonHasStripeCustomerId : HasStripeCustomerId;}
            {_logoUrl = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("logoUrl"), out var __jsonLogoUrl) ? (string)__jsonLogoUrl : (string)LogoUrl;}
            {_provider = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("provider"), out var __jsonProvider) ? (string)__jsonProvider : (string)Provider;}
            {_settings = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("settings"), out var __jsonSettings) ? JumpCloudApiSdkV1.Models.Organizationsettings.FromJson(__jsonSettings) : Settings;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Organization" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Organization" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._hasStripeCustomerId ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode)new JumpCloudApiSdkV1.Runtime.Json.JsonBoolean((bool)this._hasStripeCustomerId) : null, "hasStripeCustomerId" ,container.Add );
            AddIf( null != (((object)this._logoUrl)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._logoUrl.ToString()) : null, "logoUrl" ,container.Add );
            AddIf( null != (((object)this._provider)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._provider.ToString()) : null, "provider" ,container.Add );
            AddIf( null != this._settings ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) this._settings.ToJson(null,serializationMode) : null, "settings" ,container.Add );

namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class SystemGroupGraphManagementReq
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ISystemGroupGraphManagementReq.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ISystemGroupGraphManagementReq.</returns>
        public static JumpCloudApiSdkV1.Models.ISystemGroupGraphManagementReq FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new SystemGroupGraphManagementReq(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="SystemGroupGraphManagementReq" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemGroupGraphManagementReq(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloudApiSdkV1.Models.SystemGroupGraphManagementReqAttributes.FromJson(__jsonAttributes) : Attributes;}
            {_id = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("id"), out var __jsonId) ? (string)__jsonId : (string)Id;}
            {_op = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("op"), out var __jsonOp) ? (string)__jsonOp : (string)Op;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemGroupGraphManagementReq" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemGroupGraphManagementReq" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._attributes ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) this._attributes.ToJson(null,serializationMode) : null, "attributes" ,container.Add );
            ...
            AddIf( null != (((object)this._op)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._op.ToString()) : null, "op" ,container.Add );

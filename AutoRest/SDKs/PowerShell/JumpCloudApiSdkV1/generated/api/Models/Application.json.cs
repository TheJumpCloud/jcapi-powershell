namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Application
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="Application" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Application(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_config = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("config"), out var __jsonConfig) ? JumpCloudApiSdkV1.Models.ApplicationConfig.FromJson(__jsonConfig) : Config;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplication.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IApplication.</returns>
        public static JumpCloudApiSdkV1.Models.IApplication FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new Application(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Application" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Application" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class SystemuserputpostPhoneNumbersItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ISystemuserputpostPhoneNumbersItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ISystemuserputpostPhoneNumbersItem.</returns>
        public static JumpCloudApiSdkV1.Models.ISystemuserputpostPhoneNumbersItem FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new SystemuserputpostPhoneNumbersItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="SystemuserputpostPhoneNumbersItem" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemuserputpostPhoneNumbersItem(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_number = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("number"), out var __jsonNumber) ? (string)__jsonNumber : (string)Number;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemuserputpostPhoneNumbersItem" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemuserputpostPhoneNumbersItem" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._number)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._number.ToString()) : null, "number" ,container.Add );

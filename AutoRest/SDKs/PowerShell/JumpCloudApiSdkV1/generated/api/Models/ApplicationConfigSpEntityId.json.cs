namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigSpEntityId
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigSpEntityId" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigSpEntityId(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloudApiSdkV1.Models.ApplicationConfigSpEntityIdTooltip.FromJson(__jsonTooltip) : Tooltip;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationConfigSpEntityId.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IApplicationConfigSpEntityId.</returns>
        public static JumpCloudApiSdkV1.Models.IApplicationConfigSpEntityId FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationConfigSpEntityId(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigSpEntityId" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigSpEntityId" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigIdpPrivateKey :
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKey,
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyInternal
    {

        /// <summary>Internal Acessors for Tooltip</summary>
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltip JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyInternal.Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloudApiSdkV1.Models.ApplicationConfigIdpPrivateKeyTooltip()); set { {_tooltip = value;} } }

        /// <summary>Internal Acessors for TooltipVariables</summary>
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipVariables JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyInternal.TooltipVariables { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).Variables; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).Variables = value; }
        ...
        private JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltip _tooltip;

        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Owned)]
        internal JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltip Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloudApiSdkV1.Models.ApplicationConfigIdpPrivateKeyTooltip()); set => this._tooltip = value; }
        ...
        public string TooltipTemplate { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).Template; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).Template = value; }
        ...
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string VariableIcon { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableIcon; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableIcon = value; }

        /// <summary>FIXME: Property VariableMessage is MISSING DESCRIPTION</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string VariableMessage { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableMessage; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipInternal)Tooltip).VariableMessage = value; }
...

    {
        ...
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltip Tooltip { get; set; }

        string TooltipTemplate { get; set; }

        JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKeyTooltipVariables TooltipVariables { get; set; }

namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigIdpEntityId
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigIdpEntityId" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigIdpEntityId(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloudApiSdkV1.Models.ApplicationConfigIdpEntityIdTooltip.FromJson(__jsonTooltip) : Tooltip;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityId.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityId.</returns>
        public static JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityId FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationConfigIdpEntityId(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigIdpEntityId" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigIdpEntityId" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

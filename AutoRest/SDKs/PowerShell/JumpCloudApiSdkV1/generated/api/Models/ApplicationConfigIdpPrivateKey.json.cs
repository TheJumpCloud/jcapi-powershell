namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigIdpPrivateKey
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigIdpPrivateKey" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigIdpPrivateKey(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_tooltip = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("tooltip"), out var __jsonTooltip) ? JumpCloudApiSdkV1.Models.ApplicationConfigIdpPrivateKeyTooltip.FromJson(__jsonTooltip) : Tooltip;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKey.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKey.</returns>
        public static JumpCloudApiSdkV1.Models.IApplicationConfigIdpPrivateKey FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationConfigIdpPrivateKey(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigIdpPrivateKey" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigIdpPrivateKey" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class SystemputAgentBoundMessagesItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ISystemputAgentBoundMessagesItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ISystemputAgentBoundMessagesItem.</returns>
        public static JumpCloudApiSdkV1.Models.ISystemputAgentBoundMessagesItem FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new SystemputAgentBoundMessagesItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="SystemputAgentBoundMessagesItem" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemputAgentBoundMessagesItem(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_cmd = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("cmd"), out var __jsonCmd) ? (string)__jsonCmd : (string)Cmd;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemputAgentBoundMessagesItem" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemputAgentBoundMessagesItem" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._cmd)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._cmd.ToString()) : null, "cmd" ,container.Add );

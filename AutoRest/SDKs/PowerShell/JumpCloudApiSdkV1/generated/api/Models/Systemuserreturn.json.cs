namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Systemuserreturn
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.ISystemuserreturn.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.ISystemuserreturn.</returns>
        public static JumpCloudApiSdkV1.Models.ISystemuserreturn FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new Systemuserreturn(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="Systemuserreturn" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Systemuserreturn(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_addresses = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonArray>("addresses"), out var __jsonAddresses) ? If( __jsonAddresses as JumpCloudApiSdkV1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloudApiSdkV1.Models.ISystemuserreturnAddressesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloudApiSdkV1.Models.ISystemuserreturnAddressesItem) (JumpCloudApiSdkV1.Models.SystemuserreturnAddressesItem.FromJson(__u) )) ))() : null : Addresses;}
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonArray>("attributes"), out var __jsonAttributes) ? If( __jsonAttributes as JumpCloudApiSdkV1.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<JumpCloudApiSdkV1.Models.ISystemuserreturnAttributesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(JumpCloudApiSdkV1.Models.ISystemuserreturnAttributesItem) (JumpCloudApiSdkV1.Models.SystemuserreturnAttributesItem.FromJson(__p) )) ))() : null : Attributes;}
            {_badLoginAttempts = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonNumber>("badLoginAttempts"), out var __jsonBadLoginAttempts) ? (int?)__jsonBadLoginAttempts : BadLoginAttempts;}
            ...
            {_externalPasswordExpirationDate = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("external_password_expiration_date"), out var __jsonExternalPasswordExpirationDate) ? (string)__jsonExternalPasswordExpirationDate : (string)ExternalPasswordExpirationDate;}
            ...
            {_passwordExpirationDate = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonString>("password_expiration_date"), out var __jsonPasswordExpirationDate) ? (string)__jsonPasswordExpirationDate : (string)PasswordExpirationDate;}
            {_passwordExpired = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonBoolean>("password_expired"), out var __jsonPasswordExpired) ? (bool?)__jsonPasswordExpired : PasswordExpired;}
            ...
            {_phoneNumbers = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonArray>("phoneNumbers"), out var __jsonPhoneNumbers) ? If( __jsonPhoneNumbers as JumpCloudApiSdkV1.Runtime.Json.JsonArray, out var __l) ? new global::System.Func<JumpCloudApiSdkV1.Models.ISystemuserreturnPhoneNumbersItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__l, (__k)=>(JumpCloudApiSdkV1.Models.ISystemuserreturnPhoneNumbersItem) (JumpCloudApiSdkV1.Models.SystemuserreturnPhoneNumbersItem.FromJson(__k) )) ))() : null : PhoneNumbers;}
            ...
            {_relationships = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonArray>("relationships"), out var __jsonRelationships) ? If( __jsonRelationships as JumpCloudApiSdkV1.Runtime.Json.JsonArray, out var __g) ? new global::System.Func<JumpCloudApiSdkV1.Models.ISystemuserreturnRelationshipsItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__g, (__f)=>(JumpCloudApiSdkV1.Models.ISystemuserreturnRelationshipsItem) (JumpCloudApiSdkV1.Models.SystemuserreturnRelationshipsItem.FromJson(__f) )) ))() : null : Relationships;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Systemuserreturn" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Systemuserreturn" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._badLoginAttempts ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode)new JumpCloudApiSdkV1.Runtime.Json.JsonNumber((int)this._badLoginAttempts) : null, "badLoginAttempts" ,container.Add );
            ...
            AddIf( null != (((object)this._externalPasswordExpirationDate)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._externalPasswordExpirationDate.ToString()) : null, "external_password_expiration_date" ,container.Add );
            ...
            AddIf( null != (((object)this._passwordExpirationDate)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(this._passwordExpirationDate.ToString()) : null, "password_expiration_date" ,container.Add );
            AddIf( null != this._passwordExpired ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode)new JumpCloudApiSdkV1.Runtime.Json.JsonBoolean((bool)this._passwordExpired) : null, "password_expired" ,container.Add );
            ...
            if (null != this._tags)
            {
                ...
                {
                    AddIf(null != (((object)___y)?.ToString()) ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) new JumpCloudApiSdkV1.Runtime.Json.JsonString(___y.ToString()) : null ,___x.Add);
                }
                container.Add("tags",___x);
            }
            AddIf( null != this._totpEnabled ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode)new JumpCloudApiSdkV1.Runtime.Json.JsonBoolean((bool)this._totpEnabled) : null, "totp_enabled" ,container.Add );

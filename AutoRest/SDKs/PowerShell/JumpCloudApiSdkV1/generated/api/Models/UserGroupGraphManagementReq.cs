namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class UserGroupGraphManagementReq :
        JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReq,
        JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReqInternal
    {

        /// <summary>Backing field for <see cref="Attributes" /> property.</summary>
        private JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReqAttributes _attributes;

        /// <summary>The graph connection's attributes.</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Owned)]
        public JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReqAttributes Attributes { get => (this._attributes = this._attributes ?? new JumpCloudApiSdkV1.Models.UserGroupGraphManagementReqAttributes()); set => this._attributes = value; }
        ...
        JumpCloudApiSdkV1.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReqAttributes) })]
        JumpCloudApiSdkV1.Models.IUserGroupGraphManagementReqAttributes Attributes { get; set; }
        /// <summary>The ObjectID of graph object being added or removed as an association.</summary>
        [JumpCloudApiSdkV1.Runtime.Info(
        Required = true,
        ReadOnly = false,

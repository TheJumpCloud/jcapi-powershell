namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class UserGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IUserGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IUserGraphManagementReqAttributes.</returns>
        public static JumpCloudApiSdkV1.Models.IUserGraphManagementReqAttributes FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new UserGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReqAttributes" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReqAttributes" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV1.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV1.Runtime.Json.JsonObject container, JumpCloudApiSdkV1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sudo ? (JumpCloudApiSdkV1.Runtime.Json.JsonNode) this._sudo.ToJson(null,serializationMode) : null, "sudo" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReqAttributes(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_sudo = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("sudo"), out var __jsonSudo) ? JumpCloudApiSdkV1.Models.UserGraphManagementReqAttributesSudo.FromJson(__jsonSudo) : Sudo;}
            AfterFromJson(json);
        }
    }
}
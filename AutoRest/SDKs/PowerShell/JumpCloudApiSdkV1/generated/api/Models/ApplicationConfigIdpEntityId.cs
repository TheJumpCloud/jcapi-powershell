namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigIdpEntityId :
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityId,
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdInternal
    {

        /// <summary>Internal Acessors for Tooltip</summary>
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltip JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdInternal.Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloudApiSdkV1.Models.ApplicationConfigIdpEntityIdTooltip()); set { {_tooltip = value;} } }

        /// <summary>Internal Acessors for TooltipVariables</summary>
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipVariables JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdInternal.TooltipVariables { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).Variables; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).Variables = value; }
        ...
        private JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltip _tooltip;

        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Owned)]
        internal JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltip Tooltip { get => (this._tooltip = this._tooltip ?? new JumpCloudApiSdkV1.Models.ApplicationConfigIdpEntityIdTooltip()); set => this._tooltip = value; }
        ...
        public string TooltipTemplate { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).Template; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).Template = value; }
        ...
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string VariableIcon { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).VariableIcon; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).VariableIcon = value; }

        /// <summary>FIXME: Property VariableMessage is MISSING DESCRIPTION</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string VariableMessage { get => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).VariableMessage; set => ((JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipInternal)Tooltip).VariableMessage = value; }
...

    {
        ...
        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltip Tooltip { get; set; }

        string TooltipTemplate { get; set; }

        JumpCloudApiSdkV1.Models.IApplicationConfigIdpEntityIdTooltipVariables TooltipVariables { get; set; }

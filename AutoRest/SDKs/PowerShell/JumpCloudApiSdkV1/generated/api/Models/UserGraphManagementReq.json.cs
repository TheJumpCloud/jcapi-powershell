namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class UserGraphManagementReq
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IUserGraphManagementReq.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IUserGraphManagementReq.</returns>
        public static JumpCloudApiSdkV1.Models.IUserGraphManagementReq FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new UserGraphManagementReq(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReq" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReq" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReq" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReq(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloudApiSdkV1.Models.UserGraphManagementReqAttributes.FromJson(__jsonAttributes) : Attributes;}

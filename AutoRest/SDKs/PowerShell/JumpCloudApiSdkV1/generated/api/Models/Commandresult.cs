namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class Commandresult :
        ...
        JumpCloudApiSdkV1.Models.ICommandresultInternal
    {
        ...
        public int? DataExitCode { get => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).DataExitCode; set => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).DataExitCode = value; }

        /// <summary>The output of the command that was executed.</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string DataOutput { get => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).DataOutput; set => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).DataOutput = value; }
        ...
        JumpCloudApiSdkV1.Models.ICommandresultResponse JumpCloudApiSdkV1.Models.ICommandresultInternal.Response { get => (this._response = this._response ?? new JumpCloudApiSdkV1.Models.CommandresultResponse()); set { {_response = value;} } }

        /// <summary>Internal Acessors for ResponseData</summary>
        JumpCloudApiSdkV1.Models.ICommandresultResponseData JumpCloudApiSdkV1.Models.ICommandresultInternal.ResponseData { get => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Data; set => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Data = value; }
        ...
        private JumpCloudApiSdkV1.Models.ICommandresultResponse _response;

        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Owned)]
        internal JumpCloudApiSdkV1.Models.ICommandresultResponse Response { get => (this._response = this._response ?? new JumpCloudApiSdkV1.Models.CommandresultResponse()); set => this._response = value; }

        /// <summary>The stderr output from the command that ran.</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string ResponseError { get => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Error; set => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Error = value; }

        /// <summary>ID of the response.</summary>
        [JumpCloudApiSdkV1.Origin(JumpCloudApiSdkV1.PropertyOrigin.Inlined)]
        public string ResponseId { get => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Id; set => ((JumpCloudApiSdkV1.Models.ICommandresultResponseInternal)Response).Id = value; }
...

    {
        ...
        JumpCloudApiSdkV1.Models.ICommandresultResponse Response { get; set; }

        JumpCloudApiSdkV1.Models.ICommandresultResponseData ResponseData { get; set; }
        /// <summary>The stderr output from the command that ran.</summary>
        string ResponseError { get; set; }
        /// <summary>ID of the response.</summary>
        string ResponseId { get; set; }

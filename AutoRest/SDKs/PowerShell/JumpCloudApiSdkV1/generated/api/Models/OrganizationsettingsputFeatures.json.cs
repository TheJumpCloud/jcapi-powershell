namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class OrganizationsettingsputFeatures
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IOrganizationsettingsputFeatures.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IOrganizationsettingsputFeatures.</returns>
        public static JumpCloudApiSdkV1.Models.IOrganizationsettingsputFeatures FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new OrganizationsettingsputFeatures(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="OrganizationsettingsputFeatures" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OrganizationsettingsputFeatures(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_systemInsights = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("systemInsights"), out var __jsonSystemInsights) ? JumpCloudApiSdkV1.Models.OrganizationsettingsputFeaturesSystemInsights.FromJson(__jsonSystemInsights) : SystemInsights;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OrganizationsettingsputFeatures" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OrganizationsettingsputFeatures" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

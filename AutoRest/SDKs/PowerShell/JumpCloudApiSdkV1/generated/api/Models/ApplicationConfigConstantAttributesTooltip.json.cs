namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfigConstantAttributesTooltip
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfigConstantAttributesTooltip" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfigConstantAttributesTooltip(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_variables = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("variables"), out var __jsonVariables) ? JumpCloudApiSdkV1.Models.ApplicationConfigConstantAttributesTooltipVariables.FromJson(__jsonVariables) : Variables;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationConfigConstantAttributesTooltip.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloudApiSdkV1.Models.IApplicationConfigConstantAttributesTooltip.
        /// </returns>
        public static JumpCloudApiSdkV1.Models.IApplicationConfigConstantAttributesTooltip FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationConfigConstantAttributesTooltip(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfigConstantAttributesTooltip" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfigConstantAttributesTooltip" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"
        /// />.
        /// </returns>

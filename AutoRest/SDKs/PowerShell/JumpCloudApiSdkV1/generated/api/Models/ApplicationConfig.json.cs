namespace JumpCloudApiSdkV1.Models
{
    ...
    public partial class ApplicationConfig
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV1.Runtime.Json.JsonObject into a new instance of <see cref="ApplicationConfig" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApplicationConfig(JumpCloudApiSdkV1.Runtime.Json.JsonObject json)
        {
            ...
            {_acsUrl = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("acsUrl"), out var __jsonAcsUrl) ? JumpCloudApiSdkV1.Models.ApplicationConfigAcsUrl.FromJson(__jsonAcsUrl) : AcsUrl;}
            {_constantAttributes = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("constantAttributes"), out var __jsonConstantAttributes) ? JumpCloudApiSdkV1.Models.ApplicationConfigConstantAttributes.FromJson(__jsonConstantAttributes) : ConstantAttributes;}
            {_databaseAttributes = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("databaseAttributes"), out var __jsonDatabaseAttributes) ? JumpCloudApiSdkV1.Models.ApplicationConfigDatabaseAttributes.FromJson(__jsonDatabaseAttributes) : DatabaseAttributes;}
            {_idpCertificate = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("idpCertificate"), out var __jsonIdpCertificate) ? JumpCloudApiSdkV1.Models.ApplicationConfigIdpCertificate.FromJson(__jsonIdpCertificate) : IdpCertificate;}
            {_idpEntityId = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("idpEntityId"), out var __jsonIdpEntityId) ? JumpCloudApiSdkV1.Models.ApplicationConfigIdpEntityId.FromJson(__jsonIdpEntityId) : IdpEntityId;}
            {_idpPrivateKey = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("idpPrivateKey"), out var __jsonIdpPrivateKey) ? JumpCloudApiSdkV1.Models.ApplicationConfigIdpPrivateKey.FromJson(__jsonIdpPrivateKey) : IdpPrivateKey;}
            {_spEntityId = If( json?.PropertyT<JumpCloudApiSdkV1.Runtime.Json.JsonObject>("spEntityId"), out var __jsonSpEntityId) ? JumpCloudApiSdkV1.Models.ApplicationConfigSpEntityId.FromJson(__jsonSpEntityId) : SpEntityId;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV1.Models.IApplicationConfig.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV1.Models.IApplicationConfig.</returns>
        public static JumpCloudApiSdkV1.Models.IApplicationConfig FromJson(JumpCloudApiSdkV1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV1.Runtime.Json.JsonObject json ? new ApplicationConfig(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ApplicationConfig" /> into a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApplicationConfig" /> as a <see cref="JumpCloudApiSdkV1.Runtime.Json.JsonNode" />.
        /// </returns>

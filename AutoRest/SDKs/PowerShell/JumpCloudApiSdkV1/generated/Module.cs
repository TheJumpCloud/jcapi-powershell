namespace JumpCloudApiSdkV1
{
    ...
    public partial class Module
    {
        ...
        private JumpCloudApiSdkV1.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private JumpCloudApiSdkV1.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public JumpCloudApiSdkV1.JumpCloudApIs ClientAPI { get; set; }

        /// <summary>Backing field for <see cref="Instance" /> property.</summary>
        private static JumpCloudApiSdkV1.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static JumpCloudApiSdkV1.Module Instance => JumpCloudApiSdkV1.Module._instance?? (JumpCloudApiSdkV1.Module._instance = new JumpCloudApiSdkV1.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"JumpCloudApiSdkV1";
        ...
        partial void AfterCreatePipeline(System.Management.Automation.InvocationInfo invocationInfo, ref JumpCloudApiSdkV1.Runtime.HttpPipeline pipeline);

        /// <summary>FIXME: Method BeforeCreatePipeline is MISSING DESCRIPTION</summary>
        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(System.Management.Automation.InvocationInfo invocationInfo, ref JumpCloudApiSdkV1.Runtime.HttpPipeline pipeline);
        ...
        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <returns>An instance of JumpCloudApiSdkV1.Runtime.HttpPipeline for the remote call.</returns>
        public JumpCloudApiSdkV1.Runtime.HttpPipeline CreatePipeline(System.Management.Automation.InvocationInfo invocationInfo)
        {
            JumpCloudApiSdkV1.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new JumpCloudApiSdkV1.JumpCloudApIs();
            _handler.Proxy = _webProxy;
            _pipeline = new JumpCloudApiSdkV1.Runtime.HttpPipeline(new JumpCloudApiSdkV1.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new JumpCloudApiSdkV1.Runtime.HttpPipeline(new JumpCloudApiSdkV1.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }

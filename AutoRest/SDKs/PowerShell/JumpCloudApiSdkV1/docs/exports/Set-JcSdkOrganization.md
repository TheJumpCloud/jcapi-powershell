...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/set-jcsdkorganization
schema: 2.0.0
---
...
```yaml
Type: JumpCloudApiSdkV1.Models.IBodyParameterOrganizationPutRequestBody
...
```yaml
Type: JumpCloudApiSdkV1.Models.IOrganizationsettingsput

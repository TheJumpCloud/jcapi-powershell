...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/new-jcsdkradiusserver
schema: 2.0.0
---
...
```yaml
Type: JumpCloudApiSdkV1.Models.IRadiusserverpost

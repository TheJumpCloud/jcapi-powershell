...
This endpoint returns an individual system.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/systems/{SystemID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \n  ```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/get-jcsdksystem
.Inputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [Triggername <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/get-jcsdksystem
#>
function Get-JcSdkSystem {
[OutputType([JumpCloudApiSdkV1.Models.IJcSystem], [JumpCloudApiSdkV1.Models.ISystemslist])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloudApiSdkV1.private\Get-JcSdkSystem_Get';
            GetViaIdentity = 'JumpCloudApiSdkV1.private\Get-JcSdkSystem_GetViaIdentity';
            List = 'JumpCloudApiSdkV1.private\Get-JcSdkSystem_List';
        }

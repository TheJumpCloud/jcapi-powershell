...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/search-jcsdksearchorganization
#>
function Search-JcSdkSearchOrganization {
...
begin {
    try {
        ...
        $mapping = @{
            Search = 'JumpCloudApiSdkV1.private\Search-JcSdkSearchOrganization_Search';
            SearchExpanded = 'JumpCloudApiSdkV1.private\Search-JcSdkSearchOrganization_SearchExpanded';
        }

...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/new-jcsdksearchsystemuser
schema: 2.0.0
---

# New-JcSdkSearchSystemUser
...
```
New-JcSdkSearchSystemUser [-Fields <String>] [-Filter <String>] [-Limit <Int32>] [-Skip <Int32>]
...
### Create
```
New-JcSdkSearchSystemUser -Body <ISearch> [-Fields <String>] [-Filter <String>] [-Limit <Int32>]

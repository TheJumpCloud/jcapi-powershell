...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/invoke-jcsdksystemsearchuser
schema: 2.0.0
---

# Invoke-JcSdkSystemSearchUser
...
### SystemExpanded (Default)
```
Invoke-JcSdkSystemSearchUser [-Fields <String>] [-Filter <String>] [-Limit <Int32>] [-Skip <Int32>]
...
### System
```
Invoke-JcSdkSystemSearchUser -Body <ISearch> [-Fields <String>] [-Filter <String>] [-Limit <Int32>]

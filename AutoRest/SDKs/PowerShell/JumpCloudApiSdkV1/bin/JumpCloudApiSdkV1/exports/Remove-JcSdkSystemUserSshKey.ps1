...
This endpoint will delete a specific System User's SSH Key.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/remove-jcsdksystemusersshkey
.Inputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [Triggername <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/remove-jcsdksystemusersshkey
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloudApiSdkV1.private\Remove-JcSdkSystemUserSshKey_Delete';
            DeleteViaIdentity = 'JumpCloudApiSdkV1.private\Remove-JcSdkSystemUserSshKey_DeleteViaIdentity';
        }

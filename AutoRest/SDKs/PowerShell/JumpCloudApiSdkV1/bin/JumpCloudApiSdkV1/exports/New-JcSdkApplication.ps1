...
CONFIG <IApplicationConfig>: HELP MESSAGE MISSING
  ...
  [SpEntityIdVisible <Boolean?>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/new-jcsdkapplication
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV1.private\New-JcSdkApplication_Create';
            CreateExpanded = 'JumpCloudApiSdkV1.private\New-JcSdkApplication_CreateExpanded';
        }

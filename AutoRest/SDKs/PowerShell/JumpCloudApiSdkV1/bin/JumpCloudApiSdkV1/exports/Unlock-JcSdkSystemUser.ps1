...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [Triggername <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/unlock-jcsdksystemuser
#>
...
begin {
    try {
        ...
        $mapping = @{
            Unlock = 'JumpCloudApiSdkV1.private\Unlock-JcSdkSystemUser_Unlock';
            UnlockViaIdentity = 'JumpCloudApiSdkV1.private\Unlock-JcSdkSystemUser_UnlockViaIdentity';
        }

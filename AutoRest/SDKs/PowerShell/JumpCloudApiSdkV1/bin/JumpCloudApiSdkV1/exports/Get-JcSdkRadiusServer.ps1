...
This endpoint allows you to get a list of all RADIUS servers in your organization.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/radiusservers/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/get-jcsdkradiusserver
.Outputs
JumpCloudApiSdkV1.Models.IRadiusserverslist
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv1/get-jcsdkradiusserver
#>
function Get-JcSdkRadiusServer {
[OutputType([JumpCloudApiSdkV1.Models.IRadiusserverslist])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV1.private\Get-JcSdkRadiusServer_List';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgsuitetranslationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloudApiSdkV2.private\Get-JcSdkGSuiteTranslationRule_Get';
            GetViaIdentity = 'JumpCloudApiSdkV2.private\Get-JcSdkGSuiteTranslationRule_GetViaIdentity';
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGSuiteTranslationRule_List';
        }

...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphldapservergraphldapservertraverseusergroup
#>
function Get-JcSdkGraphLdapServerGraphLdapServerTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphLdapServerGraphLdapServerTraverseUserGroup_List';
        }

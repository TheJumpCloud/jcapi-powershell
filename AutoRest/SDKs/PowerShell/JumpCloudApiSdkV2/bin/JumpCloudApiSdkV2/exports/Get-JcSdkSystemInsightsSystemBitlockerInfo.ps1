...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksysteminsightssystembitlockerinfo
#>
function Get-JcSdkSystemInsightsSystemBitlockerInfo {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkSystemInsightsSystemBitlockerInfo_List';
        }

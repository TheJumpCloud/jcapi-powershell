...
These rules specify how JumpCloud attributes translate to [Microsoft Graph](https://developer.microsoft.com/en-us/graph) attributes.\n\n###### Sample Request\n\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/office365s/{office365_id}/translationrules/{id} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkoffice365translationrule
.Inputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkoffice365translationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloudApiSdkV2.private\Get-JcSdkOffice365TranslationRule_Get';
            GetViaIdentity = 'JumpCloudApiSdkV2.private\Get-JcSdkOffice365TranslationRule_GetViaIdentity';
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkOffice365TranslationRule_List';
        }

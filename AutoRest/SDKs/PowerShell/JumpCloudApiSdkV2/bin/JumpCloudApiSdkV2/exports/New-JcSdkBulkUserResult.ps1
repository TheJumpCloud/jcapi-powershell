...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkbulkuserresult
#>
function New-JcSdkBulkUserResult {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkBulkUserResult_Create';
            CreateViaIdentity = 'JumpCloudApiSdkV2.private\New-JcSdkBulkUserResult_CreateViaIdentity';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/set-jcsdkgraphpolicyassociation
#>
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'JumpCloudApiSdkV2.private\Set-JcSdkGraphPolicyAssociation_Set';
            SetExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkGraphPolicyAssociation_SetExpanded';
            SetViaIdentity = 'JumpCloudApiSdkV2.private\Set-JcSdkGraphPolicyAssociation_SetViaIdentity';
            SetViaIdentityExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkGraphPolicyAssociation_SetViaIdentityExpanded';
        }

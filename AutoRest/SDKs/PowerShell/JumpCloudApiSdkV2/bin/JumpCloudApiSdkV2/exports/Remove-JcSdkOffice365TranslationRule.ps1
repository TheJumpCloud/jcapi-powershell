...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/remove-jcsdkoffice365translationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloudApiSdkV2.private\Remove-JcSdkOffice365TranslationRule_Delete';
            DeleteViaIdentity = 'JumpCloudApiSdkV2.private\Remove-JcSdkOffice365TranslationRule_DeleteViaIdentity';
        }

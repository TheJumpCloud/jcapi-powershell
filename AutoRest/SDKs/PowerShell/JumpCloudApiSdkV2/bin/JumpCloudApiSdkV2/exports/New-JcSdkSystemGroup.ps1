...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdksystemgroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkSystemGroup_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkSystemGroup_CreateExpanded';
        }

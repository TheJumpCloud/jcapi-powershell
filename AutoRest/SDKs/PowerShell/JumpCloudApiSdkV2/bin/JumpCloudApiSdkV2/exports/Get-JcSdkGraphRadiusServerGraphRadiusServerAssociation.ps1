...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphradiusservergraphradiusserverassociation
#>
function Get-JcSdkGraphRadiusServerGraphRadiusServerAssociation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphRadiusServerGraphRadiusServerAssociation_List';
        }

...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphsystemgroupassociationgraphsystemgroupassociation
#>
function Get-JcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_List';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkldapserversambadomain
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkLdapServerSambaDomain_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkLdapServerSambaDomain_CreateExpanded';
            CreateViaIdentity = 'JumpCloudApiSdkV2.private\New-JcSdkLdapServerSambaDomain_CreateViaIdentity';
            CreateViaIdentityExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkLdapServerSambaDomain_CreateViaIdentityExpanded';
        }

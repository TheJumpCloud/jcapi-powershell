...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/remove-jcsdksystemgroup
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloudApiSdkV2.private\Remove-JcSdkSystemGroup_Delete';
            DeleteViaIdentity = 'JumpCloudApiSdkV2.private\Remove-JcSdkSystemGroup_DeleteViaIdentity';
        }

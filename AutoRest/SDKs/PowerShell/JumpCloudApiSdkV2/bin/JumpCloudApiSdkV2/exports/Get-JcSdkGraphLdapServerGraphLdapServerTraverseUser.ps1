...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphldapservergraphldapservertraverseuser
#>
function Get-JcSdkGraphLdapServerGraphLdapServerTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphLdapServerGraphLdapServerTraverseUser_List';
        }

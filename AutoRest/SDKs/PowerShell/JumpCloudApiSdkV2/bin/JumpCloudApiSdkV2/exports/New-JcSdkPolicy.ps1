...
VALUES <IPolicyValue[]>: HELP MESSAGE MISSING
  ...
  [Value <String>]: The value for the configuration field for this Policy instance.
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkpolicy
#>
function New-JcSdkPolicy {
[OutputType([JumpCloudApiSdkV2.Models.IPolicyWithDetails])]
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkPolicy_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkPolicy_CreateExpanded';
        }

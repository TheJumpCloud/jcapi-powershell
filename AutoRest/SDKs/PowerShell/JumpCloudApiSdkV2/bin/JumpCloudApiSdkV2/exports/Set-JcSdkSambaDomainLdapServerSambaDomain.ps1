...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/set-jcsdksambadomainldapserversambadomain
#>
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloudApiSdkV2.private\Set-JcSdkSambaDomainLdapServerSambaDomain_Put';
            PutExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkSambaDomainLdapServerSambaDomain_PutExpanded';
            PutViaIdentity = 'JumpCloudApiSdkV2.private\Set-JcSdkSambaDomainLdapServerSambaDomain_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkSambaDomainLdapServerSambaDomain_PutViaIdentityExpanded';
        }

...
BODY <IWorkdayInput>: Workday Input
  ...
  [ReportUrl <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkworkdayimportworkday
#>
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkday_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkday_CreateExpanded';
        }

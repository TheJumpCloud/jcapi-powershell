...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphradiusservergraphradiusservertraverseuser
#>
function Get-JcSdkGraphRadiusServerGraphRadiusServerTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphRadiusServerGraphRadiusServerTraverseUser_List';
        }

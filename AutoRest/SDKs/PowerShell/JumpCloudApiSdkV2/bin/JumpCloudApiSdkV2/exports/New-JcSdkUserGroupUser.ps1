...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkusergroupuser
#>
function New-JcSdkUserGroupUser {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkUserGroupUser_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkUserGroupUser_CreateExpanded';
        }

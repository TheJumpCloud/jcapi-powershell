...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphsystemgroupassociationgraphsystemgrouptraverseuser
#>
function Get-JcSdkGraphSystemGroupAssociationGraphSystemGroupTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphSystemGroupAssociationGraphSystemGroupTraverseUser_List';
        }

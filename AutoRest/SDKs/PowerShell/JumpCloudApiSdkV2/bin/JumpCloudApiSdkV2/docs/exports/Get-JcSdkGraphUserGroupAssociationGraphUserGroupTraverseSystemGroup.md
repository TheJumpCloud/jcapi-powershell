...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphusergroupassociationgraphusergrouptraversesystemgroup
schema: 2.0.0
---
...
```
Get-JcSdkGraphUserGroupAssociationGraphUserGroupTraverseSystemGroup -GroupId <String> [-Filter <String[]>]

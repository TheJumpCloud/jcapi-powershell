...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphsystemgroupassociationgraphsystemgrouptraverseusergroup
schema: 2.0.0
---
...
```
Get-JcSdkGraphSystemGroupAssociationGraphSystemGroupTraverseUserGroup -GroupId <String> [-Filter <String[]>]

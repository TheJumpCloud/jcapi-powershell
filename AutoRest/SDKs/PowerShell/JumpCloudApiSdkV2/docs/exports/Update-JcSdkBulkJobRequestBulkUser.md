...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/update-jcsdkbulkjobrequestbulkuser
schema: 2.0.0
---
...
```yaml
Type: JumpCloudApiSdkV2.Models.IBulkUserUpdate[]
Parameter Sets: (All)
Aliases:

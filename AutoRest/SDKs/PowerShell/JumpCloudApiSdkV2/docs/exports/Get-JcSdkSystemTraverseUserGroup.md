...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksystemtraverseusergroup
schema: 2.0.0
---
...
```
Get-JcSdkSystemTraverseUserGroup -SystemId <String> [-Filter <String[]>] [-Limit <Int32>] [-Skip <Int32>]

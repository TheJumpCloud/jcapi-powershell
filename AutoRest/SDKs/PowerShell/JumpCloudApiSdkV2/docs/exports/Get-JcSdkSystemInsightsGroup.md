...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksysteminsightsgroup
schema: 2.0.0
---
...
```
Get-JcSdkSystemInsightsGroup [-Filter <String[]>] [-Limit <Int32>] [-Skip <Int32>] [<CommonParameters>]
```

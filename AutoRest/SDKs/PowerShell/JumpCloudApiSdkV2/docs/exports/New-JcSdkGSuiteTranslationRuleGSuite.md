...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkgsuitetranslationrulegsuite
schema: 2.0.0
---

# New-JcSdkGSuiteTranslationRuleGSuite
...
```
New-JcSdkGSuiteTranslationRuleGSuite -GsuiteId <String> [-BuiltIn <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Create
```
New-JcSdkGSuiteTranslationRuleGSuite -GsuiteId <String> -Body <IGSuiteTranslationRuleRequest> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-JcSdkGSuiteTranslationRuleGSuite -InputObject <IJumpCloudApIsIdentity>
 -Body <IGSuiteTranslationRuleRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-JcSdkGSuiteTranslationRuleGSuite -InputObject <IJumpCloudApIsIdentity> [-BuiltIn <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

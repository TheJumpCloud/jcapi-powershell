...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkoffice365traverseuser
schema: 2.0.0
---
...
```
Get-JcSdkOffice365TraverseUser -Office365Id <String> [-Filter <String[]>] [-Limit <Int32>] [-Skip <Int32>]
 [<CommonParameters>]
```

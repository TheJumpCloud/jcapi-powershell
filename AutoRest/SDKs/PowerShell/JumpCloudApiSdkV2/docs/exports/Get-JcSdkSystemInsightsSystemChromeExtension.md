...
online version: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksysteminsightssystemchromeextension
schema: 2.0.0
---
...
```
Get-JcSdkSystemInsightsSystemChromeExtension -SystemId <String> [-Filter <String[]>] [-Limit <Int32>]

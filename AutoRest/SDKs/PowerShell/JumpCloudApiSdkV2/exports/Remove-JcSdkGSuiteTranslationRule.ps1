...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/remove-jcsdkgsuitetranslationrule
#>
...
begin {
    try {
        ...
        $mapping = @{
            Delete = 'JumpCloudApiSdkV2.private\Remove-JcSdkGSuiteTranslationRule_Delete';
            DeleteViaIdentity = 'JumpCloudApiSdkV2.private\Remove-JcSdkGSuiteTranslationRule_DeleteViaIdentity';
        }

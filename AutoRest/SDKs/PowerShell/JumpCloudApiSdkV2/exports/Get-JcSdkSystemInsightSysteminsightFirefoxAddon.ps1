...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksysteminsightsysteminsightfirefoxaddon
#>
function Get-JcSdkSystemInsightSysteminsightFirefoxAddon {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkSystemInsightSysteminsightFirefoxAddon_List';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/import-jcsdkworkdayimportworkdayresult
#>
...
begin {
    try {
        ...
        $mapping = @{
            Import = 'JumpCloudApiSdkV2.private\Import-JcSdkWorkdayImportWorkdayResult_Import';
            ImportViaIdentity = 'JumpCloudApiSdkV2.private\Import-JcSdkWorkdayImportWorkdayResult_ImportViaIdentity';
        }

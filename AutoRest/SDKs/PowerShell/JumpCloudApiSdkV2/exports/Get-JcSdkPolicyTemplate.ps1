...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkpolicytemplate
#>
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'JumpCloudApiSdkV2.private\Get-JcSdkPolicyTemplate_Get';
            GetViaIdentity = 'JumpCloudApiSdkV2.private\Get-JcSdkPolicyTemplate_GetViaIdentity';
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkPolicyTemplate_List';
        }

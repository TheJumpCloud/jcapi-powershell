...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/set-jcsdkgsuiteassociation
#>
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'JumpCloudApiSdkV2.private\Set-JcSdkGSuiteAssociation_Set';
            SetExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkGSuiteAssociation_SetExpanded';
            SetViaIdentity = 'JumpCloudApiSdkV2.private\Set-JcSdkGSuiteAssociation_SetViaIdentity';
            SetViaIdentityExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkGSuiteAssociation_SetViaIdentityExpanded';
        }

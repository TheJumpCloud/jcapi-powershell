...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphradiusservergraphradiusservertraverseusergroup
#>
function Get-JcSdkGraphRadiusServerGraphRadiusServerTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphRadiusServerGraphRadiusServerTraverseUserGroup_List';
        }

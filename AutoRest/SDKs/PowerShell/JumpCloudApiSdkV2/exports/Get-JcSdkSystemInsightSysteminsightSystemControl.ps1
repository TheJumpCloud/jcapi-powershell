...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdksysteminsightsysteminsightsystemcontrol
#>
function Get-JcSdkSystemInsightSysteminsightSystemControl {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkSystemInsightSysteminsightSystemControl_List';
            List1 = 'JumpCloudApiSdkV2.private\Get-JcSdkSystemInsightSysteminsightSystemControl_List1';
        }

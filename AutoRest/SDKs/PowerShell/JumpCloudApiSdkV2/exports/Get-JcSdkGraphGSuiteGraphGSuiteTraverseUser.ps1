...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphgsuitegraphgsuitetraverseuser
#>
function Get-JcSdkGraphGSuiteGraphGSuiteTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphGSuiteGraphGSuiteTraverseUser_List';
        }

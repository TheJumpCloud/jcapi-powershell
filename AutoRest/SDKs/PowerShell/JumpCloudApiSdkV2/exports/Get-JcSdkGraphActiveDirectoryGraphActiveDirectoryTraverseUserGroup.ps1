...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphactivedirectorygraphactivedirectorytraverseusergroup
#>
function Get-JcSdkGraphActiveDirectoryGraphActiveDirectoryTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphActiveDirectoryGraphActiveDirectoryTraverseUserGroup_List';
        }

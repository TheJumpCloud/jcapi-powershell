...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkworkdayimportworkdayauthorization
#>
function New-JcSdkWorkdayImportWorkdayAuthorization {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkdayAuthorization_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkdayAuthorization_CreateExpanded';
            CreateViaIdentity = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentity';
            CreateViaIdentityExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentityExpanded';
        }

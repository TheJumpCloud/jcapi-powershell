...
These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  {Translation Rule Parameters}\n}'\n\n```
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkgsuitetranslationrulegsuite
.Inputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/new-jcsdkgsuitetranslationrulegsuite
#>
function New-JcSdkGSuiteTranslationRuleGSuite {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloudApiSdkV2.private\New-JcSdkGSuiteTranslationRuleGSuite_Create';
            CreateExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkGSuiteTranslationRuleGSuite_CreateExpanded';
            CreateViaIdentity = 'JumpCloudApiSdkV2.private\New-JcSdkGSuiteTranslationRuleGSuite_CreateViaIdentity';
            CreateViaIdentityExpanded = 'JumpCloudApiSdkV2.private\New-JcSdkGSuiteTranslationRuleGSuite_CreateViaIdentityExpanded';
        }

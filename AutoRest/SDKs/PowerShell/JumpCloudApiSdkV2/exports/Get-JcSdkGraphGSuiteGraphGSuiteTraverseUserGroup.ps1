...
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/get-jcsdkgraphgsuitegraphgsuitetraverseusergroup
#>
function Get-JcSdkGraphGSuiteGraphGSuiteTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloudApiSdkV2.private\Get-JcSdkGraphGSuiteGraphGSuiteTraverseUserGroup_List';
        }

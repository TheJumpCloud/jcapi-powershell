...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://docs.microsoft.com/en-us/powershell/module/jumpcloudapisdkv2/set-jcsdkapplicationassociation
#>
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'JumpCloudApiSdkV2.private\Set-JcSdkApplicationAssociation_Set';
            SetExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkApplicationAssociation_SetExpanded';
            SetViaIdentity = 'JumpCloudApiSdkV2.private\Set-JcSdkApplicationAssociation_SetViaIdentity';
            SetViaIdentityExpanded = 'JumpCloudApiSdkV2.private\Set-JcSdkApplicationAssociation_SetViaIdentityExpanded';
        }

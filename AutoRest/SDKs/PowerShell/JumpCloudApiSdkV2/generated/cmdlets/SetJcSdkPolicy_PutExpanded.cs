namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1policies~1{id}'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: Policy
    /// variant: PutExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkPolicy_PutExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IPolicy))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to update a policy. Given the amount of configurable parameters required to update a Policy, we suggest you use the JumpCloud Admin Console to create new policies.\n\n\n##### Sample Request\n```\ncurl -X PUT https://console.jumpcloud.com/api/v2/policies/59fced45c9118022172547ff \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY' \\\n  -d '{\n    {Policy_Parameters}\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkPolicy_PutExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IPolicyRequest _body= new JumpCloudApiSdkV2.Models.PolicyRequest();

        /// <summary>An instance of a policy template.</summary>
        private JumpCloudApiSdkV2.Models.IPolicyRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>ObjectID of the Policy object.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Policy object.")]
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The description for this specific Policy.")]
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "ObjectId uniquely identifying a Policy instance; only allowed on POST requests.")]
        [JumpCloudApiSdkV2.Category(JumpCloudApiSdkV2.ParameterCategory.Body)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public JumpCloudApiSdkV2.Models.IPolicyValue[] Values { get => Body.Values ?? null /* arrayOf */; set => Body.Values = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IPolicy" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPolicy> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkPolicy_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkPolicy_PutExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPolicy> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IPolicy

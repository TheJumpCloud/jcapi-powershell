namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserAssociation_Set=>POST:"/users/{user_id}/associations"
    /// [METADATA]
    ...
    /// verb: Set
    /// subjectPrefix:
    /// subject: UserAssociation
    /// variant: SetViaIdentityExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkUserAssociation_SetViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkUserAssociation_SetViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UserAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UserAssociationSet(InputObject.UserId ?? null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkUserAssociation_SetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkUserAssociation_SetViaIdentityExpanded()
        {

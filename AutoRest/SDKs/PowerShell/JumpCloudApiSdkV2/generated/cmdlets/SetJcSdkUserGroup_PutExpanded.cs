namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserGroup_Put=>PUT:"/usergroups/{id}"
    /// [METADATA]
    /// path: '/usergroups/{id}'
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1usergroups~1{id}'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: UserGroup
    /// variant: PutExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkUserGroup_PutExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IUserGroup))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to do a full update of the User Group.\n\n#### Sample Request\n```\ncurl -X PUT https://console.jumpcloud.com/api/v2/usergroups/{Group_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY' \\\n  -d '{\n \""name\"": \""group_update\""\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkUserGroup_PutExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        public JumpCloudApiSdkV2.Models.IUserGroupAttributesPosixGroupsItem[] AttributePosixGroups { get => Body.AttributePosixGroups ?? null /* arrayOf */; set => Body.AttributePosixGroups = value; }
        ...
        public global::System.Management.Automation.SwitchParameter AttributeSambaEnabled { get => Body.AttributeSambaEnabled ?? default(global::System.Management.Automation.SwitchParameter); set => Body.AttributeSambaEnabled = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloudApiSdkV2.Models.IUserGroupPut _body= new JumpCloudApiSdkV2.Models.UserGroupPut();

        /// <summary>UserGroupPut</summary>
        private JumpCloudApiSdkV2.Models.IUserGroupPut Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the User Group.")]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Display name of a User Group.")]
        [JumpCloudApiSdkV2.Category(JumpCloudApiSdkV2.ParameterCategory.Body)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IUserGroup" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IUserGroup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UserGroupPut' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UserGroupPut(Id, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkUserGroup_PutExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkUserGroup_PutExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IUserGroup> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IUserGroup

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Office365Association_Set=>POST:"/office365s/{office365_id}/associations"
    /// [METADATA]
    ...
    /// verb: Set
    /// subjectPrefix:
    /// subject: Office365Association
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkOffice365Association_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkOffice365Association_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'Office365AssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.Office365AssociationSet(Office365Id, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkOffice365Association_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkOffice365Association_Set()
        {

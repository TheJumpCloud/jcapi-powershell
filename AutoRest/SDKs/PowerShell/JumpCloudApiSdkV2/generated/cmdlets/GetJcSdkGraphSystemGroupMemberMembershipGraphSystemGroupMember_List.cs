namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphSystemGroupMembers=>GET:"/systemgroups/{group_id}/members"
    /// [METADATA]
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphConnection))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns the system members of a System Group.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/systemgroups/{Group_ID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_List" /> cmdlet
        /// class.
        /// </summary>
        public GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListGraphSystemGroupMembers(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);

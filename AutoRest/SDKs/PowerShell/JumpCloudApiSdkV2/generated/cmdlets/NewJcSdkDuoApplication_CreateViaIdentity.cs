namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1duo~1accounts~1{account_id}~1applications'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkDuoApplication_CreateViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IDuoApplication), typeof(string))]
    [JumpCloudApiSdkV2.Description(@"Creates a Duo application for your organization and the specified account.\n\n#### Sample Request\n```\n  curl -X POST https://console.jumpcloud.com/api/v2/duo/accounts/{ACCOUNT_ID}/applications \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""name\"": \""Application Name\"",\n    \""apiHost\"": \""api-1234.duosecurity.com\"",\n    \""integrationKey\"": \""1234\"",\n    \""secretKey\"": \""5678\""\n  }'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkDuoApplication_CreateViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IDuoApplicationReq _body;

        /// <summary>DuoApplicationReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "DuoApplicationReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"DuoApplicationReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IDuoApplicationReq) })]
        public JumpCloudApiSdkV2.Models.IDuoApplicationReq Body { get => this._body; set => this._body = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IDuoApplication" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IDuoApplication> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkDuoApplication_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewJcSdkDuoApplication_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.AccountId)
                    {
                        ThrowTerminatingError( new System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.AccountId"),string.Empty, System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.DuoApplicationCreate(InputObject.AccountId ?? null, Body, onCreated, onBadRequest, onUnauthorized, onForbidden, onNotFound, onConflict, onInternalServerError, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IDuoApplication> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IDuoApplication

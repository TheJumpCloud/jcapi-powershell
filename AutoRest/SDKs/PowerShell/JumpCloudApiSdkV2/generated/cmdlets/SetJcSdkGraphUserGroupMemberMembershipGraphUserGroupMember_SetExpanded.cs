namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphUserGroupMembers=>POST:"/usergroups/{group_id}/members"
    /// [METADATA]
    ...
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the user members of a User Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""{User_ID}\""\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGroupMembersReq _body= new JumpCloudApiSdkV2.Models.UserGroupMembersReq();

        /// <summary>UserGroupMembersReq</summary>
        private JumpCloudApiSdkV2.Models.IUserGroupMembersReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphUserGroupMembers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphUserGroupMembers(GroupId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_SetExpanded" />
        /// cmdlet class.
        /// </summary>
        public SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_SetExpanded()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/membership \\\n -H 'Accept: application/json' \\\n -H 'Content-Type:
    /// application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphUserGroupMembership=>GET:"/usergroups/{group_id}/membership"
    /// [METADATA]
    /// path: '/usergroups/{group_id}/membership'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1usergroups~1{group_id}~1membership'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphUserGroupMemberMembershipGraphUserGroupMembership
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphUserGroupMemberMembershipGraphUserGroupMembership_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphObjectWithPaths))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all users members that are a member of this User Group.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/membership \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMembership_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMembership_List" /> cmdlet
        /// class.
        /// </summary>
        public GetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMembership_List()
        {

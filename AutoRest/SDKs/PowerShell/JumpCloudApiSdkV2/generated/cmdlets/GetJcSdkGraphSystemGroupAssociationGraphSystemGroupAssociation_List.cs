namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphSystemGroupAssociation=>GET:"/systemgroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphSystemGroupAssociationGraphSystemGroupAssociation
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphConnection))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns the _direct_ associations of a System Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example System Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/systemgroups/{GroupID}/associations?targets=user \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the System Group.")]
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_List" /> cmdlet
        /// class.
        /// </summary>
        public GetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListGraphSystemGroupAssociation(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), Targets, onOk, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] LdapServerTraverseUser_List=>GET:"/ldapservers/{ldapserver_id}/users"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1ldapservers~1{ldapserver_id}~1users'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: LdapServerTraverseUser
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkLdapServerTraverseUser_List")]
    ...
    public partial class GetJcSdkLdapServerTraverseUser_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkLdapServerTraverseUser_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkLdapServerTraverseUser_List()
        {

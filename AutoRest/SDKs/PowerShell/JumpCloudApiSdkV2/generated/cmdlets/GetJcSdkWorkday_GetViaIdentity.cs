namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// -X GET https://console.jumpcloud.com/api/v2/workdays/ \\\n -H 'Accept: application/json' \\\n -H 'Content-Type: application/json'
    /// \\\n -H 'x-api-key: {API_KEY}'\n ```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Workday_Get=>GET:"/workdays/{id}"
    /// [METADATA]
    /// path: '/workdays/{id}'
    /// apiVersions:
    /// - '2.0'
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkWorkday_GetViaIdentity")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IWorkdayOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint will return  all the available information about an instance of Workday.\n\n#### Sample Request\n\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/workdays/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkWorkday_GetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkWorkday_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetJcSdkWorkday_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayGet(InputObject.Id ?? null, onOk, this, Pipeline);

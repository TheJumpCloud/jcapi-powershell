namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// <summary>
    /// This endpoint allows you to create a new workday instance.\n\nYou must supply a username and password for `Basic Authentication`
    /// that is the same as your WorkDay Integrator System User. Failure to provide these credentials will result in the request
    /// being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be in the future.\n\nCurrently,
    /// only one instance is allowed and it must be `Workday Import`.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-Workday=>POST:"/workdays"
    /// [METADATA]
    /// path: /workdays
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1workdays'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    /// subject: WorkdayImportWorkday
    /// variant: CreateExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkWorkdayImportWorkday_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IWorkdayOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to create a new workday instance.\n\nYou must supply a username and password for `Basic Authentication` that is the same as your WorkDay Integrator System User.  Failure to provide these credentials  will result in the request being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be in the future.\n\nCurrently, only one instance is allowed and it must be `Workday Import`.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  \""name\"": \""Workday2\"",\n  \""reportUrl\"":\""https://workday.com/ccx/service/customreport2/gms/user/reportname?format=json\"",\n  \""auth\"": {\n    \""basic\"": {\n      \""username\"": \""someDeveloper\"",\n      \""password\"": \""notTheRealPassword\""\n    }\n  }\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkWorkdayImportWorkday_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        public string BasicPassword { get => Body.BasicPassword ?? null; set => Body.BasicPassword = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string BasicUsername { get => Body.BasicUsername ?? null; set => Body.BasicUsername = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloudApiSdkV2.Models.IWorkdayInput _body= new JumpCloudApiSdkV2.Models.WorkdayInput();

        /// <summary>Workday Input</summary>
        private JumpCloudApiSdkV2.Models.IWorkdayInput Body { get => this._body; set => this._body = value; }
        ...
        SerializedName = @"code",
        PossibleTypes = new [] { typeof(string) })]
        public string OauthCode { get => Body.OauthCode ?? null; set => Body.OauthCode = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ReportUrl { get => Body.ReportUrl ?? null; set => Body.ReportUrl = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IWorkdayOutput" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IWorkdayOutput> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkWorkdayImportWorkday_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkWorkdayImportWorkday_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateWorkday' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateWorkday(Body, onOk, onCreated, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IWorkdayOutput> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IWorkdayOutput

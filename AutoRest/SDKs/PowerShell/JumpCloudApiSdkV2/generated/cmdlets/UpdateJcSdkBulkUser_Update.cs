namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] BulkUsers_Update=>PATCH:"/bulk/users"
    /// [METADATA]
    /// path: /bulk/users
    /// apiVersions:
    /// - '2.0'
    ...
    /// variant: Update
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkBulkUser_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateJcSdkBulkUser_Update : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'BulkUsersUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.BulkUsersUpdate(Body, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkBulkUser_Update" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkBulkUser_Update()
        {

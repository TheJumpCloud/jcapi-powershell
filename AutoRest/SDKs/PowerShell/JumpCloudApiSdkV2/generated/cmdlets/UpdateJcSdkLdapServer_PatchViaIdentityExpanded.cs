        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchLdapServer(InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("XApiKey") ? XApiKey : null, this.InvocationInformation.BoundParameters.ContainsKey("XOrgId") ? XOrgId : null, Body, onOk, onBadRequest, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1ldapservers~1{id}'
    /// [DETAILS]
    /// verb: Update
    /// subjectPrefix:
    /// subject: LdapServer
    /// variant: PatchViaIdentityExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkLdapServer_PatchViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema), typeof(string))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows updating some attributes of an LDAP server.\n\nSample Request\n\n```\ncurl -X PATCH https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""userLockoutAction\"": \""remove\"",\n    \""userPasswordExpirationAction\"": \""disable\""\n  }'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class UpdateJcSdkLdapServer_PatchViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "LDAP Server Action")]
        [JumpCloudApiSdkV2.Category(JumpCloudApiSdkV2.ParameterCategory.Body)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="XApiKey" /> property.</summary>
        ...
        public string XApiKey { get => this._xApiKey; set => this._xApiKey = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses400ContentApplicationJsonSchema"
        ...
        partial void overrideOnBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses400ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LdapServerPatch(InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("XApiKey") ? XApiKey : null, this.InvocationInformation.BoundParameters.ContainsKey("XOrgId") ? XOrgId : null, Body, onOk, onBadRequest, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  XApiKey=this.InvocationInformation.BoundParameters.ContainsKey("XApiKey") ? XApiKey : null,XOrgId=this.InvocationInformation.BoundParameters.ContainsKey("XOrgId") ? XOrgId : null,body=Body}));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkLdapServer_PatchViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkLdapServer_PatchViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onBadRequest(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses400ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses400ContentApplicationJsonSchema
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IPathsLdapserversIdPatchResponses200ContentApplicationJsonSchema

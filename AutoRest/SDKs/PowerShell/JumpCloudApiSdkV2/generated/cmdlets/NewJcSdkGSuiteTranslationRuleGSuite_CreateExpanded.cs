namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-TranslationRuleGSuite=>POST:"/gsuites/{gsuite_id}/translationrules"
    /// [METADATA]
    ...
    /// verb: New
    /// subjectPrefix:
    /// subject: GSuiteTranslationRuleGSuite
    /// variant: CreateExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkGSuiteTranslationRuleGSuite_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGSuiteTranslationRule))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to create a translation rule for a specific G Suite instance. These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  {Translation Rule Parameters}\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkGSuiteTranslationRuleGSuite_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IGSuiteTranslationRuleRequest _body= new JumpCloudApiSdkV2.Models.GSuiteTranslationRuleRequest();

        /// <summary>G Suite Translation Rule Request</summary>
        private JumpCloudApiSdkV2.Models.IGSuiteTranslationRuleRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IGSuiteTranslationRule" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IGSuiteTranslationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkGSuiteTranslationRuleGSuite_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkGSuiteTranslationRuleGSuite_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateTranslationRuleGSuite' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateTranslationRuleGSuite(GsuiteId, Body, onCreated, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  GsuiteId=GsuiteId,body=Body}));
                }
                finally
                {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IGSuiteTranslationRule> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IGSuiteTranslationRule

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// variant: Put
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkPolicy_Put", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkPolicy_Put : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IPolicyRequest _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IPolicyRequest) })]
        public JumpCloudApiSdkV2.Models.IPolicyRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkPolicy_Put" /> cmdlet class.
        /// </summary>
        public SetJcSdkPolicy_Put()
        {

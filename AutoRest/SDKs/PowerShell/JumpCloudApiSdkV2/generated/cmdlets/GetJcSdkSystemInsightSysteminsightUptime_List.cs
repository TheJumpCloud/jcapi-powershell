namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List-SysteminsightsUptime=>GET:"/systeminsights/uptime"
    /// [METADATA]
    /// path: /systeminsights/uptime
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1systeminsights~1uptime'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemInsightSysteminsightUptime
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystemInsightSysteminsightUptime_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ISystemInsightsUptime))]
    [JumpCloudApiSdkV2.Description(@"Valid filter fields are `system_id` and `days`.")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkSystemInsightSysteminsightUptime_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.ISystemInsightsUptime[]" /> from the remote
        /// call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.ISystemInsightsUptime[]> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemInsightSysteminsightUptime_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemInsightSysteminsightUptime_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListSysteminsightsUptime(this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null /* arrayOf */, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.ISystemInsightsUptime[]> response)
        {
            using( NoSynchronizationContext )
            {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserTraverseSystem_List=>GET:"/users/{user_id}/systems"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1users~1{user_id}~1systems'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: UserTraverseSystem
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkUserTraverseSystem_List")]
    ...
    public partial class GetJcSdkUserTraverseSystem_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkUserTraverseSystem_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkUserTraverseSystem_List()
        {

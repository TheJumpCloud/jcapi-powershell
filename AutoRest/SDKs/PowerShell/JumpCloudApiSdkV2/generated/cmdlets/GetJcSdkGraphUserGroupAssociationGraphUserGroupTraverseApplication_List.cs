namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// from this User Group to the corresponding Application; this array represents all grouping and/or associations that would
    /// have to be removed to deprovision the Application from this User Group.\n\nSee `/members` and `/associations` endpoints
    /// to manage those collections.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/applications
    /// \\\n -H 'Accept: application/json' \\\n -H 'Content-Type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphUserGroupTraverseApplication=>GET:"/usergroups/{group_id}/applications"
    /// [METADATA]
    /// path: '/usergroups/{group_id}/applications'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1usergroups~1{group_id}~1applications'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphUserGroupAssociationGraphUserGroupTraverseApplication
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphUserGroupAssociationGraphUserGroupTraverseApplication_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphObjectWithPaths))]
    [JumpCloudApiSdkV2.Description(@"This endpoint will return all Applications bound to a User Group, either directly or indirectly, essentially traversing the JumpCloud Graph for your Organization.\n\nEach element will contain the type, id, attributes and paths\n\nThe `attributes` object is a key/value hash of compiled graph attributes for all paths followed.\n\nThe `paths` array enumerates each path from this User Group to the corresponding Application; this array represents all grouping and/or associations that would have to be removed to deprovision the Application from this User Group.\n\nSee `/members` and `/associations` endpoints to manage those collections.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/applications \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphUserGroupAssociationGraphUserGroupTraverseApplication_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphUserGroupAssociationGraphUserGroupTraverseApplication_List" />
        /// cmdlet class.
        /// </summary>
        public GetJcSdkGraphUserGroupAssociationGraphUserGroupTraverseApplication_List()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphSystemGroupMembers=>POST:"/systemgroups/{group_id}/members"
    /// [METADATA]
    /// path: '/systemgroups/{group_id}/members'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1systemgroups~1{group_id}~1members'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: GraphSystemGroupMemberMembershipGraphSystemGroupMember
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the system members of a System Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systemgroups/{Group_ID}/members \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{System_ID}\""\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.ISystemGroupMembersReq _body= new JumpCloudApiSdkV2.Models.SystemGroupMembersReq();

        /// <summary>SystemGroupMembersReq</summary>
        private JumpCloudApiSdkV2.Models.ISystemGroupMembersReq Body { get => this._body; set => this._body = value; }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The ObjectID of member being added or removed.")]
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "How to modify the membership connection.")]
        [JumpCloudApiSdkV2.Category(JumpCloudApiSdkV2.ParameterCategory.Body)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphSystemGroupMembers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphSystemGroupMembers(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_SetExpanded"
        /// /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_SetExpanded()
        {

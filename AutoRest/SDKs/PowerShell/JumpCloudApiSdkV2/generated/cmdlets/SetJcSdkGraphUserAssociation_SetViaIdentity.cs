namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphUserAssociation_SetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGraphUserAssociation_SetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGraphManagementReq _body;

        /// <summary>UserGraphManagementReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "UserGraphManagementReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"UserGraphManagementReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IUserGraphManagementReq) })]
        public JumpCloudApiSdkV2.Models.IUserGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphUserAssociation_SetViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphUserAssociation_SetViaIdentity()
        {

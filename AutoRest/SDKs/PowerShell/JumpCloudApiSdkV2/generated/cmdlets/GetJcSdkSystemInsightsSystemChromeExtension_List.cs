namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemInsightsSystemChromeExtension
    /// variant: List
    /// </remarks>
        ...
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemInsightsSystemChromeExtension_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemInsightsSystemChromeExtension_List()
        {

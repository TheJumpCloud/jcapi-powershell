namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GSuiteAssociation_Set=>POST:"/gsuites/{gsuite_id}/associations"
    /// [METADATA]
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGSuiteAssociation_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGSuiteAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GSuiteAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GSuiteAssociationSet(GsuiteId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGSuiteAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkGSuiteAssociation_Set()
        {

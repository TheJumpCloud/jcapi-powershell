namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] WorkdayAuthorization_Remove=>DELETE:"/workdays/{workday_id}/auth"
    /// [METADATA]
    ...
    /// verb: Remove
    /// subjectPrefix:
    /// subject: WorkdayAuthorization
    /// variant: RemoveViaIdentity
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"JcSdkWorkdayAuthorization_RemoveViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveJcSdkWorkdayAuthorization_RemoveViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WorkdayAuthorizationRemove' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayAuthorizationRemove(InputObject.WorkdayId ?? null, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveJcSdkWorkdayAuthorization_RemoveViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveJcSdkWorkdayAuthorization_RemoveViaIdentity()
        {

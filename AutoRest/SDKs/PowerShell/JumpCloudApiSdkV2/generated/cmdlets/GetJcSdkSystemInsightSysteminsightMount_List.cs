namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List-SysteminsightsMounts=>GET:"/systeminsights/mounts"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemInsightSysteminsightMount
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystemInsightSysteminsightMount_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ISystemInsightsMounts))]
    [JumpCloudApiSdkV2.Description(@"Valid filter fields are `system_id` and `path`.")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkSystemInsightSysteminsightMount_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemInsightSysteminsightMount_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemInsightSysteminsightMount_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListSysteminsightsMounts(this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null /* arrayOf */, onOk, this, Pipeline);

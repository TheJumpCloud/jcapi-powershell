namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-TranslationRuleGSuite=>GET:"/gsuites/{gsuite_id}/translationrules/{id}"
    /// [METADATA]
    /// path: '/gsuites/{gsuite_id}/translationrules/{id}'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1gsuites~1{gsuite_id}~1translationrules~1{id}'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGSuiteTranslationRuleGSuite_GetViaIdentity")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGSuiteTranslationRule))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns a specific translation rule for a specific G Suite instance. These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n###### Sample Request\n\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules/{id} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGSuiteTranslationRuleGSuite_GetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IGSuiteTranslationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGSuiteTranslationRuleGSuite_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetJcSdkGSuiteTranslationRuleGSuite_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetTranslationRuleGSuite(InputObject.GsuiteId ?? null, InputObject.Id ?? null, onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IGSuiteTranslationRule> response)
        {
            using( NoSynchronizationContext )
            {

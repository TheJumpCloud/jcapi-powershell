namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphUserMemberOf=>GET:"/users/{user_id}/memberof"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphUserMember
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphUserMember_List")]
    ...
    public partial class GetJcSdkGraphUserMember_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphUserMember_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGraphUserMember_List()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CommandAssociation_Set=>POST:"/commands/{command_id}/associations"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkCommandAssociation_SetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkCommandAssociation_SetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CommandAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CommandAssociationSet(InputObject.CommandId ?? null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkCommandAssociation_SetViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkCommandAssociation_SetViaIdentity()
        {

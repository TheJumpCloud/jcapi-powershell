namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GroupUser=>GET:"/usergroups"
    /// [METADATA]
    /// path: /usergroups
    /// apiVersions:
    /// - '2.0'
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkUserGroupUser_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IUserGroup))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all User Groups.\n\nAvailable filter fields:\n  - `name`\n  - `disabled`\n  - `type`\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/usergroups \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkUserGroupUser_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkUserGroupUser_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkUserGroupUser_List()
        {

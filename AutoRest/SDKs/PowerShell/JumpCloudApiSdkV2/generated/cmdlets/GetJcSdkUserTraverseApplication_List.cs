namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] UserTraverseApplication_List=>GET:"/users/{user_id}/applications"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1users~1{user_id}~1applications'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: UserTraverseApplication
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkUserTraverseApplication_List")]
    ...
    public partial class GetJcSdkUserTraverseApplication_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkUserTraverseApplication_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkUserTraverseApplication_List()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphUserAssociation=>POST:"/users/{user_id}/associations"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1users~1{user_id}~1associations'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphUserAssociation_SetViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the _direct_ associations of a User.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Users and Systems.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/users/{UserID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n   \""attributes\"": {\n      \""sudo\"": {\n         \""enabled\"": true,\n         \""withoutPassword\"": false\n      }\n   },\n   \""op\"": \""add\"",\n   \""type\"": \""system_group\"",\n   \""id\"": \""{GroupID}\""\n}'")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphUserAssociation_SetViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGraphManagementReq _body= new JumpCloudApiSdkV2.Models.UserGraphManagementReq();

        /// <summary>UserGraphManagementReq</summary>
        private JumpCloudApiSdkV2.Models.IUserGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphUserAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        ThrowTerminatingError( new System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.UserId"),string.Empty, System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.SetGraphUserAssociation(InputObject.UserId ?? null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphUserAssociation_SetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphUserAssociation_SetViaIdentityExpanded()
        {

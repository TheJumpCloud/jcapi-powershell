namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Workday_Create=>POST:"/workdays"
    /// [METADATA]
    /// path: /workdays
    /// apiVersions:
    /// - '2.0'
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkWorkday_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewJcSdkWorkday_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkWorkday_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkWorkday_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WorkdayCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayCreate(Body, onOk, onCreated, this, Pipeline);

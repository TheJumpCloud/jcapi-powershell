namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// relationship between 2 different objects, for example Policies and Systems.\n\n#### Sample Request\n```\ncurl -X POST
    /// https://console.jumpcloud.com/api/v2/policies/{Policy_ID}/associations/ \\\n -H 'Accept: application/json' \\\n -H 'Content-Type:
    /// application/json' \\\n -H 'x-api-key: {API_KEY}' \\\n -d '{\n \"op\": \"add\",\n \"type\": \"system_group\",\n \"id\":
    /// \"{Group_ID}\"\n}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphPolicyAssociation=>POST:"/policies/{policy_id}/associations"
    /// [METADATA]
    /// path: '/policies/{policy_id}/associations'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1policies~1{policy_id}~1associations'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    /// subject: GraphPolicyAssociation
    /// variant: SetViaIdentity
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphPolicyAssociation_SetViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the _direct_ associations of a Policy.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Policies and Systems.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/policies/{Policy_ID}/associations/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system_group\"",\n    \""id\"": \""{Group_ID}\""\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphPolicyAssociation_SetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphPolicyAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.PolicyId)
                    {
                        ThrowTerminatingError( new System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.PolicyId"),string.Empty, System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.SetGraphPolicyAssociation(InputObject.PolicyId ?? null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphPolicyAssociation_SetViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphPolicyAssociation_SetViaIdentity()
        {

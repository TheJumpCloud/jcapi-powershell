namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-GroupUser=>POST:"/usergroups"
    /// [METADATA]
    /// path: /usergroups
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1usergroups'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    /// subject: UserGroupUser
    /// variant: CreateExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkUserGroupUser_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IUserGroup))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to create a new User Group.\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n \""name\"": \""{Group_Name}\""\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkUserGroupUser_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGroupPost _body= new JumpCloudApiSdkV2.Models.UserGroupPost();

        /// <summary>UserGroupPost</summary>
        private JumpCloudApiSdkV2.Models.IUserGroupPost Body { get => this._body; set => this._body = value; }
        ...
        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IUserGroup> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkUserGroupUser_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkUserGroupUser_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateGroupUser' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateGroupUser(Body, onCreated, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IUserGroup> response)
        {
            using( NoSynchronizationContext )
            {

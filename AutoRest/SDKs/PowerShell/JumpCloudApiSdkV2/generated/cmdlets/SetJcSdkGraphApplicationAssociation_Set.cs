namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphApplicationAssociation=>POST:"/applications/{application_id}/associations"
    /// [METADATA]
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphApplicationAssociation_Set", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the _direct_ associations of an Application. A direct association can be a non-homogeneous relationship between 2 different objects, for example Application and User Groups.\n\n#### Sample Request\n```\ncurl -X POST 'https://console.jumpcloud.com/api/v2/applications/{Application_ID}/associations' \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user_group\"",\n    \""id\"": \""{Group_ID}\""\n}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphApplicationAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IGraphManagementReq _body;

        /// <summary>GraphManagementReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "GraphManagementReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"GraphManagementReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IGraphManagementReq) })]
        public JumpCloudApiSdkV2.Models.IGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphApplicationAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphApplicationAssociation(ApplicationId, Body, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  ApplicationId=ApplicationId,body=Body}));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphApplicationAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphApplicationAssociation_Set()
        {

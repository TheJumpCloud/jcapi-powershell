namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.ISystemGroupMembersReq _body;

        /// <summary>SystemGroupMembersReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "SystemGroupMembersReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"SystemGroupMembersReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.ISystemGroupMembersReq) })]
        public JumpCloudApiSdkV2.Models.ISystemGroupMembersReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_Set" /> cmdlet
        /// class.
        /// </summary>
        public SetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMember_Set()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// <summary>
    /// This endpoint adds an authorization method to a workday instance.\n\nYou must supply a username and password for `Basic
    /// Authentication` that is the same as your WorkDay Integrator System User. Failure to provide these credentials will result
    /// in the request being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be
    /// in the future.\n\n#### Sample Request\n\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/{WorkDayID}/auth
    /// \\\n -H 'Accept: application/json' \\\n -H 'Content-Type: application/json' \\\n -H 'x-api-key: {API_KEY}' \\\n -d '{\n\t\"auth\":{\n\t
    /// \"basic\": {\n\t\t\"username\": \"someDeveloper\",\t \n\t\t\"password\": \"notTheRealPassword\"\n\n\t }\n\t}\n}'\n\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-WorkdayAuthorization=>POST:"/workdays/{workday_id}/auth"
    /// [METADATA]
    /// path: '/workdays/{workday_id}/auth'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1workdays~1{workday_id}~1auth'
    /// [DETAILS]
    /// verb: New
    /// subjectPrefix:
    /// subject: WorkdayImportWorkdayAuthorization
    /// variant: CreateViaIdentityExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentityExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint adds an authorization method to a workday instance.\n\nYou must supply a username and password for `Basic Authentication` that is the same as your WorkDay Integrator System User.  Failure to provide these credentials  will result in the request being rejected.\n\nCurrently `O-Auth` isn't a supported authentication protocol for WorkDay, but will be in the future.\n\n#### Sample Request\n\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/{WorkDayID}/auth \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n\t\""auth\"":{\n\t  \""basic\"": {\n\t\t\""username\"": \""someDeveloper\"",\t  \n\t\t\""password\"": \""notTheRealPassword\""\n\n\t  }\n\t}\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IAuthInputObject _body= new JumpCloudApiSdkV2.Models.AuthInputObject();

        /// <summary>Auth Input Object</summary>
        private JumpCloudApiSdkV2.Models.IAuthInputObject Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public NewJcSdkWorkdayImportWorkdayAuthorization_CreateViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateWorkdayAuthorization' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (null == InputObject.WorkdayId)
                    {
                        ThrowTerminatingError( new System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.WorkdayId"),string.Empty, System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.CreateWorkdayAuthorization(InputObject.WorkdayId ?? null, Body, onNoContent, this, Pipeline);

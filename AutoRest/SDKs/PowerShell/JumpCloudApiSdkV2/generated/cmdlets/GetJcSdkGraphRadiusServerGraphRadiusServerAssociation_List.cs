namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphRadiusServerAssociation=>GET:"/radiusservers/{radiusserver_id}/associations"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphRadiusServerGraphRadiusServerAssociation
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphRadiusServerGraphRadiusServerAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphConnection))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns the _direct_ associations of a Radius Server.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Radius Servers and Users.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/radiusservers/{RADIUS_ID}/associations?targets=user_group \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphRadiusServerGraphRadiusServerAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Radius Server.")]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphRadiusServerGraphRadiusServerAssociation_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGraphRadiusServerGraphRadiusServerAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListGraphRadiusServerAssociation(RadiusserverId, Targets, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  RadiusserverId=RadiusserverId,Targets=Targets,Limit=this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?),Skip=this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?)}));
                }
                finally
                {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-TranslationRuleOffice365=>POST:"/office365s/{office365_id}/translationrules"
    /// [METADATA]
    ...
    /// verb: New
    /// subjectPrefix:
    /// subject: Office365TranslationRuleOffice365
    /// variant: CreateExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkOffice365TranslationRuleOffice365_CreateExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IOffice365TranslationRule))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to create a translation rule for a specific Office 365 instance. These rules specify how JumpCloud attributes translate to [Microsoft Graph](https://developer.microsoft.com/en-us/graph) attributes.\n\n##### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/office365s/{office365_id}/translationrules \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n  {Translation Rule Parameters}\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkOffice365TranslationRuleOffice365_CreateExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IOffice365TranslationRuleRequest _body= new JumpCloudApiSdkV2.Models.Office365TranslationRuleRequest();

        /// <summary>Office 365 Translation Rule Request</summary>
        private JumpCloudApiSdkV2.Models.IOffice365TranslationRuleRequest Body { get => this._body; set => this._body = value; }
        ...
        /// `mobilePhone` field of Microsoft Graph `user`* `user_department` - Translate `department` field of JumpCloud user to `department`
        /// field of Microsoft Graph `user`* `user_job_title` - Translate `jobTitle` field of JumpCloud user to `jobTitle` field of
        /// Microsoft Graph `user`* `user_office_location` - Translate `location` field of JumpCloud user to `officeLocation` field
        /// of Microsoft Graph `user`
        /// </summary>
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IOffice365TranslationRule" /> from the
        /// remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IOffice365TranslationRule> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkOffice365TranslationRuleOffice365_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewJcSdkOffice365TranslationRuleOffice365_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateTranslationRuleOffice365' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateTranslationRuleOffice365(Office365Id, Body, onCreated, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  Office365Id=Office365Id,body=Body}));
                }
                finally
                {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IOffice365TranslationRule> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IOffice365TranslationRule

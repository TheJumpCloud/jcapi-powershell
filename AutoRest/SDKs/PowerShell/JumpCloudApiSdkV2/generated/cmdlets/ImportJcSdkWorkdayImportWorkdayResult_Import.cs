namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Import-WorkdayResult=>GET:"/workdays/{id}/import/{job_id}/results"
    /// [METADATA]
    /// path: '/workdays/{id}/import/{job_id}/results'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1workdays~1{id}~1import~1{job_id}~1results'
    /// [DETAILS]
    /// verb: Import
    /// subjectPrefix:
    /// subject: WorkdayImportWorkdayResult
    /// variant: Import
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"JcSdkWorkdayImportWorkdayResult_Import")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IJobWorkresult))]
    [JumpCloudApiSdkV2.Description(@"This endpoint provides a list of job results from the workday import and will contain all imported data from Workday.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/workdays/{WorkdayID}/import/{ImportJobID}/results \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class ImportJcSdkWorkdayImportWorkdayResult_Import : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IJobWorkresult[]" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IJobWorkresult[]> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportJcSdkWorkdayImportWorkdayResult_Import" /> cmdlet class.
        /// </summary>
        public ImportJcSdkWorkdayImportWorkdayResult_Import()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ImportWorkdayResult(Id, JobId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IJobWorkresult[]> response)
        {
            using( NoSynchronizationContext )
            {

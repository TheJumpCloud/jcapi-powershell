namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] LdapServer_List=>GET:"/ldapservers"
    /// [METADATA]
    /// path: /ldapservers
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1ldapservers'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: LdapServer
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkLdapServer_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ILdapServerOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns the object IDs of your LDAP servers.\n\n\n##### Sample Request\n\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/ldapservers/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkLdapServer_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkLdapServer_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkLdapServer_List()
        {

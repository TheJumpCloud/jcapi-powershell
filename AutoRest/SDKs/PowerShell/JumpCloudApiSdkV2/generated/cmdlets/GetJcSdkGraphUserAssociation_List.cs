namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphUserAssociation=>GET:"/users/{user_id}/associations"
    /// [METADATA]
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphUserAssociation_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphConnection))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns the _direct_ associations of a User.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Users and Systems.\n\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/users/{UserID}/associations?targets=system_group \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphUserAssociation_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphUserAssociation_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGraphUserAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListGraphUserAssociation(UserId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), Targets, onOk, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// array enumerates each path from this Office 365 instance to the corresponding User Group; this array represents all grouping
    /// and/or associations that would have to be removed to deprovision the User Group from this Office 365 instance.\n\nSee
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphOffice365TraverseUserGroup=>GET:"/office365s/{office365_id}/usergroups"
    /// [METADATA]
    /// path: '/office365s/{office365_id}/usergroups'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    /// - 'mem:///108?tree%20shaken%20doc...'
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1office365s~1{office365_id}~1usergroups'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphOffice365TraverseUserGroup
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphOffice365TraverseUserGroup_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphObjectWithPaths))]
    [JumpCloudApiSdkV2.Description(@"This endpoint will return all Users Groups bound to an Office 365 instance, either directly or indirectly, essentially traversing the JumpCloud Graph for your Organization.\n\nEach element will contain the group's type, id, attributes and paths.\n\nThe `attributes` object is a key/value hash of compiled graph attributes for all paths followed.\n\nThe `paths` array enumerates each path from this Office 365 instance to the corresponding User Group; this array represents all grouping and/or associations that would have to be removed to deprovision the User Group from this Office 365 instance.\n\nSee `/members` and `/associations` endpoints to manage those collections.\n\n#### Sample Request\n```\n  curl -X GET https://console.jumpcloud.com/api/v2/office365s/{O365_ID/usergroups \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphOffice365TraverseUserGroup_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>ObjectID of the Office 365 suite.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "ObjectID of the Office 365 suite.")]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphOffice365TraverseUserGroup_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGraphOffice365TraverseUserGroup_List()
        {

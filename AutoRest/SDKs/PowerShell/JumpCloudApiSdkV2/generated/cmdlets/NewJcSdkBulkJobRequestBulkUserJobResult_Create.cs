namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-BulkUserJobResults=>GET:"/bulk/users/{job_id}/results"
    /// [METADATA]
    ...
    /// verb: New
    /// subjectPrefix:
    /// subject: BulkJobRequestBulkUserJobResult
    /// variant: Create
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkBulkJobRequestBulkUserJobResult_Create")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IJobWorkresult))]
    [JumpCloudApiSdkV2.Description(@"This endpoint will return the results of particular user import or update job request.\n\n#### Sample Request\n```\ncurl -X GET \\\n  https://console.jumpcloud.com/api/v2/bulk/users/{ImportJobID}/results \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class NewJcSdkBulkJobRequestBulkUserJobResult_Create : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkBulkJobRequestBulkUserJobResult_Create" /> cmdlet class.
        /// </summary>
        public NewJcSdkBulkJobRequestBulkUserJobResult_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateBulkUserJobResults(JobId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] SystemGroupMembership_List=>GET:"/systemgroups/{group_id}/membership"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1systemgroups~1{group_id}~1membership'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemGroupMembership
    /// variant: List
    /// </remarks>
        ...
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemGroupMembership_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemGroupMembership_List()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-GraphSystemGroupMembership=>GET:"/systemgroups/{group_id}/membership"
    /// [METADATA]
    /// path: '/systemgroups/{group_id}/membership'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphSystemGroupMemberMembershipGraphSystemGroupMembership
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMembership_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGraphObjectWithPaths))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all Systems that are a member of this System Group.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/systemgroups/{Group_ID/membership \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMembership_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMembership_List" />
        /// cmdlet class.
        /// </summary>
        public GetJcSdkGraphSystemGroupMemberMembershipGraphSystemGroupMembership_List()
        {

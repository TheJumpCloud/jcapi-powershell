namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] PolicyAssociation_Set=>POST:"/policies/{policy_id}/associations"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1policies~1{policy_id}~1associations'
    /// [DETAILS]
    /// verb: Set
    /// subjectPrefix:
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkPolicyAssociation_SetViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkPolicyAssociation_SetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PolicyAssociationSet' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PolicyAssociationSet(InputObject.PolicyId ?? null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkPolicyAssociation_SetViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkPolicyAssociation_SetViaIdentity()
        {

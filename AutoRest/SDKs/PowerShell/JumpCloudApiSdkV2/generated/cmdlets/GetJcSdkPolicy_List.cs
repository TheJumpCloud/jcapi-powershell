namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Policy_List=>GET:"/policies"
    /// [METADATA]
    /// path: /policies
    /// apiVersions:
    /// - '2.0'
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkPolicy_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IPolicy), typeof(JumpCloudApiSdkV2.Models.IError))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all policies.\n\n##### Sample Request\n\n```\n curl -X GET  https://console.jumpcloud.com/api/v2/policies \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkPolicy_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkPolicy_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkPolicy_List()
        {

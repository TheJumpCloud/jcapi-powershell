namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-LdapServerSambaDomain=>GET:"/ldapservers/{ldapserver_id}/sambadomains/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSambaDomainLdapServerSambaDomain_GetViaIdentity")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ISambaDomainOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns a specific samba domain for an LDAP server.\n\n##### Sample Request\n```\ncurl -X GET \\\n  https://console.jumpcloud.com/api/v2/ldapservers/ldapservers/{LDAP_ID}/sambadomains/{SAMBA_ID} \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkSambaDomainLdapServerSambaDomain_GetViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSambaDomainLdapServerSambaDomain_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetJcSdkSambaDomainLdapServerSambaDomain_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetLdapServerSambaDomain(InputObject.LdapserverId ?? null, InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, onOk, this, Pipeline);

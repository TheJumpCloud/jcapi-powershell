namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Workday_Authorize=>POST:"/workdays/{workday_id}/auth"
    /// [METADATA]
    ...
    /// subjectPrefix:
    /// subject: Workday
    /// variant: AuthorizeViaIdentityExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsSecurity.Grant, @"JcSdkWorkday_AuthorizeViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class GrantJcSdkWorkday_AuthorizeViaIdentityExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GrantJcSdkWorkday_AuthorizeViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public GrantJcSdkWorkday_AuthorizeViaIdentityExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'WorkdayAuthorize' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayAuthorize(InputObject.WorkdayId ?? null, Body, onNoContent, this, Pipeline);

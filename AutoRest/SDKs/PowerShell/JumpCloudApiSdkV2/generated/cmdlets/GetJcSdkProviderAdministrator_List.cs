namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// GET https://console.jumpcloud.com/api/v2/providers/{ProviderID}/administrators \\\n -H 'Accept: application/json' \\\n
    /// -H 'Content-Type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ProviderAdministrator_List=>GET:"/providers/{provider_id}/administrators"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1providers~1{provider_id}~1administrators'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: ProviderAdministrator
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkProviderAdministrator_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses200ContentApplicationJsonSchema), typeof(string))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns a list of the Administrators associated with the Provider.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/providers/{ProviderID}/administrators \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkProviderAdministrator_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses200ContentApplicationJsonSchema"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses200ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema"
        /// /> from the remote call</param>
        ...
        partial void overrideOnUnauthorized(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkProviderAdministrator_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkProviderAdministrator_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses200ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses200ContentApplicationJsonSchema
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onUnauthorized(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema

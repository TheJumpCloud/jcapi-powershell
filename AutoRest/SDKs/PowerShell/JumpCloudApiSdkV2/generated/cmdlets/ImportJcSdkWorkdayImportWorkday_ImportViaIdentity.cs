namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Import-Workday=>POST:"/workdays/{workday_id}/import"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"JcSdkWorkdayImportWorkday_ImportViaIdentity", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    [JumpCloudApiSdkV2.Description(@"The endpoint allows you to create a Workday Import request.\n\n#### Sample Request \n```\ncurl -X POST https://console.jumpcloud.com/api/v2/workdays/{WorkdayID}/import \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '[\n\t{\n\t\t\""email\"":\""{email}\"",\n\t\t\""firstname\"":\""{firstname}\"",\n\t\t\""lastname\"":\""{firstname}\"",\n\t\t\""username\"":\""{username}\"",\n\t\t\""attributes\"":[\n\t\t\t{\""name\"":\""EmployeeID\"",\""value\"":\""0000\""},\n\t\t\t{\""name\"":\""WorkdayID\"",\""value\"":\""name.name\""}\n\t\t\t]\n\t\t\n\t}\n]\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class ImportJcSdkWorkdayImportWorkday_ImportViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IBulkUserCreate[] _body;
        ...
        Description = @"",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IBulkUserCreate) })]
        public JumpCloudApiSdkV2.Models.IBulkUserCreate[] Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportJcSdkWorkdayImportWorkday_ImportViaIdentity" /> cmdlet class.
        /// </summary>
        public ImportJcSdkWorkdayImportWorkday_ImportViaIdentity()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ImportWorkday' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ImportWorkday(InputObject.WorkdayId ?? null, Body, onCreated, this, Pipeline);

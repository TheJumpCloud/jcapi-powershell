namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// variant: Import
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"JcSdkWorkdayImportWorkday_Import", SupportsShouldProcess = true)]
    ...
    public partial class ImportJcSdkWorkdayImportWorkday_Import : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportJcSdkWorkdayImportWorkday_Import" /> cmdlet class.
        /// </summary>
        public ImportJcSdkWorkdayImportWorkday_Import()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ImportWorkday(WorkdayId, Body, onCreated, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] WorkdayWorker_List=>GET:"/workdays/{workday_id}/workers"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1workdays~1{workday_id}~1workers'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: WorkdayWorker
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkWorkdayWorker_List")]
    ...
    public partial class GetJcSdkWorkdayWorker_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkWorkdayWorker_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkWorkdayWorker_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayWorkerList(WorkdayId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Sort") ? Sort : null /* arrayOf */, onOk, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphSystemAssociation=>POST:"/systems/{system_id}/associations"
    /// [METADATA]
    ...
    /// verb: Set
    /// subjectPrefix:
    /// subject: GraphSystemAssociation
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphSystemAssociation_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the _direct_ associations of a System.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Systems and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systems/{System_ID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n   \""attributes\"": {\n      \""sudo\"": {\n         \""enabled\"": true,\n         \""withoutPassword\"": false\n      }\n   },\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""UserID\""\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphSystemAssociation_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.ISystemGraphManagementReq _body= new JumpCloudApiSdkV2.Models.SystemGraphManagementReq();

        /// <summary>SystemGraphManagementReq</summary>
        private JumpCloudApiSdkV2.Models.ISystemGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphSystemAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphSystemAssociation(SystemId, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphSystemAssociation_SetExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphSystemAssociation_SetExpanded()
        {

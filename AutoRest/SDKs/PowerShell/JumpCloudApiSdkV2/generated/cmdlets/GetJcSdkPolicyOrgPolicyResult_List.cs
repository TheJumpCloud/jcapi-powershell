namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-OrgPolicyResults=>GET:"/policyresults"
    /// [METADATA]
    /// path: /policyresults
    /// apiVersions:
    /// - '2.0'
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: PolicyOrgPolicyResult
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkPolicyOrgPolicyResult_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IPolicyResult))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all policies results for an organization.\n\n##### Sample Request\n\n```\n curl -X GET https://console.jumpcloud.com/api/v2/policyresults \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkPolicyOrgPolicyResult_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkPolicyOrgPolicyResult_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkPolicyOrgPolicyResult_List()
        {

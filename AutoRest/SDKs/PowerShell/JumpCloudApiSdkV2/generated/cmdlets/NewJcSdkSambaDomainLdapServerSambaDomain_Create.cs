namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Create-LdapServerSambaDomain=>POST:"/ldapservers/{ldapserver_id}/sambadomains"
    /// [METADATA]
    ...
    /// variant: Create
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"JcSdkSambaDomainLdapServerSambaDomain_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewJcSdkSambaDomainLdapServerSambaDomain_Create : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.ISambaDomainInput _body;
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.ISambaDomainInput) })]
        public JumpCloudApiSdkV2.Models.ISambaDomainInput Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewJcSdkSambaDomainLdapServerSambaDomain_Create" /> cmdlet class.
        /// </summary>
        public NewJcSdkSambaDomainLdapServerSambaDomain_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'CreateLdapServerSambaDomain' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.CreateLdapServerSambaDomain(LdapserverId, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, Body, onCreated, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1activedirectories'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    ...
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to list all your Active Directory Instances.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/activedirectories/ \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
        ...
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IActiveDirectoryOutput[]" /> from the
        /// remote call</param>

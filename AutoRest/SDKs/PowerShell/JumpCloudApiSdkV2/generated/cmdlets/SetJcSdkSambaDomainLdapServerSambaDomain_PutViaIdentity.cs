namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Put-LdapServerSambaDomain=>PUT:"/ldapservers/{ldapserver_id}/sambadomains/{id}"
    /// [METADATA]
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkSambaDomainLdapServerSambaDomain_PutViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkSambaDomainLdapServerSambaDomain_PutViaIdentity : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PutLdapServerSambaDomain' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PutLdapServerSambaDomain(InputObject.LdapserverId ?? null, InputObject.Id ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ContentType") ? ContentType : null, this.InvocationInformation.BoundParameters.ContainsKey("Accept") ? Accept : null, Body, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkSambaDomainLdapServerSambaDomain_PutViaIdentity" /> cmdlet class.
        /// </summary>
        public SetJcSdkSambaDomainLdapServerSambaDomain_PutViaIdentity()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphUserGroupAssociation=>POST:"/usergroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphUserGroupAssociationGraphUserGroupAssociation_Set", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint manages the _direct_ associations of this User Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example User Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/usergroups/{GroupID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""system\"",\n    \""id\"": \""{SystemID}\""\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphUserGroupAssociationGraphUserGroupAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReq _body;

        /// <summary>UserGroupGraphManagementReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "UserGroupGraphManagementReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"UserGroupGraphManagementReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReq) })]
        public JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphUserGroupAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphUserGroupAssociation(GroupId, Body, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  GroupId=GroupId,body=Body}));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphUserGroupAssociationGraphUserGroupAssociation_Set" /> cmdlet
        /// class.
        /// </summary>
        public SetJcSdkGraphUserGroupAssociationGraphUserGroupAssociation_Set()
        {

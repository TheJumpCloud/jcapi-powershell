namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List-SysteminsightsApps=>GET:"/systeminsights/apps"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: SystemInsightSysteminsightApp
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSystemInsightSysteminsightApp_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ISystemInsightsApps))]
    [JumpCloudApiSdkV2.Description(@"Valid filter fields are `system_id` and `bundle_name`.")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkSystemInsightSysteminsightApp_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSystemInsightSysteminsightApp_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSystemInsightSysteminsightApp_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListSysteminsightsApps(this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null /* arrayOf */, onOk, this, Pipeline);

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkLdapServer_PatchExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateJcSdkLdapServer_PatchExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string Id1 { get => Body.Id ?? null; set => Body.Id = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkLdapServer_PatchExpanded" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkLdapServer_PatchExpanded()
        {

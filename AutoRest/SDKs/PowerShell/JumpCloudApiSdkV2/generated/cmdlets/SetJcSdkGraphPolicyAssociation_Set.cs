namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphPolicyAssociation_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGraphPolicyAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphPolicyAssociation(PolicyId, Body, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new {  PolicyId=PolicyId,body=Body}));
                }
                finally
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphPolicyAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphPolicyAssociation_Set()
        {

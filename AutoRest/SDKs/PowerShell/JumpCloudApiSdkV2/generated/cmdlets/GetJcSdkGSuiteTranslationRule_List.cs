namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] GSuiteTranslationRule_List=>GET:"/gsuites/{gsuite_id}/translationrules"
    /// [METADATA]
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkGSuiteTranslationRule_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IGSuiteTranslationRule))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all graph translation rules for a specific G Suite instance. These rules specify how JumpCloud attributes translate to [G Suite Admin SDK](https://developers.google.com/admin-sdk/directory/) attributes.\n\n##### Sample Request\n\n```\n curl -X GET  https://console.jumpcloud.com/api/v2/gsuites/{gsuite_id}/translationrules \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkGSuiteTranslationRule_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloudApiSdkV2.Models.IGSuiteTranslationRule[]" /> from the
        /// remote call</param>
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkGSuiteTranslationRule_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkGSuiteTranslationRule_List()
        {

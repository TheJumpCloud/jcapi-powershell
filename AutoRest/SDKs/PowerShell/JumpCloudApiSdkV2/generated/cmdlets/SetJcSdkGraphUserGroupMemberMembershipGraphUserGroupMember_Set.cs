namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        private JumpCloudApiSdkV2.Models.IUserGroupMembersReq _body;

        /// <summary>UserGroupMembersReq</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "UserGroupMembersReq", ValueFromPipeline = true)]
        [JumpCloudApiSdkV2.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"UserGroupMembersReq",
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(JumpCloudApiSdkV2.Models.IUserGroupMembersReq) })]
        public JumpCloudApiSdkV2.Models.IUserGroupMembersReq Body { get => this._body; set => this._body = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_Set" /> cmdlet
        /// class.
        /// </summary>
        public SetJcSdkGraphUserGroupMemberMembershipGraphUserGroupMember_Set()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] WorkdayResult_Import=>GET:"/workdays/{id}/import/{job_id}/results"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/2/s/AutoRest/SwaggerSpecs/V2.json#/paths/~1workdays~1{id}~1import~1{job_id}~1results'
    /// [DETAILS]
    /// verb: Import
    /// subjectPrefix:
    /// subject: WorkdayResult
    /// variant: Import
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"JcSdkWorkdayResult_Import")]
    ...
    public partial class ImportJcSdkWorkdayResult_Import : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportJcSdkWorkdayResult_Import" /> cmdlet class.
        /// </summary>
        public ImportJcSdkWorkdayResult_Import()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.WorkdayResultImport(Id, JobId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), onOk, this, Pipeline);

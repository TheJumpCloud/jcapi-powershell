namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Update-BulkUsers=>PATCH:"/bulk/users"
    /// [METADATA]
    /// path: /bulk/users
    /// apiVersions:
    /// - '2.0'
    ...
    /// verb: Update
    /// subjectPrefix:
    /// subject: BulkJobRequestBulkUser
    /// variant: Update
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"JcSdkBulkJobRequestBulkUser_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateJcSdkBulkJobRequestBulkUser_Update : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateBulkUsers' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateBulkUsers(Body, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateJcSdkBulkJobRequestBulkUser_Update" /> cmdlet class.
        /// </summary>
        public UpdateJcSdkBulkJobRequestBulkUser_Update()
        {

namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-LdapServerSambaDomain=>GET:"/ldapservers/{ldapserver_id}/sambadomains"
    /// [METADATA]
    ...
    /// verb: Get
    /// subjectPrefix:
    /// subject: SambaDomainLdapServerSambaDomain
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkSambaDomainLdapServerSambaDomain_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.ISambaDomainOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint returns all samba domains for an LDAP server.\n\n##### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/ldapservers/{LDAP_ID}/sambadomains \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkSambaDomainLdapServerSambaDomain_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkSambaDomainLdapServerSambaDomain_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkSambaDomainLdapServerSambaDomain_List()
        {

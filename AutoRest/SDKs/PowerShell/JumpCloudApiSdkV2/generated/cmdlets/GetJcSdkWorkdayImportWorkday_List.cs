namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-Workday=>GET:"/workdays"
    /// [METADATA]
    /// path: /workdays
    /// apiVersions:
    /// - '2.0'
    ...
    /// variant: List
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"JcSdkWorkdayImportWorkday_List")]
    [System.Management.Automation.OutputType(typeof(JumpCloudApiSdkV2.Models.IWorkdayOutput))]
    [JumpCloudApiSdkV2.Description(@"This endpoint will return  all the available information about all your instances of Workday.\n\n##### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/workdays/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n  ```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class GetJcSdkWorkdayImportWorkday_List : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkWorkdayImportWorkday_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkWorkdayImportWorkday_List()
        {

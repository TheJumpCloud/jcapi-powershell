namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphSystemGroupAssociation=>POST:"/systemgroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// variant: SetExpanded
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_SetExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [JumpCloudApiSdkV2.Description(@"This endpoint allows you to manage the _direct_ associations of a System Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example System Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systemgroups/{GroupID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""{UserID}\""\n}'\n\n```")]
    [JumpCloudApiSdkV2.Generated]
    public partial class SetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_SetExpanded : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        public JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReqAttributes Attributes { get => Body.Attributes ?? null /* object */; set => Body.Attributes = value; }

        /// <summary>Backing field for <see cref="Body" /> property.</summary>
        private JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReq _body= new JumpCloudApiSdkV2.Models.SystemGroupGraphManagementReq();

        /// <summary>SystemGroupGraphManagementReq</summary>
        private JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReq Body { get => this._body; set => this._body = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphSystemGroupAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphSystemGroupAssociation(GroupId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_SetExpanded"
        /// /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphSystemGroupAssociationGraphSystemGroupAssociation_SetExpanded()
        {

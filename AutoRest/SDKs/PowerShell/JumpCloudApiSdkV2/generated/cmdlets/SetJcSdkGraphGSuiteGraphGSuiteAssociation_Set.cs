namespace JumpCloudApiSdkV2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-GraphGSuiteAssociation=>POST:"/gsuites/{gsuite_id}/associations"
    /// [METADATA]
    ...
    /// variant: Set
    /// </remarks>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"JcSdkGraphGSuiteGraphGSuiteAssociation_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetJcSdkGraphGSuiteGraphGSuiteAssociation_Set : System.Management.Automation.PSCmdlet,
        JumpCloudApiSdkV2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetGraphGSuiteAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SetGraphGSuiteAssociation(GsuiteId, Body, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkGraphGSuiteGraphGSuiteAssociation_Set" /> cmdlet class.
        /// </summary>
        public SetJcSdkGraphGSuiteGraphGSuiteAssociation_Set()
        {

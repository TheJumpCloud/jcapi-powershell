namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class UserGraphManagementReq
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IUserGraphManagementReq.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IUserGraphManagementReq.</returns>
        public static JumpCloudApiSdkV2.Models.IUserGraphManagementReq FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new UserGraphManagementReq(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReq" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReq" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReq" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReq(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloudApiSdkV2.Models.UserGraphManagementReqAttributes.FromJson(__jsonAttributes) : Attributes;}

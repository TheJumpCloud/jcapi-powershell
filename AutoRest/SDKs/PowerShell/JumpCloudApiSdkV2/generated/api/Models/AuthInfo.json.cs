namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class AuthInfo
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="AuthInfo" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal AuthInfo(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_expiry = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("expiry"), out var __jsonExpiry) ? (string)__jsonExpiry : (string)Expiry;}
            {_isValid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonBoolean>("isValid"), out var __jsonIsValid) ? (bool?)__jsonIsValid : IsValid;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IAuthInfo.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IAuthInfo.</returns>
        public static JumpCloudApiSdkV2.Models.IAuthInfo FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new AuthInfo(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="AuthInfo" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="AuthInfo" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._expiry)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._expiry.ToString()) : null, "expiry" ,container.Add );
            AddIf( null != this._isValid ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonBoolean((bool)this._isValid) : null, "isValid" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class ActiveDirectoryOutput
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="ActiveDirectoryOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ActiveDirectoryOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasActiveDirectoryOutputAllof0 = new JumpCloudApiSdkV2.Models.ComponentsSchemasActiveDirectoryOutputAllof0(json);
            __activeDirectoryInput = new JumpCloudApiSdkV2.Models.ActiveDirectoryInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IActiveDirectoryOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IActiveDirectoryOutput.</returns>
        public static JumpCloudApiSdkV2.Models.IActiveDirectoryOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new ActiveDirectoryOutput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ActiveDirectoryOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ActiveDirectoryOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            __componentsSchemasActiveDirectoryOutputAllof0?.ToJson(container, serializationMode);
            __activeDirectoryInput?.ToJson(container, serializationMode);

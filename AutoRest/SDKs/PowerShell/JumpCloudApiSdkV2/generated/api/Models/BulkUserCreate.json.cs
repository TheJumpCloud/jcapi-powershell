namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class BulkUserCreate
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="BulkUserCreate" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal BulkUserCreate(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonArray>("attributes"), out var __jsonAttributes) ? If( __jsonAttributes as JumpCloudApiSdkV2.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloudApiSdkV2.Models.IBulkUserCreateAttributesItem[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloudApiSdkV2.Models.IBulkUserCreateAttributesItem) (JumpCloudApiSdkV2.Models.BulkUserCreateAttributesItem.FromJson(__u) )) ))() : null : Attributes;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IBulkUserCreate.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IBulkUserCreate.</returns>
        public static JumpCloudApiSdkV2.Models.IBulkUserCreate FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new BulkUserCreate(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BulkUserCreate" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BulkUserCreate" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>

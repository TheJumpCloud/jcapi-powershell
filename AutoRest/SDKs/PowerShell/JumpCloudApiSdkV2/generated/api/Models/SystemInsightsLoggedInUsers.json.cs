namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsLoggedInUsers
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsLoggedInUsers.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsLoggedInUsers.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsLoggedInUsers FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsLoggedInUsers(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsLoggedInUsers" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsLoggedInUsers(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_host = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("host"), out var __jsonHost) ? (string)__jsonHost : (string)Host;}
            {_pid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("pid"), out var __jsonPid) ? (int?)__jsonPid : Pid;}
            ...
            {_time = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("time"), out var __jsonTime) ? (int?)__jsonTime : Time;}
            {_tty = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("tty"), out var __jsonTty) ? (string)__jsonTty : (string)Tty;}
            {_user = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("user"), out var __jsonUser) ? (string)__jsonUser : (string)User;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsLoggedInUsers" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsLoggedInUsers" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._host)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._host.ToString()) : null, "host" ,container.Add );
            AddIf( null != this._pid ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._pid) : null, "pid" ,container.Add );
            ...
            AddIf( null != this._time ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._time) : null, "time" ,container.Add );
            AddIf( null != (((object)this._tty)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._tty.ToString()) : null, "tty" ,container.Add );
            AddIf( null != (((object)this._user)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._user.ToString()) : null, "user" ,container.Add );

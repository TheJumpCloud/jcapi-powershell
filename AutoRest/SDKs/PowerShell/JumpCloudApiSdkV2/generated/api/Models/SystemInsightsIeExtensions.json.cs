namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsIeExtensions
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsIeExtensions.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsIeExtensions.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsIeExtensions FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsIeExtensions(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsIeExtensions" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsIeExtensions(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_registryPath = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("registry_path"), out var __jsonRegistryPath) ? (string)__jsonRegistryPath : (string)RegistryPath;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsIeExtensions" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsIeExtensions" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._registryPath)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._registryPath.ToString()) : null, "registry_path" ,container.Add );

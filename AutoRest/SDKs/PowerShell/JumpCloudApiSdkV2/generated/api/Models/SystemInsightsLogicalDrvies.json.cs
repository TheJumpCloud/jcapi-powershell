namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsLogicalDrvies
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsLogicalDrvies.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsLogicalDrvies.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsLogicalDrvies FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsLogicalDrvies(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsLogicalDrvies" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsLogicalDrvies(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_bootPartition = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("boot_partition"), out var __jsonBootPartition) ? (int?)__jsonBootPartition : BootPartition;}
            ...
            {_fileSystem = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("file_system"), out var __jsonFileSystem) ? (string)__jsonFileSystem : (string)FileSystem;}
            {_freeSpace = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("free_space"), out var __jsonFreeSpace) ? (string)__jsonFreeSpace : (string)FreeSpace;}
            {_size = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("size"), out var __jsonSize) ? (string)__jsonSize : (string)Size;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsLogicalDrvies" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsLogicalDrvies" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._bootPartition ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._bootPartition) : null, "boot_partition" ,container.Add );
            ...
            AddIf( null != (((object)this._fileSystem)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._fileSystem.ToString()) : null, "file_system" ,container.Add );
            AddIf( null != (((object)this._freeSpace)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._freeSpace.ToString()) : null, "free_space" ,container.Add );
            AddIf( null != (((object)this._size)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._size.ToString()) : null, "size" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class WorkdayOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IWorkdayOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IWorkdayOutput.</returns>
        public static JumpCloudApiSdkV2.Models.IWorkdayOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new WorkdayOutput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WorkdayOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="WorkdayOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._auth ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) this._auth.ToJson(null,serializationMode) : null, "auth" ,container.Add );
            ...
            AddIf( null != (((object)this._lastImport)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._lastImport.ToString()) : null, "lastImport" ,container.Add );
            AddIf( null != (((object)this._reportUrl)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._reportUrl.ToString()) : null, "reportUrl" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="WorkdayOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WorkdayOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_auth = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("auth"), out var __jsonAuth) ? JumpCloudApiSdkV2.Models.WorkdayOutputAuth.FromJson(__jsonAuth) : Auth;}
            ...
            {_lastImport = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("lastImport"), out var __jsonLastImport) ? (string)__jsonLastImport : (string)LastImport;}
            {_reportUrl = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("reportUrl"), out var __jsonReportUrl) ? (string)__jsonReportUrl : (string)ReportUrl;}
            AfterFromJson(json);
        }
    }
}
namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemGraphManagementReqAttributes.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemGraphManagementReqAttributes FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemGraphManagementReqAttributes(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_sudo = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("sudo"), out var __jsonSudo) ? JumpCloudApiSdkV2.Models.SystemGraphManagementReqAttributesSudo.FromJson(__jsonSudo) : Sudo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemGraphManagementReqAttributes" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemGraphManagementReqAttributes" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sudo ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) this._sudo.ToJson(null,serializationMode) : null, "sudo" ,container.Add );

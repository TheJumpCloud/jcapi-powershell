namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsDiskEncryption
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsDiskEncryption.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsDiskEncryption.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsDiskEncryption FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsDiskEncryption(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsDiskEncryption" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsDiskEncryption(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_encrypted = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("encrypted"), out var __jsonEncrypted) ? (int?)__jsonEncrypted : Encrypted;}
            {_encryptionStatus = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("encryption_status"), out var __jsonEncryptionStatus) ? (string)__jsonEncryptionStatus : (string)EncryptionStatus;}
            ...
            {_userUuid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("user_uuid"), out var __jsonUserUuid) ? (string)__jsonUserUuid : (string)UserUuid;}
            {_uuid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("uuid"), out var __jsonUuid) ? (string)__jsonUuid : (string)Uuid;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsDiskEncryption" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsDiskEncryption" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._encrypted ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._encrypted) : null, "encrypted" ,container.Add );
            AddIf( null != (((object)this._encryptionStatus)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._encryptionStatus.ToString()) : null, "encryption_status" ,container.Add );
            ...
            AddIf( null != (((object)this._userUuid)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._userUuid.ToString()) : null, "user_uuid" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class PolicyRequest
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IPolicyRequest.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IPolicyRequest.</returns>
        public static JumpCloudApiSdkV2.Models.IPolicyRequest FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new PolicyRequest(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="PolicyRequest" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PolicyRequest(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_template = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("template"), out var __jsonTemplate) ? JumpCloudApiSdkV2.Models.PolicyRequestTemplate.FromJson(__jsonTemplate) : Template;}
            {_name = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            {_values = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonArray>("values"), out var __jsonValues) ? If( __jsonValues as JumpCloudApiSdkV2.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<JumpCloudApiSdkV2.Models.IPolicyValue[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(JumpCloudApiSdkV2.Models.IPolicyValue) (JumpCloudApiSdkV2.Models.PolicyValue.FromJson(__u) )) ))() : null : Values;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PolicyRequest" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PolicyRequest" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>

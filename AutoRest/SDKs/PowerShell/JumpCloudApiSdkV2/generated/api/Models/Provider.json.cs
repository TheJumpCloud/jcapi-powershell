namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class Provider
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IProvider.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IProvider.</returns>
        public static JumpCloudApiSdkV2.Models.IProvider FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new Provider(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="Provider" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Provider(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_contact = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("contact"), out var __jsonContact) ? JumpCloudApiSdkV2.Models.ProviderContact.FromJson(__jsonContact) : Contact;}
            {_name = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("name"), out var __jsonName) ? (string)__jsonName : (string)Name;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Provider" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Provider" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._contact ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) this._contact.ToJson(null,serializationMode) : null, "contact" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class PolicyTemplateConfigFieldTooltipVariables
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IPolicyTemplateConfigFieldTooltipVariables.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloudApiSdkV2.Models.IPolicyTemplateConfigFieldTooltipVariables.
        /// </returns>
        public static JumpCloudApiSdkV2.Models.IPolicyTemplateConfigFieldTooltipVariables FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new PolicyTemplateConfigFieldTooltipVariables(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="PolicyTemplateConfigFieldTooltipVariables" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PolicyTemplateConfigFieldTooltipVariables(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_icon = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("icon"), out var __jsonIcon) ? (string)__jsonIcon : (string)Icon;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="PolicyTemplateConfigFieldTooltipVariables" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PolicyTemplateConfigFieldTooltipVariables" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._icon)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._icon.ToString()) : null, "icon" ,container.Add );

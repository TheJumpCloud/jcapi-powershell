namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class GsuiteOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IGsuiteOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IGsuiteOutput.</returns>
        public static JumpCloudApiSdkV2.Models.IGsuiteOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new GsuiteOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="GsuiteOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal GsuiteOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasGsuiteOutputAllof0 = new JumpCloudApiSdkV2.Models.ComponentsSchemasGsuiteOutputAllof0(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="GsuiteOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="GsuiteOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            __componentsSchemasGsuiteOutputAllof0?.ToJson(container, serializationMode);

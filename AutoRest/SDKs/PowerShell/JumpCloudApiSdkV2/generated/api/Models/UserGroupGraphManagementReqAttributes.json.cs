namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class UserGroupGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReqAttributes.</returns>
        public static JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReqAttributes FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new UserGroupGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGroupGraphManagementReqAttributes" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGroupGraphManagementReqAttributes" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="UserGroupGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGroupGraphManagementReqAttributes(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;

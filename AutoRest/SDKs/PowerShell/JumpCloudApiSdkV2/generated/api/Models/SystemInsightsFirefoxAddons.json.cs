namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsFirefoxAddons
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsFirefoxAddons.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsFirefoxAddons.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsFirefoxAddons FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsFirefoxAddons(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsFirefoxAddons" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsFirefoxAddons(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_active = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("active"), out var __jsonActive) ? (int?)__jsonActive : Active;}
            {_autoupdate = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("autoupdate"), out var __jsonAutoupdate) ? (int?)__jsonAutoupdate : Autoupdate;}
            ...
            {_creator = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("creator"), out var __jsonCreator) ? (string)__jsonCreator : (string)Creator;}
            {_disabled = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("disabled"), out var __jsonDisabled) ? (int?)__jsonDisabled : Disabled;}
            ...
            {_sourceUrl = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("source_url"), out var __jsonSourceUrl) ? (string)__jsonSourceUrl : (string)SourceUrl;}
            ...
            {_visible = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("visible"), out var __jsonVisible) ? (int?)__jsonVisible : Visible;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsFirefoxAddons" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsFirefoxAddons" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._active ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._active) : null, "active" ,container.Add );
            AddIf( null != this._autoupdate ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._autoupdate) : null, "autoupdate" ,container.Add );
            ...
            AddIf( null != (((object)this._creator)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._creator.ToString()) : null, "creator" ,container.Add );
            AddIf( null != this._disabled ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._disabled) : null, "disabled" ,container.Add );
            ...
            AddIf( null != (((object)this._sourceUrl)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._sourceUrl.ToString()) : null, "source_url" ,container.Add );
            ...
            AddIf( null != this._visible ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._visible) : null, "visible" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class UserGraphManagementReqAttributes
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IUserGraphManagementReqAttributes.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IUserGraphManagementReqAttributes.</returns>
        public static JumpCloudApiSdkV2.Models.IUserGraphManagementReqAttributes FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new UserGraphManagementReqAttributes(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UserGraphManagementReqAttributes" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UserGraphManagementReqAttributes" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="UserGraphManagementReqAttributes" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal UserGraphManagementReqAttributes(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_sudo = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("sudo"), out var __jsonSudo) ? JumpCloudApiSdkV2.Models.UserGraphManagementReqAttributesSudo.FromJson(__jsonSudo) : Sudo;}
            AfterFromJson(json);
        }
    }
}
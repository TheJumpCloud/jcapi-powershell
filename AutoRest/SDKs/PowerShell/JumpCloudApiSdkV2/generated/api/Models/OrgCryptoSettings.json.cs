namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class OrgCryptoSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IOrgCryptoSettings.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IOrgCryptoSettings.</returns>
        public static JumpCloudApiSdkV2.Models.IOrgCryptoSettings FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new OrgCryptoSettings(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="OrgCryptoSettings" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OrgCryptoSettings(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_sshKeys = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("sshKeys"), out var __jsonSshKeys) ? JumpCloudApiSdkV2.Models.OrgCryptoSettingsSshKeys.FromJson(__jsonSshKeys) : SshKeys;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OrgCryptoSettings" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OrgCryptoSettings" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sshKeys ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) this._sshKeys.ToJson(null,serializationMode) : null, "sshKeys" ,container.Add );

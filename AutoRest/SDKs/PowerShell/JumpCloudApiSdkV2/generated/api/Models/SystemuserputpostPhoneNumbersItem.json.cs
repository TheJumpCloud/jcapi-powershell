namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemuserputpostPhoneNumbersItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemuserputpostPhoneNumbersItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemuserputpostPhoneNumbersItem.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemuserputpostPhoneNumbersItem FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemuserputpostPhoneNumbersItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemuserputpostPhoneNumbersItem" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemuserputpostPhoneNumbersItem(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_number = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("number"), out var __jsonNumber) ? (string)__jsonNumber : (string)Number;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SystemuserputpostPhoneNumbersItem" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemuserputpostPhoneNumbersItem" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._number)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._number.ToString()) : null, "number" ,container.Add );

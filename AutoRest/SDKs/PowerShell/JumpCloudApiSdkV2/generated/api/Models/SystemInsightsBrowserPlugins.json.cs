namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsBrowserPlugins
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsBrowserPlugins.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsBrowserPlugins.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsBrowserPlugins FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsBrowserPlugins(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsBrowserPlugins" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsBrowserPlugins(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_native = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonNumber>("native"), out var __jsonNative) ? (int?)__jsonNative : Native;}
            {_sdk = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("sdk"), out var __jsonSdk) ? (string)__jsonSdk : (string)Sdk;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsBrowserPlugins" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsBrowserPlugins" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._native ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonNumber((int)this._native) : null, "native" ,container.Add );
            AddIf( null != (((object)this._sdk)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._sdk.ToString()) : null, "sdk" ,container.Add );

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SambaDomainOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISambaDomainOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISambaDomainOutput.</returns>
        public static JumpCloudApiSdkV2.Models.ISambaDomainOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SambaDomainOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SambaDomainOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SambaDomainOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasSambaDomainOutputAllof0 = new JumpCloudApiSdkV2.Models.ComponentsSchemasSambaDomainOutputAllof0(json);
            __sambaDomainInput = new JumpCloudApiSdkV2.Models.SambaDomainInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SambaDomainOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SambaDomainOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            __componentsSchemasSambaDomainOutputAllof0?.ToJson(container, serializationMode);
            __sambaDomainInput?.ToJson(container, serializationMode);

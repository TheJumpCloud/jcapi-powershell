namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class ComponentsSchemasGsuiteOutputAllof0
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="ComponentsSchemasGsuiteOutputAllof0" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ComponentsSchemasGsuiteOutputAllof0(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IComponentsSchemasGsuiteOutputAllof0.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IComponentsSchemasGsuiteOutputAllof0.</returns>
        public static JumpCloudApiSdkV2.Models.IComponentsSchemasGsuiteOutputAllof0 FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new ComponentsSchemasGsuiteOutputAllof0(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ComponentsSchemasGsuiteOutputAllof0" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"
        /// />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ComponentsSchemasGsuiteOutputAllof0" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class LdapServerOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ILdapServerOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ILdapServerOutput.</returns>
        public static JumpCloudApiSdkV2.Models.ILdapServerOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new LdapServerOutput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="LdapServerOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal LdapServerOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            __componentsSchemasLdapServerOutputAllof0 = new JumpCloudApiSdkV2.Models.ComponentsSchemasLdapServerOutputAllof0(json);
            __ldapServerInput = new JumpCloudApiSdkV2.Models.LdapServerInput(json);
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="LdapServerOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="LdapServerOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            __componentsSchemasLdapServerOutputAllof0?.ToJson(container, serializationMode);
            __ldapServerInput?.ToJson(container, serializationMode);

namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemGroupGraphManagementReq
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReq.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReq.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemGroupGraphManagementReq FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemGroupGraphManagementReq(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemGroupGraphManagementReq" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemGroupGraphManagementReq(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_attributes = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonObject>("attributes"), out var __jsonAttributes) ? JumpCloudApiSdkV2.Models.SystemGroupGraphManagementReqAttributes.FromJson(__jsonAttributes) : Attributes;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemGroupGraphManagementReq" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemGroupGraphManagementReq" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>

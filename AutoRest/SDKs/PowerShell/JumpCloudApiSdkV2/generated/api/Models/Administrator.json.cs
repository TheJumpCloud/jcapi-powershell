namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class Administrator
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="Administrator" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Administrator(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_enableMultiFactor = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonBoolean>("enableMultiFactor"), out var __jsonEnableMultiFactor) ? (bool?)__jsonEnableMultiFactor : EnableMultiFactor;}
            ...
            {_registered = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonBoolean>("registered"), out var __jsonRegistered) ? (bool?)__jsonRegistered : Registered;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IAdministrator.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IAdministrator.</returns>
        public static JumpCloudApiSdkV2.Models.IAdministrator FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new Administrator(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="Administrator" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Administrator" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._enableMultiFactor ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonBoolean((bool)this._enableMultiFactor) : null, "enableMultiFactor" ,container.Add );
            ...
            AddIf( null != this._registered ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode)new JumpCloudApiSdkV2.Runtime.Json.JsonBoolean((bool)this._registered) : null, "registered" ,container.Add );

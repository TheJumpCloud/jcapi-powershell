namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsSafariExtensions
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsSafariExtensions.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsSafariExtensions.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsSafariExtensions FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsSafariExtensions(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsSafariExtensions" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsSafariExtensions(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_developerId = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("developer_id"), out var __jsonDeveloperId) ? (string)__jsonDeveloperId : (string)DeveloperId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsSafariExtensions" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsSafariExtensions" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._developerId)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._developerId.ToString()) : null, "developer_id" ,container.Add );

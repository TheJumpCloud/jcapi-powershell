namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class ActiveDirectoryAgentGetOutput
    {
        ...
        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="ActiveDirectoryAgentGetOutput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ActiveDirectoryAgentGetOutput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_connectKey = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("connectKey"), out var __jsonConnectKey) ? (string)__jsonConnectKey : (string)ConnectKey;}
            {_contactAt = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("contactAt"), out var __jsonContactAt) ? (string)__jsonContactAt : (string)ContactAt;}
            ...
            {_sourceIP = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("source_ip"), out var __jsonSourceIP) ? (string)__jsonSourceIP : (string)SourceIP;}
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IActiveDirectoryAgentGetOutput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.IActiveDirectoryAgentGetOutput.</returns>
        public static JumpCloudApiSdkV2.Models.IActiveDirectoryAgentGetOutput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new ActiveDirectoryAgentGetOutput(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ActiveDirectoryAgentGetOutput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ActiveDirectoryAgentGetOutput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._connectKey)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._connectKey.ToString()) : null, "connectKey" ,container.Add );
            AddIf( null != (((object)this._contactAt)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._contactAt.ToString()) : null, "contactAt" ,container.Add );
            ...
            AddIf( null != (((object)this._sourceIP)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._sourceIP.ToString()) : null, "source_ip" ,container.Add );

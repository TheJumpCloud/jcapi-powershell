namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SystemInsightsGroups
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISystemInsightsGroups.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISystemInsightsGroups.</returns>
        public static JumpCloudApiSdkV2.Models.ISystemInsightsGroups FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SystemInsightsGroups(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsGroups" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsGroups(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_comment = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("comment"), out var __jsonComment) ? (string)__jsonComment : (string)Comment;}
            ...
            {_groupSid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("group_sid"), out var __jsonGroupSid) ? (string)__jsonGroupSid : (string)GroupSid;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsGroups" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsGroups" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._comment)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._comment.ToString()) : null, "comment" ,container.Add );
            ...
            AddIf( null != (((object)this._groupSid)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._groupSid.ToString()) : null, "group_sid" ,container.Add );

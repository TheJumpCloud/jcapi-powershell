namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class SambaDomainInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.ISambaDomainInput.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloudApiSdkV2.Models.ISambaDomainInput.</returns>
        public static JumpCloudApiSdkV2.Models.ISambaDomainInput FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new SambaDomainInput(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="SambaDomainInput" />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SambaDomainInput(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {
            ...
            {_sid = If( json?.PropertyT<JumpCloudApiSdkV2.Runtime.Json.JsonString>("sid"), out var __jsonSid) ? (string)__jsonSid : (string)Sid;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="SambaDomainInput" /> into a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SambaDomainInput" /> as a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloudApiSdkV2.Runtime.Json.JsonNode ToJson(JumpCloudApiSdkV2.Runtime.Json.JsonObject container, JumpCloudApiSdkV2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._sid)?.ToString()) ? (JumpCloudApiSdkV2.Runtime.Json.JsonNode) new JumpCloudApiSdkV2.Runtime.Json.JsonString(this._sid.ToString()) : null, "sid" ,container.Add );

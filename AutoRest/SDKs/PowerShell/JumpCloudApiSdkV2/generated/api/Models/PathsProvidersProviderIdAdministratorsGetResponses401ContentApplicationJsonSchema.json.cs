namespace JumpCloudApiSdkV2.Models
{
    ...
    public partial class PathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode"/> into an instance of JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloudApiSdkV2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema.
        /// </returns>
        public static JumpCloudApiSdkV2.Models.IPathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema FromJson(JumpCloudApiSdkV2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloudApiSdkV2.Runtime.Json.JsonObject json ? new PathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloudApiSdkV2.Runtime.Json.JsonObject into a new instance of <see cref="PathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloudApiSdkV2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PathsProvidersProviderIdAdministratorsGetResponses401ContentApplicationJsonSchema(JumpCloudApiSdkV2.Runtime.Json.JsonObject json)
        {

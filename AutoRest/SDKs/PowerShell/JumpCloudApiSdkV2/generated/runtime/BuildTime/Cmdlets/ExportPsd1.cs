...
namespace JumpCloudApiSdkV2.Runtime.PowerShell
{
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            sb.AppendLine($@"{Indent}RootModule = '{"./JumpCloudApiSdkV2.psm1"}'");
            ...
            sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/JumpCloudApiSdkV2.private.dll"}'");
            ...
            var formatList = customFormatPs1xmlFiles.Prepend("./JumpCloudApiSdkV2.format.ps1xml").ToPsList();

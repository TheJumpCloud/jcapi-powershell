namespace JumpCloudApiSdkV2.Runtime.PowerShell
{
    ...
    {
        JumpCloudApiSdkV2.Runtime.SendAsyncStep Wrap(JumpCloudApiSdkV2.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<JumpCloudApiSdkV2.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloudApiSdkV2.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public JumpCloudApiSdkV2.Runtime.SendAsyncStep Wrap(JumpCloudApiSdkV2.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<JumpCloudApiSdkV2.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloudApiSdkV2.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);

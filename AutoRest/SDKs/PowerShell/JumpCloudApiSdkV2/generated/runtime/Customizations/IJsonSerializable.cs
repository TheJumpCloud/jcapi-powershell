...
using JumpCloudApiSdkV2.Runtime.Json;
using System;
...
namespace JumpCloudApiSdkV2.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is JumpCloudApiSdkV2.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return JumpCloudApiSdkV2.Runtime.JsonSerializable.ToJson(dictionary, null);
            }

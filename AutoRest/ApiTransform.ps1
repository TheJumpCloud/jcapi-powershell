...
$FindReplaceHash = [Ordered]@{
    ...
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/SystemGroupData"}}'                                                                                                                                                                                                                                                                                                                                                                                                                     = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/PolicyRequest"}}'                                                                                                                                                                                                                                                                                                                                                                                                                       = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/UserGroupGraphManagementReq"}}'                                                                                                                                                                                                                                                                                                                                                                                                         = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/SystemGroupGraphManagementReq"}}'                                                                                                                                                                                                                                                                                                                                                                                                       = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/SystemGroupMembersReq"}}'                                                                                                                                                                                                                                                                                                                                                                                                               = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/UserGroupMembersReq"}}'                                                                                                                                                                                                                                                                                                                                                                                                                 = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/UserGroupPost"}}'                                                                                                                                                                                                                                                                                                                                                                                                                       = '';
    # '{"name": "body", "in": "body", "schema": {"$ref": "#/definitions/workday-input"}}'                                                                                                                                                                                                                                                                                                                                                                                                                       = '';
    # '{"name": "body", "in": "body", "schema": {"type": "array", "items": {"$ref": "#/definitions/bulk-user-create"}}}'                                                                                                                                                                                                                                                                                                                                                                                        = '';
    # V1 Issues
...
$OperationIdHash = [Ordered]@{
    ...
    'DELETE_workdays-workday_id-auth'                       = 'Workday_Delete';

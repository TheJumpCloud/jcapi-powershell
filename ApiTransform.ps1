...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping  = [Ordered]@{
            ...
            'WorkflowAccessRequestApi_UserApprovalRequest' = 'WorkflowRequest_Create'
            'WorkflowAccessRequestApi_GetAllWorkflowAccessRequests' = 'WorkflowRequest_Get'
            'WorkflowAccessRequestApi_GetWorkflowAccessRequests'    = 'WorkflowApproval_Get';
            'WorkflowAccessRequestApi_CreateWorkflowAccessRequest' = 'WorkflowApproval_Create'
            'WorkflowAccessRequestApi_UpdateWorkflowAccessRequests' = 'WorkflowApproval_Set'
            'WorkflowAccessRequestApi_GetAccessRequestApprovalProgressAdminPortal' = 'WorkflowApprovalProgress_Get'

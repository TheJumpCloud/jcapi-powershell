...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        ExcludedList       = @('/applications/{application_id}', '/applications/{application_id}/logo', '/logos/{id}', '/applemdms/{apple_mdm_id}/enrollmentprofiles/{id}', '/applemdms/{apple_mdm_id}/depkey', '/applemdms/{apple_mdm_id}/csr', '/applemdms/{apple_mdm_id}/devices/{device_id}', '/applemdms/{apple_mdm_id}/devices/{device_id}/clearActivationLock')
    }
}

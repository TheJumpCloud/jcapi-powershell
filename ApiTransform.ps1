...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V1'                = [PSCustomObject]@{
        ...
        FindAndReplace      = [Ordered]@{
            ...
            # long descriptions break autorest
            '"trait:filter:filter":{"description":".*?"in":"query"'                                                                                                                                                                                                                                = '"trait:filter:filter":{"description":"A filter to apply to the query. Populate with a valid field from an endpoint response.","in":"query"'
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping  = [Ordered]@{
            ...
            # 'AccessRequestApi_CreateAccessRequest'              = 'WorkflowUserRequest_Create';
            # 'AccessRequestApi_GetAccessRequest'                 = 'WorkflowUserRequest_Get';
            # 'AccessRequestApi_UpdateAccessRequest'              = 'WorkflowUserRequest_Set';
            # 'AccessRequestApi_RevokeAccessRequest'                  = 'WorkflowUserRequest_Delete';
            'WorkflowAccessRequestApi_UserApprovalRequest'          = 'WorkflowUserApprovalRequest_Set'
            'WorkflowAccessRequestApi_GetAllWorkflowAccessRequests' = 'WorkflowAccessRequest_List'
            'WorkflowAccessRequestApi_GetWorkflowAccessRequests'    = 'WorkflowAccessRequest_Get';
            # 'WorkflowAccessRequestApi_CreateWorkflowAccessRequest'  = 'WorkflowAccessRequest_Create' # unsure how this endpoint works/ removing from CUT-4022
            'WorkflowAccessRequestApi_UpdateWorkflowAccessRequests' = 'WorkflowAccessRequest_Set'
            'WorkflowAccessRequestApi_GetAccessRequestApprovalProgressAdminPortal' = 'WorkflowAccessRequestProgress_Get'
            'AccessWorkflowApi_GetAllAccessWorkFlows' = 'Workflow_List'
            'AccessWorkflowApi_CreateAccessWorkflow' = 'Workflow_Create'
            'AccessWorkflowApi_DeleteAccessWorkflow' = 'Workflow_Delete'

...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V1'                = [PSCustomObject]@{
        ...
        OperationIdMapping = [Ordered]@{
            ...
            'PUT_applications-id'                             = 'Update-Application';
            ...
            'PUT_commands-id'                                 = 'Update-Command';
            ...
            'PUT_organizations-id'                            = 'Update-Organization';
            ...
            'PUT_radiusservers-id'                            = 'Update-RadiusServer';
            ...
            'PUT_systemusers-id'                              = 'Update-SystemUser';
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping = [Ordered]@{
            ...
            'GET_applications-application_id-users'                      = 'Get-ApplicationTraverseSystemUser';
            ...
            'POST_bulk-users'                                            = 'Create-BulkSystemUser';
            'PATCH_bulk-users'                                           = 'Update-BulkSystemUser';
            'GET_bulk-users-job_id-results'                              = 'Get-BulkSystemUserResult';
            ...
            'PUT_customemails-custom_email_type'                         = 'Update-CustomEmailConfiguration';
            ...
            'PUT_duo-accounts-account_id-applications-application_id'    = 'Update-DuoApplication';
            ...
            'PUT_ldapservers-ldapserver_id-sambadomains-id'              = 'Update-LdapServerSambaDomain';
            'GET_ldapservers-ldapserver_id-users'                        = 'Get-LdapServerTraverseSystemUser';
            ...
            'GET_office365s-office365_id-users'                          = 'Get-Office365TraverseSystemUser';
            ...
            'GET_radiusservers-radiusserver_id-users'                    = 'Get-RadiusServerTraverseSystemUser';
            ...
            'PUT_systemgroups-id'                                        = 'Update-SystemGroup';
            ...
            'GET_systemgroups-group_id-users'                            = 'Get-SystemGroupTraverseSystemUser';
            ...
            'GET_systems-system_id-users'                                = 'Get-SystemTraverseSystemUser';
            'GET_systems-system_id-usergroups'                           = 'Get-SystemTraverseUserGroup';
            'GET_users-user_id-associations'                             = 'Get-SystemUserAssociation';
            'POST_users-user_id-associations'                            = 'Set-SystemUserAssociation';
            'GET_users-user_id-memberof'                                 = 'Get-SystemUserMemberOf';
            'GET_users-user_id-applications'                             = 'Get-SystemUserTraverseApplication';
            'GET_users-user_id-directories'                              = 'Get-SystemUserTraverseDirectory';
            'GET_users-user_id-gsuites'                                  = 'Get-SystemUserTraverseGSuite';
            'GET_users-user_id-ldapservers'                              = 'Get-SystemUserTraverseLdapServer';
            'GET_users-user_id-office365s'                               = 'Get-SystemUserTraverseOffice365';
            'GET_users-user_id-radiusservers'                            = 'Get-SystemUserTraverseRadiusServer';
            'GET_users-user_id-systems'                                  = 'Get-SystemUserTraverseSystem';
            'GET_users-user_id-systemgroups'                             = 'Get-SystemUserTraverseSystemGroup';
            ...
            'PUT_usergroups-id'                                          = 'Update-UserGroup';
            ...
            'PUT_workdays-id'                                            = 'Update-Workday';

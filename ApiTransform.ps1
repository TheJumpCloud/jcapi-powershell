...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V1'                = [PSCustomObject]@{
        ...
        ExcludedList       = @('/systemusers/{systemuser_id}/sshkeys/{id}', '/systemusers/{id}/unlock', '/systemusers/{id}/resetmfa', '/systemusers/{id}/expire');
    }
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping = [Ordered]@{
            ...
            'connectwise_deleteConfiguration'                   = 'ConnectwiseConfigurationDelete_'
            'connectwise_updateConfiguration'                   = 'ConnectwiseConfiguration_Update'
        };

...
$OperationIdMapping = [Ordered]@{
    ...
    'JumpCloud.SDK.V2'                = [Ordered]@{
        ...
        'POST_applemdms-apple_mdm_id-devices-device_id-erase'        = 'Erase-AppleMDMDevice';
        ...
        'GET_systeminsights-certificates'                            = 'List-Certificates';
        ...
        'GET_systeminsights-cups_destinations'                       = 'List-CupsDestinations';
        ...
        'GET_systeminsights-interface_details'                       = 'List-InterfaceDetails';
        ...
        'GET_systeminsights-python_packages'                         = 'List-PythonPackages';
        ...
        'GET_systeminsights-scheduled_tasks'                         = 'List-ScheduledTasks';
        'GET_systeminsights-services'                                = 'List-Services';
        'GET_systeminsights-startup_items'                           = 'List-StartupItems';
        ...
        # 'GET_systeminsights-registry'                                = 'List-SystemInsightsRegistry';

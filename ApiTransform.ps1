...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping = [Ordered]@{
            ...
            'groups_policy_delete'                              = 'Delete-PolicyGroup';
            ...
            'groups_policy_get'                                 = 'Get-PolicyGroup';
            ...
            'groups_policy_list'                                = 'List-PolicyGroup';
            ...
            'groups_policy_post'                                = 'New-PolicyGroup';
            ...
            'groups_policy_put'                                 = 'Set-PolicyGroup';

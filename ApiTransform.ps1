...
$TransformConfig = [Ordered]@{
    ...
    'JumpCloud.SDK.V2'                = [PSCustomObject]@{
        ...
        OperationIdMapping  = [Ordered]@{
            ...
            'WorkflowAccessRequestApi_UserApprovalRequest' = 'WorkflowUserApprovalRequest_Create'
            ...
            'WorkflowAccessRequestApi_CreateWorkflowAccessRequest' = 'WorkflowAccessRequest_Create'

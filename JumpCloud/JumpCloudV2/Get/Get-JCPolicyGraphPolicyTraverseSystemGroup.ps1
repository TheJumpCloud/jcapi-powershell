...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCPolicyGraphPolicyTraverseSystemGroup
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkPolicyGraphPolicyTraverseSystemGroup @PSBoundParameters

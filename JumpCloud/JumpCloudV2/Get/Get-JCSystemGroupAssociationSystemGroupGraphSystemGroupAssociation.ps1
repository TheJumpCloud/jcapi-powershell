...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupAssociation
#>
Function Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupAssociation
{
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupAssociation @PSBoundParameters

...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseSystemGroup
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseSystemGroup @PSBoundParameters

...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupTraversePolicy
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupTraversePolicy @PSBoundParameters

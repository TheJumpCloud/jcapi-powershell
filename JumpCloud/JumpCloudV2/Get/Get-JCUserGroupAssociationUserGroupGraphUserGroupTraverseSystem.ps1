...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseSystem
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseSystem @PSBoundParameters

...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCUserGroupAssociationUserGroupGraphUserGroupAssociation
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupAssociation @PSBoundParameters

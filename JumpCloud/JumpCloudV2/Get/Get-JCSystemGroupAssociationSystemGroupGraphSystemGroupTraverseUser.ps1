...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUser
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUser @PSBoundParameters

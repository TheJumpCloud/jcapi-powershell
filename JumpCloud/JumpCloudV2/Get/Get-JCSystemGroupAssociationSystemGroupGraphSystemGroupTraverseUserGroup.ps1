...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUserGroup
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkSystemGroupAssociationSystemGroupGraphSystemGroupTraverseUserGroup @PSBoundParameters

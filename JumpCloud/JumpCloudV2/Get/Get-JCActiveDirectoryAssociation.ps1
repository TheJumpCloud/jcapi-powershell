...
Function Get-JCActiveDirectoryAssociation
{
    ...
    Param(
        ...
        [Alias()][string]$ActivedirectoryId,
    ...
    Process {
        Do
        {
            ...
            $Result = Get-JcSdkActiveDirectoryAssociation @PSBoundParameters

...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCLdapServerGraphLdapServerTraverseUserGroup
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkLdapServerGraphLdapServerTraverseUserGroup @PSBoundParameters

...
.Link
https://github.com/TheJumpCloud/support/wiki/Get-JCUserGroupAssociationUserGroupGraphUserGroupTraverseDirectory
#>
    ...
    Process
    {
        If ($Paginate)
        {
            ...
            Do
            {
                ...
                $Result = Get-JcSdkUserGroupAssociationUserGroupGraphUserGroupTraverseDirectory @PSBoundParameters

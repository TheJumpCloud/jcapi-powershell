...
Function Set-JCUserGroupAssociation
{
    ...
    Param(
        ...
        [Alias()][JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReqAttributes]$Attributes,
        ...
        [Alias()][JumpCloudApiSdkV2.Models.IUserGroupGraphManagementReq]$Body,
    ...
    Process {
        $Results = Set-JcSdkUserGroupAssociation @PSBoundParameters
    }
    End {
        Return $Results
    }

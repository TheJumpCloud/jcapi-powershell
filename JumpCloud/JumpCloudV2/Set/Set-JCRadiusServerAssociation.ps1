...
Function Set-JCRadiusServerAssociation
{
    ...
    Param(
        ...
        [Alias()][JumpCloudApiSdkV2.Models.IGraphManagementReqAttributes]$Attributes,
        ...
        [Alias()][JumpCloudApiSdkV2.Models.IGraphManagementReq]$Body,
    ...
    Process {
        $Results = Set-JcSdkRadiusServerAssociation @PSBoundParameters
    }
    End {
        Return $Results
    }

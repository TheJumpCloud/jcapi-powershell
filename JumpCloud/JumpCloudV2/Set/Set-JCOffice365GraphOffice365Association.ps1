...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/support/wiki/Set-JCOffice365GraphOffice365Association
#>
Function Set-JCOffice365GraphOffice365Association
{
    ...
    Process
    {
        $Results = Set-JcSdkOffice365GraphOffice365Association @PSBoundParameters
    }
    End
    {
        Return $Results

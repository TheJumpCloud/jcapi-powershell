...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/support/wiki/Set-JCApplicationGraphApplicationAssociation
#>
Function Set-JCApplicationGraphApplicationAssociation
{
    ...
    Process
    {
        $Results = Set-JcSdkApplicationGraphApplicationAssociation @PSBoundParameters
    }
    End
    {
        Return $Results

...
### UpdateViaIdentity
```
Update-JcSdkGSuite -InputObject <IJumpCloudSdkV2Identity> -Body <IGsuitePatchInput> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-JcSdkGSuite -InputObject <IJumpCloudSdkV2Identity> [-GroupsEnabled] [-Name <String>]

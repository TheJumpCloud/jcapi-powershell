...
### SetExpanded (Default)
```
Set-JcSdkUserAssociation -UserId <String> -Id <String> -Op <String> -Type <Type4>
 [-Attributes <IGraphOperationUserAttributes>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### SetViaIdentity
```
Set-JcSdkUserAssociation -InputObject <IJumpCloudSdkV2Identity> -Body <IGraphOperationUser> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkUserAssociation -InputObject <IJumpCloudSdkV2Identity> -Id <String> -Op <String> -Type <Type4>
 [-Attributes <IGraphOperationUserAttributes>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: JumpCloud.SDK.V2.Models.IGraphOperationUserAttributes
...
ATTRIBUTES <IGraphOperationUserAttributes>: .
  - `[Sudo <IGraphAttributeSudoAutoGenerated>]`: 

...
### SetViaIdentity
```
Set-JcSdkIPList -InputObject <IJumpCloudSdkV2Identity> -Body <IIPListRequest> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkIPList -InputObject <IJumpCloudSdkV2Identity> [-Description <String>] [-Ips <String[]>]

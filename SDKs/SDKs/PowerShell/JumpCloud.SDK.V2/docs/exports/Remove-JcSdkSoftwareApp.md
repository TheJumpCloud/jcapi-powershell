...
### Delete (Default)
```
Remove-JcSdkSoftwareApp -Id <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkSoftwareApp -InputObject <IJumpCloudSdkV2Identity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

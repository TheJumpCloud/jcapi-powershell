...
### SetViaIdentity
```
Set-JcSdkSystemGroupMember -InputObject <IJumpCloudSdkV2Identity> -Body <IGraphOperationSystemGroupMember>
 [-Authorization <String>] [-Date <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkSystemGroupMember -InputObject <IJumpCloudSdkV2Identity> -Id <String> -Op <String>

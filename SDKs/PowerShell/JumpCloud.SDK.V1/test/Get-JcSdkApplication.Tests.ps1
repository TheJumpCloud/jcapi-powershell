...
Describe 'Get-JcSdkApplication' -Tag:(""){
    ...
    It 'List Filter Tests' {
        ...
        $NameEQ = Get-JcsdkApplication -Filter @("name:`$eq:$($app.Name)")
        $NameEQ | Should -Not -BeNullOrEmpty
        $NameNE = Get-JcsdkApplication -Filter @("name:`$ne:$($app.Name)")
        $nameNE  | Should -Not -BeNullOrEmpty
        $nameNE | Should -Not -Contain $NameEQ
        # Multiple Filter Conditions
        Get-JcsdkApplication -Filter @("name:`$eq:$($app.Name)", "_id:`$eq:$($app.Id)") | Should -Not -BeNullOrEmpty
        Get-JcsdkApplication -Filter @("name:`$eq:$($app.Name)", "_id:`$eq:$($app.Organization)") | Should -BeNullOrEmpty
    }

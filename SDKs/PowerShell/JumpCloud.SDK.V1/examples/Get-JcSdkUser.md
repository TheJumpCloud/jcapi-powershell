...
This function will return a list of all Users. Search, and Sort are optional parameters.

### Example 2: Get an User by Id
```powershell
...
This function will Get an User by Id. Id is a required parameter.

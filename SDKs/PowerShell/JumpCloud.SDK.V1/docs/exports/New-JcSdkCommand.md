...
```
New-JcSdkCommand -ConsoleHost <String> [-AiGenerated] [-Command <String>] [-CommandRunners <String[]>]
...
### Create
```
New-JcSdkCommand -ConsoleHost <String> -Body <ICommand> [-Confirm] [-WhatIf] [<CommonParameters>]
```

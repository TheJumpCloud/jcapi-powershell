...
```
New-JcSdkRadiusServer -ConsoleHost <String> [-AuthIdp <String>] [-CaCert <String>] [-DeviceCertEnabled]
...
### Create
```
New-JcSdkRadiusServer -ConsoleHost <String> -Body <IRadiusserverpost> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

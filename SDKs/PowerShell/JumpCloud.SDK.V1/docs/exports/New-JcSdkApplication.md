...
```
New-JcSdkApplication -ConsoleHost <String> [-Active] [-Beta] [-Color <String>] [-Config <IApplicationConfig>]
...
### Create
```
New-JcSdkApplication -ConsoleHost <String> -Body <IApplication> [-Confirm] [-WhatIf] [<CommonParameters>]
```

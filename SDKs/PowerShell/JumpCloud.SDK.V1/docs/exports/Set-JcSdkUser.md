...
### Set
```
Set-JcSdkUser -ConsoleHost <String> -Id <String> -Body <ISystemuserput> [-FullValidationDetails <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Body <ISystemuserput>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Set-JcSdkUser -Id:(<string>) -Body:(<JumpCloud.SDK.V1.Models.Systemuserput>)
```

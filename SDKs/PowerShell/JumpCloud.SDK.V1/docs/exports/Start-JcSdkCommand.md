...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Start-JcSdkCommand.md
schema: 2.0.0
---
...
### RunExpanded (Default)
```
Start-JcSdkCommand -HostEnv <String> [-Id <String>] [-SystemIds <String[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Run
```
Start-JcSdkCommand -HostEnv <String> -Body <IPathsPnxbyeRuncommandPostRequestbodyContentApplicationJsonSchema>

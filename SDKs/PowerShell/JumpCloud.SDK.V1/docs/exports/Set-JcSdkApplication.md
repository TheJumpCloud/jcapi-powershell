...
### SetExpanded (Default)
```
Set-JcSdkApplication -ConsoleHost <String> -Id <String> [-Active] [-Beta] [-Color <String>]
...
### Set
```
Set-JcSdkApplication -ConsoleHost <String> -Id <String> -Body <IApplication> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkApplication -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Body <IApplication>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkApplication -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Id <String>] [-Active]
 [-Beta] [-Color <String>] [-Config <IApplicationConfig>] [-Created <String>]
 [-DatabaseAttributes <IApplicationDatabaseAttributesItem[]>] [-Description <String>] [-DisplayLabel <String>]

...
### Stop (Default)
```
Stop-JcSdkSystem -ConsoleHost <String> -SystemId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### StopViaIdentity
```
Stop-JcSdkSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

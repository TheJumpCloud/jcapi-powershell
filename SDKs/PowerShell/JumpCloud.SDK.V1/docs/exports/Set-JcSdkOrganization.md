...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Set-JcSdkOrganization.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkOrganization -HostEnv <String> -Id <String> [-Settings <IOrganizationsettingsput>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkOrganization -HostEnv <String> -Id <String>
...
### SetViaIdentity
```
Set-JcSdkOrganization -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IPaths1Vyp8HsOrganizationsIdPutRequestbodyContentApplicationJsonSchema> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

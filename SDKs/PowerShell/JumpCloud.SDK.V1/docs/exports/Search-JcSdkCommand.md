...
```
Search-JcSdkCommand -ConsoleHost <String> [-Fields <String>] [-Filter <Hashtable>] [-SearchFilter <Hashtable>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Search
```
Search-JcSdkCommand -ConsoleHost <String> -Body <ISearch> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Lock (Default)
```
Lock-JcSdkSystem -ConsoleHost <String> -SystemId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### LockViaIdentity
```
Lock-JcSdkSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Delete (Default)
```
Remove-JcSdkApplication -ConsoleHost <String> -Id <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkApplication -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

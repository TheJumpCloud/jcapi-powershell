...
### List (Default)
```
Get-JcSdkUser -ConsoleHost <String> [-Fields <String>] [-Filter <List<String>>] [-Search <String>]
 [-Sort <String>] [<CommonParameters>]
```

### Get
```
Get-JcSdkUser -ConsoleHost <String> -Id <String> [-Fields <String>] [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Fields <String>]

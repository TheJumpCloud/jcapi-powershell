...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Get-JcSdkApplicationTemplate.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkApplicationTemplate -HostEnv <String> [-Fields <String>] [-Filter <List<String>>] [-Sort <String>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkApplicationTemplate -HostEnv <String> -Id <String> [-Fields <String>] [-Filter <List<String>>]
 [-Sort <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationTemplate -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Fields <String>]

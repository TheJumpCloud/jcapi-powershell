...
### List (Default)
```
Get-JcSdkOrganization -ConsoleHost <String> [-Fields <String>] [-Filter <List<String>>] [-Search <String>]
 [-Sort <String>] [-SortIgnoreCase <String>] [<CommonParameters>]
```

### Get
```
Get-JcSdkOrganization -ConsoleHost <String> -Id <String> [-Fields <String>] [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOrganization -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Fields <String>]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Remove-JcSdkRadiusServer.md
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-JcSdkRadiusServer -InputObject <IJumpCloudSdkV1Identity> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### Get (Default)
```
Get-JcSdkUserTotp -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTotp -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

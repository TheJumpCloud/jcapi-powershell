...
### Post (Default)
```
Invoke-JcSdkCommandTrigger -ConsoleHost <String> -Triggername <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-JcSdkCommandTrigger -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

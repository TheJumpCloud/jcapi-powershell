...
### Delete (Default)
```
Remove-JcSdkUserSshKey -ConsoleHost <String> -Id <String> -SystemuserId <String> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkUserSshKey -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

...
```
Search-JcSdkOrganization -ConsoleHost <String> [-Fields <String>] [-Filter <Hashtable>]
 [-SearchFilter <Hashtable>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Search
```
Search-JcSdkOrganization -ConsoleHost <String> -Body <ISearch> [-Confirm] [-WhatIf] [<CommonParameters>]
```

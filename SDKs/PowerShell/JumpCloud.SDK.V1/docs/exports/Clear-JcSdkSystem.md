...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Clear-JcSdkSystem.md
schema: 2.0.0
---
...
### Clear (Default)
```
Clear-JcSdkSystem -HostEnv <String> -SystemId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ClearViaIdentity
```
Clear-JcSdkSystem -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Clear (Default)
```
Clear-JcSdkSystem -ConsoleHost <String> -SystemId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ClearViaIdentity
```
Clear-JcSdkSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

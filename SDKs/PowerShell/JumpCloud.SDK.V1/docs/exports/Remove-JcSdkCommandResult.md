...
### Delete (Default)
```
Remove-JcSdkCommandResult -ConsoleHost <String> -Id <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkCommandResult -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

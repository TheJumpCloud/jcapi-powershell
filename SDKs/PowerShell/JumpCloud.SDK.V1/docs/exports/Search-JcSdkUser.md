...
```
Search-JcSdkUser -ConsoleHost <String> [-Fields <String>] [-Filter <Hashtable>] [-SearchFilter <Hashtable>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Search
```
Search-JcSdkUser -ConsoleHost <String> -Body <ISearch> [-Confirm] [-WhatIf] [<CommonParameters>]
```

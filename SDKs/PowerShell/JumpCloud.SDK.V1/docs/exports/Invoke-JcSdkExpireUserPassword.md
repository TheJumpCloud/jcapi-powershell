...
### Post (Default)
```
Invoke-JcSdkExpireUserPassword -ConsoleHost <String> -Id <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-JcSdkExpireUserPassword -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Get-JcSdkCommandResult.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkCommandResult -HostEnv <String> [-Fields <String>] [-Sort <String>] [<CommonParameters>]
```

### Get
```
Get-JcSdkCommandResult -HostEnv <String> -Id <String> [-Fields <String>] [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandResult -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Fields <String>]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Get-JcSdkCommand.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkCommand -HostEnv <String> [-Fields <String>] [-Filter <List<String>>] [-Sort <String>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkCommand -HostEnv <String> -Id <String> [-Fields <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommand -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Fields <String>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Restart-JcSdkSystem.md
schema: 2.0.0
---
...
### Restart (Default)
```
Restart-JcSdkSystem -HostEnv <String> -SystemId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-JcSdkSystem -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
### Restart (Default)
```
Restart-JcSdkSystem -SystemId <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-JcSdkSystem -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
```
Search-JcSdkSystem -ConsoleHost <String> [-Fields <String>] [-Filter <Hashtable>] [-SearchFilter <Hashtable>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Search
```
Search-JcSdkSystem -ConsoleHost <String> -Body <ISearch> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Search-JcSdkSystem.md
schema: 2.0.0
---
...
```
Search-JcSdkSystem -HostEnv <String> [-Fields <String>] [-Filter <Hashtable>] [-SearchFilter <Hashtable>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Search
```
Search-JcSdkSystem -HostEnv <String> -Body <ISearch> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Search-JcSdkSystem -Body:(<JumpCloud.SDK.V1.Models.Search>)
```
...
### -------------------------- EXAMPLE 2 --------------------------
```powershell
Search-JcSdkSystem -Fields:(<string>) -Filter:(<hashtable>) -SearchFilter:(<hashtable>)
```

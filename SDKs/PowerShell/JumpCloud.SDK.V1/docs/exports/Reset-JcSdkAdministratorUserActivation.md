...
### Reset (Default)
```
Reset-JcSdkAdministratorUserActivation -Id <String> [-PassThru] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-JcSdkAdministratorUserActivation -InputObject <IJumpCloudApiIdentity> [-PassThru] [<CommonParameters>]
```

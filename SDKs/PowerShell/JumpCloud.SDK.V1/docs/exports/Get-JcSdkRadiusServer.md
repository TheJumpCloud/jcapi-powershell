...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Get-JcSdkRadiusServer.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkRadiusServer -HostEnv <String> [-Fields <String>] [-Filter <List<String>>] [-Sort <String>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkRadiusServer -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServer -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

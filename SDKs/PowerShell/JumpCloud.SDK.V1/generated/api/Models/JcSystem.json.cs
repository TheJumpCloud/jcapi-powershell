...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class JcSystem
    {
        ...
        internal JcSystem(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_mdm = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("mdm"), out var __jsonMdm) ? JumpCloud.SDK.V1.Models.JcSystemMdm.FromJson(__jsonMdm) : Mdm;}
        ...
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._mdm ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._mdm.ToJson(null,serializationMode) : null, "mdm" ,container.Add );

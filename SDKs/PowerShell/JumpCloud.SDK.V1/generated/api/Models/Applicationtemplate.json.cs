...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Applicationtemplate
    {
        ...
        internal Applicationtemplate(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
            ...
            {_logo = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonObject>("logo"), out var __jsonLogo) ? JumpCloud.SDK.V1.Models.ApplicationtemplateLogo.FromJson(__jsonLogo) : Logo;}
            ...
            {_keywords = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonArray>("keywords"), out var __jsonKeywords) ? If( __jsonKeywords as JumpCloud.SDK.V1.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is JumpCloud.SDK.V1.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : Keywords;}
            ...
            {_test = If( json?.PropertyT<JumpCloud.SDK.V1.Runtime.Json.JsonString>("test"), out var __jsonTest) ? (string)__jsonTest : (string)Test;}
        ...
        public JumpCloud.SDK.V1.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V1.Runtime.Json.JsonObject container, JumpCloud.SDK.V1.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._logo ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) this._logo.ToJson(null,serializationMode) : null, "logo" ,container.Add );
            ...
            if (null != this._keywords)
            {
                ...
                foreach( var __x in this._keywords )
                {
            ...
            AddIf( null != (((object)this._test)?.ToString()) ? (JumpCloud.SDK.V1.Runtime.Json.JsonNode) new JumpCloud.SDK.V1.Runtime.Json.JsonString(this._test.ToString()) : null, "test" ,container.Add );

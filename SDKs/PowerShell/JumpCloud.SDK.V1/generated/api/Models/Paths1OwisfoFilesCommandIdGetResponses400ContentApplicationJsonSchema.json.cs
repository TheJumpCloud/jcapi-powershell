...
namespace JumpCloud.SDK.V1.Models
{
    ...
    public partial class Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V1.Models.IPaths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V1.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V1.Models.IPaths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema.
        /// </returns>
        public static JumpCloud.SDK.V1.Models.IPaths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema FromJson(JumpCloud.SDK.V1.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V1.Runtime.Json.JsonObject json ? new Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V1.Runtime.Json.JsonObject into a new instance of <see cref="Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V1.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema(JumpCloud.SDK.V1.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema" /> into
        ...
        /// <returns>
        /// a serialized instance of <see cref="Paths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema" /> as a <see

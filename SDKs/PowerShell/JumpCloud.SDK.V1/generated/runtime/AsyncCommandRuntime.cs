...
namespace JumpCloud.SDK.V1.Runtime.PowerShell
{
    ...
    {
        JumpCloud.SDK.V1.Runtime.SendAsyncStep Wrap(JumpCloud.SDK.V1.Runtime.SendAsyncStep func);
        System.Collections.Generic.IEnumerable<JumpCloud.SDK.V1.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloud.SDK.V1.Runtime.SendAsyncStep> funcs);
    ...
    public class AsyncCommandRuntime : System.Management.Automation.ICommandRuntime2, IAsyncCommandRuntimeExtensions, System.IDisposable
    {
        ...
        public JumpCloud.SDK.V1.Runtime.SendAsyncStep Wrap(JumpCloud.SDK.V1.Runtime.SendAsyncStep func) => func.Target.GetType().Name != "Closure" ? func : (p1, p2, p3) => ExecuteSync<System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>>(() => func(p1, p2, p3));
        public System.Collections.Generic.IEnumerable<JumpCloud.SDK.V1.Runtime.SendAsyncStep> Wrap(System.Collections.Generic.IEnumerable<JumpCloud.SDK.V1.Runtime.SendAsyncStep> funcs) => funcs?.Select(Wrap);

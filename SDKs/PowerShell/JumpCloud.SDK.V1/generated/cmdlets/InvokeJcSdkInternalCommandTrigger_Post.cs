...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] POST-CommandTrigger=>POST:"/command/trigger/{triggername}"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V1.json#/paths/~1command~1trigger~1{triggername}'
    /// [DETAILS]
    /// verb: Invoke
    /// subjectPrefix:
    /// subject: CommandTrigger
    /// variant: Post
    /// </remarks>
    [global::JumpCloud.SDK.V1.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"JcSdkInternalCommandTrigger_Post", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to launch a command based on a defined trigger.\n\n#### Sample Requests\n\n**Launch a Command via a Trigger**\n\n```\ncurl --silent \\\n     -X 'POST' \\\n     -H \""x-api-key: {API_KEY}\"" \\\n     \""https://console.jumpcloud.com/api/command/trigger/{TriggerName}\""\n```\n**Launch a Command via a Trigger passing a JSON object to the command**\n```\ncurl --silent \\\n     -X 'POST' \\\n     -H \""x-api-key: {API_KEY}\"" \\\n     -H 'Accept: application/json' \\\n     -H 'Content-Type: application/json' \\\n     -d '{ \""srcip\"":\""192.168.2.32\"", \""attack\"":\""Cross Site Scripting Attempt\"" }' \\\n     \""https://console.jumpcloud.com/api/command/trigger/{TriggerName}\""\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class InvokeJcSdkInternalCommandTrigger_Post : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        /// <param name="response">the body result as a <see cref="JumpCloud.SDK.V1.Models.ITriggerreturn" /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V1.Models.ITriggerreturn> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeJcSdkInternalCommandTrigger_Post" /> cmdlet class.
        /// </summary>
        public InvokeJcSdkInternalCommandTrigger_Post()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PostCommandTrigger' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PostCommandTrigger(Triggername, onOk, onUnauthorized, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Triggername=Triggername})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<JumpCloud.SDK.V1.Models.ITriggerreturn> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // nested-array / triggered / <none>
                WriteObject((await response).Triggered, true);
            }
        }

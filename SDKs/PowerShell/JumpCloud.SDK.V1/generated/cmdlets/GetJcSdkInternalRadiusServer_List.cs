...
namespace JumpCloud.SDK.V1.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalRadiusServer_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V1.Models.IRadiusserverslist))]
    [global::JumpCloud.SDK.V1.Description(@"This endpoint allows you to get a list of all RADIUS servers in your organization.\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/radiusservers/ \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n```")]
    [global::JumpCloud.SDK.V1.Generated]
    public partial class GetJcSdkInternalRadiusServer_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V1.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalRadiusServer_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkInternalRadiusServer_List()
        {

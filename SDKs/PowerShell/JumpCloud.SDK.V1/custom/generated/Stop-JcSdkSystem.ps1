...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [Triggername <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Stop-JcSdkSystem.md
#>
 Function Stop-JcSdkSystem
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V1.internal\Stop-JcSdkInternalSystem @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
{
    [OutputType([JumpCloud.SDK.V1.Models.ISshkeylist], [JumpCloud.SDK.V1.Models.IAny])]
    ...
    Process
    {
        $Results = JumpCloud.SDK.V1.internal\New-JcSdkInternalUserSshKey @PSBoundParameters
    }
    End
    {

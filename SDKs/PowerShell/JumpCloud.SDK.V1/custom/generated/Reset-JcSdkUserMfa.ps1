...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [Triggername <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Reset-JcSdkUserMfa.md
#>
 Function Reset-JcSdkUserMfa
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V1.internal\Reset-JcSdkInternalUserMfa @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
.Outputs
JumpCloud.SDK.V1.Models.ICommandFileGetApplicationJsonResponse
.Outputs
...
{
    [OutputType([JumpCloud.SDK.V1.Models.ICommandFileGetApplicationJsonResponse], [JumpCloud.SDK.V1.Models.IPaths1OwisfoFilesCommandIdGetResponses400ContentApplicationJsonSchema])]

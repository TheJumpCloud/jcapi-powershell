...
.Outputs
JumpCloud.SDK.V1.Models.IOrganizationGetResponse
.Outputs
JumpCloud.SDK.V1.Models.IOrganizationListResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V1.Models.IOrganizationGetResponse], [JumpCloud.SDK.V1.Models.IOrganizationListResponse])]

...
.Outputs
JumpCloud.SDK.V1.Models.ISystemDeleteApplicationJsonResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V1.Models.ISystemDeleteApplicationJsonResponse])]
    ...
    Process
    {
        $Results = (JumpCloud.SDK.V1.internal\Remove-JcSdkInternalSystem @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
    }
    End
    {

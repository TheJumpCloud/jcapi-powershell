...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [Triggername <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Remove-JcSdkRadiusServer.md
#>
 Function Remove-JcSdkRadiusServer
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V1.internal\Remove-JcSdkInternalRadiusServer @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

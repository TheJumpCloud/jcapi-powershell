...
.Outputs
JumpCloud.SDK.V1.Models.IRadiusServerGetApplicationJsonResponse
.Outputs
JumpCloud.SDK.V1.Models.IRadiusServerListApplicationJsonResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V1.Models.IRadiusServerGetApplicationJsonResponse], [JumpCloud.SDK.V1.Models.IRadiusServerListApplicationJsonResponse])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V1.internal\Get-JcSdkInternalRadiusServer @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

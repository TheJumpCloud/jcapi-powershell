...
{
    [OutputType([JumpCloud.SDK.V1.Models.IPathsXbrw3SRadiusserversIdGetResponses200ContentApplicationJsonSchema], [JumpCloud.SDK.V1.Models.IPaths1Eil0UaRadiusserversGetResponses200ContentApplicationJsonSchema])]

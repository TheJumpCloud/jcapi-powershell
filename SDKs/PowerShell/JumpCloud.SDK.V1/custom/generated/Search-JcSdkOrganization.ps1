...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Search-JcSdkOrganization.md
#>
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('SearchExpanded')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    $Result = JumpCloud.SDK.V1.internal\Search-JcSdkInternalOrganization @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
                    If ($sdkError){

...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [Triggername <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Remove-JcSdkCommandResult.md
#>
 Function Remove-JcSdkCommandResult
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V1.internal\Remove-JcSdkInternalCommandResult @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [Triggername <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/Lock-JcSdkSystem.md
#>
 Function Lock-JcSdkSystem
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            try {
                $Results = JumpCloud.SDK.V1.internal\Lock-JcSdkInternalSystem @PSBoundParameters -errorAction SilentlyContinue
                break retryLoop
            } catch {

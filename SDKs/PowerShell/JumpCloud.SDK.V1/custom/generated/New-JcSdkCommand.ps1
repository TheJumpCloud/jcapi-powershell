...
FILESS3 <IFilesS3[]>:
  ...
  Sha256 <String>: The SHA256 hash of the file.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V1/docs/exports/New-JcSdkCommand.md
#>

if(($null -eq $TestName) -or ($TestName -contains 'Get-JcSdkWorkflow'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Get-JcSdkWorkflow.Recording.json'
...
Describe 'Get-JcSdkWorkflow' {
    It 'List' {
        { Get-JcSdkWorkflow } | Should -Not -Throw
    }
    ...
    It 'Get' {
        ...
        Get-JcSdkWorkflow -ApprovalFlowId $workflow.Id | Should -Not -BeNullOrEmpty

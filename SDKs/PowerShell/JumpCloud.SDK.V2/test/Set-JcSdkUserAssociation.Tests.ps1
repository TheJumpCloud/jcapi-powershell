...
Describe 'Set-JcSdkUserAssociation' -Tag:(""){
    It 'SetExpanded' {
        ...
        {Set-JcSdkUserAssociation -UserId $user.Id -Op 'add' -Type 'ldap_server' -id $global:PesterTestLdapServer.Id} | Should -Not -Throw
        {Set-JcSdkUserAssociation -UserId $user.Id -Op 'remove' -Type 'ldap_server' -id $global:PesterTestLdapServer.Id} | Should -Not -Throw

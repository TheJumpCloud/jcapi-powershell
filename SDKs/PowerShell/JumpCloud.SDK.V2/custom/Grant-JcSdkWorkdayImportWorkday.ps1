...
INPUTOBJECT <IJumpCloudApIsIdentity>: 
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Grant-JcSdkWorkdayImportWorkday.md
#>
 Function Grant-JcSdkWorkdayImportWorkday
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Grant-JcSdkInternalWorkdayImportWorkday @PSBoundParameters
    }
    End
    {
        Return $Results

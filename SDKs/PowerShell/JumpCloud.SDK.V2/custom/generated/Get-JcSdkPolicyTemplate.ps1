...
.Outputs
JumpCloud.SDK.V2.Models.IPolicyTemplateGetResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPolicyTemplateGetResponse], [JumpCloud.SDK.V2.Models.IPaths1Pt2HgfPolicytemplatesGetResponses200ContentApplicationJsonSchemaItems], [JumpCloud.SDK.V2.Models.IError])]

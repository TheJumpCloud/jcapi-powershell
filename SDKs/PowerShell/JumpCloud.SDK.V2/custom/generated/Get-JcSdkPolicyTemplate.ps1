...
.Outputs
JumpCloud.SDK.V2.Models.IPolicyTemplateGetApplicationJsonResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPolicyTemplateGetApplicationJsonResponse], [JumpCloud.SDK.V2.Models.IPaths1Pt2HgfPolicytemplatesGetResponses200ContentApplicationJsonSchemaItems], [JumpCloud.SDK.V2.Models.IError])]

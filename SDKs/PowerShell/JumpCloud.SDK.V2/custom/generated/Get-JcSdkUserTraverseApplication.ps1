...
.Outputs
JumpCloud.SDK.V2.Models.IPathsJn7Q7UsersUserIdApplicationsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseApplication.md
#>
 Function Get-JcSdkUserTraverseApplication
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsJn7Q7UsersUserIdApplicationsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserTraverseApplication @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

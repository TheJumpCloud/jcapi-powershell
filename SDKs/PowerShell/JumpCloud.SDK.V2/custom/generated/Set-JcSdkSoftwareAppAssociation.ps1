...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkSoftwareAppAssociation.md
#>
 Function Set-JcSdkSoftwareAppAssociation
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalSoftwareAppAssociation @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

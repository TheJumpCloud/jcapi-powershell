        ...
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    try {
                        $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalGsuiteUsersToImportFormatted -ErrorAction SilentlyContinue @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
                        break retryLoop
                    } catch {

    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalGsuiteUsersToImportFormatted -ErrorAction SilentlyContinue -errorVariable sdkError @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
                    If ($errVar){

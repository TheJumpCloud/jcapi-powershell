...
SLACKCONFIG <IJumpcloudIngressoSlackConfig[]>:
  [SlackResourceId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkWorkflow.md
#>
 Function New-JcSdkWorkflow
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\New-JcSdkInternalWorkflow @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

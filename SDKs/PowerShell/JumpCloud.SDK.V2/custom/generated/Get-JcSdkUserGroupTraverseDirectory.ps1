...
.Outputs
JumpCloud.SDK.V2.Models.IPaths1OspxumUsergroupsGroupIdDirectoriesGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseDirectory.md
#>
 Function Get-JcSdkUserGroupTraverseDirectory
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths1OspxumUsergroupsGroupIdDirectoriesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserGroupTraverseDirectory @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

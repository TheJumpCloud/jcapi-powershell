...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Update-JcSdkLdapServer.md
#>
 Function Update-JcSdkLdapServer
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = (JumpCloud.SDK.V2.internal\Update-JcSdkInternalLdapServer -ErrorAction SilentlyContinue -errorVariable sdkError @PSBoundParameters); if (-not [System.String]::IsNullOrEmpty($Result)) { $Result = $Result.ToJsonString() | ConvertFrom-Json };
            If ($sdkError){

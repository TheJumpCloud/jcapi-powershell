 ...
 Function Update-JcSdkLdapServer
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = (JumpCloud.SDK.V2.internal\Update-JcSdkInternalLdapServer -ErrorAction SilentlyContinue -errorVariable sdkError @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
            If ($sdkError){

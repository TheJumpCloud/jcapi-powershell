...
.Outputs
JumpCloud.SDK.V2.Models.IPaths7Spo6LdapserversLdapserverIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerTraverseUserGroup.md
#>
 Function Get-JcSdkLdapServerTraverseUserGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths7Spo6LdapserversLdapserverIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalLdapServerTraverseUserGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

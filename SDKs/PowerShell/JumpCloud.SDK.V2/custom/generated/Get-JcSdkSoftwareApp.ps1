...
{
    [OutputType([JumpCloud.SDK.V2.Models.ISoftwareAppGetApplicationJsonResponse], [System.String], [JumpCloud.SDK.V2.Models.IPaths7V9L3KSoftwareappsGetResponses200ContentApplicationJsonSchemaItems])]

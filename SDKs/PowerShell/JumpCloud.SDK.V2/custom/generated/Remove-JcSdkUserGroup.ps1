...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkUserGroup.md
#>
 Function Remove-JcSdkUserGroup
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkInternalUserGroup @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

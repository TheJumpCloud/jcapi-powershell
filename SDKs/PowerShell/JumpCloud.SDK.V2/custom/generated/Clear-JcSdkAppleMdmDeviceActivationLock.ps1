...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Clear-JcSdkAppleMdmDeviceActivationLock.md
#>
 Function Clear-JcSdkAppleMdmDeviceActivationLock
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Clear-JcSdkInternalAppleMdmDeviceActivationLock @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
BODY <IGraphOperationPolicyGroup>:
...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkPolicyGroupAssociation.md
#>
 Function Set-JcSdkPolicyGroupAssociation
{
    ...
    [Parameter(ParameterSetName='SetExpanded', Mandatory)]
    [Parameter(ParameterSetName='SetViaIdentityExpanded', Mandatory)]
    [ArgumentCompleter([JumpCloud.SDK.V2.Support.GraphOperationPolicyGroup1])]
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Support.GraphOperationPolicyGroup1]
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalPolicyGroupAssociation @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($errVar){

...
{
    [OutputType([JumpCloud.SDK.V2.Models.ISystemGroupGetResponse], [JumpCloud.SDK.V2.Models.IPaths1WkdzfcSystemgroupsGetResponses200ContentApplicationJsonSchemaItems])]

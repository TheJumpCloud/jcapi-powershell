...
.Outputs
JumpCloud.SDK.V2.Models.IGSuiteUsersToImportListApplicationJsonResponse
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IGSuiteUsersToImportListApplicationJsonResponse])]

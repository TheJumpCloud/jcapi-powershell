...
.Outputs
JumpCloud.SDK.V2.Models.IPathsBug7QiSysteminsightsSharedResourcesGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsBug7QiSysteminsightsSharedResourcesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightSharedResource @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

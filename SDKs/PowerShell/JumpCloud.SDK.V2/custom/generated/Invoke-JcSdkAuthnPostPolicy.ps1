...
TARGETRESOURCES <IAuthnPolicyResourceTarget[]>:
  [Type <Type?>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Invoke-JcSdkAuthnPostPolicy.md
#>
 Function Invoke-JcSdkAuthnPostPolicy
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Invoke-JcSdkInternalAuthnPostPolicy @PSBoundParameters
    }
    End
    {

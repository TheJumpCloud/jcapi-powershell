...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Invoke-JcSdkReclaimSoftwareAppLicense.md
#>
 Function Invoke-JcSdkReclaimSoftwareAppLicense
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Invoke-JcSdkInternalReclaimSoftwareAppLicense @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths3C9Yi3SysteminsightsWifiStatusGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths3C9Yi3SysteminsightsWifiStatusGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightWifiStatus @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

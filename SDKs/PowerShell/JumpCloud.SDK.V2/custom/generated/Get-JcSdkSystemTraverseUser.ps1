...
.Outputs
JumpCloud.SDK.V2.Models.IPaths144S8SfSystemsSystemIdUsersGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUser.md
#>
 Function Get-JcSdkSystemTraverseUser
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths144S8SfSystemsSystemIdUsersGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemTraverseUser @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

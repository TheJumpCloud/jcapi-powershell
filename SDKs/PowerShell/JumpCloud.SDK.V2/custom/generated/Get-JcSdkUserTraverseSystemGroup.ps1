...
.Outputs
JumpCloud.SDK.V2.Models.IPathsClxkfxUsersUserIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseSystemGroup.md
#>
 Function Get-JcSdkUserTraverseSystemGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsClxkfxUsersUserIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserTraverseSystemGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

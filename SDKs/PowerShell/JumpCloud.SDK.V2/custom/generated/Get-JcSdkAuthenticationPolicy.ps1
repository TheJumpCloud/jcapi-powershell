...
{
    [OutputType([JumpCloud.SDK.V2.Models.IAuthenticationPolicyGetResponse], [System.String], [JumpCloud.SDK.V2.Models.IPaths17Qpg71AuthnPoliciesGetResponses200ContentApplicationJsonSchemaItems])]

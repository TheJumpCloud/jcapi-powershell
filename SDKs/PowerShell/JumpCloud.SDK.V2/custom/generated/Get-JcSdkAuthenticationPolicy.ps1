...
.Outputs
JumpCloud.SDK.V2.Models.IAuthenticationPolicyGetApplicationJsonResponse
.Outputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkAuthenticationPolicy.md
#>
 Function Get-JcSdkAuthenticationPolicy
{
    [OutputType([JumpCloud.SDK.V2.Models.IAuthenticationPolicyGetApplicationJsonResponse], [System.String], [JumpCloud.SDK.V2.Models.IPaths17Qpg71AuthnPoliciesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalAuthenticationPolicy @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

...
.Outputs
JumpCloud.SDK.V2.Models.IPathsD9UccoSysteminsightsAppsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsD9UccoSysteminsightsAppsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightApp @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

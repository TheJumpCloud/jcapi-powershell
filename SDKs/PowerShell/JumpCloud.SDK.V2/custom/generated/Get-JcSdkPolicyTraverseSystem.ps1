...
.Outputs
JumpCloud.SDK.V2.Models.IPathsP070PrPoliciesPolicyIdSystemsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyTraverseSystem.md
#>
 Function Get-JcSdkPolicyTraverseSystem
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsP070PrPoliciesPolicyIdSystemsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalPolicyTraverseSystem @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

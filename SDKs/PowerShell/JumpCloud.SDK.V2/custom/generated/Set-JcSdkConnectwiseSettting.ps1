...
BODY <IConnectWiseSettingsPatchReq>:
...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkConnectwiseSettting.md
#>
 Function Set-JcSdkConnectwiseSettting
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalConnectwiseSettting @PSBoundParameters
    }
    End
    {

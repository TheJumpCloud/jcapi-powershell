...
.Outputs
JumpCloud.SDK.V2.Models.IPathsA76Ht5SysteminsightsScheduledTasksGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsA76Ht5SysteminsightsScheduledTasksGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightScheduledTask @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

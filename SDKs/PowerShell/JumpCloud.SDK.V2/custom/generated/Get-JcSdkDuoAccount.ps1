...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkDuoAccount.md
#>
 Function Get-JcSdkDuoAccount
{
    [OutputType([JumpCloud.SDK.V2.Models.IDuoAccountGetResponse], [JumpCloud.SDK.V2.Models.IPaths1DeihhrDuoAccountsGetResponses200ContentApplicationJsonSchemaItems])]

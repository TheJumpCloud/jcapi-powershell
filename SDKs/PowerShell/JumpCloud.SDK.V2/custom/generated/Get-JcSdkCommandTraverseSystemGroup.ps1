...
.Outputs
JumpCloud.SDK.V2.Models.IPaths141UxwrCommandsCommandIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkCommandTraverseSystemGroup.md
#>
 Function Get-JcSdkCommandTraverseSystemGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths141UxwrCommandsCommandIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalCommandTraverseSystemGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

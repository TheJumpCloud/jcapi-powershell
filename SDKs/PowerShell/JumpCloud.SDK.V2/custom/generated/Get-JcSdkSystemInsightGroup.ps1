...
.Outputs
JumpCloud.SDK.V2.Models.IPathsQmq2LjSysteminsightsGroupsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsQmq2LjSysteminsightsGroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

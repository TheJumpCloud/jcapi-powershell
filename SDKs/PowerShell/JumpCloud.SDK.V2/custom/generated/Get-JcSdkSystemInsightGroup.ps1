...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemInsightGroup.md
#>
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightGroup @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
                    If ($sdkError){

...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppStatus.md
#>
 Function Get-JcSdkSoftwareAppStatus
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsR1Xng3SoftwareappsSoftwareAppIdStatusesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSoftwareAppStatus @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

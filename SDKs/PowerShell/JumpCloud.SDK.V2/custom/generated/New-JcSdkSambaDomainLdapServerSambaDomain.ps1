...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkSambaDomainLdapServerSambaDomain.md
#>
 Function New-JcSdkSambaDomainLdapServerSambaDomain
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkInternalSambaDomainLdapServerSambaDomain @PSBoundParameters
    }
    End
    {

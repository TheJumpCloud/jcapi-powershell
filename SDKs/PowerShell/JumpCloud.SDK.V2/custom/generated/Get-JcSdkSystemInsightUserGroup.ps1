...
.Outputs
JumpCloud.SDK.V2.Models.IPathsNit072SysteminsightsUserGroupsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsNit072SysteminsightsUserGroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightUserGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

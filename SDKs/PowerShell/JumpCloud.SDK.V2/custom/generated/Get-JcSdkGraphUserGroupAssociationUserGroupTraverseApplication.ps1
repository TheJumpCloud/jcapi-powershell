...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphUserGroupAssociationUserGroupTraverseApplication.md
#>
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseApplication @PSBoundParameters

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths1NhphebSoftwareappsSoftwareAppIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppTraverseSystemGroup.md
#>
 Function Get-JcSdkSoftwareAppTraverseSystemGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths1NhphebSoftwareappsSoftwareAppIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSoftwareAppTraverseSystemGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

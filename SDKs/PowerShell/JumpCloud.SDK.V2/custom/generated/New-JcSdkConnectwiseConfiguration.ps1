...
BODY <IConnectwiseIntegrationReq>:
...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkConnectwiseConfiguration.md
#>
 Function New-JcSdkConnectwiseConfiguration
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\New-JcSdkInternalConnectwiseConfiguration @PSBoundParameters
    }
    End
    {

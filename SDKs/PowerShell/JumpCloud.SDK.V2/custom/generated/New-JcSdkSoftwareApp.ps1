...
SETTINGS <ISoftwareAppSettings[]>:
  ...
  [VersionlessDownloadUrl <Boolean?>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkSoftwareApp.md
#>
 Function New-JcSdkSoftwareApp
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\New-JcSdkInternalSoftwareApp @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

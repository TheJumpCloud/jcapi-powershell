...
CHANNELEVENTS <IJumpcloudIngressoChannelEvent[]>:
  ...
  [EventTypes <List<String>>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkApprovalFlowSetting.md
#>
 Function Set-JcSdkApprovalFlowSetting
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalApprovalFlowSetting @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

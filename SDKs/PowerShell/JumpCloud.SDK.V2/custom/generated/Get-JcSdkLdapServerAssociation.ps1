...
.Outputs
JumpCloud.SDK.V2.Models.IPaths5Vn3ToLdapserversLdapserverIdAssociationsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerAssociation.md
#>
 Function Get-JcSdkLdapServerAssociation
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths5Vn3ToLdapserversLdapserverIdAssociationsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalLdapServerAssociation @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

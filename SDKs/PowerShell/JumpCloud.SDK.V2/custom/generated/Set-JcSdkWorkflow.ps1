...
SLACKCONFIG <IJumpcloudIngressoSlackConfig[]>:
  [SlackResourceId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkWorkflow.md
#>
 Function Set-JcSdkWorkflow
{
    [OutputType([JumpCloud.SDK.V2.Models.IJumpcloudIngressoUpdateAccessWorkflowResponse])]
    ...
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Models.IJumpcloudIngressoApproverResource[]]
    # .
    ${ApproverResources}, 
    ...
    [AllowEmptyCollection()]
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Models.IJumpcloudIngressoSlackConfig[]]
    # .
    ${SlackConfig}, 
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalWorkflow @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

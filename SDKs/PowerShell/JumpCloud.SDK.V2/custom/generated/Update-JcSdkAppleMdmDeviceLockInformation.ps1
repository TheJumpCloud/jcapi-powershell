...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Update-JcSdkAppleMdmDeviceLockInformation.md
#>
 Function Update-JcSdkAppleMdmDeviceLockInformation
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Update-JcSdkInternalAppleMdmDeviceLockInformation @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

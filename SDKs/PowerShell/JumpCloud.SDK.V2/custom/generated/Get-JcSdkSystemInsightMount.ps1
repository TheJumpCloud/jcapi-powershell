...
.Outputs
JumpCloud.SDK.V2.Models.IPaths8LelrtSysteminsightsMountsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths8LelrtSysteminsightsMountsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightMount @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseUser.md
#>
 Function Get-JcSdkSystemGroupTraverseUser
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths1Dskqg3SystemgroupsGroupIdUsersGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemGroupTraverseUser @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

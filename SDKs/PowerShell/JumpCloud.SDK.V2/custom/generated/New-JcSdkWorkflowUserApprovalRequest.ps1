...
BODY <IJumpcloudIngressoUserApprovalRequest>:
  ...
  [Status <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkWorkflowUserApprovalRequest.md
#>
 Function New-JcSdkWorkflowUserApprovalRequest
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\New-JcSdkInternalWorkflowUserApprovalRequest @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

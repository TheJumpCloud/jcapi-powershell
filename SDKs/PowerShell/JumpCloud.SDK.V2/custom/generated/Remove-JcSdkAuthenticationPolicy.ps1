...
.Outputs
JumpCloud.SDK.V2.Models.IAuthenticationPolicyDeleteResponse
.Outputs
System.String
.Notes
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IAuthenticationPolicyDeleteResponse], [System.String])]
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkInternalAuthenticationPolicy @PSBoundParameters
    }
    End
    {

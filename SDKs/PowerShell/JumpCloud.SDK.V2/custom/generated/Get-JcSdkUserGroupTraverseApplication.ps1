...
.Outputs
JumpCloud.SDK.V2.Models.IPaths5D6X5RUsergroupsGroupIdApplicationsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseApplication.md
#>
 Function Get-JcSdkUserGroupTraverseApplication
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths5D6X5RUsergroupsGroupIdApplicationsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserGroupTraverseApplication @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

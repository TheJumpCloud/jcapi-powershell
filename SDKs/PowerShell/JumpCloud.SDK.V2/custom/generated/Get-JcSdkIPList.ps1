...
.Outputs
JumpCloud.SDK.V2.Models.IIPListGetApplicationJsonResponse
.Outputs
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IIPListGetApplicationJsonResponse], [System.String], [JumpCloud.SDK.V2.Models.IPathsAriiqoIplistsGetResponses200ContentApplicationJsonSchemaItems])]

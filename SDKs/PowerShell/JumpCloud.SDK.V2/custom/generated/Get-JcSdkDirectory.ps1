...
.Outputs
JumpCloud.SDK.V2.Models.IPathsVhyemnDirectoriesGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsVhyemnDirectoriesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalDirectory @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

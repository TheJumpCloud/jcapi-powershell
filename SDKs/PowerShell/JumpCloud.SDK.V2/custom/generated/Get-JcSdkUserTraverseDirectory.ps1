...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseDirectory.md
#>
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserTraverseDirectory @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
                    If ($sdkError){

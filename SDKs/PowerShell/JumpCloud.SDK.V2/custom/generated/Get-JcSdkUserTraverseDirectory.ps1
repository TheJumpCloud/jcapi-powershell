...
.Outputs
JumpCloud.SDK.V2.Models.IPaths11GjtttUsersUserIdDirectoriesGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseDirectory.md
#>
 Function Get-JcSdkUserTraverseDirectory
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths11GjtttUsersUserIdDirectoriesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserTraverseDirectory @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

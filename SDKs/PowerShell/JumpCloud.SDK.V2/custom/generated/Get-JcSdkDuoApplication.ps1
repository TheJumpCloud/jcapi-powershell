...
{
    [OutputType([JumpCloud.SDK.V2.Models.IDuoApplicationGetResponse], [System.String], [JumpCloud.SDK.V2.Models.IPaths1Oh4NhdDuoAccountsAccountIdApplicationsGetResponses200ContentApplicationJsonSchemaItems])]

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths1Kab4HaRadiusserversRadiusserverIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerTraverseUserGroup.md
#>
 Function Get-JcSdkRadiusServerTraverseUserGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths1Kab4HaRadiusserversRadiusserverIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalRadiusServerTraverseUserGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

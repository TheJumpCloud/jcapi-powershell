...
.Outputs
JumpCloud.SDK.V2.Models.IPolicyGetResponse
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicy.md
#>
 Function Get-JcSdkPolicy
{
    [OutputType([JumpCloud.SDK.V2.Models.IPolicyGetResponse], [JumpCloud.SDK.V2.Models.IPaths13XluwaPoliciesGetResponses200ContentApplicationJsonSchemaItems], [JumpCloud.SDK.V2.Models.IError])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalPolicy @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

 ...
 Function Set-JcSdkPolicyAssociation
{
    ...
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Models.IPaths1IkbmsxPoliciesPolicyIdAssociationsPostRequestbodyContentApplicationJsonSchemaPropertiesAttributes]
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalPolicyAssociation @PSBoundParameters
    }
    End
    {

 ...
 Function Set-JcSdkRadiusServerAssociation
{
    ...
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Models.IPaths11B0O8NRadiusserversRadiusserverIdAssociationsPostRequestbodyContentApplicationJsonSchemaPropertiesAttributes]

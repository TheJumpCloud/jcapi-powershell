...
.Outputs
JumpCloud.SDK.V2.Models.IPathsJl6UeeSystemgroupsGroupIdCommandsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseCommand.md
#>
 Function Get-JcSdkSystemGroupTraverseCommand
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsJl6UeeSystemgroupsGroupIdCommandsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemGroupTraverseCommand @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

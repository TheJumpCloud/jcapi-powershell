...
.Outputs
JumpCloud.SDK.V2.Models.IPathsX1W8N4WorkdaysWorkdayIdWorkersGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsX1W8N4WorkdaysWorkdayIdWorkersGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalWorkdayWorker @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

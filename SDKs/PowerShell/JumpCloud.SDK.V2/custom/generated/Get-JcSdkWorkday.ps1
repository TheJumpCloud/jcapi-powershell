...
.Outputs
JumpCloud.SDK.V2.Models.IWorkdayGetResponse
.Notes
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IWorkdayGetResponse], [JumpCloud.SDK.V2.Models.IPaths19545LgWorkdaysGetResponses200ContentApplicationJsonSchemaItems])]

...
.Outputs
JumpCloud.SDK.V2.Models.IOffice365TranslationRuleGetResponse
.Outputs
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkOffice365TranslationRule.md
#>
 Function Get-JcSdkOffice365TranslationRule
{
    [OutputType([JumpCloud.SDK.V2.Models.IOffice365TranslationRuleGetResponse], [JumpCloud.SDK.V2.Models.IPaths1T5IugnOffice365SOffice365IdTranslationrulesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalOffice365TranslationRule @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

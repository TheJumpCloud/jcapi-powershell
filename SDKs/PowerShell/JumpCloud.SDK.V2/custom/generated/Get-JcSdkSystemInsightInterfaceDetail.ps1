...
.Outputs
JumpCloud.SDK.V2.Models.IPathsR160JdSysteminsightsInterfaceDetailsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsR160JdSysteminsightsInterfaceDetailsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightInterfaceDetail @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

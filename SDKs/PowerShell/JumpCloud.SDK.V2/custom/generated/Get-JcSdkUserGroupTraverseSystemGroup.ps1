...
.Outputs
JumpCloud.SDK.V2.Models.IPathsBsan7EUsergroupsGroupIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseSystemGroup.md
#>
 Function Get-JcSdkUserGroupTraverseSystemGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsBsan7EUsergroupsGroupIdSystemgroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserGroupTraverseSystemGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

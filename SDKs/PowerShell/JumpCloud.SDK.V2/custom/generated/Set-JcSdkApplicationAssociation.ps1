...
BODY <IGraphOperationApplication1>:
 ...
 Function Set-JcSdkApplicationAssociation
{
    ...
    [Parameter(ParameterSetName='SetExpanded', Mandatory)]
    [Parameter(ParameterSetName='SetViaIdentityExpanded', Mandatory)]
    [ArgumentCompleter([JumpCloud.SDK.V2.Support.GraphOperationApplication])]
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Support.GraphOperationApplication]
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalApplicationAssociation @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($errVar){

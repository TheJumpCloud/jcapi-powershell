...
.Outputs
JumpCloud.SDK.V2.Models.IPathsUsp7A3SystemgroupsGroupIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseUserGroup.md
#>
 Function Get-JcSdkSystemGroupTraverseUserGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsUsp7A3SystemgroupsGroupIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemGroupTraverseUserGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

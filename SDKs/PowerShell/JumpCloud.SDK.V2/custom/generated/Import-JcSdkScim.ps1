...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Import-JcSdkScim.md
#>
 Function Import-JcSdkScim
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            try {
                $Results = JumpCloud.SDK.V2.internal\Import-JcSdkInternalScim @PSBoundParameters -errorAction SilentlyContinue
                break retryLoop
            } catch {

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths16Vv57CSysteminsightsKernelInfoGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths16Vv57CSysteminsightsKernelInfoGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightKernelInfo @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

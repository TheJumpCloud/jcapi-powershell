...
.Outputs
JumpCloud.SDK.V2.Models.IPaths5Ldh9OSystemsSystemIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUserGroup.md
#>
 Function Get-JcSdkSystemTraverseUserGroup
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths5Ldh9OSystemsSystemIdUsergroupsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemTraverseUserGroup @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

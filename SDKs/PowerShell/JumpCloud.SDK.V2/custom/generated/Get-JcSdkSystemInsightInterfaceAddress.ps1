...
.Outputs
JumpCloud.SDK.V2.Models.IPaths2H0IvSysteminsightsInterfaceAddressesGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths2H0IvSysteminsightsInterfaceAddressesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightInterfaceAddress @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Lock-JcSdkPost.md
#>
 Function Lock-JcSdkPost
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Lock-JcSdkInternalPost @PSBoundParameters
    }
    End
    {

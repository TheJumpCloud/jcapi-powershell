...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraversePolicy.md
#>
 Function Get-JcSdkSystemTraversePolicy
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths1Nktx8ESystemsSystemIdPoliciesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemTraversePolicy @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

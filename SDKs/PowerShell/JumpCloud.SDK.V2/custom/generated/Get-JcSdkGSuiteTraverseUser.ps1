...
.Outputs
JumpCloud.SDK.V2.Models.IPathsEiwopyGsuitesGsuiteIdUsersGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTraverseUser.md
#>
 Function Get-JcSdkGSuiteTraverseUser
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsEiwopyGsuitesGsuiteIdUsersGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalGSuiteTraverseUser @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths9XokpSysteminsightsCertificatesGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths9XokpSysteminsightsCertificatesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightCertificate @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

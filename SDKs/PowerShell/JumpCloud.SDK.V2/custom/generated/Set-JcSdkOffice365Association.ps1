...
BODY <IGraphOperationOffice3651>:
 ...
 Function Set-JcSdkOffice365Association
{
    ...
    [Parameter(ParameterSetName='SetExpanded', Mandatory)]
    [Parameter(ParameterSetName='SetViaIdentityExpanded', Mandatory)]
    [ArgumentCompleter([JumpCloud.SDK.V2.Support.GraphOperationOffice365])]
    [JumpCloud.SDK.V2.Category('Body')]
    [JumpCloud.SDK.V2.Support.GraphOperationOffice365]
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalOffice365Association @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

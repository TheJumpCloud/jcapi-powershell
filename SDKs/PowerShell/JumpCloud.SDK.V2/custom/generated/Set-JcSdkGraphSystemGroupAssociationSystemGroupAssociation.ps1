...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkGraphSystemGroupAssociationSystemGroupAssociation.md
#>
 Function Set-JcSdkGraphSystemGroupAssociationSystemGroupAssociation
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation @PSBoundParameters
    }
    End
    {

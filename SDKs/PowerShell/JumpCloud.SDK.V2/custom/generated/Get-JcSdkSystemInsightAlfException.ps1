...
.Outputs
JumpCloud.SDK.V2.Models.IPathsP0CdsxSysteminsightsAlfExceptionsGetResponses200ContentApplicationJsonSchemaItems
.Link
...
{
    [OutputType([JumpCloud.SDK.V2.Models.IPathsP0CdsxSysteminsightsAlfExceptionsGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('List'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightAlfException @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

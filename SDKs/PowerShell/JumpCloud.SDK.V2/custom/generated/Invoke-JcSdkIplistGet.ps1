...
System.String
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Invoke-JcSdkIplistGet.md
#>
 Function Invoke-JcSdkIplistGet
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Invoke-JcSdkInternalIplistGet @PSBoundParameters
    }
    End
    {

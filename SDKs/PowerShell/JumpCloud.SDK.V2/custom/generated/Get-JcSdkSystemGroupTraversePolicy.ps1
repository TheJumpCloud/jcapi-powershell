...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraversePolicy.md
#>
        ...
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    try {
                        $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemGroupTraversePolicy @PSBoundParameters -errorAction SilentlyContinue
                        break retryLoop
                    } catch {

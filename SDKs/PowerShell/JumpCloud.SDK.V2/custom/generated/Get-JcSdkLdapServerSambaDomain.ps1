...
.Outputs
JumpCloud.SDK.V2.Models.ISambaDomainOutput0
.Notes
...
{
    [OutputType([JumpCloud.SDK.V2.Models.ISambaDomainOutput0], [JumpCloud.SDK.V2.Models.IPathsDzyitwLdapserversLdapserverIdSambadomainsGetResponses200ContentApplicationJsonSchemaItems])]

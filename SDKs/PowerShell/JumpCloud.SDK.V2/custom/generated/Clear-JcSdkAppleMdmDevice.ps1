...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Clear-JcSdkAppleMdmDevice.md
#>
 Function Clear-JcSdkAppleMdmDevice
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Clear-JcSdkInternalAppleMdmDevice @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkAppleMdm.md
#>
 Function Remove-JcSdkAppleMdm
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkInternalAppleMdm @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

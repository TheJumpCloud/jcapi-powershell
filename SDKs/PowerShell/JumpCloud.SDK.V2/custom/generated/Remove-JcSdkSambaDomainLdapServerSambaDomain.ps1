...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkSambaDomainLdapServerSambaDomain.md
#>
 Function Remove-JcSdkSambaDomainLdapServerSambaDomain
{
    ...
    Process
    {
        $Results = JumpCloud.SDK.V2.internal\Remove-JcSdkInternalSambaDomainLdapServerSambaDomain @PSBoundParameters
    }
    End
    {

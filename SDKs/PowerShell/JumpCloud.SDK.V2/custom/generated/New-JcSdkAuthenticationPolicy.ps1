...
USERATTRIBUTEINCLUSIONS <IAuthnPolicyUserAttributeFilter[]>:
  ...
  [Value <IAny>]: Can be any value - string, number, boolean, array or object.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkAuthenticationPolicy.md
#>

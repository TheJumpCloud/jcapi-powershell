...
INPUTOBJECT <IJumpCloudApiIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkAccessRequest.md
#>
 Function Set-JcSdkAccessRequest
{
    ...
    Process
    {
        ...
        :retryLoop do {
            $resultCounter++
            $Results = JumpCloud.SDK.V2.internal\Set-JcSdkInternalAccessRequest @PSBoundParameters -errorAction SilentlyContinue -errorVariable sdkError
            If ($sdkError){

...
.Outputs
JumpCloud.SDK.V2.Models.IPaths2EotjjUsersUserIdGsuitesGetResponses200ContentApplicationJsonSchemaItems
.Notes
...
INPUTOBJECT <IJumpCloudApIsIdentity>:
  ...
  [WorkdayId <String>]:
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseGSuite.md
#>
 Function Get-JcSdkUserTraverseGSuite
{
    [OutputType([JumpCloud.SDK.V2.Models.IPaths2EotjjUsersUserIdGsuitesGetResponses200ContentApplicationJsonSchemaItems])]
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('Get'))
        {
            ...
            Do
            {
                ...
                $Result = (JumpCloud.SDK.V2.internal\Get-JcSdkInternalUserTraverseGSuite @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdksysteminsightscheduledtask
#>
    ...
    Process
    {
        If ($Paginate -and $PSCmdlet.ParameterSetName -in (''))
        {
            ...
            Do
            {
                ...
                $Result = JumpCloud.SDK.V2.internal\Get-JcSdkInternalSystemInsightScheduledTask @PSBoundParameters

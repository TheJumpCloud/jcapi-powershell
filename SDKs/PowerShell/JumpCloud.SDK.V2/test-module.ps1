...
#>
    ...
    If ($moduleName -eq 'JumpCloud.SDK.V2' -and "MTP" -notin $Env:IncludeTagList) {
        ...
        $global:pesterDefBulkEmail = "$($global:pesterDefBulkUsername)@example$(-join ((65..90) + (97..122) | Get-Random -Count 5 | ForEach-Object { [char]$_ })).com"
        $global:PesterDefBulkUser = [JumpCloud.SDK.V2.Models.BulkUserCreate]@{
            Email                         = $global:pesterDefBulkEmail;
            ...
            AllowPublicKey                = $true;
            AlternateEmail                = "$($global:pesterDefBulkEmail)1";
            Company                       = 'someCompany';
            ...
            Location                      = 'dingapore';
            ManagedAppleId                = $global:pesterDefBulkEmail;
            Manager                       = $global:PesterDefUser.Id;
            MfaConfigured                 = $true;
            Password                      = 'T#st1234';
        ...
        $global:PesterDefUpdateBulkUser = [JumpCloud.SDK.V2.Models.BulkUserUpdate]@{
            ...
            AllowPublicKey                = $true;
            AlternateEmail                = "$($global:pesterDefBulkEmail)1";
            Company                       = 'someCompany1';
            CostCenter                    = 'something1';
            Department                    = 'something1';
            Description                   = 'some description1';
            DisableDeviceMaxLoginAttempts = $false;
            Displayname                   = 'display1';
            EmployeeIdentifier            = '100992881';
            EmployeeType                  = 'bulk1';
            EnableManagedUid              = $false;
            EnableUserPortalMultifactor   = $true;
            ExternallyManaged             = $false;

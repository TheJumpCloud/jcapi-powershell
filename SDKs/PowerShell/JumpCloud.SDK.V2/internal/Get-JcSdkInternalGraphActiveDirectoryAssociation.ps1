...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphactivedirectoryassociation
#>
function Get-JcSdkInternalGraphActiveDirectoryAssociation {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphActiveDirectoryAssociation_List';
        }

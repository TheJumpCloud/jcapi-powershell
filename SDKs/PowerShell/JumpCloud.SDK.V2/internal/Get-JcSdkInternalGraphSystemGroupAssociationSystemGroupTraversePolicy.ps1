...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphsystemgroupassociationsystemgrouptraversepolicy
#>
function Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraversePolicy {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraversePolicy_List';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphapplicationtraverseusergroup
#>
function Get-JcSdkInternalGraphApplicationTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphApplicationTraverseUserGroup_List';
        }

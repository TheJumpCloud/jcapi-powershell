...
BODY <IWorkdayInput>: Workday Input
  ...
  [ReportUrl <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsdkinternalworkdayimportworkday
#>
function New-JcSdkInternalWorkdayImportWorkday {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkInternalWorkdayImportWorkday_Create';
            CreateExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkInternalWorkdayImportWorkday_CreateExpanded';
        }

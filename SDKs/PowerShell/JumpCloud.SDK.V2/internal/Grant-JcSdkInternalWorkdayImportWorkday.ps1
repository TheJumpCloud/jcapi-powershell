...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/grant-jcsdkinternalworkdayimportworkday
#>
function Grant-JcSdkInternalWorkdayImportWorkday {
...
begin {
    try {
        ...
        $mapping = @{
            Authorize = 'JumpCloud.SDK.V2.private\Grant-JcSdkInternalWorkdayImportWorkday_Authorize';
            AuthorizeExpanded = 'JumpCloud.SDK.V2.private\Grant-JcSdkInternalWorkdayImportWorkday_AuthorizeExpanded';
            AuthorizeViaIdentity = 'JumpCloud.SDK.V2.private\Grant-JcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentity';
            AuthorizeViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Grant-JcSdkInternalWorkdayImportWorkday_AuthorizeViaIdentityExpanded';
        }

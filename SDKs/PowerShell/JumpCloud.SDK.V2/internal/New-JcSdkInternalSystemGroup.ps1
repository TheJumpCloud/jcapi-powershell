...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsdkinternalsystemgroup
#>
function New-JcSdkInternalSystemGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkInternalSystemGroup_Create';
            CreateExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkInternalSystemGroup_CreateExpanded';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphusergroupassociationusergrouptraversesystemgroup
#>
function Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseSystemGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseSystemGroup_List';
        }

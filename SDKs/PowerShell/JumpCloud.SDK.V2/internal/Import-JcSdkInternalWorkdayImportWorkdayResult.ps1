...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/import-jcsdkinternalworkdayimportworkdayresult
#>
function Import-JcSdkInternalWorkdayImportWorkdayResult {
...
begin {
    try {
        ...
        $mapping = @{
            Import = 'JumpCloud.SDK.V2.private\Import-JcSdkInternalWorkdayImportWorkdayResult_Import';
            ImportViaIdentity = 'JumpCloud.SDK.V2.private\Import-JcSdkInternalWorkdayImportWorkdayResult_ImportViaIdentity';
        }

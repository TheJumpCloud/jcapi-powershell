...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphpolicytraversesystemgroup
#>
function Get-JcSdkInternalGraphPolicyTraverseSystemGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphPolicyTraverseSystemGroup_List';
        }

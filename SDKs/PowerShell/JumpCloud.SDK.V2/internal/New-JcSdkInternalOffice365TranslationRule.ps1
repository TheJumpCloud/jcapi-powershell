...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/new-jcsdkinternaloffice365translationrule
#>
function New-JcSdkInternalOffice365TranslationRule {
...
begin {
    try {
        ...
        $mapping = @{
            Create = 'JumpCloud.SDK.V2.private\New-JcSdkInternalOffice365TranslationRule_Create';
            CreateExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkInternalOffice365TranslationRule_CreateExpanded';
            CreateViaIdentity = 'JumpCloud.SDK.V2.private\New-JcSdkInternalOffice365TranslationRule_CreateViaIdentity';
            CreateViaIdentityExpanded = 'JumpCloud.SDK.V2.private\New-JcSdkInternalOffice365TranslationRule_CreateViaIdentityExpanded';
        }

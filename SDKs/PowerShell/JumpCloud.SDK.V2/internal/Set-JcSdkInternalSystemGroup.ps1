...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkinternalsystemgroup
#>
function Set-JcSdkInternalSystemGroup {
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSystemGroup_Put';
            PutExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSystemGroup_PutExpanded';
            PutViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSystemGroup_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSystemGroup_PutViaIdentityExpanded';
        }

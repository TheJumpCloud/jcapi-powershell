...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphusergroupassociationusergrouptraversedirectory
#>
function Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseDirectory {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseDirectory_List';
        }

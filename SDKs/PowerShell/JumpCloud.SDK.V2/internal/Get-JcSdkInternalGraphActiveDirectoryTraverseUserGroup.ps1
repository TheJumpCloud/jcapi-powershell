...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphactivedirectorytraverseusergroup
#>
function Get-JcSdkInternalGraphActiveDirectoryTraverseUserGroup {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphActiveDirectoryTraverseUserGroup_List';
        }

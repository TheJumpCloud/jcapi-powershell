...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphusergroupassociationusergrouptraversegsuite
#>
function Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphUserGroupAssociationUserGroupTraverseGSuite_List';
        }

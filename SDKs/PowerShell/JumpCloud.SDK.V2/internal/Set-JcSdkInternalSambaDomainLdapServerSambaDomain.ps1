...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkinternalsambadomainldapserversambadomain
#>
function Set-JcSdkInternalSambaDomainLdapServerSambaDomain {
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSambaDomainLdapServerSambaDomain_Put';
            PutExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSambaDomainLdapServerSambaDomain_PutExpanded';
            PutViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSambaDomainLdapServerSambaDomain_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalSambaDomainLdapServerSambaDomain_PutViaIdentityExpanded';
        }

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/get-jcsdkinternalgraphsystemgroupassociationsystemgrouptraverseuser
#>
function Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseUser {
...
begin {
    try {
        ...
        $mapping = @{
            List = 'JumpCloud.SDK.V2.private\Get-JcSdkInternalGraphSystemGroupAssociationSystemGroupTraverseUser_List';
        }

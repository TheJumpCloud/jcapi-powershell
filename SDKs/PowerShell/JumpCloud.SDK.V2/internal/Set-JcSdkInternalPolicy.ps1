...
VALUES <IPolicyValue[]>: .
  ...
  [Value <String>]: The value for the configuration field for this Policy instance.
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/set-jcsdkinternalpolicy
#>
function Set-JcSdkInternalPolicy {
...
begin {
    try {
        ...
        $mapping = @{
            Put = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalPolicy_Put';
            PutExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalPolicy_PutExpanded';
            PutViaIdentity = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalPolicy_PutViaIdentity';
            PutViaIdentityExpanded = 'JumpCloud.SDK.V2.private\Set-JcSdkInternalPolicy_PutViaIdentityExpanded';
        }

...
INPUTOBJECT <IJumpCloudApIsIdentity>: Identity Parameter
  ...
  [WorkdayId <String>]: 
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/jumpcloud.sdk.v2/update-jcsdkinternalapplemdmdevice
#>
function Update-JcSdkInternalAppleMdmDevice {
...
begin {
    try {
        ...
        $mapping = @{
            Refresh = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalAppleMdmDevice_Refresh';
            RefreshViaIdentity = 'JumpCloud.SDK.V2.private\Update-JcSdkInternalAppleMdmDevice_RefreshViaIdentity';
        }

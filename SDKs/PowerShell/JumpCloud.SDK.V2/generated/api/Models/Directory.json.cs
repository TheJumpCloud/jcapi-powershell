...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class Directory
    {
        ...
        internal Directory(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_oAuthStatus = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("oAuthStatus"), out var __jsonOAuthStatus) ? JumpCloud.SDK.V2.Models.DirectoryOAuthStatus.FromJson(__jsonOAuthStatus) : OAuthStatus;}
            AfterFromJson(json);
        }
        ...
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._oAuthStatus ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) this._oAuthStatus.ToJson(null,serializationMode) : null, "oAuthStatus" ,container.Add );

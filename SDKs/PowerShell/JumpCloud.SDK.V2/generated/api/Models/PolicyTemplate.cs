...
namespace JumpCloud.SDK.V2.Models
{
        ...
        JumpCloud.SDK.V2.Models.IPolicyTemplateInternal
    {
        ...
        /// <summary>Backing field for <see cref="DeliveryTypes" /> property.</summary>
        private string[] _deliveryTypes;

        /// <summary>The supported delivery mechanisms for this policy template.</summary>
        [JumpCloud.SDK.V2.Origin(JumpCloud.SDK.V2.PropertyOrigin.Owned)]
        public string[] DeliveryTypes { get => this._deliveryTypes; set => this._deliveryTypes = value; }

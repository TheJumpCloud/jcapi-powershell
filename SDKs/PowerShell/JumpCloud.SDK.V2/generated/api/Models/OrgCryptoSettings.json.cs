...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class OrgCryptoSettings
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IOrgCryptoSettings.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IOrgCryptoSettings.</returns>
        public static JumpCloud.SDK.V2.Models.IOrgCryptoSettings FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new OrgCryptoSettings(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="OrgCryptoSettings" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal OrgCryptoSettings(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_sshKeys = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonObject>("sshKeys"), out var __jsonSshKeys) ? JumpCloud.SDK.V2.Models.OrgCryptoSettingsSshKeys.FromJson(__jsonSshKeys) : SshKeys;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OrgCryptoSettings" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OrgCryptoSettings" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._sshKeys ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) this._sshKeys.ToJson(null,serializationMode) : null, "sshKeys" ,container.Add );

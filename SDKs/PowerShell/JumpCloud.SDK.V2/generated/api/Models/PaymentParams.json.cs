...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class PaymentParams
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IPaymentParams.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.IPaymentParams.</returns>
        public static JumpCloud.SDK.V2.Models.IPaymentParams FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new PaymentParams(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="PaymentParams" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal PaymentParams(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_publishableKey = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("publishableKey"), out var __jsonPublishableKey) ? (string)__jsonPublishableKey : (string)PublishableKey;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="PaymentParams" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="PaymentParams" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._publishableKey)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._publishableKey.ToString()) : null, "publishableKey" ,container.Add );

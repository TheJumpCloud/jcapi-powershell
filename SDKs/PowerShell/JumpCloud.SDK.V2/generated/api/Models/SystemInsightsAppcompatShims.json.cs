...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsAppcompatShims
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAppcompatShims.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsAppcompatShims.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsAppcompatShims FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsAppcompatShims(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsAppcompatShims" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsAppcompatShims(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_executable = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("executable"), out var __jsonExecutable) ? (string)__jsonExecutable : (string)Executable;}
            {_installTime = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("install_time"), out var __jsonInstallTime) ? (float?)__jsonInstallTime : InstallTime;}
            {_sdbId = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("sdb_id"), out var __jsonSdbId) ? (string)__jsonSdbId : (string)SdbId;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsAppcompatShims" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsAppcompatShims" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._executable)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._executable.ToString()) : null, "executable" ,container.Add );
            AddIf( null != this._installTime ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber((float)this._installTime) : null, "install_time" ,container.Add );
            AddIf( null != (((object)this._sdbId)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._sdbId.ToString()) : null, "sdb_id" ,container.Add );

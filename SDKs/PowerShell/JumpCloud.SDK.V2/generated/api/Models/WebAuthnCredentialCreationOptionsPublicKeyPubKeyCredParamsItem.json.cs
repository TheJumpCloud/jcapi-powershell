...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.IWebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.V2.Models.IWebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem.
        /// </returns>
        public static JumpCloud.SDK.V2.Models.IWebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem" /> into a <see
        ...
        /// <returns>
        /// a serialized instance of <see cref="WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (JumpCloud.SDK.V2.Runtime.Json.JsonNode)new JumpCloud.SDK.V2.Runtime.Json.JsonNumber(this._alg), "alg" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem"
        /// />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal WebAuthnCredentialCreationOptionsPublicKeyPubKeyCredParamsItem(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            {_alg = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonNumber>("alg"), out var __jsonAlg) ? (int)__jsonAlg : Alg;}
            AfterFromJson(json);
        }
    }
}
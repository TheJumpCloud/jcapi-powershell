...
namespace JumpCloud.SDK.V2.Models
{
    ...
    public partial class SystemInsightsCupsDestinations
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.V2.Models.ISystemInsightsCupsDestinations.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of JumpCloud.SDK.V2.Models.ISystemInsightsCupsDestinations.</returns>
        public static JumpCloud.SDK.V2.Models.ISystemInsightsCupsDestinations FromJson(JumpCloud.SDK.V2.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.V2.Runtime.Json.JsonObject json ? new SystemInsightsCupsDestinations(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.V2.Runtime.Json.JsonObject into a new instance of <see cref="SystemInsightsCupsDestinations" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.V2.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal SystemInsightsCupsDestinations(JumpCloud.SDK.V2.Runtime.Json.JsonObject json)
        {
            ...
            {_optionName = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("option_name"), out var __jsonOptionName) ? (string)__jsonOptionName : (string)OptionName;}
            {_optionValue = If( json?.PropertyT<JumpCloud.SDK.V2.Runtime.Json.JsonString>("option_value"), out var __jsonOptionValue) ? (string)__jsonOptionValue : (string)OptionValue;}
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemInsightsCupsDestinations" /> into a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemInsightsCupsDestinations" /> as a <see cref="JumpCloud.SDK.V2.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.V2.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.V2.Runtime.Json.JsonObject container, JumpCloud.SDK.V2.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._optionName)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._optionName.ToString()) : null, "option_name" ,container.Add );
            AddIf( null != (((object)this._optionValue)?.ToString()) ? (JumpCloud.SDK.V2.Runtime.Json.JsonNode) new JumpCloud.SDK.V2.Runtime.Json.JsonString(this._optionValue.ToString()) : null, "option_value" ,container.Add );

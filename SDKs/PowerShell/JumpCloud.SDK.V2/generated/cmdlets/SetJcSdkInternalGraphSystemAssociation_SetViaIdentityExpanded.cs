...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Set-SystemAssociation=>POST:"/systems/{system_id}/associations"
    /// [METADATA]
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"JcSdkInternalGraphSystemAssociation_SetViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint allows you to manage the _direct_ associations of a System.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example Systems and Users.\n\n\n#### Sample Request\n```\ncurl -X POST https://console.jumpcloud.com/api/v2/systems/{System_ID}/associations \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}' \\\n  -d '{\n   \""attributes\"": {\n      \""sudo\"": {\n         \""enabled\"": true,\n         \""withoutPassword\"": false\n      }\n   },\n    \""op\"": \""add\"",\n    \""type\"": \""user\"",\n    \""id\"": \""UserID\""\n}'\n\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class SetJcSdkInternalGraphSystemAssociation_SetViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SetSystemAssociation' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.SystemId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                    }
                    await this.Client.SetSystemAssociation(InputObject.SystemId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null, this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null, Body, onNoContent, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  Authorization=this.InvocationInformation.BoundParameters.ContainsKey("Authorization") ? Authorization : null,Date=this.InvocationInformation.BoundParameters.ContainsKey("Date") ? Date : null,body=Body})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetJcSdkInternalGraphSystemAssociation_SetViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public SetJcSdkInternalGraphSystemAssociation_SetViaIdentityExpanded()
        {

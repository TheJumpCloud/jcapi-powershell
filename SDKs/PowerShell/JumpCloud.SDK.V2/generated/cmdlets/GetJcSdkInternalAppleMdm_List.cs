...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// <summary>
    /// Get a list of all Apple MDM configurations. An empty topic indicates that a signed certificate from Apple has not been
    /// provided to the PUT endpoint yet.\n\nNote: currently only one MDM configuration per organization is supported.\n\n####
    /// Sample Request\n```\ncurl https://console.jumpcloud.com/api/v2/applemdms \\\n -H 'accept: application/json' \\\n -H 'content-type:
    /// application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-AppleMDM=>GET:"/applemdms"
    /// [METADATA]
    /// path: /applemdms
    /// apiVersions:
    /// - '2.0'
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1applemdms'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: AppleMdm
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalAppleMdm_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IAppleMdm))]
    [global::JumpCloud.SDK.V2.Description(@"Get a list of all Apple MDM configurations.  An empty topic indicates that a signed certificate from Apple has not been provided to the PUT endpoint yet.\n\nNote: currently only one MDM configuration per organization is supported.\n\n#### Sample Request\n```\ncurl https://console.jumpcloud.com/api/v2/applemdms \\\n  -H 'accept: application/json' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalAppleMdm_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalAppleMdm_List" /> cmdlet class.
        /// </summary>
        public GetJcSdkInternalAppleMdm_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListAppleMdm(onOk, this, Pipeline);

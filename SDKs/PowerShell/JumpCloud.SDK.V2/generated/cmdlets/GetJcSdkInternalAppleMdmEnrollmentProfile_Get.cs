...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// https://console.jumpcloud.com/api/v2/applemdms/{APPLE_MDM_ID}/enrollmentprofiles/{ID} \\\n -H 'accept: application/x-apple-aspen-config'
    /// \\\n -H 'content-type: application/json' \\\n -H 'x-api-key: {API_KEY}'\n```
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Get-AppleMDMEnrollmentProfile=>GET:"/applemdms/{apple_mdm_id}/enrollmentprofiles/{id}"
    /// [METADATA]
    /// path: '/applemdms/{apple_mdm_id}/enrollmentprofiles/{id}'
    /// apiVersions:
    /// - '2.0'
    /// filename:
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalAppleMdmEnrollmentProfile_Get")]
    [global::System.Management.Automation.OutputType(typeof(string))]
    [global::JumpCloud.SDK.V2.Description(@"Get an enrollment profile\n\nCurrently only requesting the mobileconfig is supported.\n\n#### Sample Request\n\n```\ncurl https://console.jumpcloud.com/api/v2/applemdms/{APPLE_MDM_ID}/enrollmentprofiles/{ID} \\\n  -H 'accept: application/x-apple-aspen-config' \\\n  -H 'content-type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalAppleMdmEnrollmentProfile_Get : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalAppleMdmEnrollmentProfile_Get" /> cmdlet class.
        /// </summary>
        public GetJcSdkInternalAppleMdmEnrollmentProfile_Get()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.GetAppleMdmEnrollmentProfile(AppleMdmId, Id, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  AppleMdmId=AppleMdmId,Id=Id})
                    {
        ...
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<string> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // onOk - response for 200 / application/x-apple-aspen-config

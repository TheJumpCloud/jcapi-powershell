...
namespace JumpCloud.SDK.V2.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] List-SystemGroupAssociation=>GET:"/systemgroups/{group_id}/associations"
    /// [METADATA]
    ...
    /// originalLocations:
    /// - 'file:///D:/a/1/s/AutoRest/SwaggerSpecs/JumpCloud.SDK.V2.json#/paths/~1systemgroups~1{group_id}~1associations'
    /// [DETAILS]
    /// verb: Get
    /// subjectPrefix:
    /// subject: GraphSystemGroupAssociationSystemGroupAssociation
    /// variant: List
    /// </remarks>
    [global::JumpCloud.SDK.V2.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"JcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_List")]
    [global::System.Management.Automation.OutputType(typeof(JumpCloud.SDK.V2.Models.IGraphConnection))]
    [global::JumpCloud.SDK.V2.Description(@"This endpoint returns the _direct_ associations of a System Group.\n\nA direct association can be a non-homogeneous relationship between 2 different objects, for example System Groups and Users.\n\n\n#### Sample Request\n```\ncurl -X GET https://console.jumpcloud.com/api/v2/systemgroups/{GroupID}/associations?targets=user \\\n  -H 'Accept: application/json' \\\n  -H 'Content-Type: application/json' \\\n  -H 'x-api-key: {API_KEY}'\n```")]
    [global::JumpCloud.SDK.V2.Generated]
    public partial class GetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_List : global::System.Management.Automation.PSCmdlet,
        JumpCloud.SDK.V2.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_List" />
        /// cmdlet class.
        /// </summary>
        public GetJcSdkInternalGraphSystemGroupAssociationSystemGroupAssociation_List()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ListSystemGroupAssociation(GroupId, this.InvocationInformation.BoundParameters.ContainsKey("Limit") ? Limit : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Skip") ? Skip : default(int?), Targets, onOk, this, Pipeline);

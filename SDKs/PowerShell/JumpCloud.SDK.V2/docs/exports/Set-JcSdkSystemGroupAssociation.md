...
### SetExpanded (Default)
```
Set-JcSdkSystemGroupAssociation -GroupId <String> -Id <String> -Op <String> -Type <Type>
...
```
Set-JcSdkSystemGroupAssociation -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <String> -Type <Type>
 [-Attributes <Hashtable>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

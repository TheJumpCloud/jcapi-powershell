...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkPolicyGroupMember.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkPolicyGroupMember -ConsoleHost <String> -GroupId <String> [-Attributes <Hashtable>] [-Id <String>]
 [-Op <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkPolicyGroupMember -ConsoleHost <String> -GroupId <String> -Body <IGraphOperationPolicyGroupMember>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkPolicyGroupMember -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

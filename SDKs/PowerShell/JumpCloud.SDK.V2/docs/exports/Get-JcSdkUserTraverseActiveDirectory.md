...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseActiveDirectory.md
schema: 2.0.0
---

# Get-JcSdkUserTraverseActiveDirectory
...
### Get (Default)
```
Get-JcSdkUserTraverseActiveDirectory -HostEnv <String> -UserId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseActiveDirectory -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserTraverseActiveDirectory -UserId:(<string>)
```

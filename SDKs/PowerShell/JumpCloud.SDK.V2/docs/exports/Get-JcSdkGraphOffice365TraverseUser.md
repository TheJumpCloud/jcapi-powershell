...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphOffice365TraverseUser.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphOffice365TraverseUser -Office365Id <String> [-Filter <String[]>] [<CommonParameters>]
```

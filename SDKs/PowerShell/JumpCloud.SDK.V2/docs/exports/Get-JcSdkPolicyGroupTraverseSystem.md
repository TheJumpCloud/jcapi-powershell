...
### Get (Default)
```
Get-JcSdkPolicyGroupTraverseSystem -GroupId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroupTraverseSystem -InputObject <IJumpCloudApiIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkSystemAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkSystemAssociation -ConsoleHost <String> -SystemId <String> [-Authorization <String>] [-Date <String>]
...
### Set
```
Set-JcSdkSystemAssociation -ConsoleHost <String> -SystemId <String> -Body <IGraphOperationSystem>
 [-Authorization <String>] [-Date <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkSystemAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

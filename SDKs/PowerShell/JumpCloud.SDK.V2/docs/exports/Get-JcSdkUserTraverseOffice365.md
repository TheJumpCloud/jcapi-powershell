...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseOffice365.md
schema: 2.0.0
---

# Get-JcSdkUserTraverseOffice365
...
### Get (Default)
```
Get-JcSdkUserTraverseOffice365 -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseOffice365 -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [<CommonParameters>]
```

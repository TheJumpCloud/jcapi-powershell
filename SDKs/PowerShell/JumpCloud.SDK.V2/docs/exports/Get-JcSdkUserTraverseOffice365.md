...
### Get (Default)
```
Get-JcSdkUserTraverseOffice365 -UserId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseOffice365 -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

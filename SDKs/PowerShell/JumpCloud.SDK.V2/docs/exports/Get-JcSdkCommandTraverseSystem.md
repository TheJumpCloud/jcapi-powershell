...
### Get (Default)
```
Get-JcSdkCommandTraverseSystem -CommandId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandTraverseSystem -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

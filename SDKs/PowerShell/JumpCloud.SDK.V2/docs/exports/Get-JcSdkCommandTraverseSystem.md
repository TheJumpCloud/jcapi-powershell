...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkCommandTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkCommandTraverseSystem -ConsoleHost <String> -CommandId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandTraverseSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

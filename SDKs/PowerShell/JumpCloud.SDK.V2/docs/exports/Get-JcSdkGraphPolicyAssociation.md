...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphPolicyAssociation.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphPolicyAssociation -PolicyId <String> -Targets <String[]> [<CommonParameters>]
```

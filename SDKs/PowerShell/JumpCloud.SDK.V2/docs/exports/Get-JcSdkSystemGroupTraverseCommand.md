...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseCommand.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupTraverseCommand -HostEnv <String> -GroupId <String> [-Details <String>]
 [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupTraverseCommand -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Details <String>]
 [-Filter <List<String>>] [<CommonParameters>]
```

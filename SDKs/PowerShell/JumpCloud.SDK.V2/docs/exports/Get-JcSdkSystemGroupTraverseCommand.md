...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseCommand.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupTraverseCommand -ConsoleHost <String> -GroupId <String> [-Details <String>]
 [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupTraverseCommand -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 [-Details <String>] [-Filter <List<String>>] [<CommonParameters>]
```

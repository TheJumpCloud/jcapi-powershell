...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkProvidersInvoice.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkProvidersInvoice -HostEnv <String> -ProviderId <String> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkProvidersInvoice -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkAdministratorOrganization.md
schema: 2.0.0
---
...
```
New-JcSdkAdministratorOrganization -ConsoleHost <String> -Id <String> [-Organization <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkAdministratorOrganization -ConsoleHost <String> -Id <String>
 -Body <IAdministratorOrganizationLinkReq> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-JcSdkAdministratorOrganization -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IAdministratorOrganizationLinkReq> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkAdministratorOrganization.md
schema: 2.0.0
---
...
```
New-JcSdkAdministratorOrganization -HostEnv <String> -Id <String> [-Organization <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkAdministratorOrganization -HostEnv <String> -Id <String> -Body <IAdministratorOrganizationLinkReq>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-JcSdkAdministratorOrganization -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
```
New-JcSdkAdministratorOrganization -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
 [-Organization <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

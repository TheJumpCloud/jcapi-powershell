...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkPolicyAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkPolicyAssociation -ConsoleHost <String> -PolicyId <String> [-Attributes <Hashtable>] [-Id <String>]
 [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkPolicyAssociation -ConsoleHost <String> -PolicyId <String> -Body <IGraphOperationPolicy> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkPolicyAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

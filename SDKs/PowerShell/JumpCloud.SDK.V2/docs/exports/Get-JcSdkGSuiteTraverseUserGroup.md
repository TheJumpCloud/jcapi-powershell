...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkGSuiteTraverseUserGroup -ConsoleHost <String> -GsuiteId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTraverseUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

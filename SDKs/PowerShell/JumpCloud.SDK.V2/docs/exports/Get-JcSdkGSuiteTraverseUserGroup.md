...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkGSuiteTraverseUserGroup -HostEnv <String> -GsuiteId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkGSuiteTraverseUserGroup -GsuiteId:(<string>)
```

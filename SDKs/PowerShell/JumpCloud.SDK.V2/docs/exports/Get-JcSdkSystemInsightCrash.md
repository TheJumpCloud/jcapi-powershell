...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemInsightCrash.md
schema: 2.0.0
---
...
```
Get-JcSdkSystemInsightCrash -HostEnv <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerSambaDomain.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkLdapServerSambaDomain -HostEnv <String> -LdapserverId <String> [-Fields <List<String>>]
 [-Filter <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkLdapServerSambaDomain -HostEnv <String> -Id <String> -LdapserverId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServerSambaDomain -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

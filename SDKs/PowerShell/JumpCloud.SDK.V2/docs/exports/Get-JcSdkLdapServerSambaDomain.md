...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerSambaDomain.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkLdapServerSambaDomain -ConsoleHost <String> -LdapserverId <String> [-Fields <List<String>>]
 [-Filter <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkLdapServerSambaDomain -ConsoleHost <String> -Id <String> -LdapserverId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServerSambaDomain -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkWorkdayWorker.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkWorkdayWorker -HostEnv <String> -WorkdayId <String> [-Sort <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkWorkdayWorker -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Sort <List<String>>]
 [<CommonParameters>]
```

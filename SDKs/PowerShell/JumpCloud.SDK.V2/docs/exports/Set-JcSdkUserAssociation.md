...
### SetExpanded (Default)
```
Set-JcSdkUserAssociation -UserId <String> -Id <String> -Op <String> -Type <Type3> [-AttributeSudoEnabled]
...
```
Set-JcSdkUserAssociation -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <String> -Type <Type3>
...
BODY <IGraphOperationUser>: GraphOperation (User)
  ...
  - `Type <Type3>`: Targets which a "user" can be associated to.

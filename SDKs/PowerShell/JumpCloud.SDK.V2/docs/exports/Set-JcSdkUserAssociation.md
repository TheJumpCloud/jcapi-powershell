...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkUserAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkUserAssociation -HostEnv <String> -UserId <String> [-Attributes <Hashtable>] [-Id <String>]
 [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkUserAssociation -HostEnv <String> -UserId <String> -Body <IGraphOperationUser> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkUserAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Body <IGraphOperationUser>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkUserAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Attributes <Hashtable>]

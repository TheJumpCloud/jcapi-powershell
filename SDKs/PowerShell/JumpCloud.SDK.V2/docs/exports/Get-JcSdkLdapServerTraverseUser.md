...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkLdapServerTraverseUser -ConsoleHost <String> -LdapserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServerTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkLdapServerTraverseUser -HostEnv <String> -LdapserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServerTraverseUser -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkLdapServerTraverseUser -LdapserverId:(<string>)
```

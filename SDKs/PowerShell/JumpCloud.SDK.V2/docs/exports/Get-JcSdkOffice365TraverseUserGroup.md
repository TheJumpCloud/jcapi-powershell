...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkOffice365TraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkOffice365TraverseUserGroup -HostEnv <String> -Office365Id <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365TraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkOffice365TraverseUserGroup -Office365Id:(<string>)
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkOffice365TraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkOffice365TraverseUserGroup -ConsoleHost <String> -Office365Id <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365TraverseUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

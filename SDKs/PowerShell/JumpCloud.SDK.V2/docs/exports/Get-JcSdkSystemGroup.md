...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroup.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkSystemGroup -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkSystemGroup -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroup.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkSystemGroup -HostEnv <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkSystemGroup -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemGroup -Fields:(<string[]>) -Filter:(<string[]>) -Sort:(<string[]>)
```
...
### -------------------------- EXAMPLE 2 --------------------------
```powershell
Get-JcSdkSystemGroup -Id:(<string>)
```

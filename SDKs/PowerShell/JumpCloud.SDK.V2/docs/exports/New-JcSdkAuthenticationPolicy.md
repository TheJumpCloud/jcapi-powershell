...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkAuthenticationPolicy.md
schema: 2.0.0
---
...
```
New-JcSdkAuthenticationPolicy -ConsoleHost <String> [-Conditions <Hashtable>] [-CustomErrorMessage <String>]
...
### Create
```
New-JcSdkAuthenticationPolicy -ConsoleHost <String> -Body <IAuthnPolicy> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

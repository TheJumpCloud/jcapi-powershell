...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseRadiusServer.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupTraverseRadiusServer -HostEnv <String> -GroupId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupTraverseRadiusServer -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserGroupTraverseRadiusServer -GroupId:(<string>)
```

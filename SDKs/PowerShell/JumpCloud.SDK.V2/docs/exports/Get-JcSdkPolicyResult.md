...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyResult.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyResult -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyResult -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

### List
```
Get-JcSdkPolicyResult -HostEnv <String> -PolicyId <String> [-Fields <List<String>>] [-Filter <List<String>>]

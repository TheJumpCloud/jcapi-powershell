...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyResult.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyResult -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyResult -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

### List
```
Get-JcSdkPolicyResult -ConsoleHost <String> -PolicyId <String> [-Fields <List<String>>]

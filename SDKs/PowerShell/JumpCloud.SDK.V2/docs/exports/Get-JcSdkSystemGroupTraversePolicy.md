...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraversePolicy.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupTraversePolicy -HostEnv <String> -GroupId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupTraversePolicy -HostEnv <String> -InputObject <IJumpCloudApiIdentity>

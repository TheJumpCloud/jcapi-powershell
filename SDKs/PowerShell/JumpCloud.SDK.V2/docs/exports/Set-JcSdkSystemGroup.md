...
### SetExpanded (Default)
```
Set-JcSdkSystemGroup -Id <String> -Name <String> [-CreationSource <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Set
```
Set-JcSdkSystemGroup -Id <String> -Body <ISystemGroupData> [-CreationSource <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkSystemGroup -InputObject <IJumpCloudApIsIdentity> -Body <ISystemGroupData> [-CreationSource <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkSystemGroup -InputObject <IJumpCloudApIsIdentity> -Name <String> [-CreationSource <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

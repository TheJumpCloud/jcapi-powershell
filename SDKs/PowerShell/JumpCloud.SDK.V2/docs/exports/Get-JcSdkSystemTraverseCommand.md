...
### Get (Default)
```
Get-JcSdkSystemTraverseCommand -SystemId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseCommand -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseCommand.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraverseCommand -HostEnv <String> -SystemId <String> [-Details <String>]
 [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseCommand -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Details <String>]
 [-Filter <List<String>>] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemTraverseCommand -SystemId:(<string>)
```

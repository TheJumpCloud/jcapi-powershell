...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphSystemTraversePolicy.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphSystemTraversePolicy -SystemId <String> [-Filter <String[]>] [<CommonParameters>]
```

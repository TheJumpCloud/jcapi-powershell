...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphSystemTraverseCommand.md
schema: 2.0.0
---

# Get-JcSdkGraphSystemTraverseCommand
...
```
Get-JcSdkGraphSystemTraverseCommand -SystemId <String> [-Filter <String[]>] [<CommonParameters>]
```

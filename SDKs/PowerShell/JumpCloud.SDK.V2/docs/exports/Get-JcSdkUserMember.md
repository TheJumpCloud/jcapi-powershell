...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserMember -HostEnv <String> -UserId <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserMember -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserMember -UserId:(<string>)
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserMember -ConsoleHost <String> -UserId <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserMember -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]

...
### Get (Default)
```
Get-JcSdkOffice365Association -Office365Id <String> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365Association -InputObject <IJumpCloudApIsIdentity> -Targets <String>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkAppleMdmDevice.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkAppleMdmDevice -HostEnv <String> -AppleMdmId <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [-XTotalCount <Int32>] [<CommonParameters>]
```

### Get
```
Get-JcSdkAppleMdmDevice -HostEnv <String> -AppleMdmId <String> -DeviceId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkAppleMdmDevice -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

...
### SetExpanded (Default)
```
Set-JcSdkAppleMdm -Id <String> [-AppleSignedCert <String>] [-DefaultSystemGroupId <String>] [-Dep <IDep>]
...
Set-JcSdkAppleMdm -InputObject <IJumpCloudSdkV2Identity> [-AppleSignedCert <String>]
 [-DefaultSystemGroupId <String>] [-Dep <IDep>] [-EncryptedDepServerToken <String>] [-Name <String>]
...
```yaml
Type: JumpCloud.SDK.V2.Models.IDep
Parameter Sets: SetExpanded, SetViaIdentityExpanded
Aliases:

...
```
New-JcSdkIPList [-CreationSource <String>] [-Description <String>] [-Ips <String[]>] [-Name <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkIPList -Body <IIPListRequest> [-CreationSource <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

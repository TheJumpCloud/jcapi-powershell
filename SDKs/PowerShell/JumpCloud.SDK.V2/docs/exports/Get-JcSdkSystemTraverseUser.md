...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraverseUser -ConsoleHost <String> -SystemId <String> [-Filter <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

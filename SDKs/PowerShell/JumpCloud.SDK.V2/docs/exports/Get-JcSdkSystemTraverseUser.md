...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraverseUser -SystemId <String> [-Filter <String[]>] [-Authorization <String>] [-Date <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseUser -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

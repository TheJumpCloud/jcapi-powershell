...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraverseUser -HostEnv <String> -SystemId <String> [-Filter <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseUser -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

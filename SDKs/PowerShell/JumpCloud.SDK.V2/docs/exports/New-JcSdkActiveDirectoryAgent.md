...
### CreateViaIdentity
```
New-JcSdkActiveDirectoryAgent -InputObject <IJumpCloudApIsIdentity> -Body <Hashtable> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-JcSdkActiveDirectoryAgent -InputObject <IJumpCloudApIsIdentity> [-AdditionalProperties <Hashtable>]

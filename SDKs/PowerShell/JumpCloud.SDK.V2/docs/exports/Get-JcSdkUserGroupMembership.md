...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupMembership.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupMembership -HostEnv <String> -GroupId <String> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupMembership -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserGroupMembership -GroupId:(<string>)
```

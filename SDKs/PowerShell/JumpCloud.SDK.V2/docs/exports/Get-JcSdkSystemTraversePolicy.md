...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraversePolicy.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraversePolicy -HostEnv <String> -SystemId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraversePolicy -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemTraversePolicy -SystemId:(<string>)
```

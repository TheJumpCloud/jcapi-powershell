...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraversePolicy.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraversePolicy -ConsoleHost <String> -SystemId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraversePolicy -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

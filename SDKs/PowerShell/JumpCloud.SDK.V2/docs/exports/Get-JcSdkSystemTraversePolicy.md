...
### Get (Default)
```
Get-JcSdkSystemTraversePolicy -SystemId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraversePolicy -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

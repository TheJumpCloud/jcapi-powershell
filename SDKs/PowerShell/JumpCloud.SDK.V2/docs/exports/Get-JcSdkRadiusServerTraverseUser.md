...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkRadiusServerTraverseUser -ConsoleHost <String> -RadiusserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServerTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

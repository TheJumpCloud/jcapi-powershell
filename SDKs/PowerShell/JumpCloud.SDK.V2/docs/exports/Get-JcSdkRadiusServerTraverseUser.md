...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkRadiusServerTraverseUser -RadiusserverId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServerTraverseUser -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

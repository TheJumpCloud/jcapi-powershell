...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkRadiusServerTraverseUser -HostEnv <String> -RadiusserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServerTraverseUser -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkRadiusServerTraverseUser -RadiusserverId:(<string>)
```

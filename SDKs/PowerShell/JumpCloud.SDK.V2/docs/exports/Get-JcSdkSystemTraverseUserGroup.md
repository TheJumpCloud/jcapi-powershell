...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemTraverseUserGroup -HostEnv <String> -SystemId <String> [-Filter <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemTraverseUserGroup -SystemId:(<string>)
```

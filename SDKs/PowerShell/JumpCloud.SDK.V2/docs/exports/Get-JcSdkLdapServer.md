...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServer.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkLdapServer -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkLdapServer -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServer -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

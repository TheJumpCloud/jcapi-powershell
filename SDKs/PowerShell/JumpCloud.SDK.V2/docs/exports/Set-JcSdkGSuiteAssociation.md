...
### SetViaIdentity
```
Set-JcSdkGSuiteAssociation -InputObject <IJumpCloudApiIdentity> -Body <IGraphOperationGSuite1> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkGSuiteAssociation -InputObject <IJumpCloudApiIdentity> -Id <String> -Op <String>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Set-JcSdkGSuiteAssociation -GsuiteId:(<string>) -Body:(<JumpCloud.SDK.V2.Models.GraphOperationGSuite1>)
```
...
### -------------------------- EXAMPLE 2 --------------------------
```powershell
Set-JcSdkGSuiteAssociation -GsuiteId:(<string>) -Id:(<string>) -Op:(<string>) -Type:(<JumpCloud.SDK.V2.Support.GraphOperationGSuite>) -Attributes:(<hashtable>)
```

...
### List (Default)
```
Get-JcSdkPolicyTemplate -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkPolicyTemplate -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyTemplate -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

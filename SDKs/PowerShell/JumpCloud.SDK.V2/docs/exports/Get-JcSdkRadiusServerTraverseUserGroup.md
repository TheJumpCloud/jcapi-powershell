...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkRadiusServerTraverseUserGroup -HostEnv <String> -RadiusserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServerTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkRadiusServerTraverseUserGroup -RadiusserverId:(<string>)
```

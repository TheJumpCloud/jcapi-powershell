...
### Get (Default)
```
Get-JcSdkUserTraverseRadiusServer -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseRadiusServer -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

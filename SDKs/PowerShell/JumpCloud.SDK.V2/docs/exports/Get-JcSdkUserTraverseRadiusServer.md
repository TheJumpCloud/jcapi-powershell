...
### Get (Default)
```
Get-JcSdkUserTraverseRadiusServer -ConsoleHost <String> -UserId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseRadiusServer -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

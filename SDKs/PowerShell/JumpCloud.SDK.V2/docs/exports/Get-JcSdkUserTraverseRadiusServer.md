...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseRadiusServer.md
schema: 2.0.0
---

# Get-JcSdkUserTraverseRadiusServer
...
### Get (Default)
```
Get-JcSdkUserTraverseRadiusServer -HostEnv <String> -UserId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseRadiusServer -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserTraverseRadiusServer -UserId:(<string>)
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupAssociation -ConsoleHost <String> -GroupId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupAssociation -HostEnv <String> -GroupId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```

...
### SetViaIdentity
```
Set-JcSdkUserGroupAssociation -InputObject <IJumpCloudSdkV2Identity> -Body <IGraphOperationUserGroup>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkUserGroupAssociation -InputObject <IJumpCloudSdkV2Identity> -Id <String> -Op <String> -Type <Type4>
 [-Attributes <Hashtable>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
### SetExpanded (Default)
```
Set-JcSdkUserGroupAssociation -GroupId <String> -Id <String> -Op <String> -Type <Type3>
...
```
Set-JcSdkUserGroupAssociation -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <String> -Type <Type3>
 [-Attributes <Hashtable>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
BODY <IGraphOperationUserGroup>: GraphOperation (UserGroup)
  ...
  - `Type <Type3>`: Targets which a "user_group" can be associated to.

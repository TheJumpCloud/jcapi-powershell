...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkApplicationTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkApplicationTraverseUserGroup -HostEnv <String> -ApplicationId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkApplicationTraverseUserGroup -ApplicationId:(<string>)
```

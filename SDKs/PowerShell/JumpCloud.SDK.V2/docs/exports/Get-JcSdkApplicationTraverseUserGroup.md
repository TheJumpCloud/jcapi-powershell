...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkApplicationTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkApplicationTraverseUserGroup -ConsoleHost <String> -ApplicationId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationTraverseUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkApplicationTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkApplicationTraverseUserGroup -ApplicationId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationTraverseUserGroup -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

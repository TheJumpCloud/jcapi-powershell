...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkWorkday.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkWorkday -HostEnv <String> [-Fields <List<String>>] [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkWorkday -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkWorkday -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

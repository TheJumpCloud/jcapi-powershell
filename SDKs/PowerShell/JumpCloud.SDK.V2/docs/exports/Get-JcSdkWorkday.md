...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkWorkday.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkWorkday -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkWorkday -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkWorkday -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

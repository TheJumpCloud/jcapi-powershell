...
### Get (Default)
```
Get-JcSdkGSuiteAssociation -GsuiteId <String> -Targets <GraphTargetsActiveDirectoryTargets>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteAssociation -InputObject <IJumpCloudApiIdentity> -Targets <GraphTargetsActiveDirectoryTargets>
 [<CommonParameters>]
```

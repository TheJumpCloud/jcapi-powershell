...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkGSuiteAssociation -HostEnv <String> -GsuiteId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkGSuiteAssociation -GsuiteId:(<string>)
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkApprovalFlowSetting.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkApprovalFlowSetting -ConsoleHost <String> [-AdminApprovalEmail]
...
### Set
```
Set-JcSdkApprovalFlowSetting -ConsoleHost <String>
 -Body <IJumpcloudIngressoUpdateAccessWorkflowSettingsRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

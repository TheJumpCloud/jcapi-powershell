...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicy.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkPolicy -HostEnv <String> [-Fields <List<String>>] [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkPolicy -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicy -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkPolicy -Fields:(<string[]>) -Filter:(<string[]>) -Sort:(<string[]>)
```

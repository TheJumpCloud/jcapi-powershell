...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphRadiusServerTraverseUser.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphRadiusServerTraverseUser -RadiusserverId <String> [-Filter <String[]>] [<CommonParameters>]
```

...
### SetViaIdentity
```
Set-JcSdkRadiusServerAssociation -InputObject <IJumpCloudApiIdentity> -Body <IGraphOperationRadiusServer1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkRadiusServerAssociation -InputObject <IJumpCloudApiIdentity> -Id <String> -Op <String>
 -Type <GraphOperationRadiusServer> [-Attributes <Hashtable>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Set-JcSdkRadiusServerAssociation -RadiusserverId:(<string>) -Body:(<JumpCloud.SDK.V2.Models.GraphOperationRadiusServer1>)
```
...
### -------------------------- EXAMPLE 2 --------------------------
```powershell
Set-JcSdkRadiusServerAssociation -RadiusserverId:(<string>) -Id:(<string>) -Op:(<string>) -Type:(<JumpCloud.SDK.V2.Support.GraphOperationRadiusServer>) -Attributes:(<hashtable>)
```

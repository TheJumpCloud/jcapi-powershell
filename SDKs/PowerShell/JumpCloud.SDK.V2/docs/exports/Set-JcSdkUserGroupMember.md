...
### SetViaIdentity
```
Set-JcSdkUserGroupMember -InputObject <IJumpCloudApiIdentity> -Body <IGraphOperationUserGroupMember>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkUserGroupMember -InputObject <IJumpCloudApiIdentity> -Id <String> -Op <String>

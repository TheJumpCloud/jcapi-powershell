...
### List (Default)
```
Get-JcSdkAuthenticationPolicy [-Filter <String[]>] [-Sort <String[]>] [-CreationSource <String>]
 [-XTotalCount <Int32>] [-XUnfilteredTotalCount <Int32>] [<CommonParameters>]
```

### Get
```
Get-JcSdkAuthenticationPolicy -Id <String> [-CreationSource <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkAuthenticationPolicy -InputObject <IJumpCloudApIsIdentity> [-CreationSource <String>]
 [<CommonParameters>]
```

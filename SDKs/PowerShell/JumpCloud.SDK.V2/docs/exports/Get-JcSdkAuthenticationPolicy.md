...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkAuthenticationPolicy.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkAuthenticationPolicy -ConsoleHost <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [-XTotalCount <Int32>] [<CommonParameters>]
```

### Get
```
Get-JcSdkAuthenticationPolicy -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkAuthenticationPolicy -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

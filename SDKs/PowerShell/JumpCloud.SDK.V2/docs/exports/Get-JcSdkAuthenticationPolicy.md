...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkAuthenticationPolicy.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkAuthenticationPolicy -HostEnv <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [-XTotalCount <Int32>] [<CommonParameters>]
```

### Get
```
Get-JcSdkAuthenticationPolicy -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkAuthenticationPolicy -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

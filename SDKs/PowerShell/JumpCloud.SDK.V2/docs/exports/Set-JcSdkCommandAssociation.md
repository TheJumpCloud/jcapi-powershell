...
### SetExpanded (Default)
```
Set-JcSdkCommandAssociation -CommandId <String> -Id <String> -Op <Op> -Type <Type>
 [-Attributes <IPaths1Gc5TamCommandsCommandIdAssociationsPostRequestbodyContentApplicationJsonSchemaPropertiesAttributes>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkCommandAssociation -CommandId <String> -Body <IGraphManagementReq0> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkCommandAssociation -InputObject <IJumpCloudApIsIdentity> -Body <IGraphManagementReq0> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkCommandAssociation -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <Op> -Type <Type>
 [-Attributes <IPaths1Gc5TamCommandsCommandIdAssociationsPostRequestbodyContentApplicationJsonSchemaPropertiesAttributes>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: JumpCloud.SDK.V2.Models.IPaths1Gc5TamCommandsCommandIdAssociationsPostRequestbodyContentApplicationJsonSchemaPropertiesAttributes
...
```yaml
Type: JumpCloud.SDK.V2.Models.IGraphManagementReq0
...
BODY <IGraphManagementReq0>: GraphManagementReq

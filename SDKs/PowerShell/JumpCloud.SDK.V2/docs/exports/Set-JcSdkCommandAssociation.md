...
### Set
```
Set-JcSdkCommandAssociation -CommandId <String> -Body <IGraphOperationCommand> [-CreationSource <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkCommandAssociation -InputObject <IJumpCloudApIsIdentity> -Body <IGraphOperationCommand>

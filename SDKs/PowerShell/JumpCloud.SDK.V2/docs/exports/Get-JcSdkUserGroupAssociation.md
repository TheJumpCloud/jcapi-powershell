...
### Get (Default)
```
Get-JcSdkUserGroupAssociation -GroupId <String> -Targets <GraphTargetsActiveDirectoryTargets>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupAssociation -InputObject <IJumpCloudApiIdentity>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupAssociation -HostEnv <String> -GroupId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserGroupAssociation -GroupId:(<string>)
```

...
### Get (Default)
```
Get-JcSdkUserGroupAssociation -GroupId <String> -Targets <Targets> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupAssociation -InputObject <IJumpCloudApIsIdentity> -Targets <Targets> [<CommonParameters>]
```

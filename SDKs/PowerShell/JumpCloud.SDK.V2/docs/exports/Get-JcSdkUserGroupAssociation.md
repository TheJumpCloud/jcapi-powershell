...
### Get (Default)
```
Get-JcSdkUserGroupAssociation -GroupId <String> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupAssociation -InputObject <IJumpCloudApIsIdentity> -Targets <String>

...
### Get (Default)
```
Get-JcSdkPolicyGroupMembership -GroupId <String> [-Filter <String[]>] [-Sort <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroupMembership -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [-Sort <String[]>]
 [<CommonParameters>]
```

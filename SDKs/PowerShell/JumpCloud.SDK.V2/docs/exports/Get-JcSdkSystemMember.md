...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemMember -ConsoleHost <String> -SystemId <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemMember -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]

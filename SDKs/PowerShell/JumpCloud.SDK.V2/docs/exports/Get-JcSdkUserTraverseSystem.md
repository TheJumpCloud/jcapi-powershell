...
### Get (Default)
```
Get-JcSdkUserTraverseSystem -UserId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseSystem -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

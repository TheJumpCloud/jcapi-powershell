...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseSystem.md
schema: 2.0.0
---

# Get-JcSdkUserTraverseSystem
...
### Get (Default)
```
Get-JcSdkUserTraverseSystem -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseSystem -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [<CommonParameters>]
```

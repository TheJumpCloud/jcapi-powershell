...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseSystemGroup.md
schema: 2.0.0
---

# Get-JcSdkUserGroupTraverseSystemGroup
...
### Get (Default)
```
Get-JcSdkUserGroupTraverseSystemGroup -GroupId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupTraverseSystemGroup -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

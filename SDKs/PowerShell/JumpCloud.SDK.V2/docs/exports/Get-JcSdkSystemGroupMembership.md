...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupMembership.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupMembership -HostEnv <String> -GroupId <String> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupMembership -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemGroupMembership -GroupId:(<string>)
```

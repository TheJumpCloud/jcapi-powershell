...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkApplicationAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkApplicationAssociation -ConsoleHost <String> -ApplicationId <String> [-Attributes <Hashtable>]
 [-Id <String>] [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkApplicationAssociation -ConsoleHost <String> -ApplicationId <String>
 -Body <IGraphOperationApplicationAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkApplicationAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IGraphOperationApplicationAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

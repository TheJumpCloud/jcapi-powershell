...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyGroupMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyGroupMember -HostEnv <String> -PolicyId <String> [-Filter <List<String>>]
 [-Sort <List<String>>] [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroupMember -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [-Sort <List<String>>] [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### List
```
Get-JcSdkPolicyGroupMember -HostEnv <String> -GroupId <String> [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkPolicyGroupMember -PolicyId:(<string>) -Filter:(<string[]>) -Sort:(<string[]>) -Authorization:(<string>) -Date:(<string>)
```
...
### -------------------------- EXAMPLE 2 --------------------------
```powershell
Get-JcSdkPolicyGroupMember -GroupId:(<string>)
```

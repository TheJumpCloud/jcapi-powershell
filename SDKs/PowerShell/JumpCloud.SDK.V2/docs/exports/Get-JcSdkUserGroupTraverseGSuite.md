...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseGSuite.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupTraverseGSuite -GroupId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupTraverseGSuite -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

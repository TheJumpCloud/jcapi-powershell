...
### LockViaIdentity
```
Lock-JcSdkAppleMdmDevice -InputObject <IJumpCloudSdkV2Identity>
 -Body <IPathsLf7IzoApplemdmsAppleMdmIdDevicesDeviceIdLockPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Lock-JcSdkAppleMdmDevice -InputObject <IJumpCloudSdkV2Identity> -Pin <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

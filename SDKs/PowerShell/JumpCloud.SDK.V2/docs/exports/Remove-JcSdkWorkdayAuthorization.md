...
### Delete (Default)
```
Remove-JcSdkWorkdayAuthorization -WorkdayId <String> [-CreationSource <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkWorkdayAuthorization -InputObject <IJumpCloudApIsIdentity> [-CreationSource <String>] [-PassThru]

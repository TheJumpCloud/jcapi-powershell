...
### Get (Default)
```
Get-JcSdkSoftwareAppAssociation -SoftwareAppId <String> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareAppAssociation -InputObject <IJumpCloudApIsIdentity> -Targets <String>

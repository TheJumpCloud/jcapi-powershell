...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkPolicyGroup.md
schema: 2.0.0
---
...
```
New-JcSdkPolicyGroup -HostEnv <String> [-Name <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkPolicyGroup -HostEnv <String> -Body <IPolicyGroupData> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkOffice365TranslationRule.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkOffice365TranslationRule -HostEnv <String> -Office365Id <String> [-Fields <List<String>>]
 [-Filter <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkOffice365TranslationRule -HostEnv <String> -Id <String> -Office365Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365TranslationRule -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

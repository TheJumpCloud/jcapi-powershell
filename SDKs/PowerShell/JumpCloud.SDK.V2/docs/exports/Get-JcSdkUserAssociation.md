...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserAssociation -HostEnv <String> -UserId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserAssociation -UserId:(<string>)
```

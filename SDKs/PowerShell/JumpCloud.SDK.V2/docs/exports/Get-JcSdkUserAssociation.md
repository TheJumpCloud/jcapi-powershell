...
### Get (Default)
```
Get-JcSdkUserAssociation -UserId <String> -Targets <Targets3> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserAssociation -InputObject <IJumpCloudSdkV2Identity> -Targets <Targets3> [<CommonParameters>]
```

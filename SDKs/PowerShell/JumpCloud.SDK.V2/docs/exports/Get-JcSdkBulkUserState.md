...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkBulkUserState.md
schema: 2.0.0
---
...
```
Get-JcSdkBulkUserState -HostEnv <String> [-Filter <List<String>>] [-Userid <String>] [<CommonParameters>]
```

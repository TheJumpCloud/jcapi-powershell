...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyGroup.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkPolicyGroup -HostEnv <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkPolicyGroup -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

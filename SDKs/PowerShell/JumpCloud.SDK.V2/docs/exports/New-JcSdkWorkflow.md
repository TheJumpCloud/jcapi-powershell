...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkWorkflow.md
schema: 2.0.0
---
...
```
New-JcSdkWorkflow -ConsoleHost <String> [-ApprovalType <String>] [-ApproverRequirement <String>]
...
### Create
```
New-JcSdkWorkflow -ConsoleHost <String> -Body <IJumpcloudIngressoCreateAccessWorkflowRequest> [-Confirm]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseLdapServer.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupTraverseLdapServer -ConsoleHost <String> -GroupId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupTraverseLdapServer -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserGroupTraverseLdapServer -GroupId:(<string>)
```

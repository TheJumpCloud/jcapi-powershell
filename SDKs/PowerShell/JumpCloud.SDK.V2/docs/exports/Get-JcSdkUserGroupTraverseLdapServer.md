...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroupTraverseLdapServer.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserGroupTraverseLdapServer -GroupId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroupTraverseLdapServer -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

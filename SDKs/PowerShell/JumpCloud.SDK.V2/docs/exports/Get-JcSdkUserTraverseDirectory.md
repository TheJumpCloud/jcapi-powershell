...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseDirectory.md
schema: 2.0.0
---

# Get-JcSdkUserTraverseDirectory
...
### Get (Default)
```
Get-JcSdkUserTraverseDirectory -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseDirectory -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [<CommonParameters>]
```

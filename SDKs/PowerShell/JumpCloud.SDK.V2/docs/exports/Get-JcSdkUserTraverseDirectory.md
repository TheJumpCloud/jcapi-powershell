...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseDirectory.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserTraverseDirectory -HostEnv <String> -UserId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseDirectory -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkUserTraverseDirectory -UserId:(<string>)
```

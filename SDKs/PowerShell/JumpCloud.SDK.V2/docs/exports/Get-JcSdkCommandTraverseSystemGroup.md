...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkCommandTraverseSystemGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkCommandTraverseSystemGroup -ConsoleHost <String> -CommandId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandTraverseSystemGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

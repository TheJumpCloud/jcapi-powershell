...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareApp.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkSoftwareApp -ConsoleHost <String> [-Filter <List<String>>] [-Sort <List<String>>]
 [<CommonParameters>]
```

### Get
```
Get-JcSdkSoftwareApp -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareApp -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

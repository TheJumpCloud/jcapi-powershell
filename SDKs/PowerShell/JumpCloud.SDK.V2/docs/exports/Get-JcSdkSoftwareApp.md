...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareApp.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkSoftwareApp -HostEnv <String> [-Filter <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkSoftwareApp -HostEnv <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareApp -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

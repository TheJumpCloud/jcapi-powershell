...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkCommandAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkCommandAssociation -HostEnv <String> -CommandId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkCommandAssociation -CommandId:(<string>)
```

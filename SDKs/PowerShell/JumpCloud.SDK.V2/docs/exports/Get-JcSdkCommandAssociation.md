...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkCommandAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkCommandAssociation -ConsoleHost <String> -CommandId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkCommandAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```

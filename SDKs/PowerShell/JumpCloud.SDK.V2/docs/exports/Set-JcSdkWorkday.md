...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkWorkday.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkWorkday -HostEnv <String> -Id <String> [-Name <String>] [-ReportUrl <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Set
```
Set-JcSdkWorkday -HostEnv <String> -Id <String> -Body <IWorkdayFields> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkWorkday -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Body <IWorkdayFields> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkWorkday -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Name <String>] [-ReportUrl <String>]

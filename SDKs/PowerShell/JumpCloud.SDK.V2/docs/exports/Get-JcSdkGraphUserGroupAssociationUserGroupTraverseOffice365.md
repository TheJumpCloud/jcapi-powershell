...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphUserGroupAssociationUserGroupTraverseOffice365.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphUserGroupAssociationUserGroupTraverseOffice365 -GroupId <String> [-Filter <String[]>]
 [<CommonParameters>]
```

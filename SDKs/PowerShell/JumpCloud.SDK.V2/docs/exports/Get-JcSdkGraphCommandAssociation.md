...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphCommandAssociation.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphCommandAssociation -CommandId <String> -Targets <String[]> [<CommonParameters>]
```

...
### Get (Default)
```
Get-JcSdkPolicyAssociation -PolicyId <String> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyAssociation -InputObject <IJumpCloudApIsIdentity> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyAssociation -HostEnv <String> -PolicyId <String> -Targets <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkPolicyAssociation -PolicyId:(<string>)
```

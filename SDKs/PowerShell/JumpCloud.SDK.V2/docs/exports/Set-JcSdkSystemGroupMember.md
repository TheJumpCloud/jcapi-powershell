...
### SetExpanded (Default)
```
Set-JcSdkSystemGroupMember -GroupId <String> -Id <String> -Op <Op> [-Authorization <String>] [-Date <String>]
...
```
Set-JcSdkSystemGroupMember -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <Op>
 [-Authorization <String>] [-Date <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Import-JcSdkWorkday.md
schema: 2.0.0
---
...
### Import (Default)
```
Import-JcSdkWorkday -HostEnv <String> -WorkdayId <String> -Body <List<IBulkUserCreate>> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ImportViaIdentity
```
Import-JcSdkWorkday -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Body <List<IBulkUserCreate>>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Update-JcSdkGSuite.md
schema: 2.0.0
---
...
### Update
```
Update-JcSdkGSuite -ConsoleHost <String> -Id <String> -Body <IGsuite> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-JcSdkGSuite -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Body <IGsuite> [-Confirm]

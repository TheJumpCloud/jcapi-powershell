...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkAppleMdmDevice.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkAppleMdmDevice -ConsoleHost <String> -AppleMdmId <String> -DeviceId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkAppleMdmDevice -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkAuthenticationPolicy.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkAuthenticationPolicy -ConsoleHost <String> -Id <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkAuthenticationPolicy -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm]

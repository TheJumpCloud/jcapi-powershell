...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkAuthenticationPolicy.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkAuthenticationPolicy -HostEnv <String> -Id <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkAuthenticationPolicy -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Remove-JcSdkAuthenticationPolicy -Id:(<string>)
```

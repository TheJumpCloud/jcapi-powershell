...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemTraversePolicyGroup.md
schema: 2.0.0
---

# Get-JcSdkSystemTraversePolicyGroup
...
### Get (Default)
```
Get-JcSdkSystemTraversePolicyGroup -HostEnv <String> -SystemId <String> [-Filter <List<String>>]
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraversePolicyGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
 [-Filter <List<String>>] [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSystemTraversePolicyGroup -SystemId:(<string>)
```

...
### Get (Default)
```
Get-JcSdkSystemTraversePolicyGroup -SystemId <String> [-Filter <String[]>] [-Authorization <String>]
 [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemTraversePolicyGroup -InputObject <IJumpCloudApiIdentity> [-Filter <String[]>]

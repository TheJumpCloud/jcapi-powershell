...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupMember -HostEnv <String> -GroupId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupMember -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

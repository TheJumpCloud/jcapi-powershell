...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupMember.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupMember -ConsoleHost <String> -GroupId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupMember -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

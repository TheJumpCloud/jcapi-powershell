...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkUserGroup.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkUserGroup -ConsoleHost <String> -Id <String> [-Attributes <Hashtable>] [-Description <String>]
...
### Set
```
Set-JcSdkUserGroup -ConsoleHost <String> -Id <String> -Body <IUserGroupPut> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Body <IUserGroupPut> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Attributes <Hashtable>]

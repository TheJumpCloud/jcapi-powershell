...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkGraphRadiusServerAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkGraphRadiusServerAssociation -RadiusserverId <String> -Id <String> -Op <String> -Type <String>
 [-Attributes <IGraphManagementReqAttributes>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkGraphRadiusServerAssociation -RadiusserverId <String> -Body <IGraphManagementReq> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkGraphRadiusServerAssociation -InputObject <IJumpCloudApIsIdentity> -Body <IGraphManagementReq>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkGraphRadiusServerAssociation -InputObject <IJumpCloudApIsIdentity> -Id <String> -Op <String>

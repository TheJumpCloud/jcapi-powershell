...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkDuoApplication.md
schema: 2.0.0
---
...
```
New-JcSdkDuoApplication -HostEnv <String> -AccountId <String> [-ApiHost <String>] [-IntegrationKey <String>]
 [-Name <String>] [-SecretKey <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkDuoApplication -HostEnv <String> -AccountId <String> -Body <IDuoApplicationReq> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-JcSdkDuoApplication -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Body <IDuoApplicationReq>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-JcSdkDuoApplication -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-ApiHost <String>]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkUserGroup.md
schema: 2.0.0
---
...
```
New-JcSdkUserGroup -ConsoleHost <String> [-Attributes <Hashtable>] [-Description <String>] [-Email <String>]
...
### Create
```
New-JcSdkUserGroup -ConsoleHost <String> -Body <IUserGroupPost> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSambaDomainLdapServerSambaDomain.md
schema: 2.0.0
---
...
### Get
```
Get-JcSdkSambaDomainLdapServerSambaDomain -Id <String> -LdapserverId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSambaDomainLdapServerSambaDomain -InputObject <IJumpCloudApIsIdentity> [<CommonParameters>]
```

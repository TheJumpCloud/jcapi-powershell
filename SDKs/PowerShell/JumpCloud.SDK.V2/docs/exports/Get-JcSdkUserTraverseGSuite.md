...
### Get (Default)
```
Get-JcSdkUserTraverseGSuite -UserId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseGSuite -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

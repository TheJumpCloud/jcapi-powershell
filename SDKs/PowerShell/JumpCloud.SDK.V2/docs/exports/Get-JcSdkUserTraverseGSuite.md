...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserTraverseGSuite.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkUserTraverseGSuite -ConsoleHost <String> -UserId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserTraverseGSuite -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkAccessRequest.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkAccessRequest -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-OrganizationObjectId <Byte[]>] [-Sort <String>] [<CommonParameters>]
```

### Get
```
Get-JcSdkAccessRequest -ConsoleHost <String> -Id <String> [-OrganizationObjectId <Byte[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkAccessRequest -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

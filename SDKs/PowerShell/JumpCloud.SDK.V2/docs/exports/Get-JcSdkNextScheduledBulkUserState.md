...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkNextScheduledBulkUserState.md
schema: 2.0.0
---
...
```
Get-JcSdkNextScheduledBulkUserState -ConsoleHost <String> -Users <List<String>> [<CommonParameters>]
```

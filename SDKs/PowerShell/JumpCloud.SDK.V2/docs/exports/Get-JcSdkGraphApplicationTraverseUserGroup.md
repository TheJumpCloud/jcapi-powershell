...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphApplicationTraverseUserGroup.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphApplicationTraverseUserGroup -ApplicationId <String> [-Filter <String[]>] [<CommonParameters>]
```

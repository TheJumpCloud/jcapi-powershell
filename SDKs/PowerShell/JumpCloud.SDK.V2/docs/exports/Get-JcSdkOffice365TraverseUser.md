...
### Get (Default)
```
Get-JcSdkOffice365TraverseUser -Office365Id <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365TraverseUser -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

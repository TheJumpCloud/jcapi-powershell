...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkOffice365TraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkOffice365TraverseUser -Office365Id <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkOffice365TraverseUser -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [<CommonParameters>]
```

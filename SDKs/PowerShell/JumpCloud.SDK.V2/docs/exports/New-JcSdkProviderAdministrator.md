...
```
New-JcSdkProviderAdministrator -ProviderId <String> -Email <String> [-CreationSource <String>]
...
### Create
```
New-JcSdkProviderAdministrator -ProviderId <String> -Body <IProviderAdminReq> [-CreationSource <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-JcSdkProviderAdministrator -InputObject <IJumpCloudApIsIdentity> -Body <IProviderAdminReq>
 [-CreationSource <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-JcSdkProviderAdministrator -InputObject <IJumpCloudApIsIdentity> -Email <String>
 [-CreationSource <String>] [-EnableMultiFactor] [-Firstname <String>] [-Lastname <String>] [-Role <String>]

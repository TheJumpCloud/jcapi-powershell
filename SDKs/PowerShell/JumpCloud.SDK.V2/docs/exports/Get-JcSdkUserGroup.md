...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkUserGroup.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkUserGroup -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkUserGroup -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkUserGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

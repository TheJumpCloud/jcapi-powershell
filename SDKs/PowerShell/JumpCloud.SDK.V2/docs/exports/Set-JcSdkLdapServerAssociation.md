...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkLdapServerAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkLdapServerAssociation -HostEnv <String> -LdapserverId <String> [-Attributes <Hashtable>]
 [-Id <String>] [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkLdapServerAssociation -HostEnv <String> -LdapserverId <String>
 -Body <IGraphOperationLdapServerAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkLdapServerAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IGraphOperationLdapServerAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: JumpCloud.SDK.V2.Models.IGraphOperationLdapServerAutoGenerated
...
### JumpCloud.SDK.V2.Models.IGraphOperationLdapServerAutoGenerated
...
`BODY <IGraphOperationLdapServerAutoGenerated>`: GraphOperation (LdapServer)

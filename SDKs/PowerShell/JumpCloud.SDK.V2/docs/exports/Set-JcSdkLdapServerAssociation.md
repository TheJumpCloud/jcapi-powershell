...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkLdapServerAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkLdapServerAssociation -ConsoleHost <String> -LdapserverId <String> [-Attributes <Hashtable>]
 [-Id <String>] [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkLdapServerAssociation -ConsoleHost <String> -LdapserverId <String>
 -Body <IGraphOperationLdapServerAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkLdapServerAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IGraphOperationLdapServerAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

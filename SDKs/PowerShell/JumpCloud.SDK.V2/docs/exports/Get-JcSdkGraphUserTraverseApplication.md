...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphUserTraverseApplication.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphUserTraverseApplication -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

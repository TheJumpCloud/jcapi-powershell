...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkBulkUsersResult.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkBulkUsersResult -HostEnv <String> -JobId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkBulkUsersResult -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

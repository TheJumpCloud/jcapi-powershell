...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkRadiusServerAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkRadiusServerAssociation -HostEnv <String> -RadiusserverId <String> -Targets <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkRadiusServerAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```

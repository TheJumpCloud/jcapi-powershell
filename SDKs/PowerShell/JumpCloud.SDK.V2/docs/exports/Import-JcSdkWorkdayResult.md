...
### Import (Default)
```
Import-JcSdkWorkdayResult -Id <String> -JobId <String> [-CreationSource <String>] [<CommonParameters>]
```

### ImportViaIdentity
```
Import-JcSdkWorkdayResult -InputObject <IJumpCloudApIsIdentity> [-CreationSource <String>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Import-JcSdkWorkdayResult.md
schema: 2.0.0
---
...
### Import (Default)
```
Import-JcSdkWorkdayResult -HostEnv <String> -Id <String> -JobId <String> [<CommonParameters>]
```

### ImportViaIdentity
```
Import-JcSdkWorkdayResult -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

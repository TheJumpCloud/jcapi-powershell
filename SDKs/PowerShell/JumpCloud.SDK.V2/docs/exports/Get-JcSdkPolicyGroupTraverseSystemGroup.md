...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyGroupTraverseSystemGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyGroupTraverseSystemGroup -HostEnv <String> -GroupId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroupTraverseSystemGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkPolicyGroupTraverseSystemGroup -GroupId:(<string>)
```

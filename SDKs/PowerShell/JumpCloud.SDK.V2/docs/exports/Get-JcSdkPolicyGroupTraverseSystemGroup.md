...
### Get (Default)
```
Get-JcSdkPolicyGroupTraverseSystemGroup -GroupId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyGroupTraverseSystemGroup -InputObject <IJumpCloudApiIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

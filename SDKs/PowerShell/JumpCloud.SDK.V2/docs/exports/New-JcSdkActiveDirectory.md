...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkActiveDirectory.md
schema: 2.0.0
---
...
```
New-JcSdkActiveDirectory -HostEnv <String> [-DelegationState <String>] [-Domain <String>] [-GroupsEnabled]
 [-UpdatedAt <DateTime>] [-UseCase <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkActiveDirectory -HostEnv <String> -Body <IActiveDirectory> [-Confirm] [-WhatIf] [<CommonParameters>]
```

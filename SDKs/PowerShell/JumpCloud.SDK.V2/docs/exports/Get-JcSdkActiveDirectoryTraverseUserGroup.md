...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkActiveDirectoryTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkActiveDirectoryTraverseUserGroup -HostEnv <String> -ActivedirectoryId <String>
 [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkActiveDirectoryTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
 [-Filter <List<String>>] [<CommonParameters>]
```

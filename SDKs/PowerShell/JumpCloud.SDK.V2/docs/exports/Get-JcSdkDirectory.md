...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkDirectory.md
schema: 2.0.0
---
...
```
Get-JcSdkDirectory -HostEnv <String> [-Fields <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

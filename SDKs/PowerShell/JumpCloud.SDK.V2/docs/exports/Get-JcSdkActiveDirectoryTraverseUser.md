...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkActiveDirectoryTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkActiveDirectoryTraverseUser -ActivedirectoryId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkActiveDirectoryTraverseUser -InputObject <IJumpCloudApiIdentity> [-Filter <String[]>]
 [<CommonParameters>]
```

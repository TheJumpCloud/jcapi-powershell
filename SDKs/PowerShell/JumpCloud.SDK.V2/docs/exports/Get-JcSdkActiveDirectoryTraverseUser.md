...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkActiveDirectoryTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkActiveDirectoryTraverseUser -ConsoleHost <String> -ActivedirectoryId <String>
 [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkActiveDirectoryTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 [-Filter <List<String>>] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphLdapServerTraverseUser.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphLdapServerTraverseUser -LdapserverId <String> [-Filter <String[]>] [<CommonParameters>]
```

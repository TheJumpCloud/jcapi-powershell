...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkAccessRequest.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkAccessRequest -ConsoleHost <String> -Id <String> [-Admin <String>] [-ApprovedDuration <String>]
 [-InternalNote <String>] [-OrganizationObjectIdInputFile <String>] [-Remarks <String>] [-Status <String>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkAccessRequest -ConsoleHost <String> -Id <String>
...
### SetViaIdentity
```
Set-JcSdkAccessRequest -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IPaths17F25RsApprovalflowrequestIdPutRequestbodyContentApplicationJsonSchema> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Set-JcSdkAccessRequest -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Admin <String>]

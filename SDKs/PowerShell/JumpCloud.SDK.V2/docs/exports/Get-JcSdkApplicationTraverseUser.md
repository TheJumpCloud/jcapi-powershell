...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkApplicationTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkApplicationTraverseUser -HostEnv <String> -ApplicationId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationTraverseUser -HostEnv <String> -InputObject <IJumpCloudApiIdentity>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkWorkday.md
schema: 2.0.0
---
...
```
New-JcSdkWorkday -HostEnv <String> [-BasicPassword <String>] [-BasicUsername <String>] [-Name <String>]
 [-OauthCode <String>] [-ReportUrl <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkWorkday -HostEnv <String> -Body <IWorkdayInput> [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
```
New-JcSdkWorkday [-CreationSource <String>] [-BasicPassword <String>] [-BasicUsername <String>]
 [-Name <String>] [-OauthCode <String>] [-ReportUrl <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkWorkday -Body <IWorkdayInput> [-CreationSource <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Import-JcSdkScim.md
schema: 2.0.0
---
...
### Import (Default)
```
Import-JcSdkScim -HostEnv <String> -ApplicationId <String> [-Filter <String>] [-Query <String>]
 [-Sort <String>] [-SortOrder <String>] [<CommonParameters>]
```

### ImportViaIdentity
```
Import-JcSdkScim -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <String>] [-Query <String>]
 [-Sort <String>] [-SortOrder <String>] [<CommonParameters>]
```

...
### Import (Default)
```
Import-JcSdkScim -ApplicationId <String> [-Filter <String>] [-Query <String>] [-Sort <Sort>]
 [-SortOrder <SortOrder1>] [<CommonParameters>]
```

### ImportViaIdentity
```
Import-JcSdkScim -InputObject <IJumpCloudApiIdentity> [-Filter <String>] [-Query <String>] [-Sort <Sort>]
 [-SortOrder <SortOrder1>] [<CommonParameters>]
```
...
```yaml
Type: JumpCloud.SDK.V2.Support.Sort
Parameter Sets: (All)
Aliases:
...
```yaml
Type: JumpCloud.SDK.V2.Support.SortOrder1
Parameter Sets: (All)
Aliases:

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkSystemGroup.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkSystemGroup -HostEnv <String> -Id <String> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkSystemGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm]

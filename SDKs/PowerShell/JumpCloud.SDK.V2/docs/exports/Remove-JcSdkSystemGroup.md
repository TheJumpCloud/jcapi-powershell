...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkSystemGroup.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkSystemGroup -ConsoleHost <String> -Id <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkSystemGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-PassThru] [-Confirm]

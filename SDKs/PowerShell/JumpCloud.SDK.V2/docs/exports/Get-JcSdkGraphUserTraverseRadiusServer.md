...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphUserTraverseRadiusServer.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphUserTraverseRadiusServer -UserId <String> [-Filter <String[]>] [<CommonParameters>]
```

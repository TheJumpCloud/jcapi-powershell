...
### SetExpanded (Default)
```
Set-JcSdkSoftwareAppAssociation -SoftwareAppId <String> -Id <String> -Op <String> -Type <Type1>
...
### SetViaIdentity
```
Set-JcSdkSoftwareAppAssociation -InputObject <IJumpCloudSdkV2Identity> -Body <IGraphOperationSoftwareApp>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-JcSdkSoftwareAppAssociation -InputObject <IJumpCloudSdkV2Identity> -Id <String> -Op <String> -Type <Type1>
 [-Attributes <Hashtable>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

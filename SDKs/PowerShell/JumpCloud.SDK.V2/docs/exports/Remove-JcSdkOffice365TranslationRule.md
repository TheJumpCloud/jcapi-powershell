...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Remove-JcSdkOffice365TranslationRule.md
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-JcSdkOffice365TranslationRule -HostEnv <String> -Id <String> -Office365Id <String> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-JcSdkOffice365TranslationRule -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

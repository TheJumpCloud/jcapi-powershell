...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppTraverseSystemGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSoftwareAppTraverseSystemGroup -HostEnv <String> -SoftwareAppId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareAppTraverseSystemGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>

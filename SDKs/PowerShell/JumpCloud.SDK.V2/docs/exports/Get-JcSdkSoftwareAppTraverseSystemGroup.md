...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppTraverseSystemGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSoftwareAppTraverseSystemGroup -ConsoleHost <String> -SoftwareAppId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareAppTraverseSystemGroup -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

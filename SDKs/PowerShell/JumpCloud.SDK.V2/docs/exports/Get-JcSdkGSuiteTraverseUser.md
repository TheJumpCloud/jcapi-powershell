...
### Get (Default)
```
Get-JcSdkGSuiteTraverseUser -GsuiteId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTraverseUser -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

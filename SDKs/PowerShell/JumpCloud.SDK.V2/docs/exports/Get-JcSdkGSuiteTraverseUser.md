...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkGSuiteTraverseUser -HostEnv <String> -GsuiteId <String> [-Filter <List<String>>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTraverseUser -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkGSuiteTraverseUser -ConsoleHost <String> -GsuiteId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

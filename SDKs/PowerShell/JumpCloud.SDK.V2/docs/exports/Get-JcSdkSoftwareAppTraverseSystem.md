...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSoftwareAppTraverseSystem -HostEnv <String> -SoftwareAppId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareAppTraverseSystem -HostEnv <String> -InputObject <IJumpCloudApiIdentity>
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkSoftwareAppTraverseSystem -SoftwareAppId:(<string>)
```

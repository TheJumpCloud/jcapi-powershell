...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSoftwareAppTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSoftwareAppTraverseSystem -ConsoleHost <String> -SoftwareAppId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSoftwareAppTraverseSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

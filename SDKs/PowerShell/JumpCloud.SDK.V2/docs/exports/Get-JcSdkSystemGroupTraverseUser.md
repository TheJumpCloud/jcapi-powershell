...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemGroupTraverseUser.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemGroupTraverseUser -ConsoleHost <String> -GroupId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemGroupTraverseUser -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

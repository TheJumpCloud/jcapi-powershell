...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphUserGroupAssociationUserGroupTraverseSystem.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphUserGroupAssociationUserGroupTraverseSystem -GroupId <String> [-Filter <String[]>]
 [<CommonParameters>]
```

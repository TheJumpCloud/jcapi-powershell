...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Invoke-JcSdkReclaimSoftwareAppLicense.md
schema: 2.0.0
---
...
### Reclaim (Default)
```
Invoke-JcSdkReclaimSoftwareAppLicense -ConsoleHost <String> -SoftwareAppId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ReclaimViaIdentity
```
Invoke-JcSdkReclaimSoftwareAppLicense -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [-Confirm]

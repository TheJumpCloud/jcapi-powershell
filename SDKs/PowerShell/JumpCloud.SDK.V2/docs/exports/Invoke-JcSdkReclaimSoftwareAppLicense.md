...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Invoke-JcSdkReclaimSoftwareAppLicense.md
schema: 2.0.0
---
...
### Reclaim (Default)
```
Invoke-JcSdkReclaimSoftwareAppLicense -HostEnv <String> -SoftwareAppId <String> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ReclaimViaIdentity
```
Invoke-JcSdkReclaimSoftwareAppLicense -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Confirm]

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkApplicationAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkApplicationAssociation -HostEnv <String> -ApplicationId <String> -Targets <String>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationAssociation -HostEnv <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkApplicationAssociation -ApplicationId:(<string>)
```

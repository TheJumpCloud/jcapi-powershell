...
### Get (Default)
```
Get-JcSdkApplicationAssociation -ApplicationId <String> -Targets <String> [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkApplicationAssociation -InputObject <IJumpCloudApIsIdentity> -Targets <String>

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyStatus.md
schema: 2.0.0
---
...
```
Get-JcSdkPolicyStatus -HostEnv <String> -PolicyId <String> [-Fields <List<String>>] [-Filter <List<String>>]

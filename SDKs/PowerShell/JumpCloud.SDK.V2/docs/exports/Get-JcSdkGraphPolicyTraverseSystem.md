...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphPolicyTraverseSystem.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphPolicyTraverseSystem -PolicyId <String> [-Filter <String[]>] [<CommonParameters>]
```

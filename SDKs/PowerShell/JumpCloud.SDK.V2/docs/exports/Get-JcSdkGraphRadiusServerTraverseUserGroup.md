...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphRadiusServerTraverseUserGroup.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphRadiusServerTraverseUserGroup -RadiusserverId <String> [-Filter <String[]>] [<CommonParameters>]
```

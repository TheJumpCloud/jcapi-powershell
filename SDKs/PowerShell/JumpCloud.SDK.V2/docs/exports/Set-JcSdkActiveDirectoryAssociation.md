...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkActiveDirectoryAssociation.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkActiveDirectoryAssociation -ConsoleHost <String> -ActivedirectoryId <String>
...
### SetViaIdentity
```
Set-JcSdkActiveDirectoryAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IGraphOperationActiveDirectoryAutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

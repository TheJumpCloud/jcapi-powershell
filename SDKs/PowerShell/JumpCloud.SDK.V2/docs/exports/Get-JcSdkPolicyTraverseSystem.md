...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyTraverseSystem -PolicyId <String> [-Filter <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyTraverseSystem -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>] [<CommonParameters>]
```

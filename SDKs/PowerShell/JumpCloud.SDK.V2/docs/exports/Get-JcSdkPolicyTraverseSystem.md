...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyTraverseSystem -ConsoleHost <String> -PolicyId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyTraverseSystem -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>

...
### Get (Default)
```
Get-JcSdkPolicyTraverseSystem -PolicyId <String> [-Filter <String[]>] [-CreationSource <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyTraverseSystem -InputObject <IJumpCloudApIsIdentity> [-Filter <String[]>]

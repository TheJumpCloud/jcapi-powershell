...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkPolicyTraverseSystem.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkPolicyTraverseSystem -HostEnv <String> -PolicyId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkPolicyTraverseSystem -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [-Filter <List<String>>]
 [<CommonParameters>]
```
...
### -------------------------- EXAMPLE 1 --------------------------
```powershell
Get-JcSdkPolicyTraverseSystem -PolicyId:(<string>)
```

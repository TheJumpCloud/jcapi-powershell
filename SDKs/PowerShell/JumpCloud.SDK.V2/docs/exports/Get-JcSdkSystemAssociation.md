...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkSystemAssociation.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkSystemAssociation -ConsoleHost <String> -SystemId <String> -Targets <String>
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkSystemAssociation -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> -Targets <String>
 [-Authorization <String>] [-Date <String>] [<CommonParameters>]
```

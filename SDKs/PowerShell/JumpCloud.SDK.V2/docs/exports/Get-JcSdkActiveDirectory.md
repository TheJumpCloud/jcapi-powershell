...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkActiveDirectory.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkActiveDirectory -ConsoleHost <String> [-Fields <List<String>>] [-Filter <List<String>>]
 [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkActiveDirectory -ConsoleHost <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkActiveDirectory -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkPolicy.md
schema: 2.0.0
---
...
```
New-JcSdkPolicy -HostEnv <String> [-Name <String>] [-Notes <String>] [-TemplateId <String>]
 [-Values <IPolicyValue[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkPolicy -HostEnv <String> -Body <IPolicyCreateRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```

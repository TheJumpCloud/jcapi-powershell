...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkLdapServerTraverseUserGroup.md
schema: 2.0.0
---
...
### Get (Default)
```
Get-JcSdkLdapServerTraverseUserGroup -HostEnv <String> -LdapserverId <String> [-Filter <List<String>>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkLdapServerTraverseUserGroup -HostEnv <String> -InputObject <IJumpCloudApiIdentity>

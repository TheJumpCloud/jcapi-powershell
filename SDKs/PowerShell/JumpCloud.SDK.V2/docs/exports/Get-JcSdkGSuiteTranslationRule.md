...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4908_userGroupDeviceGroupFilters/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGSuiteTranslationRule.md
schema: 2.0.0
---
...
### List (Default)
```
Get-JcSdkGSuiteTranslationRule -HostEnv <String> -GsuiteId <String> [-Fields <List<String>>]
 [-Filter <List<String>>] [-Sort <List<String>>] [<CommonParameters>]
```

### Get
```
Get-JcSdkGSuiteTranslationRule -HostEnv <String> -GsuiteId <String> -Id <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JcSdkGSuiteTranslationRule -HostEnv <String> -InputObject <IJumpCloudApiIdentity> [<CommonParameters>]
```

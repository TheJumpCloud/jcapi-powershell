...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Get-JcSdkGraphCommandTraverseSystemGroup.md
schema: 2.0.0
---
...
```
Get-JcSdkGraphCommandTraverseSystemGroup -CommandId <String> [-Filter <String[]>] [<CommonParameters>]
```

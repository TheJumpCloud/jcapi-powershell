...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/Set-JcSdkOffice365Association.md
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-JcSdkOffice365Association -ConsoleHost <String> -Office365Id <String> [-Attributes <Hashtable>]
 [-Id <String>] [-Op <String>] [-Type <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-JcSdkOffice365Association -ConsoleHost <String> -Office365Id <String>
 -Body <IGraphOperationOffice365AutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-JcSdkOffice365Association -ConsoleHost <String> -InputObject <IJumpCloudApiIdentity>
 -Body <IGraphOperationOffice365AutoGenerated> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

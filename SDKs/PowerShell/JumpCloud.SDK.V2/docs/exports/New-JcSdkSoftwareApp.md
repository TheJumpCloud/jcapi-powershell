...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4022_AccessRequests/SDKs/PowerShell/JumpCloud.SDK.V2/docs/exports/New-JcSdkSoftwareApp.md
schema: 2.0.0
---
...
```
New-JcSdkSoftwareApp -ConsoleHost <String> [-CreatedAt <DateTime>] [-DisplayName <String>] [-Id <String>]
 [-Settings <ISoftwareAppSettings[]>] [-UpdatedAt <DateTime>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-JcSdkSoftwareApp -ConsoleHost <String> -Body <ISoftwareApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```

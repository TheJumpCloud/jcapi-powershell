...
using static JumpCloud.SDK.DirectoryInsights.Runtime.PowerShell.PsHelpers;
  ...
  public class ExportPsd1 : PSCmdlet
  {
    ...
    protected override void ProcessRecord()
    {
      try
      {
        ...
        string version = Convert.ToString(@"0.0.5");
        ...
        sb.AppendLine($@"{Indent}RootModule = '{"./JumpCloud.SDK.DirectoryInsights.psm1"}'");
        ...
        sb.AppendLine($@"{Indent}Description = '{"The JumpCloud DirectoryInsights PowerShell SDK"}'");
        sb.AppendLine($@"{Indent}PowerShellVersion = '5.1'");
        sb.AppendLine($@"{Indent}DotNetFrameworkVersion = '4.7.2'");
        sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/JumpCloud.SDK.DirectoryInsights.private.dll"}'");
        ...
        var formatList = customFormatPs1xmlFiles.Prepend("./JumpCloud.SDK.DirectoryInsights.format.ps1xml").ToPsList();
        ...
        sb.AppendLine($@"{Indent}{Indent}{Indent}ProjectUri = '{"https://github.com/TheJumpCloud/jcapi-powershell/tree/master/AutoRest/SDKs/PowerShell/JumpCloud.SDK.DirectoryInsights/"}'");

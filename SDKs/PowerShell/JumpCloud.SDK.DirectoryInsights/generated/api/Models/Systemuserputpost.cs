...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class Systemuserputpost :
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpost,
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostInternal
    {
        ...
        private JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem[] _addresses;

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Owned)]
        public JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem[] Addresses { get => this._addresses; set => this._addresses = value; }
        ...
        private JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem[] _attributes;

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Owned)]
        public JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem[] Attributes { get => this._attributes; set => this._attributes = value; }
        ...
        JumpCloud.SDK.DirectoryInsights.Models.IMfa JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostInternal.Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.DirectoryInsights.Models.Mfa()); set { {_mfa = value;} } }
        ...
        private JumpCloud.SDK.DirectoryInsights.Models.IMfa _mfa;

        /// <summary>mfa</summary>
        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Owned)]
        internal JumpCloud.SDK.DirectoryInsights.Models.IMfa Mfa { get => (this._mfa = this._mfa ?? new JumpCloud.SDK.DirectoryInsights.Models.Mfa()); set => this._mfa = value; }

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Inlined)]
        public bool? MfaConfigured { get => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).Configured; set => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).Configured = value; }

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Inlined)]
        public bool? MfaExclusion { get => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).Exclusion; set => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).Exclusion = value; }

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Inlined)]
        public global::System.DateTime? MfaExclusionUntil { get => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).ExclusionUntil; set => ((JumpCloud.SDK.DirectoryInsights.Models.IMfaInternal)Mfa).ExclusionUntil = value; }
        ...
        private JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem[] _phoneNumbers;

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Owned)]
        public JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem[] PhoneNumbers { get => this._phoneNumbers; set => this._phoneNumbers = value; }
        ...
        private JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem[] _relationships;

        [JumpCloud.SDK.DirectoryInsights.Origin(JumpCloud.SDK.DirectoryInsights.PropertyOrigin.Owned)]
        public JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem[] Relationships { get => this._relationships; set => this._relationships = value; }
        ...
        JumpCloud.SDK.DirectoryInsights.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem) })]
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAddressesItem[] Addresses { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem) })]
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostAttributesItem[] Attributes { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem) })]
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostPhoneNumbersItem[] PhoneNumbers { get; set; }
        ...
        PossibleTypes = new [] { typeof(JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem) })]
        JumpCloud.SDK.DirectoryInsights.Models.ISystemuserputpostRelationshipsItem[] Relationships { get; set; }
...

    {
        ...
        string Location { get; set; }
        /// <summary>mfa</summary>
        JumpCloud.SDK.DirectoryInsights.Models.IMfa Mfa { get; set; }

...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class ErrorresponseTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Errorresponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.IErrorresponse ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(JumpCloud.SDK.DirectoryInsights.Models.IErrorresponse).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try

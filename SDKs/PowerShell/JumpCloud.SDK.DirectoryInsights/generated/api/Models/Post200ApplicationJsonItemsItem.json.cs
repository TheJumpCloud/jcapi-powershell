...
namespace JumpCloud.SDK.DirectoryInsights.Models
{
    ...
    public partial class Post200ApplicationJsonItemsItem
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode"/> into an instance of JumpCloud.SDK.DirectoryInsights.Models.IPost200ApplicationJsonItemsItem.
        /// </summary>
        /// <param name="node">a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of JumpCloud.SDK.DirectoryInsights.Models.IPost200ApplicationJsonItemsItem.
        /// </returns>
        public static JumpCloud.SDK.DirectoryInsights.Models.IPost200ApplicationJsonItemsItem FromJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode node)
        {
            return node is JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json ? new Post200ApplicationJsonItemsItem(json) : null;
        }

        /// <summary>
        /// Deserializes a JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject into a new instance of <see cref="Post200ApplicationJsonItemsItem" />.
        /// </summary>
        /// <param name="json">A JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject instance to deserialize from.</param>
        /// <param name="exclusions"></param>
        internal Post200ApplicationJsonItemsItem(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject json, global::System.Collections.Generic.HashSet<string> exclusions = null)
        {
            ...
            JumpCloud.SDK.DirectoryInsights.Runtime.JsonSerializable.FromJson( json, ((JumpCloud.SDK.DirectoryInsights.Runtime.IAssociativeArray<global::System.Object>)this).AdditionalProperties, JumpCloud.SDK.DirectoryInsights.Runtime.JsonSerializable.DeserializeDictionary(()=>new global::System.Collections.Generic.Dictionary<global::System.String,global::System.Object>()),exclusions );
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Post200ApplicationJsonItemsItem" /> into a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Post200ApplicationJsonItemsItem" /> as a <see cref="JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode" />.
        /// </returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonNode ToJson(JumpCloud.SDK.DirectoryInsights.Runtime.Json.JsonObject container, JumpCloud.SDK.DirectoryInsights.Runtime.SerializationMode serializationMode)
        {
            ...
            JumpCloud.SDK.DirectoryInsights.Runtime.JsonSerializable.ToJson( ((JumpCloud.SDK.DirectoryInsights.Runtime.IAssociativeArray<global::System.Object>)this).AdditionalProperties, container);

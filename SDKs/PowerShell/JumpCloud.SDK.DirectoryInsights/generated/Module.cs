...
namespace JumpCloud.SDK.DirectoryInsights
{
    ...
    public partial class Module
    {
        ...
        private JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline _pipelineWithProxy;

        public global::System.Net.WebProxy _webProxy = new global::System.Net.WebProxy();

        /// <summary>The instance of the Client API</summary>
        public JumpCloud.SDK.DirectoryInsights.DirectoryInsightsApi ClientAPI { get; set; }

        /// <summary>Backing field for <see cref="Instance" /> property.</summary>
        private static JumpCloud.SDK.DirectoryInsights.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static JumpCloud.SDK.DirectoryInsights.Module Instance => JumpCloud.SDK.DirectoryInsights.Module._instance?? (JumpCloud.SDK.DirectoryInsights.Module._instance = new JumpCloud.SDK.DirectoryInsights.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"JumpCloud.SDK.DirectoryInsights";
        ...
        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline for the remote call.</returns>
        public JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string parameterSetName = null)
        {
            JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new JumpCloud.SDK.DirectoryInsights.DirectoryInsightsApi();
            _handler.Proxy = _webProxy;
            _pipeline = new JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline(new JumpCloud.SDK.DirectoryInsights.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new JumpCloud.SDK.DirectoryInsights.Runtime.HttpPipeline(new JumpCloud.SDK.DirectoryInsights.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }

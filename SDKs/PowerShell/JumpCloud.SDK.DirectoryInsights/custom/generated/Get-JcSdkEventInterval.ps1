        ...
        If ($Paginate -and $PSCmdlet.ParameterSetName -in ('GetExpanded')) {
            ...
            Do {
                ...
                :retryLoop do {
                    $resultCounter++
                    try {
                        $Result = (JumpCloud.SDK.DirectoryInsights.internal\Get-JcSdkInternalEventInterval -ErrorAction SilentlyContinue @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
                        break retryLoop
                    } catch {

...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.DirectoryInsights/docs/exports/New-JcSdkDirectoryInsightReport.md
#>
 Function New-JcSdkDirectoryInsightReport
{
    ...
    Process
    {
        $Results = (JumpCloud.SDK.DirectoryInsights.internal\New-JcSdkInternalDirectoryInsightReport @PSBoundParameters).ToJsonString() | ConvertFrom-Json;
    }
    End
    {

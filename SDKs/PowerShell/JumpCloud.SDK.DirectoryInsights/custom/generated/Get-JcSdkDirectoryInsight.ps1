...
.Link
https://github.com/TheJumpCloud/jcapi-powershell/tree/master/SDKs/PowerShell/JumpCloud.SDK.DirectoryInsights/docs/exports/Get-JcSdkDirectoryInsight.md
#>
 Function Get-JcSdkDirectoryInsight
{
    ...
    Process
    {
        $Result = (JumpCloud.SDK.DirectoryInsights.internal\Get-JcSdkInternalDirectoryInsight @PSBoundParameters).ToJsonString() | ConvertFrom-Json;

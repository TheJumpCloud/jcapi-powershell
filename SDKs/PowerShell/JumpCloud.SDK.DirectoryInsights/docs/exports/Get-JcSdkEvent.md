...
online version: https://github.com/TheJumpCloud/jcapi-powershell/tree/CUT-4981_v2EUSupport/SDKs/PowerShell/JumpCloud.SDK.DirectoryInsights/docs/exports/Get-JcSdkEvent.md
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-JcSdkEvent -ApiHost <String> -Service <String[]> -StartTime <DateTime> [-EndTime <DateTime>]
...
### Get
```
Get-JcSdkEvent -ApiHost <String> -Body <IEventQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
